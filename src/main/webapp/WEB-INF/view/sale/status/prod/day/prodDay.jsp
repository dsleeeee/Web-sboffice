...
<div id="prodDayView" class="subCon" style="display: none;">
	<div ng-controller="prodDayCtrl">
		<div class="searchBar flddUnfld">
	    	...
	    	<%-- 조회 --%>
	    	<button class="btn_blue fr mt5 mr10" id="btnSearch" ng-click="_broadcast('prodDayCtrl')">
	    ...
	    <div class="w100 mt10">   
	      <div class="wj-gridWrap" style="height: 350px;">
	        <wj-flex-grid
	          ...
	          <!-- define columns -->
	          <wj-flex-grid-column header="<s:message code="prodday.prodClassNm"/>" binding="prodClassNm" 	width="150" align="center" is-read-only="true"></wj-flex-grid-column>
	          ...
	          <wj-flex-grid-column header="<s:message code="prodday.totSaleQty"/>" 	binding="totSaleQty" 	width="100" align="center" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/prod/day/prodDay.js?ver=20190125.02" charset="utf-8"></script>
