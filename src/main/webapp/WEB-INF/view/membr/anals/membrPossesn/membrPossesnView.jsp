    ...
    <div class="w100 mt10 mb20">
        <div class="wj-gridWrap" style="height:370px; overflow-y: hidden; overflow-x: hidden;">
            <wj-flex-grid
                ...
                <wj-flex-grid-column header="<s:message code="membrPossesn.totCnt"/>" binding="totCnt" width="115" is-read-only="true" align="right" aggregate="Sum"></wj-flex-grid-column>
