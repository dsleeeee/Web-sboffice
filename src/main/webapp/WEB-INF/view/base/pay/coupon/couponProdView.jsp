            ...
            <div ng-controller="regProdCtrl">
                <table class="tblType01">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="sb-input" id="srchProdClassCd" ng-model="prodClassNm" ng-click="popUpProdClass()" style="float: left;  width: 300px;" placeholder="<s:message code="cmm.prodClass" /> 선택" readonly/>
                        ...
                        <td>
                            <input type="text" id="srchBarcdCd" ng-model="barcdCd" class="sb-input w100" maxlength="40"/>
                        </td>
                    </tr>
                    <tr>
                        <%-- 사용여부 --%>
...
<script type="text/javascript" src="/resource/solbipos/js/base/pay/coupon/couponProd.js?ver=20250523.02" charset="utf-8"></script>
