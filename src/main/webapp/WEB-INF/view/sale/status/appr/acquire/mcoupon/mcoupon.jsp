...
<div id="apprAcquireMcouponView" class="subCon"  ng-controller="apprAcquireMcouponCtrl">
       ...
       <%-- 할부구분 --%>
        ...
        <td>
          <div class="sb-select">
              <span class="txtIn">
                    <wj-combo-box
                      id="srchAcquireMcouponApprFgDisplay"
                      ng-model="apprFg"
                      items-source="_getComboData('srchAcquireMcouponApprFgDisplay')"
                      display-member-path="name"
                      selected-value-path="value"
                      is-editable="false"
                      initialized="_initComboBox(s)">
