...
<div id="apprMpayView" class="subCon3"  ng-controller="apprMpayCtrl" style="display: none;padding: 10px 20px 40px;">
    ...
    <table class="searchTbl">
      ...
      <tr>
        ...
        <div class="sb-select">
            <span class="txtIn"><input id="srchApprMpayStartDate" class="w110px"></span>
                <span class="rg">~</span>
            <span class="txtIn"><input id="srchApprMpayEndDate" class="w110px"></span>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/appr/payMethod/mpay/mpay.js?ver=20250416.01" charset="utf-8"></script>
