 ...
 *
 * 파일명 : storeDayPos.js
 * 설  명 : 맘스터치 > 매장분석 > 매장-일별매출현황(포스별) JavaScript
 *
...
app.controller('storeDayPosCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  // 상위 객체 상속 : T/F 는 picker
  angular.extend(this, new RootController('storeDayPosCtrl', $scope, $http, true));
  ...
  $scope.initGrid = function (s, e) {
    ...
    $scope._makePickColumns("storeDayPosCtrl");
    ...
    dataItem.genRealSaleCntPos  = messages["day.dayTotal.pos"];
    dataItem.genRealSaleAmtPos  = messages["day.dayTotal.pos"];
    dataItem.dlvrRealSaleCntPos = messages["day.dayTotal.pos"];
    dataItem.dlvrRealSaleAmtPos = messages["day.dayTotal.pos"];
    dataItem.packRealSaleCntPos = messages["day.dayTotal.pos"];
    dataItem.packRealSaleAmtPos = messages["day.dayTotal.pos"];

    dataItem.genRealSaleCntChannel  = messages["day.dayTotal.channel"];
    dataItem.genRealSaleAmtChannel  = messages["day.dayTotal.channel"];
    dataItem.dlvrRealSaleCntChannel = messages["day.dayTotal.channel"];
    dataItem.dlvrRealSaleAmtChannel = messages["day.dayTotal.channel"];
    dataItem.packRealSaleCntChannel = messages["day.dayTotal.channel"];
    dataItem.packRealSaleAmtChannel = messages["day.dayTotal.channel"];

    dataItem.genRealSaleCntKiosk  = messages["day.dayTotal.kiosk"];
    dataItem.genRealSaleAmtKiosk  = messages["day.dayTotal.kiosk"];
    dataItem.dlvrRealSaleCntKiosk = messages["day.dayTotal.kiosk"];
    dataItem.dlvrRealSaleAmtKiosk = messages["day.dayTotal.kiosk"];
    dataItem.packRealSaleCntKiosk = messages["day.dayTotal.kiosk"];
    dataItem.packRealSaleAmtKiosk = messages["day.dayTotal.kiosk"];
  ...
  $scope.$on("storeDayPosCtrl", function (event, data) {
    $scope.searchDayList();
    // 기능수행 종료 : 반드시 추가
  ...
  $scope.searchDayList = function () {
    ...
    $.postJSON("/sale/store/storeDayPos/storeDayPos/getDayList.sb", params, function (response){
      var grid = $scope.flex;
 ...
 *  엑셀다운로드 그리드 생성
 */
app.controller('storeDayPosExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('storeDayPosExcelCtrl', $scope, $http, false));
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $.postJSON("/sale/store/storeDayPos/storeDayPos/getDayExcelList.sb", params, function (response){
          ...
          $timeout(function () {
            wijmo.grid.xlsx.FlexGridXlsxConverter.saveAsync($scope.excelFlex, {
              ...
              includeColumns: function (column) {
                ...
                messages["storeDayPos.storeDayPos"] + '_' + params.startDate + '_' + params.endDate + '_' + getCurDateTime() +'.xlsx', function () {
                  $timeout(function () {
