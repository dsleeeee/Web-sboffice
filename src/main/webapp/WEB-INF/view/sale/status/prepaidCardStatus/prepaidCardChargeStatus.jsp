...
<%--엑셀 리스트--%>
<div class="w100 mt10" style="display:none;" ng-controller="prepaidCardChargeStatusExcelCtrl">
    <div class="wj-gridWrap" style="height: 380px; overflow-x: hidden; overflow-y: hidden;">
        <wj-flex-grid
            ...
            <wj-flex-grid-column header="<s:message code="prepaidCardStatus.chargeCnt"/>" binding="chargeCnt" width="100" align="center" is-read-only="true"></wj-flex-grid-column>
            <wj-flex-grid-column header="<s:message code="prepaidCardStatus.totChargeAmt"/>" binding="totChargeAmt" width="120" align="center" is-read-only="true"></wj-flex-grid-column>
            <wj-flex-grid-column header="<s:message code="prepaidCardStatus.chargeCancelCnt"/>" binding="chargeCancelCnt" width="100" align="center" is-read-only="true"></wj-flex-grid-column>
            <wj-flex-grid-column header="<s:message code="prepaidCardStatus.totChargeCancelAmt"/>" binding="totChargeCancelAmt" width="120" align="center" is-read-only="true"></wj-flex-grid-column>
        </wj-flex-grid>
    </div>
</div>
<%--//엑셀 리스트--%>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/prepaidCardStatus/prepaidCardChargeStatus.js?ver=20260917.02" charset="utf-8"></script>
