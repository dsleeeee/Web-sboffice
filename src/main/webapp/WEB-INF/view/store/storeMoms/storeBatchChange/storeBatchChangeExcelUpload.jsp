    ...
    <div ng-controller="storeBatchChangeExcelUploadCtrl">
        ...
        <div class="mt10 oh">
            ...
            <c:if test="${sessionScope.sessionInfo.userId == 'ds021' or sessionScope.sessionInfo.userId == 'ds034' or sessionScope.sessionInfo.userId == 'h0393'}">
                <p class="tl s14 mt5 lh15 red">※ 업로드시 '매장코드, 그룹, 팀별, AC점포별, 지역구분, 상권, 정포유형, 매장관리타입, 매장그룹' 기준으로 처리됩니다.</p>
            </c:if>
...
<script type="text/javascript" src="/resource/solbipos/js/store/storeMoms/storeBatchChange/storeBatchChangeExcelUpload.js?ver=20231117.01" charset="utf-8"></script>
