...
<div class="subCon">
    ...
    <div class="w100 mt10">
      ...
      <div class="wj-gridWrap" style="height: 350px; overflow-x: hidden; overflow-y: hidden;">
        <wj-flex-grid
          ...
          <wj-flex-grid-column header="<s:message code="mcoupn.apprAmt"/>"  binding="apprAmt" width="80" align="right" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
  ...
  <div class="pageNum mt20">
    <%-- id --%>
    <ul id="mcoupnCtrlPager" data-size="10">
    </ul>
  </div>
  <%--//페이지 리스트--%>

  <%--엑셀 리스트--%>
  <div class="w100 mt10" style="display:none;" ng-controller="mcoupnExcelCtrl">
    <%--위즈모 테이블--%>
    <div class="wj-gridWrap" style="height: 350px; overflow-x: hidden; overflow-y: hidden;">
      <wj-flex-grid
              autoGenerateColumns="false"
...
<script type="text/javascript" src="/resource/solbipos/js/sale/appr/mcoupn/mcoupn.js?ver=20221005.01" charset="utf-8"></script>
