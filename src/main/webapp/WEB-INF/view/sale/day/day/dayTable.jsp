...
<div id="dayTableView" name="dayView" class="subCon" style="display: none;padding: 10px 20px 40px;" ng-controller="dayTableCtrl">
    ...
    <table class="searchTbl">
        ...
        <tbody>
            <tr>
                ...
                <td colspan="3">
                    <div class="sb-select">
                        <span class="txtIn"> <input id="startDateDayTable" name="startDate" class="w110px" /></span>
                        <span class="rg">~</span>
                        <span class="txtIn"> <input id="endDateDayTable" name="endDate" class="w110px" /></span>
                    </div>
                </td>
            </tr>
            <tr>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/day/day/dayTable.js?ver=20220114.02" charset="utf-8"></script>
