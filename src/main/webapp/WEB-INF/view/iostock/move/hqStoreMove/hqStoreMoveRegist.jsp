      ...
      <div class="w100 mt10 mb20">
        ...
        <div class="wj-gridWrap oh" style="height: 400px;">
          <wj-flex-grid
            ...
            <wj-flex-grid-column header="<s:message code="hqStoreMove.reg.poUnitFg"/>" binding="poUnitFg" width="70" align="center" is-read-only="true" data-map="poUnitFgMap"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/iostock/move/hqStoreMove/hqStoreMoveRegist.js?ver=20181224.01" charset="utf-8"></script>
