...
<wj-popup id="wjDayCashLayer" control="wjDayCashLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:900px;">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/cmmSalePopup/dayPayInfo/dayCash.js?ver=20190209.01" charset="utf-8"></script>
