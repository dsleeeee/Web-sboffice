 ...
 *  회원매출점유 그리드 생성
 */
app.controller('membrPossesnCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
 ...
 */
  ...
  $scope.searchMembrPossesn = function () {
    ...
    $scope._inquiryMain("/membr/anals/membrPossesn/membrPossesn/getMembrPossesnList.sb", params, function () {
    }, false);
  };
  // <-- //검색 호출 -->
