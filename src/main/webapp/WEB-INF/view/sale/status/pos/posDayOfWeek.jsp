...
<div id="posDayOfWeekView" class="subCon" style="display: none;" ng-controller="posDayOfWeekCtrl">
    ...
    <table class="searchTbl">
        ...
        <tr>
            ...
            <td>
                <div class="sb-select">
                    <span class="txtIn"><input id="srchPosDayOfWeekStartDate" class="w110px"></span>
                    <span class="rg">~</span>
                    <span class="txtIn"><input id="srchPosDayOfWeekEndDate" class="w110px"></span>
    ...
    <div class="w100 mt10" id="wjWrapType3">
        <div class="wj-gridWrap">
            <wj-flex-grid
                ...
                <!-- define columns -->
                <wj-flex-grid-column header="<s:message code="pos.yoil"/>"				binding="dayName" width="50" align="center" is-read-only="true" ></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/pos/posDayOfWeek.js?ver=20241209.01" charset="utf-8"></script>
