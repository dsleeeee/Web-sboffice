...
<div class="subCon" id ="hqSalePriceExcelUploadView" style="display: none">
    ...
    <div ng-controller="hqSalePriceExcelUploadSampleCtrl">
        ...
        <div class="searchBar flddUnfld">
            <a href="#" class="open fl"><s:message code="hqSalePriceExcelUpload.hqSalePriceExcelUpload" /></a>
        </div>
    ...
    <div ng-controller="hqSalePriceExcelUploadCtrl">
        <div class="mt10 oh sb-select dkbr">
            ...
            <%-- 전매장적용 --%>
            <span class="fr mr10"><input type="checkbox" id="applyFg" ng-model="applyFg" />
                <s:message code="hqSalePriceExcelUpload.allStoreApply" />
            </span>
        </div>
        <%-- 저장 --%>
...
<script type="text/javascript" src="/resource/solbipos/js/base/price/salePrice/hqSalePriceExcelUpload.js?ver=20230323.01" charset="utf-8"></script>
