...
app.controller('dstbCloseProdDtlCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  ...
  $scope.procFgMap = new wijmo.grid.DataMap([
    ...
    {id: "20", name: messages["dstbCloseProd.dtl.procFgDstbClose"]},
    {id: "30", name: messages["dstbCloseProd.dtl.procFgSlip"]}
  ], 'id', 'name');
