 ...
 */
public class ProdBarcdVO extends PageVO {
    ...
    private String barcdOld;


    /** 바코드유무 */
    private String barcdYn;
    /**
     * 소속구분<br>
     * M : 시스템<br>
     * A : 대리점<br>
    ...
    public String getBarcdOld() {
        return barcdOld;
    }

    public void setBarcdOld(String barcdOld) {
        this.barcdOld = barcdOld;
    }

    public String getBarcdYn() {
        return barcdYn;
    }

    public void setBarcdYn(String barcdYn) {
        this.barcdYn = barcdYn;
    }
