...
<div class="subCon" id="prodInfoView" ng-controller="prodInfoCtrl" style="display: none;padding: 10px 20px 40px;">
  <%--searchTbl--%>
  <div class="searchBar">
    ...
    <div class="wj-TblWrapBr mt10">
      ...
      <div class="wj-gridWrap" style="height: 380px; overflow-x: hidden; overflow-y: hidden;">
        <wj-flex-grid
          ...
          <wj-flex-grid-column header="<s:message code="prodInfoSearch.prodInfo.prodCd"/>" binding="prodCd" width="100" align="center" is-read-only="true"format="@"></wj-flex-grid-column>
          ...
          <wj-flex-grid-column header="<s:message code="prodInfoSearch.sideMenu.fixProdFg"/>" binding="grpFixProdFg" width="100" align="center" is-read-only="true"></wj-flex-grid-column>
          <wj-flex-grid-column header="<s:message code="prodInfoSearch.sideMenu.sdselTypeFg"/>" binding="sdselTypeFg" width="100" align="center" is-read-only="true"></wj-flex-grid-column>
          ...
          <c:if test="${(orgnFg == 'HQ' and hqOfficeCd == 'A0001') or (orgnFg == 'HQ' and hqOfficeCd == 'DS019')}">
            <wj-flex-grid-column header="<s:message code="prodInfoSearch.prodInfo.topYn"/>" binding="topYn" width="85" align="center" is-read-only="true"></wj-flex-grid-column>
          ...
          <wj-flex-grid-column header="<s:message code="prodInfoSearch.prodInfo.sdselProdCd"/>" binding="sdselProdCd" width="100" align="center" is-read-only="true"format="@"></wj-flex-grid-column>
          ...
          <wj-flex-grid-column header="<s:message code="prodInfoSearch.option.optionProdCd"/>" binding="optionProdCd" width="100" align="center" is-read-only="true"format="@"></wj-flex-grid-column>
