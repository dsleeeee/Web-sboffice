            ...
            <div class="w100 mt10 mb20">
                ...
                <div class="wj-gridWrap" style="height: 400px;">
                    <wj-flex-grid
                        ...
                        <wj-flex-grid-column header="<s:message code="dstbCloseProd.dtl.procFg"/>"           binding="procFg"           width="70"  align="center" is-read-only="true" ></wj-flex-grid-column>
    ...
    app.controller('dstbCloseProdDtlCtrl', ['$scope', '$http', function ($scope, $http) {
      ...
      // grid 초기화 : 생성되기전 초기화되면서 생성된다
        ...
        $scope.save = function () {
            ...
            $scope._save("/iostock/order/dstbCloseProd/dstbCloseProdDtl/save.sb", params, function() { $scope.saveDstbCloseProdDtlCallback() });
        };
