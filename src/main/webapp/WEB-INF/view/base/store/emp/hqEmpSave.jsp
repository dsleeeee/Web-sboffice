        ...
        <table class="searchTbl">
          ...
          <tr ng-if="hqEmpRegistInfo.webUseYn == 'Y'">
            ...
            <td colspan="3">
              ...
              <a href="#" class="btn_grayS" ng-show="newEmpYn == 2" ng-click="changePassword()"><s:message code="hqEmp.change.pwd" /></a>
            </td>
          </tr>
          <tr>
            <%-- 휴대폰번호 --%>
                ...
                <td>
                  <div class="sb-select">
                    <wj-combo-box
                            ...
                            ng-model="hqEmpRegistInfo.momsStoreFg02"
                ...
                <td>
                  <div class="sb-select">
                    <wj-combo-box
                            ...
                            ng-model="hqEmpRegistInfo.momsStoreFg03"
                ...
                <td>
                  <div class="sb-select">
                    <wj-combo-box
                            ...
                            ng-model="hqEmpRegistInfo.momsStoreFg04"
                ...
                <td>
                  <div class="sb-select">
                    <wj-combo-box
                            ...
                            ng-model="hqEmpRegistInfo.momsStoreFg05"
...
<script type="text/javascript" src="/resource/solbipos/js/base/store/emp/hqEmpSave.js?ver=20240322.02" charset="utf-8"></script>
