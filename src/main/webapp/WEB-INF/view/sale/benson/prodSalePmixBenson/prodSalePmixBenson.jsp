...
<div class="subCon">
    ...
    <div ng-controller="prodSalePmixBensonCtrl">
        <div class="searchBar">
            <a href="#" class="open fl"><s:message code="prodSalePmixBenson.prodSalePmixBenson" /></a>
            <%-- 조회 --%>
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('prodSalePmixBensonCtrl', 1)">
        ...
        <table class="searchTbl">
            ...
            <tr>
                <%-- 기간선택 --%>
                <th><s:message code="prodSalePmixBenson.period"/></th>
                <td>
                    <div class="sb-select">
                        <%-- 일/월 구분 --%>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                            ...
                            <jsp:param name="targetId" value="prodSalePmixBensonStore"/>
                        </jsp:include>
                        <%--// 매장선택 모듈 사용시 include --%>
                    </td>
                </tr>
            ...
            <c:if test="${sessionInfo.orgnFg == 'STORE'}">
                <input type="hidden" id="prodSalePmixBensonStoreCd" value="${sessionInfo.storeCd}"/>
            </c:if>
            <tr>
                <c:if test="${sessionInfo.orgnFg == 'HQ'}">
                    <%-- 상품브랜드 --%>
                ...
                <td>
                    ...
                    <jsp:include page="/WEB-INF/view/sale/com/popup/selectProdMMoms.jsp" flush="true">
                        <jsp:param name="targetId" value="prodSalePmixBensonSelect"/>
                    </jsp:include>
        ...
        <div class="w100 mt10">
            <div class="wj-gridWrap" style="height: 370px; overflow-x: hidden; overflow-y: hidden;">
                <wj-flex-grid
                    ...
                    <!-- define columns -->
                    <wj-flex-grid-column header="<s:message code="prodSalePmixBenson.prodClassNm"/>" binding="prodClassNm" width="150" align="center" is-read-only="true"></wj-flex-grid-column>
                    <wj-flex-grid-column header="<s:message code="prodSalePmixBenson.prodNm"/>" binding="prodNm" width="120" align="center" is-read-only="true"></wj-flex-grid-column>
                </wj-flex-grid>
            </div>
        </div>
        <%-- 페이지 리스트 --%>
        <div class="pageNum mt20">
            <%-- id --%>
            <ul id="prodSalePmixBensonCtrlPager" data-size="10">
            </ul>
        </div>
        <%-- //페이지 리스트 --%>
    </div>
    ...
    <%-- 엑셀 리스트 --%>
    <div class="w100 mt10" style="display:none;" ng-controller="prodSalePmixBensonExcelCtrl">
        <div class="wj-gridWrap" style="height: 370px; overflow-x: hidden; overflow-y: hidden;">
            <wj-flex-grid
                    id="wjGridExcelList"
                    autoGenerateColumns="false"
...
<script type="text/javascript" src="/resource/solbipos/js/sale/benson/prodSalePmixBenson/prodSalePmixBenson.js?ver=20260909.01" charset="utf-8"></script>
