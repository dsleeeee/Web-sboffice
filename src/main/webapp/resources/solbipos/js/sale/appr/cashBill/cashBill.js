...
app.controller('cashBillCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  ...
  $scope.$on("cashBillCtrl", function (event, data) {
  ...
  $scope.searchCashBillList = function () {
    ...
    if( isEmptyObject( $("#cashBillStoreCd").val()) ) {
    ...
    $scope._inquiryMain("/sale/appr/cashBill/cashBill/getCashBillList.sb", params);
  };
  ...
  $scope.cashBillStoreShow = function () {
    $scope._broadcast('cashBillStoreCtrl');
  };
...
app.controller('cashBillExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

  // 상위 객체 상속 : T/F 는 picker
  angular.extend(this, new RootController('cashBillExcelCtrl', $scope, $http, true));
  ...
  // 다른 컨트롤러의 broadcast 받기
  $scope.$on("cashBillExcelCtrl", function (event, data) {
  ...
  $scope.searchExcelList = function (data) {
    ...
    // 조회 수행 : 조회URL, 파라미터, 콜백함수
    $scope._inquiryMain("/sale/appr/cashBill/cashBill/getCashBillExcelList.sb", params, function() {
      ...
      $timeout(function () {
        ...
        }, messages["cashBillMoms.cashBillMoms"]+getToday()+'.xlsx', function () {
          $timeout(function () {
