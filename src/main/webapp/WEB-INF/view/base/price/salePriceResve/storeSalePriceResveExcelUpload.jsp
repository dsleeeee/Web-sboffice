        ...
        <div class="wj-gridWrap" style="display: none">
            <wj-flex-grid
                ...
                <c:if test="${momsEnvstVal == '1'}">
                    <wj-flex-grid-column header="<s:message code="storeSalePriceResveExcelUpload.storeChgNot"/>" binding="storeChgNot" width="100" is-read-only="true" align="center"></wj-flex-grid-column>
                </c:if>
            </wj-flex-grid>
        </div>
    </div>
