...
<!-- contents start -->
<div class="subCon" ng-controller="mobileHqMonthIoStockCtrl">

    <div class="searchBar">
        <a href="#" class="open fl">${menuNm}</a>
        <%-- 조회 --%>
        <button class="btn_blue fr mt5 mr10" id="btnSearch" ng-click="_broadcast('mobileHqMonthIoStockMainCtrlSrch')">
        ...
        <tr>
            ...
            <td style="display: none;">
                ...
                <jsp:include page="/WEB-INF/view/iostock/cmm/selectVendrM.jsp" flush="true">
                    <jsp:param name="targetId" value="mobileHqMonthIoStockSelectVendr"/>
                </jsp:include>
                <input type="hidden" id="mobileHqMonthIoStockSelectVendrCd" value=""/>
            </td>
        </tr>
        </tbody>
    </table>
    ...
    <div ng-controller="mobileHqMonthIoStockMainCtrl">
        ...
        <div class="w100 mt10" id="wjWrapType2">
            <div class="wj-gridWrap" style="overflow-x: hidden; overflow-y: hidden;">
                <wj-flex-grid
                    ...
                    <wj-flex-grid-column header="<s:message code="monthIostock.accSaleVendrOutQty"/>" binding="saleVendrOrderQty" width="60" align="right" is-read-only="true" aggregate="Sum" visible="false"></wj-flex-grid-column>
                    <wj-flex-grid-column header="<s:message code="monthIostock.accSaleVendrOutAmt"/>" binding="saleVendrOrderTot" width="60" align="right" is-read-only="true" aggregate="Sum" visible="false"></wj-flex-grid-column>
                    <wj-flex-grid-column header="<s:message code="monthIostock.accSaleVendrInQty"/>"  binding="saleVendrRtnQty" width="60" align="right" is-read-only="true" aggregate="Sum" visible="false"></wj-flex-grid-column>
                    <wj-flex-grid-column header="<s:message code="monthIostock.accSaleVendrInAmt"/>"  binding="saleVendrRtnTot" width="60" align="right" is-read-only="true" aggregate="Sum" visible="false"></wj-flex-grid-column>
                    ...
                    <div class="gridMsg" id="mobileHqMonthIoStockMsg" style="line-height: 150px; display: none;"><s:message code="mobile.cmm.search.result.empty"/></div>
                </wj-flex-grid>
                <%-- ColumnPicker 사용시 include --%>
                <jsp:include page="/WEB-INF/view/layout/columnPicker.jsp" flush="true">
                    <jsp:param name="pickerTarget" value="mobileHqMonthIoStockMainCtrl"/>
                </jsp:include>
                <%--// ColumnPicker 사용시 include --%>
            </div>
            <%-- 페이지 리스트 --%>
            <div class="pageNum3 mt20">
                <%-- id --%>
                <ul id="mobileHqMonthIoStockMainCtrlPager" data-size="10">
                </ul>
            </div>
            <%--//페이지 리스트--%>
            ...
            <%-- 엑셀 리스트 --%>
            <div class="w100 mt10" id="wjWrapType3" style="display:none;" ng-controller="mobileHqMonthIoStockExcelCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/mobile/stock/status/monthIoStock/mobileHqMonthIoStock.js?ver=20240719.01" charset="utf-8"></script>
