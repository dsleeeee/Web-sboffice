...
<div class="subCon" ng-controller="storeDayChannelBensonCtrl">
    <div class="searchBar">
        <a href="#" class="open fl"><s:message code="storeDayChannelBenson.storeDayChannelBenson"/></a>
        <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
            <%-- 조회 --%>
            <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('storeDayChannelBensonCtrl', 1)">
    ...
    <table class="searchTbl">
            ...
            <tr>
                ...
                <td>
                    ...
                    <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                        ...
                        <jsp:param name="targetId" value="storeDayChannelBensonStore"/>
                    </jsp:include>
                        <%--// 매장선택 모듈 사용시 include --%>
                </td>
            </tr>
        ...
        <c:if test="${sessionInfo.orgnFg == 'STORE'}">
            <input type="hidden" id="storeDayChannelBensonStoreCd" value="${sessionInfo.storeCd}"/>
        </c:if>
        </tbody>
    </table>
    ...
    <div class="w100 mt10">
        ...
        <div class="pageNum mt20">
            <ul id="storeDayChannelBensonCtrlPager" data-size="10">
            </ul>
        </div>
        <%--//페이지 리스트--%>

        <%--위즈모 테이블--%>
        <div class="wj-gridWrap" style="display: none;" ng-controller="storeDayChannelBensonExcelCtrl">
            <wj-flex-grid
                    id="wjGridExcelList"
                    autoGenerateColumns="false"
                    selection-mode="Row"
...
<script type="text/javascript" src="/resource/solbipos/js/sale/store/storeDayChannelBenson/storeDayChannelBenson.js?ver=20260708.01" charset="utf-8"></script>
