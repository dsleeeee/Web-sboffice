...
<div id="envConfgBatchChangeStoreView" class="subCon" ng-controller="envConfgBatchChangeStoreCtrl" style="display: none;padding: 10px 20px 40px;">
    ...
    <div class="searchBar flddUnfld">
        ...
        <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
            <button class="btn_blue fr" ng-click="_broadcast('envConfgBatchChangeStoreCtrl',1)" id="nxBtnSearch2">
...
<script type="text/javascript" src="/resource/solbipos/js/store/manage/envConfgBatchChange/envConfgBatchChangeStore.js?ver=20251022.01" charset="utf-8"></script>