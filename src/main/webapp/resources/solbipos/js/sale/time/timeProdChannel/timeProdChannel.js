...
app.controller('timeProdChannelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchList = function(){
       ...
       $.postJSON("/sale/time/timeProdChannel/timeProdChannel/getTimeProdChannelList.sb", params, function (response){
           var grid = $scope.flex;
...
app.controller('timeProdChannelExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $.postJSON("/sale/time/timeProdChannel/timeProdChannel/getTimeProdChannelExcelList.sb", params, function (response){
