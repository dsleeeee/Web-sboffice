...
<div id="inOutStockReportView" style="display: none;" ng-controller="inOutStockReportCtrl">
    ...
    <div class="inOutStockReport reportPrint w100" id="report">
    </div>
</div>

<script type="text/javascript" src="/resource/solbipos/js/kookmin/acquire/acquireSlipRegist/inOutStockReport.js?ver=20251128.01" charset="utf-8"></script>
