...
<wj-popup id="memberInfoDetailLayer" control="memberInfoDetailLayer" show-trigger="Click" hide-trigger="Click" style="width:750px;height:570px;" fade-in="false" fade-out="false">
