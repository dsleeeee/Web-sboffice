...
//        			params.tblCd	 = storeTable.join(",");
    ...
    $scope.searchTableDayOfWeekList = function (isPageChk) {
        ...
        var startDt = new Date(wijmo.Globalize.format($scope.srchTableDayOfWeekStartDate.value, 'yyyy-MM-dd'));
        var endDt = new Date(wijmo.Globalize.format($scope.srchTableDayOfWeekEndDate.value, 'yyyy-MM-dd'));
