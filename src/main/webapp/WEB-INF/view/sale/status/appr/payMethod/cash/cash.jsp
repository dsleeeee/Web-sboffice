       ...
       <%-- 할부구분 --%>
        ...
        <td>
          <div class="sb-select">
              <span class="txtIn">
                    <wj-combo-box
                      id="srchCashInstCntFgDisplay"
                      ng-model="instCntFg"
                      items-source="_getComboData('srchCashInstCntFgDisplay')"
        ...
        <td>
          <div class="sb-select">
              <span class="txtIn">
                    <wj-combo-box
                      id="srchCashApprFgDisplay"
                      ng-model="apprFg"
                      items-source="_getComboData('srchCashApprFgDisplay')"
                      display-member-path="name"
                      selected-value-path="value"
                      is-editable="false"
                      initialized="_initComboBox(s)">
...
<%--             </jsp:include> --%>
      ...
      <c:if test="${sessionInfo.orgnFg == 'STORE'}">  
        ...
        <input type="hidden" id="apprCashSelectCornrNo" value=""/>
