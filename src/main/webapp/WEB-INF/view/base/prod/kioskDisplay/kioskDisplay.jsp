...
<div class="subCon" ng-controller="kioskDisplayCtrl" >
    ...
    <div class="wj-TblWrapBr mt10">
        ...
        <div id="theGrid" style="height: 370px;">
            <wj-flex-grid
                ...
                <wj-flex-grid-column header="<s:message code="soldOut.soldOutYn"/>" binding="soldOutYn" width="80" data-map="soldOutYnDataMap" is-read-only="true" align="center"></wj-flex-grid-column>
            ...
            <jsp:include page="/WEB-INF/view/layout/columnPicker.jsp" flush="true">
                <jsp:param name="pickerTarget" value="kioskDisplayCtrl"/>
            </jsp:include>
        </div>
    </div>
    <%--//위즈모 테이블--%>
    ...
    <div class="pageNum mt20">
        <%-- id --%>
        <ul id="kioskDisplayCtrlPager" data-size="10">
        </ul>
    </div>
    <%--//페이지 리스트--%>
...
<script type="text/javascript" src="/resource/solbipos/js/base/prod/kioskDisplay/kioskDisplay.js?ver=20230310.01" charset="utf-8"></script>
