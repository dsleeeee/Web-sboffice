    ...
    <table class="searchTbl">
      ...
      <tr>
        ...
        <td>
          ...
          <%-- 매장코드 --%>
        <th class="storePayDay" style="display: none;"><s:message code="todayBillSaleDtl.store"/></th>
      ...
      <div class="wj-gridWrap" style="height: 350px; overflow-y: hidden; overflow-x: hidden;">
        <wj-flex-grid
          ...
          <c:forEach var="payCol" items="${payColList}">
            <wj-flex-grid-column header="<s:message code="storePayDay.cnt"/>" binding="payCnt${payCol.payCd}" width="100" align="right" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/pay/storePayDay/storePayDay.js?ver=20221221.01" charset="utf-8"></script>