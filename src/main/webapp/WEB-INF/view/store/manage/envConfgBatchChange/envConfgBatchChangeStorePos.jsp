...
<div id="envConfgBatchChangeStorePosView" class="subCon" ng-controller="envConfgBatchChangeStorePosCtrl" style="display: none;">
    ...
    <div class="searchBar flddUnfld">
        ...
        <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
            <button class="btn_blue fr" ng-click="_broadcast('envConfgBatchChangeStorePosCtrl',1)">
...
<script type="text/javascript" src="/resource/solbipos/js/store/manage/envConfgBatchChange/envConfgBatchChangeStorePos.js?ver=20210322.04" charset="utf-8"></script>