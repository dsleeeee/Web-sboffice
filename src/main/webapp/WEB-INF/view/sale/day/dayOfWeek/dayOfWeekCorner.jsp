            ...
            <div class="row">
                <wj-flex-grid
                    ...
                    <c:forEach var="cornerCol" items="${cornerColList}">
                        <wj-flex-grid-column header="<s:message code="dayofweek.realSaleAmt"/>" binding="cornr${cornerCol.storeCornrCd}RealSaleAmt" width="80" align="right" is-read-only="true" aggregate="Sum" visible="false"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="dayofweek.saleQty"/>" binding="cornr${cornerCol.storeCornrCd}SaleQty" width="80" align="right" is-read-only="true" aggregate="Sum" visible="false"></wj-flex-grid-column>
                    </c:forEach>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/day/dayOfWeek/dayOfWeekCorner.js?ver=20200117.09" charset="utf-8"></script>