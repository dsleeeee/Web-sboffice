...
app.controller('apprAcquireNcardCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  ...
  $scope.searchApprAcquireNcardList = function (isPageChk) {
	  ...
	  var startDt = new Date(wijmo.Globalize.format($scope.srchApprAcquireNcardStartDate.value, 'yyyy-MM-dd'));
	  var endDt = new Date(wijmo.Globalize.format($scope.srchApprAcquireNcardEndDate.value, 'yyyy-MM-dd'));
