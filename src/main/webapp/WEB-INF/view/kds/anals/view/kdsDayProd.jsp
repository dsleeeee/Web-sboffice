...
<div class="subCon" ng-controller="kdsDayProdCtrl">
    ...
    <div class="searchBar flddUnfld">
        ...
        <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
            <button class="btn_blue fr" ng-click="_broadcast('kdsDayProdList')">
...
<script type="text/javascript" src="/resource/solbipos/js/kds/anals/chart/kdsDayProd.js?ver=2020070801.13"
