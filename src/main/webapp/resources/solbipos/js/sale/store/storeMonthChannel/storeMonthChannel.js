...
app.controller('storeMonthChannelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchMonthTotal = function() {
        ...
        $.postJSON("/sale/store/storeMonthChannel/storeMonthChannel/getMonthList.sb", params, function(response) {
            var grid = $scope.flex;
...
app.controller('storeMonthChannelExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchExcelList = function (params) {
        ...
        $.postJSON("/sale/store/storeMonthChannel/storeMonthChannel/getMonthExcelList.sb", params, function(response) {
            ...
            $timeout(function () {
                wijmo.grid.xlsx.FlexGridXlsxConverter.saveAsync($scope.excelFlex, {
                    ...
                    messages["storeMonthChannel.storeMonthChannel"] + '_' + params.startMonth + '_' + params.endMonth + '_' + getCurDateTime() +'.xlsx', function () {
                        $timeout(function () {
