...
<div id="apprAcquireCardView" class="subCon"  ng-controller="apprAcquireCardCtrl">
    ...
    <table class="searchTbl">
       ...
       <%-- 할부구분 --%>
        ...
        <td>
          <div class="sb-select">
              <span class="txtIn">
                    <wj-combo-box
                      id="srchAcquireCardProdDcFgDisplay"
                      ng-model="prodDcFg"
                      items-source="_getComboData('srchAcquireCardProdDcFgDisplay')"
        ...
        <td>
          <div class="sb-select">
              <span class="txtIn">
                    <wj-combo-box
                      id="srchAcquireCardApprFgDisplay"
                      ng-model="apprFg"
                      items-source="_getComboData('srchAcquireCardApprFgDisplay')"
                      display-member-path="name"
                      selected-value-path="value"
                      is-editable="false"
                      initialized="_initComboBox(s)">
      ...
      <c:if test="${sessionInfo.orgnFg == 'STORE'}">  
        ...
        <input type="hidden" id="apprAcquireCardSelectCornrNo" value=""/>
