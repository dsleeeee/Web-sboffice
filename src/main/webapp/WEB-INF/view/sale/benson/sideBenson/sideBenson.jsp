...
<%--
    ...
    No  ||  수정자 ||  수정일자    ||  수정내역
    ======================================================
    1       김유승     2026.09.10     신규생성 (링크 개발실 개발1팀 김유승)
--%>
...
<div class="con">
    <div class="tabType1" ng-controller="sideBensonCtrl" ng-init="init()">
        <ul>
            <%-- 상품별 탭 --%>
            <li>
                <a id="sideBensonProdClassTab" href="#" class="on" ng-click="sideBensonProdClassShow()"><s:message code="sideBenson.prodClass"/></a>
            </li>
        </ul>
    </div>
</div>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/benson/sideBenson/sideBenson.js?ver=20260910.02" charset="utf-8"></script>

<%-- 탭페이지 레이어 시작 --%>
<%-- 상품별 레이어 --%>
<c:import url="/WEB-INF/view/sale/benson/sideBenson/sideBensonProdClass.jsp">
