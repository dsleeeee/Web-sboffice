...
<div class="subCon" id="hqSalePriceResve" style="padding: 10px 20px 40px;">

    <div  ng-controller="hqSalePriceResveCtrl">
        <div class="searchBar">
        ...
        <div class="mt10 oh">
            ...
            <%-- 조회조건 엑셀다운로드 --%>
            <button class="btn_skyblue ml5 fr" ng-click="excelDownloadProdPrice()"><s:message code="cmm.excel.downCondition"/></button>
            <%-- 저장 --%>
        ...
        <div class="wj-TblWrapBr mt10">
            <div style="height: 400px; overflow-y: hidden; overflow-x: hidden;">
                <wj-flex-grid
                    ...
                    <wj-flex-grid-column header="<s:message code="salePriceResve.update"/>" binding="saleUprc" width="60" align="right" max-length="10"></wj-flex-grid-column>
    ...
    <%-- 엑셀 리스트 --%>
    <div class="w100 mt10" style="display:none;" ng-controller="hqSalePriceResveExcelCtrl">
        <div class="wj-gridWrap" style="height: 370px; overflow-x: hidden; overflow-y: hidden;">
            <wj-flex-grid
                    ...
                    selection-mode="Row"
                    items-source="data"
                    control="excelFlexHqSalePriceResve"
                    initialized="initGrid(s,e)"
                    is-read-only="true"
                    item-formatter="_itemFormatter">
...
<script type="text/javascript" src="/resource/solbipos/js/base/price/salePriceResve/hqSalePriceResve.js?ver=20260605.01" charset="utf-8"></script>
