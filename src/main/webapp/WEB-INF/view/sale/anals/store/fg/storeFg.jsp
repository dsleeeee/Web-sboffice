...
<div id="storeFgView" class="subCon" ng-controller="storeFgCtrl">
	<div class="searchBar flddUnfld">
		...
		<%-- 조회 --%>
		<button class="btn_blue fr mt5 mr10" id="btnStoreFgSearch" ng-click="_broadcast('storeFgCtrl')">
		...
		<tbody>
			...
			<tr>
				...
				<td>
                    ...
                    <jsp:includepage="/WEB-INF/view/iostock/cmm/selectStoreS.jsp" flush="true">
						<jsp:param name="targetId" value="storeFgSelectProd" />
						<jsp:param name="closeFunc" value="getStoreFgComboList" />
					</jsp:include> 
