    ...
    <div class="wj-TblWrapBr mt10">
      ...
      <div class="wj-gridWrap" style="height: 450px; overflow-x: hidden; overflow-y: hidden;">
        <wj-flex-grid
          ...
          <wj-flex-grid-column header="<s:message code="prodInfoSearch.kioskKeyMap.prodCd"/>" binding="prodCd" width="100" align="center" is-read-only="true" format="@"></wj-flex-grid-column>
