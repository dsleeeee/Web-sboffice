...
/**
 * @Class Name : StoreChgCostPriceVO.java
 ...
 */
public class StoreChgCostPriceVO extends PageVO {

    private static final long serialVersionUID = -1554223653486980382L;
    ...
    public String getStoreCostUprc() {
        return storeCostUprc;
    }

    public void setStoreCostUprc(String storeCostUprc) {
        this.storeCostUprc = storeCostUprc;
    }
