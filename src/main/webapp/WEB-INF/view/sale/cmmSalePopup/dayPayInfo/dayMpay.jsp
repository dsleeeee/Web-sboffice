...
<wj-popup id="wjDayMpayLayer" control="wjDayMpayLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:550px; height:480px;">
      ...
      <div class="w100 mt10">
        ...
        <div class="wj-gridWrap" style="height: 350px; overflow-y: hidden; overflow-x: hidden;">
          <wj-flex-grid
            ...
            <!-- define columns -->
            <wj-flex-grid-column header="<s:message code="dayMpay.mpayNm"/>" binding="mpayNm" width="*" align="center" is-read-only="true"></wj-flex-grid-column>
            <wj-flex-grid-column header="<s:message code="dayMpay.apprCnt"/>" binding="apprCnt" width="70" align="right" is-read-only="true" data-type="Number" format="n0" aggregate="Sum"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/cmmSalePopup/dayPayInfo/dayMpay.js?ver=20210719.01" charset="utf-8"></script>