...
<wj-popup id="wjInStockReportDtlReportLayer" control="wjInStockReportDtlReportLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:900px;">
    <div id="dstbProdReportLayer" class="wj-dialog wj-dialog-columns" ng-controller="inStockReportDtlReportCtrl">
        ...
        <div class="wj-dialog-body sc2" style="height: 600px;">
            ...
            <div class="inStockReportDtlReport reportPrint w100" id="inStockReportDtlReport">
            </div>
