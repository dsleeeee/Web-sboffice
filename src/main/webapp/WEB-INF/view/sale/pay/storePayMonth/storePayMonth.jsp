    ...
    <div ng-controller="storePayMonthCtrl">
        ...
        <div class="searchBar">
            ...
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <%-- 조회 --%>
                <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('storePayMonthCtrl', 1)">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/pay/storePayMonth/storePayMonth.js?ver=20251229.01" charset="utf-8"></script>
