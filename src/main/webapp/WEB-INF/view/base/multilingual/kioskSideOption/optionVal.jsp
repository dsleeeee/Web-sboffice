...
<%-- 양식다운로드 관련 --%>
<div style="display: none;" ng-controller="optionValExcelDownCtrl">
...
<%-- 엑셀 업로드 관련 --%>
<div style="display: none;" ng-controller="optionValExcelUploadCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/base/multilingual/kioskSideOption/optionVal.js?ver=20231130.01" charset="utf-8"></script>