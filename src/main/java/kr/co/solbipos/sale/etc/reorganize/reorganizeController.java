package kr.co.solbipos.sale.etc.reorganize;
...
* @Description : 매출관리>매출현황2>매출현황구성(종합탭)
...
*/
@Controller
@RequestMapping(value = "/sale/etc/reorganize")
public class reorganizeController {
    ...
    public reorganizeController(SessionService sessionService, CmmEnvUtil cmmEnvUtil, TouchKeyService touchkeyService, ProdService prodService) {
    ...
    public String view(HttpServletRequest request, HttpServletResponse response,
        ...
        return "sale/etc/reorganize/reorganize";
    }
