...
<c:set var="baseUrl" value="/iostock/vendr/verdrOrder/vendrOrderProd/"/>
  ...
  <div class="w100 mt10 mb20">
    ...
    <div class="wj-gridWrap" style="height: 400px;">
      <wj-flex-grid
        ...
        <wj-flex-grid-column header="<s:message code="vendrOrder.prod.poUnitFg"/>" binding="poUnitFg" width="70" align="right" is-read-only="true"></wj-flex-grid-column>
