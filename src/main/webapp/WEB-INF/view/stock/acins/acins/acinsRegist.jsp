    ...
    <div class="wj-dialog-body sc2" style="height: 600px;">
      ...
      <form name="myForm" novalidate>
        <table class="tblType01" style="position: relative;">
          ...
          <tr>
            <td colspan="4">
              <a href="#" class="btn_grayS" ng-click=""><s:message code="acins.reg.excelFormDownload"/></a>
              <a href="#" class="btn_grayS" ng-click=""><s:message code="acins.reg.excelFormUpload"/></a>
              <a href="#" class="btn_grayS" ng-click=""><s:message code="acins.reg.textFormUpload"/></a>
              <a href="#" class="btn_grayS" ng-click=""><s:message code="cmm.excel.down"/></a>
              <a href="#" class="btn_grayS" ng-click=""><s:message code="acins.reg.excelFormUploadErrorInfo"/></a>
            </td>
          </tr>
          </tbody>
        </table>
