                ...
                reader.onload = function(){
                    ...
                    wb.SheetNames.forEach(function(sheetName) {
                        ...
                        arr.forEach(function(item){
                            ...
                            renameKey(item, '본사판매가', 'hqSaleUprc');
                            renameKey(item, '매장현재판매가', 'storeSaleUprc');
                            renameKey(item, '매장변경판매가', 'saleUprc');
                            renameKey(item, '매장현재내점판매가', 'storeStinSaleUprc');
                            renameKey(item, '매장변경내점판매가', 'stinSaleUprc');
                            renameKey(item, '매장현재배달판매가', 'storeDlvrSaleUprc');
                            renameKey(item, '매장변경배달판매가', 'dlvrSaleUprc');
                            renameKey(item, '매장현재포장판매가', 'storePackSaleUprc');
                            renameKey(item, '매장변경포장판매가', 'packSaleUprc');
