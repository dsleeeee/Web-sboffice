...
public class MobileApprServiceImpl implements MobileApprService {
    ...
    public MobileApprServiceImpl(MobileApprMapper mobileApprMapper, PopupMapper popupMapper) {
    ...
    public List<DefaultMap<Object>> getMobileApprList(MobileApprVO mobileApprVO, SessionInfoVO sessionInfoVO) {
        ...
        if(!StringUtil.getOrBlank(mobileApprVO.getSrchStoreCd()).equals("")) {
            ...
            storeVO.setArrSplitStoreCd(CmmUtil.splitText(mobileApprVO.getSrchStoreCd(), 3900));
            mobileApprVO.setStoreCdQuery(popupMapper.getSearchMultiStoreRtn(storeVO));
        }
