...
<wj-popup id="mobileProdQtyDtlLayer" control="mobileProdQtyDtlLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:90%;height:90%">
    <div id="cardLayer" class="wj-dialog wj-dialog-columns" ng-controller="mobileProdQtyDtlCtrl">
        <div id="popHeader" class="wj-dialog-header wj-dialog-header-font">
            <span>{{ioOccrFg}}<s:message code="periodIostock.info"/></span>&nbsp;&nbsp;{{prodNm}}
            ...
            <div class="w100 mt10 mb20">
                ...
                <div class="popGrid mt5" style="height: 500px; overflow-x: hidden; overflow-y: hidden;">
                    ...
                    <jsp:include page="/WEB-INF/view/layout/columnPicker.jsp" flush="true">
                        <jsp:param name="pickerTarget" value="mobileProdQtyDtlCtrl"/>
                    </jsp:include>
                    <%--// ColumnPicker 사용시 include --%>
                </div>
                <%--//위즈모 테이블--%>
...
<script type="text/javascript" src="/resource/solbipos/js/mobile/stock/com/popup/prodQtyDtl/mobileProdQtyDtl.js?ver=20240730.01" charset="utf-8"></script>
