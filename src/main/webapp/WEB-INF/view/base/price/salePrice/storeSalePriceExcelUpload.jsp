...
<div class="subCon" id ="storeSalePriceExcelUploadView" style="display: none;padding: 10px 20px 40px;">
    ...
    <div ng-controller="storeSalePriceExcelUploadSampleCtrl">
        ...
        <div class="wj-gridWrap" style="display: none">
            <wj-flex-grid
                ...
                <wj-flex-grid-column header="<s:message code="storeSalePriceExcelUpload.prodCd"/>" binding="prodCd" width="100" is-read-only="true" align="center" format="@"></wj-flex-grid-column>
                ...
                <wj-flex-grid-column header="<s:message code="storeSalePriceExcelUpload.saleUprc"/>" binding="saleUprc" width="100" align="right" max-length="10"></wj-flex-grid-column>
        ...
        <div class="w100 mt10 mb20">
            <div class="wj-gridWrap" style="height:310px; overflow-y: hidden; overflow-x: hidden;">
                <wj-flex-grid
                    ...
                    <wj-flex-grid-column header="<s:message code="storeSalePriceExcelUpload.prodTypeFg"/>" binding="prodTypeFg" is-read-only="true" width="85" align="center" visible="false"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/base/price/salePrice/storeSalePriceExcelUpload.js?ver=20240530.01" charset="utf-8"></script>
