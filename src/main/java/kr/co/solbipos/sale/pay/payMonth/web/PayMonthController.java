package kr.co.solbipos.sale.pay.payMonth.web;
...
/**
 * @Class Name : PayMonthController.java
 ...
 */
@Controller
@RequestMapping("/sale/pay/payMonth")
public class PayMonthController {

    private final SessionService sessionService;
    private final PayMonthService payMonthService;
     ...
     */
    @Autowired
    public PayMonthController(SessionService sessionService, PayMonthService payMonthService, DayService dayService, CmmCodeUtil cmmCodeUtil, DayProdService dayProdService) {
     ...
     * @param model
     */
    @RequestMapping(value = "/payMonth/list.sb", method = RequestMethod.GET)
    public String payMonthView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/pay/payMonth/payMonth";
    }
     ...
     * @since   2022.10.13
     */
    @RequestMapping(value = "/payMonth/getPayMonthList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getPayMonthList(HttpServletRequest request, HttpServletResponse response, Model model, PayMonthVO payMonthVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> list = payMonthService.getPayMonthList(payMonthVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, list, payMonthVO);
    }
