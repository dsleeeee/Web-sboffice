...
app.controller('prodSaleDayStoreMomsCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchProdSaleDayStoreMomsList = function () {
        ...
        $.postJSON("/sale/moms/prodSaleDayStoreMoms/prodSaleDayStoreMoms/getProdSaleDayStoreMomsList.sb", params, function (response){
            // <-- 그리드 visible -->
                ...
                function delay(x){
                    return new Promise(function(resolve, reject){
                        ...
                        $.postJSON("/sale/moms/prodSaleDayStoreMoms/prodSaleDayStoreMoms/getDivisionExcelDownloadSaveUpdate.sb", params, function(response){
                            ...
                            // ajax 통신 설정
                            $.postJSON("/sale/moms/prodSaleDayStoreMoms/prodSaleDayStoreMoms/getProdSaleDayStoreMomsExcelDivisionList.sb", params, function(response) {
                                // <-- 그리드 visible -->
                                // 선택한 테이블에 따른 리스트 항목 visible
                                var grid = wijmo.Control.getControl("#wjGridExcelList");
                                var columns = grid.columns;
