package kr.co.solbipos.sale.anals.abcBenson.web;
...
/**
 * @Class Name : AbcBensonController.java
 ...
 */
@Controller
@RequestMapping("/sale/anals/abcBenson")
public class AbcBensonController {

    private final SessionService sessionService;
    private final AbcBensonService abcBensonService;
    ...
    @Autowired
    public AbcBensonController(SessionService sessionService, AbcBensonService abcBensonService, CmmEnvUtil cmmEnvUtil, DayProdService dayProdService, CmmCodeUtil cmmCodeUtil, KioskDisplayService kioskDisplayService, ProdService prodService) {
        this.sessionService = sessionService;
        this.abcBensonService = abcBensonService;
     ...
     * @param model
     */
    @RequestMapping(value = "/abcBenson/list.sb", method = RequestMethod.GET)
    public String view(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/anals/abcBenson/abcBenson";
    }
     ...
     * @since   2026.07.09
     */
    @RequestMapping(value = "/abcBenson/abcBensonList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getAbcBensonList(HttpServletRequest request, HttpServletResponse response, Model model, AbcBensonVO abcBensonVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<String>> list = abcBensonService.getAbcBensonList(abcBensonVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, list, abcBensonVO);
    }
...
/*    @RequestMapping(value = "/fg/storeFgComboList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getStoreFgComboList(HttpServletRequest request, HttpServletResponse response, Model model, AbcVO abcBensonVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<String>> list = abcBensonService.getStoreFgComboList(abcBensonVO, sessionInfoVO);
