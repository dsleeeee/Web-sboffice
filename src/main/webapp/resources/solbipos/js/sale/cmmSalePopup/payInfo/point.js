...
app.controller('pointCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  // 상위 객체 상속 : T/F 는 picker
  angular.extend(this, new RootController('pointCtrl', $scope, $http, true));
  ...
  // 포인트 내역 리스트 조회
  $scope.searchPointList = function () {
    // 파라미터
    var params       = {};
