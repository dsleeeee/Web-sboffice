    ...
    <div ng-controller="prodSaleDayMomsCtrl">
        ...
        <div class="searchBar">
            ...
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <button class="btn_blue fr" id="btnSearch" ng-click="_broadcast('prodSaleDayMomsCtrl', 1)">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/moms/prodSaleDayMoms/prodSaleDayMoms.js?ver=20240221.01" charset="utf-8"></script>