/****************************************************************
 *
 * 파일명 : mobileStoreDayIoStock.js
 * 설  명 : (모바일) 재고현황 > 일수불현황(매장) JavaScript
 *
...
app.controller('mobileDayIoStockCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('mobileDayIoStockCtrl', $scope, $http, true));
    ...
    $scope.mobileDayIoStockSelectVendrShow = function () {
        $scope._broadcast('mobileDayIoStockSelectVendrCtrl');
    };
...
/** 주문대비 입고현황 그리드 controller */
app.controller('mobileDayIoStockMainCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('mobileDayIoStockMainCtrl', $scope, $http, true));
    ...
    $scope.initGrid = function (s, e) {
        ...
        $scope._makePickColumns("mobileDayIoStockMainCtrl");
        ...
        s.columnHeaders.rows[0].dataItem = {
            ...
            storeOutQty 	:messages["dayIostock.accStoreOut"],
            storeOutTot 	:messages["dayIostock.accStoreOut"],
            purchsInQty 	:messages["dayIostock.accPurchsIn"],
            purchsInTot 	:messages["dayIostock.accPurchsIn"],
            purchsOutQty	:messages["dayIostock.accPurchsOut"],
            purchsOutTot	:messages["dayIostock.accPurchsOut"],
            storeSaleQty	:messages["dayIostock.accStoreSale"],
            storeSaleTot	:messages["dayIostock.accStoreSale"],

            moveInQty		:messages["dayIostock.accStoreMoveIn"],
            moveInTot		:messages["dayIostock.accStoreMoveIn"],
            moveOutQty	:messages["dayIostock.accStoreMoveOut"],
            moveOutTot	:messages["dayIostock.accStoreMoveOut"],
    ...
    $scope.$on("mobileDayIoStockMainCtrl", function (event, data) {
    ...
    //다른 컨트롤러의 broadcast 받기
    $scope.$on("mobileDayIoStockMainCtrlSrch", function (event, data) {
    ...
    $scope.searchMobileDayIoStockList = function (isPageChk) {
        ...
        params.vendrCd 	   = $("#mobileDayIoStockSelectVendrCd").val();
        ...
        $scope._inquirySub("/mobile/stock/status/dayIoStock/mobileDayIoStock/viewList.sb", params, function () {
            ...
            gridShowMsgNoData("mobileStoreDayIoStock", $scope.flex, "Y");
        },true);
        $scope.excelFg = true;
    };
    ...
    $scope.excelDownloadDayIostock = function () {
        // 파라미터
        var params     = {};
        $scope._broadcast('mobileDayIoStockMainExcelCtrl', params);
...
/** 주문대비 입고현황 그리드 controller */
app.controller('mobileDayIoStockMainExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('mobileDayIoStockMainExcelCtrl', $scope, $http, true));
    ...
    // 다른 컨트롤러의 broadcast 받기
    $scope.$on("mobileDayIoStockMainExcelCtrl", function (event, data) {
