...
<wj-popup control="touchKeyStyleLayer" show-trigger="Click" hide-trigger="Click" style="display: none; width:680px; height:700px;">
  <div class="wj-dialog wj-dialog-columns" ng-controller="tblmsListCtrl2">
...
alert('tblmsSettingView.jsp');

</script>
<script type="text/javascript" src="/resource/solbipos/js/base/store/tblms/tblmsSettingView.js?ver=20210430.01" charset="utf-8"></script>
