...
<div class="subCon">
    <div ng-controller="timeProdChannelCtrl">
        <div class="searchBar">
            ...
            <%-- 조회 --%>
            <button class="btn_blue fr mt5 mr10" id="btnSearch" ng-click="_pageView('timeProdChannelCtrl', 1)">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/time/timeProdChannel/timeProdChannel.js?ver=20240813.01" charset="utf-8"></script>