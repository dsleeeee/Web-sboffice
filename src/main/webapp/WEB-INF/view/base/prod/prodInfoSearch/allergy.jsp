...
<div class="subCon" id="allergyView" ng-controller="allergyCtrl" style="display: none;padding: 10px 20px 40px;">
  <%--searchTbl--%>
  <div class="searchBar">
    <a href="#" class="open fl"><s:message code="prodInfoSearch.allergy"/></a>
    <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
      <%-- 조회 --%>
      <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('allergyCtrl',1)">
    ...
    <div class="wj-TblWrapBr mt10">
      ...
      <div class="wj-gridWrap" style="height: 380px; overflow-x: hidden; overflow-y: hidden;">
        <wj-flex-grid
          ...
          <!-- define columns -->
          <wj-flex-grid-column header="<s:message code="prodInfoSearch.allergy.prodCd"/>" binding="prodCd" width="100" align="center" is-read-only="true" format="d"></wj-flex-grid-column>
