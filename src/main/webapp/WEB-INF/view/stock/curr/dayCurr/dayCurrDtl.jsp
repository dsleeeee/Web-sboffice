...
<c:set var="baseUrl" value="/stock/curr/dayCurr/"/>

<wj-popup id="dayCurrDtlLayer" control="dayCurrDtlLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:700px;">
  <div id="cardLayer" class="wj-dialog wj-dialog-columns" ng-controller="dayCurrDtlCtrl">
    <div id="spanPopDtlTitle" class="wj-dialog-header wj-dialog-header-font">
      <s:message code="dayCurr.dayCurrDtl"/>
      ...
      <div class="w100 mt10 mb20">
        ...
        <div class="wj-gridWrap" style="height: 200px; overflow-y: hidden; overflow-x: hidden" >
          <wj-flex-grid
            ...
            <!-- define columns -->
	       <wj-flex-grid-column header="<s:message code="dayCurr.prodCd"/>"			binding="prodCd"		width="130"		align="center"	is-read-only="true"></wj-flex-grid-column>
	       <wj-flex-grid-column header="<s:message code="dayCurr.storageCd"/>"		binding="storageCd"		width="130"		align="center"	is-read-only="true"></wj-flex-grid-column>
	       <wj-flex-grid-column header="<s:message code="dayCurr.storageNm"/>"		binding="storageNm"		width="*"		align="center"	is-read-only="true"></wj-flex-grid-column>
	       <wj-flex-grid-column header="<s:message code="dayCurr.currQty"/>"			binding="currQty"		width="120"		align="center"	is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
          </wj-flex-grid>
          <%-- ColumnPicker 사용시 include --%>
          <jsp:include page="/WEB-INF/view/layout/columnPicker.jsp" flush="true">
            <jsp:param name="pickerTarget" value="dayCurrDtlCtrl"/>
          </jsp:include>
          <%--// ColumnPicker 사용시 include --%>
        </div>
        <%--//위즈모 테이블--%>
...
<script type="text/javascript" src="/resource/solbipos/js/stock/curr/dayCurr/dayCurrDtl.js?ver=20220715.01" charset="utf-8"></script>
