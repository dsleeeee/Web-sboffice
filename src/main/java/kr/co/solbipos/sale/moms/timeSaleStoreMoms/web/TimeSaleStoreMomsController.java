package kr.co.solbipos.sale.moms.timeSaleStoreMoms.web;
...
/**
 * @Class Name : TimeSaleStoreMomsController.java
 ...
 */
@Controller
@RequestMapping("/sale/moms/timeSaleStoreMoms")
public class TimeSaleStoreMomsController {

    private final SessionService sessionService;
    private final TimeSaleStoreMomsService timeSaleStoreMomsService;
     ...
     */
    @Autowired
    public TimeSaleStoreMomsController(SessionService sessionService, TimeSaleStoreMomsService timeSaleStoreMomsService, CmmCodeUtil cmmCodeUtil, DayProdService dayProdService, CmmEnvUtil cmmEnvUtil) {
        this.sessionService = sessionService;
        this.timeSaleStoreMomsService = timeSaleStoreMomsService;
     ...
     * @param model
     */
    @RequestMapping(value = "/timeSaleStoreMoms/list.sb", method = RequestMethod.GET)
    public String timeSaleStoreMomsView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/moms/timeSaleStoreMoms/timeSaleStoreMoms";
    }
     ...
     * @since   2024. 01. 05.
     */
    @RequestMapping(value = "/timeSaleStoreMoms/getTimeSaleStoreMomsList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getTimeSaleStoreMomsList(TimeSaleStoreMomsVO timeSaleStoreMomsVO, HttpServletRequest request,
                                      HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = timeSaleStoreMomsService.getTimeSaleStoreMomsList(timeSaleStoreMomsVO, sessionInfoVO);
     ...
     * @since   2024. 01. 05.
     */
    @RequestMapping(value = "/timeSaleStoreMoms/getTimeSaleStoreMomsExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getTimeSaleStoreMomsExcelList(TimeSaleStoreMomsVO timeSaleStoreMomsVO, HttpServletRequest request,
                                           HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = timeSaleStoreMomsService.getTimeSaleStoreMomsExcelList(timeSaleStoreMomsVO, sessionInfoVO);
