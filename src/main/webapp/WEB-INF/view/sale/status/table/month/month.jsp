...
<div id="tableMonthView" class="subCon" ng-controller="tableMonthCtrl">
  <div class="searchBar flddUnfld">
      <a href="#" class="open fl"><s:message code="tableMonth.tableMonthSale"/></a>
      <%-- 조회 --%>
      <button class="btn_blue fr mt5 mr10" id="btnSearch" ng-click="_broadcast('tableMonthCtrl')">
    ...
    <table class="searchTbl">
      ...
      <tr>
        ...
        <td>
          ...
          <span class="txtIn w110px">
              <wj-input-date
                      id="srchTableMonthStartDate"
                      value="tableMonthStartDate"
                      ng-model="startDate"
            ...
            <span class="txtIn w110px">
              <wj-input-date
                      id="srchTableMonthEndDate"
                      value="tablTeDayEndDate"
                      ng-model="endDate"
      ...
      <th><s:message code="tableDay.table"/></th>
        ...
        <span class="txtIn w150px sb-select">
            <wj-combo-box
              id="srchTableMonthTableNo"
              ng-model="tableNo"
              control="tableMonthTableNoCombo"
              items-source="_getComboData('srchTableMonthTableNo')"
	...
	<div class="mt40 oh sb-select dkbr">
		...
		<%-- 엑셀다운로드 --%>
		<button class="btn_skyblue fr" ng-click="excelDownloadTableMonth()">
        ...
        <div class="wj-TblWrapBr">
          ...
          <div class="wj-gridWrap" style="height: 350px;">
            <wj-flex-grid
              ...
              <wj-flex-grid-column header="<s:message code="tableMonth.totRealSaleCnt"/>" binding="totRealSaleCnt" width="80" align="center" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/table/month/month.js?ver=20190122.04" charset="utf-8"></script>
<%-- 상품매출내역 팝업 상세 레이어 --%>
