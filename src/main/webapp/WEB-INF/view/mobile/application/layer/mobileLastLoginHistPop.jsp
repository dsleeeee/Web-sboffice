        ...
        <div class="title" style="width: 355px; height: 450px;">
            ...
            <div ng-controller="mobileLastLoginHistCtrl">
                ...
                <div class="btnSet">
                    ...
                    <span><a href="#" class="btn_blue s13" ng-click="dayRemove()"><s:message code="login.layer.lastLoginHist.dayRemove" /></a></span>
                </div>
            </div>
            <%-- //내용 --%>
        </div>
...
<script type="text/javascript" src="/resource/solbipos/js/mobile/application/layer/mobileLastLoginHistPop.js?ver=20250625.01" charset="utf-8"></script>