...
<wj-popup control="kioskKeyMapStoreCopyLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:945px;">
    <div class="wj-dialog wj-dialog-columns title">
        ...
        <div class="wj-dialog-body" style="min-height:550px;">
            <div ng-controller="kioskKeyMapStoreCopyCtrl">
                <p class="mb5" style="font-size: small">-<s:message code="kioskKeyMap.original.storeCd" />-</p>
                ...
                <table class="tblType01">
                    ...
                    <c:if test="${brandUseFg == '1'}">
                        <c:if test="${sessionInfo.orgnFg == 'HQ'}">
                            <tr>
                                <th><s:message code="kioskKeyMap.brand" /></th>
                                <td>
                                    <div class="sb-select">
                                      <wj-combo-box
                    ...
                    <tr>
                        ...
                        <td>
                            <%--조회--%>
                            <button class="btn_skyblue fr" id="nxBtnSearch1" ng-click="_pageView('kioskKeyMapStoreCopyCtrl',1)"><s:message code="cmm.search" /></button>
                        </td>
                    </tr>
                    </tbody>
                </table>
                <c:if test="${momsEnvstVal == '1'}">
                    <table class="tblType01" id="tblSearchAddShowCopy" style="display: none;">
                        <colgroup>
                            <col class="w15"/>
                            <col class="w30"/>
                            <col class="w15"/>
                ...
                <div class="w100 mt10 mb10">
                    <div class="wj-gridWrap" style="height:120px; overflow-y: hidden; overflow-x: hidden;">
                        <wj-flex-grid
                            ...
                            <c:if test="${brandUseFg == '1'}">
                                <c:if test="${sessionInfo.orgnFg == 'HQ'}">
                                    <wj-flex-grid-column header="<s:message code="kioskKeyMap.storeHqBrand"/>" binding="brand" width="80" is-read-only="true" align="left"></wj-flex-grid-column>
                                </c:if>
                            </c:if>
                            <wj-flex-grid-column header="<s:message code="kioskKeyMap.storeCd"/>" binding="storeCd" width="80" is-read-only="true" align="center"></wj-flex-grid-column>
                            <wj-flex-grid-column header="<s:message code="kioskKeyMap.storeNm"/>" binding="storeNm" width="100" is-read-only="true" align="left"></wj-flex-grid-column>
                            ...
                            <wj-flex-grid-column header="[<s:message code="kioskKeymap.store"/>]<s:message code="kioskKeyMap.envstVal"/>" binding="env4068" width="120" align="center" is-read-only="true"></wj-flex-grid-column>
                            <wj-flex-grid-column header="[<s:message code="kioskKeyMap.pack"/>]<s:message code="kioskKeyMap.envstVal"/>" binding="env4069" width="120" align="center" is-read-only="true"></wj-flex-grid-column>
                        </wj-flex-grid>
                    </div>
                </div>
            </div>
            <div ng-controller="kioskKeyMapStoreCopy2Ctrl">
                ...
                <p class="mb5" style="font-size: small">- <s:message code="kioskKeyMap.target.storeCd" /> -</p>
                ...
                <table class="tblType01">
                        ...
                        <c:if test="${sessionInfo.orgnFg == 'HQ'}">
                            <tr>
                                ...
                                <td>
                                    <c:if test="${momsEnvstVal == '1'}">
                                        <%-- 확장조회 --%>
                                        <button class="btn_skyblue mr5" id="btnSearchAddShow2" ng-click="searchAddShowChangeCopy2()">
                                            <s:message code="cmm.search.addShow" />
                                        </button>
                                    </c:if>
                                </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <%--조회--%>
                            <button class="btn_skyblue fr" id="nxBtnSearch2" ng-click="_pageView('kioskKeyMapStoreCopy2Ctrl',1)"><s:message code="cmm.search" /></button>
                        </td>
                    </tr>
                    </tbody>
                </table>
                <c:if test="${momsEnvstVal == '1'}">
                    <table class="tblType01" id="tblSearchAddShowCopy2" style="display: none;">
                        <colgroup>
                            <col class="w15"/>
                            <col class="w30"/>
                            <col class="w15"/>
                ...
                <div class="w100 mt10 mb10">
                    <div class="wj-gridWrap" style="height:120px; overflow-y: hidden; overflow-x: hidden;">
                        <wj-flex-grid
                            ...
                            <c:if test="${brandUseFg == '1'}">
                                <c:if test="${sessionInfo.orgnFg == 'HQ'}">
                                    <wj-flex-grid-column header="<s:message code="storeView.storeHqBrand"/>" binding="brand" width="80" is-read-only="true" align="left"></wj-flex-grid-column>
                                </c:if>
                            </c:if>
                            <wj-flex-grid-column header="<s:message code="storeView.storeCd"/>" binding="storeCd" width="80" is-read-only="true" align="center"></wj-flex-grid-column>
                            <wj-flex-grid-column header="<s:message code="storeView.storeNm"/>" binding="storeNm" width="100" is-read-only="true" align="left"></wj-flex-grid-column>
                            <wj-flex-grid-column header="<s:message code="kioskKeyMap.sysStatFg"/>" binding="sysStatFg" width="85"  data-map="sysStatFgDataMap" align="center" is-read-only="true"></wj-flex-grid-column>
                            <wj-flex-grid-column header="<s:message code="kioskKeyMap.kioskPosNo"/>" binding="posNo" width="110" align="center" is-read-only="true"></wj-flex-grid-column>
                            <wj-flex-grid-column header="<s:message code="kioskKeyMap.kioskTuMClsFg"/>" binding="tuMClsFg" data-map="tuMClsFgDataMap" width="110" align="center" is-read-only="true"></wj-flex-grid-column>
                            <wj-flex-grid-column header="[<s:message code="kioskKeymap.store"/>]<s:message code="kioskKeyMap.envstVal"/>" binding="env4068" width="120" align="center" is-read-only="true"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/base/prod/kioskKeyMap/kioskKeyMapStoreCopy.js?ver=20230329.01" charset="utf-8"></script>