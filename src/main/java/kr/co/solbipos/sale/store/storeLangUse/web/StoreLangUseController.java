package kr.co.solbipos.sale.store.storeLangUse.web;
...
/**
 * @Class Name : StoreLangUseController.java
 ...
 */
@Controller
@RequestMapping("/sale/store/storeLangUse")
public class StoreLangUseController {

    private final SessionService sessionService;
    private final DayProdService dayProdService;
    private final CmmCodeUtil cmmCodeUtil;
    private final StoreLangUseService storeLangUseService;


    @Autowired
    public StoreLangUseController(SessionService sessionService, DayProdService dayProdService, CmmCodeUtil cmmCodeUtil, StoreLangUseService storeLangUseService) {
        this.sessionService = sessionService;
        this.dayProdService = dayProdService;
        this.cmmCodeUtil = cmmCodeUtil;
        this.storeLangUseService = storeLangUseService;
    }
     ...
     * @since   2022.11.18
     */
    @RequestMapping(value = "/storeLangUse/view.sb", method = RequestMethod.GET)
    public String empMonthView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/store/storeLangUse/storeLangUse";
    }
     ...
     * @param   response
     * @param   model
     * @param   storeLangUseVO
     * @return  String
     * @author  김유승
     * @since   2024.04.23
     */
    @RequestMapping(value = "/storeLangUse/getStoreLangUseList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getStoreLangUseList(HttpServletRequest request, HttpServletResponse response,
                             Model model, StoreLangUseVO storeLangUseVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<String>> list = storeLangUseService.getStoreLangUseList(storeLangUseVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, list, storeLangUseVO);
    }
}
