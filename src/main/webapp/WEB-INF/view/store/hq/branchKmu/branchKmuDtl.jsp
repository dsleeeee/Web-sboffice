...
<wj-popup id="wjBranchKmuDtlLayer" control="wjBranchKmuDtlLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:600px;height:700px;">
    <div id="branchKmuDtlLayer" class="wj-dialog wj-dialog-columns" ng-controller="branchKmuDtlCtrl">

        <div class="wj-dialog-header wj-dialog-header-font">
            <span id="branchKmuDtlTitle"></span>
            ...
            <f:form id="regForm" name="regForm" ng-submit="submit()">
                <table class="searchTbl">
                    ...
                    <tr style="border-top: 1px solid #ccc;">
                        ...
                        <%-- 그룹명 --%>
                        <th><s:message code="branchKmu.branchNm"/><em class="imp">*</em></th>
                        <td>
                    ...
                    <tr>
                        ...
                        <%-- 이메일 --%>
                        <th><s:message code="branchKmu.email"/></th>
                        <td>
                    ...
                    <tr>
                        <%-- 사용여부 --%>
                        <th><s:message code="branchKmu.useYn"/></th>
                        <td>
                            <div class="sb-select">
                                <wj-combo-box
                                        id="useYn"
                    ...
                    <tr>
                        <%-- 주소 //TODO 주소검색 추가 필요 --%>
                        <th><s:message code="branchKmu.addr"/></th>
                        <td colspan="3">
                    ...
                    <tr style="height: 330px; display: none;">
                        <%-- 비고 --%>
                        <th><s:message code="branchKmu.orgplceInfo"/></th>
                        <td colspan="3">
...
<script type="text/javascript" src="/resource/solbipos/js/store/hq/branchKmu/branchKmuDtl.js?ver=20251027.01" charset="utf-8"></script>