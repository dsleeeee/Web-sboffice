    ...
    <div ng-controller="hqSalePriceResveExcelUploadSampleCtrl">
        ...
        <div class="wj-gridWrap" style="display: none">
            <wj-flex-grid
                ...
                <wj-flex-grid-column header="<s:message code="hqSalePriceResveExcelUpload.saleUprc"/>" width="100" align="right"></wj-flex-grid-column>
            </wj-flex-grid>
        </div>
    </div>
...
<script type="text/javascript" src="/resource/solbipos/js/base/price/salePriceResve/hqSalePriceResveExcelUpload.js?ver=20230303.01" charset="utf-8"></script>
