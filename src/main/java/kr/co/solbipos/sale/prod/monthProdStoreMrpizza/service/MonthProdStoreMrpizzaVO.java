...
/**
 * @Class Name : MonthProdStoreMrpizzaVO.java
 ...
 */
public class MonthProdStoreMrpizzaVO extends PageVO {

    private static final long serialVersionUID = -6921399072946964192L;
    ...
    public String getChkProdClassSumDisplay() {
        return chkProdClassSumDisplay;
    }

    public void setChkProdClassSumDisplay(String chkProdClassSumDisplay) {
        this.chkProdClassSumDisplay = chkProdClassSumDisplay;
    }
