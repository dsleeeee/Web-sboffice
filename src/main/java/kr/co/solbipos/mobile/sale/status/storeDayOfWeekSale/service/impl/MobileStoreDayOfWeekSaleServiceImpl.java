...
public class MobileStoreDayOfWeekSaleServiceImpl implements MobileStoreDayOfWeekSaleService {
    ...
    public MobileStoreDayOfWeekSaleServiceImpl(MobileStoreDayOfWeekSaleMapper mobileStoreDayOfWeekSaleMapper, PopupMapper popupMapper) {
    ...
    public List<DefaultMap<Object>> getMobileStoreDayOfWeekSaleList(MobileStoreDayOfWeekSaleVO mobileStoreDayOfWeekSaleVO, SessionInfoVO sessionInfoVO) {
        ...
        mobileStoreDayOfWeekSaleVO.setEmpNo(sessionInfoVO.getEmpNo());
        if(!StringUtil.getOrBlank(mobileStoreDayOfWeekSaleVO.getSrchStoreCd()).equals("")) {
            ...
            storeVO.setArrSplitStoreCd(CmmUtil.splitText(mobileStoreDayOfWeekSaleVO.getSrchStoreCd(), 3900));
            mobileStoreDayOfWeekSaleVO.setStoreCdQuery(popupMapper.getSearchMultiStoreRtn(storeVO));
        }
