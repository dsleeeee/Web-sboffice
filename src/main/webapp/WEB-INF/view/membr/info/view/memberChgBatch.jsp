...
<div class="subCon" ng-controller="memberChgBatchCtrl">
    ...
    <table class="searchTbl" id="tblSearchAddShow" style="display: none;">
        ...
        <c:if test="${orgnFg == 'HQ'}">
            <tr>
                <%-- 등록매장선택 --%>
                <th><s:message code="regist.reg.store"/></th>
                <td>
                    <%-- 매장선택 모듈 사용시 include --%>
                ...
                <%-- 사용매장선택 --%>
                <th><s:message code="regist.use.store"/></th>
                <td>
                    <%-- 매장선택 모듈 사용시 include --%>
                    <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                        <jsp:param name="targetTypeFg" value="M"/>
...
<script type="text/javascript" src="/resource/solbipos/js/membr/info/view/memberChgBatch.js?ver=20241111.01" charset="utf-8"></script>
