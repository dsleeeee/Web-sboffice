package kr.co.solbipos.sale.store.storeMonthPos.web;
...
/**
 * @Class Name : StoreMonthPosController.java
...
@Controller
@RequestMapping("/sale/store/storeMonthPos")
public class StoreMonthPosController {
    private final DayService dayService;
    private final TodayDtlService todayDtlService;
    private final SessionService sessionService;
    private final StoreMonthPosService storeMonthPosService;
    ...
    @Autowired
    public StoreMonthPosController(DayService dayService, TodayDtlService todayDtlService, SessionService sessionService, StoreMonthPosService storeMonthPosService, StoreChannelService storeChannelService, DayProdService dayProdService, CmmCodeUtil cmmCodeUtil) {
        this.dayService = dayService;
        this.todayDtlService = todayDtlService;
        this.sessionService = sessionService;
        this.storeMonthPosService = storeMonthPosService;
     ...
     * @since   2022.11.18
     */
    @RequestMapping(value = "/storeMonthPos/view.sb", method = RequestMethod.GET)
    public String empMonthView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/store/storeMonthPos/storeMonthPos";
    }
     ...
     * @param   response
     * @param   model
     * @param   storeMonthPosVO
     * @return  String
     * @author  권지현
     * @since   2022.11.18
     */
    @RequestMapping(value = "/storeMonthPos/getMonthList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getMonthList(HttpServletRequest request, HttpServletResponse response,
                             Model model, StoreMonthPosVO storeMonthPosVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<String>> list = storeMonthPosService.getMonthList(storeMonthPosVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, list, storeMonthPosVO);
    }
     ...
     * @since   2022.11.18
     */
    @RequestMapping(value = "/storeMonthPos/getMonthExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getMonthExcelList(HttpServletRequest request, HttpServletResponse response,
        ...
        List<DefaultMap<String>> list = storeMonthPosService.getMonthExcelList(storeMonthPosVO, sessionInfoVO);
