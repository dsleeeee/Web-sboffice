...
<div id="cornerDayOfWeekView" class="subCon" style="display: none;padding: 10px 20px 40px;" ng-controller="cornerDayOfWeekCtrl">
    ...
    <table class="searchTbl">
      ...
      <tr>
        ...
        <div class="sb-select">
            <span class="txtIn"><input id="srchCornerDayOfWeekStartDate" class="w110px"></span>
                <span class="rg">~</span>
            <span class="txtIn"><input id="srchCornerDayOfWeekEndDate" class="w110px"></span>
...
<!--     </wj-combo-box> -->
    ...
    <div class="w100 mt10" id="wjWrapType3">
        ...
        <wj-flex-grid
          ...
          <!-- define columns -->
          <wj-flex-grid-column header="<s:message code="corner.storeCd"/>"           binding="storeCd"           width="100" align="center" is-read-only="true" visible="false"></wj-flex-grid-column>
