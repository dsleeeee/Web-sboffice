...
<div id="weightProdView" class="subCon3" ng-controller="weightProdCtrl"> <%-- 수정 사항 || 클래스 변경 :: class="subCon" >> class="subCon3"--%>
    <div class="searchBar flddUnfld">
        <a href="#" class="open fl"><s:message code="weight.weightProd"/></a>
        <%-- 조회 --%>
        <button class="btn_blue fr mt5 mr10" id="nxBtnSearch1" ng-click="_broadcast('weightProdCtrl')">
    ...
    <div id="wjWrapType1" class="w100 mt10"> <%-- 수정 사항 || head line 1 아이디 추가 :: id="wjWrapType1" --%>
        <div class="wj-gridWrap" style="height:370px; overflow-y: hidden; overflow-x: hidden;"> <%-- 수정 사항 || 그리드 높이값 스타일 제거 :: style="height: 000px;" --%>
            <wj-flex-grid
...
<%--                <wj-flex-grid-column header="<s:message code="side.prodNm"/>"		binding="prodNm" 		width="200" align="center" is-read-only="true"></wj-flex-grid-column>--%>
                ...
                <wj-flex-grid-column header="<s:message code="weight.weightKg"/>"   binding="saleScaleWtKg" width="100" align="center" is-read-only="true"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="weight.weight"/>"     binding="saleScaleWt" 	width="100" align="center" is-read-only="true"></wj-flex-grid-column>
                ...
                <wj-flex-grid-column header="<s:message code="weight.totSaleScaleWt"/>" 	binding="totSaleScaleWt" 	width="100" align="center" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/weight/weightProd.js?ver=20200106.02" charset="utf-8"></script>
