package kr.co.solbipos.sale.status.dayOfWeekSale.web;
...
@Controller
@RequestMapping("/sale/status/dayOfWeekSale")
public class DayOfWeekSaleController {
    private final SessionService sessionService;
    private final DayService dayService;

    @Autowired
    public DayOfWeekSaleController(SessionService sessionService, DayService dayService) {
    ...
    public String dayOfWeekSaleView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/status/dayOfWeekSale/dayOfWeekSale";
    }
}