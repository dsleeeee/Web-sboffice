...
<div id="apprNcashView" class="subCon3"  ng-controller="apprNcashCtrl" style="display: none;padding: 10px 20px 40px;">
    ...
    <table class="searchTbl">
      ...
      <tr>
        ...
        <td>
        <div class="sb-select">
            <span class="txtIn"><input id="srchApprNcashStartDate" class="w110px"></span>
                <span class="rg">~</span>
            <span class="txtIn"><input id="srchApprNcashEndDate" class="w110px"></span>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/appr/payMethod/ncash/ncash.js?ver=20250416.01" charset="utf-8"></script>
