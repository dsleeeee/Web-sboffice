...
app.controller('cardCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  ...
  $scope.apprProcFgMap = new wijmo.grid.DataMap([
    {id: "1", name: messages["card.apprProcFg1"]},
    {id: "2", name: messages["card.apprProcFg2"]},
  ], 'id', 'name');

  $scope.cardTypeFgMap = new wijmo.grid.DataMap([
    {id: "1", name: messages["card.cardTypeFg1"]},
    {id: "2", name: messages["card.cardTypeFg2"]},
    {id: "3", name: messages["card.cardTypeFg3"]},
    {id: "4", name: messages["card.cardTypeFg4"]},
    {id: "5", name: messages["card.cardTypeFg5"]},
  ], 'id', 'name');
