...
public class OutstockConfmController {
    ...
    @Autowired
    public OutstockConfmController(SessionService sessionService, OutstockConfmService outstockConfmService, IostockCmmService iostockCmmService, DstbReqService dstbReqService, StoreOrderService storeOrderService, CmmEnvService cmmEnvService) {
