    ...
    <div class="wj-dialog-body" style="height:520px; overflow-y: auto;">
      ...
      <div class="mt10 oh sb-select dkbr">
        <p class="s12 bk mt10 lh20">
          ...
          4. 상품 : 상품분류, 상품, 판매가격을 복사합니다.<br />
          5. 판매가격 : 판매가격을 복사합니다.<br />
          - 적용대상매장에 있는 상품의 판매가격만 적용됨<br />
          6. 포스기능키 : 매장별 포스기능키, 포스별 포스기능키, 포스기능키 적용매장, 기능키 XML(왼쪽키,오른쪽키,배달메뉴키,셀프키)을 복사합니다.<br />
          - 포스수가 '기준매장 < 적용대상매장' 일 경우 기준매장의 마지막 포스정보가 들어감<br />
          7. 판매터치키 : 터치키분류, 터치키, 터치키 XML을 복사합니다.<br />
          8. 쿠폰 : 쿠폰분류를 복사합니다.<br />
          9. 상품권 : 상품권분류, 상품권을 복사합니다.<br />
          10. 입금/출금계정 : 입금/출금계정을 복사합니다.<br />
          11. 원산지 : 재료-원산지정보, 재료-상품맵핑정보를 복사합니다.<br />
          12. 식품 알레르기 : 재료-알레르기정보, 재료-상품맵핑정보를 복사합니다.<br />
          13. 배달상품명칭매핑 : 배달상품명칭매핑 정보를 복사합니다.
        </p>
        <p class="s12 blue mt10 lh20">
          ※ '객층', '상품이미지', '키오스크키맵'은 해당 메뉴에서 매장복사 하실 수 있습니다.<br />
        </p>
      </div>
    </div>
    <%-- //body --%>
