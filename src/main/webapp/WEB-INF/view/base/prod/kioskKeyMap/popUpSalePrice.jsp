    ...
    <div class="wj-dialog wj-dialog-columns title" ng-controller="popUpSalePriceCtrl">
        ...
        <div class="wj-dialog-body">
            ...
            <table class="tblType01">
                ...
                <tr>
                    <%-- 터치키 --%>
                    <th><s:message code="kioskKeyMap.posNo"/>/<s:message code="kioskKeyMap.tuClsType"/></th>
                    <td>
                        <div class="sb-select" style="width:100px; float:left;">
                            <wj-combo-box
                                    id="popUpPosNo"
                                    ng-model="popUpPosNo"
                                    items-source="_getComboData('popUpPosNo')"
                                    display-member-path="name"
                                    selected-value-path="value"
                                    is-editable="false"
                                    control="popUpPosNoCombo"
                                    selected-index-changed="setPopUpTuClsType(s)">
                            </wj-combo-box>
                        </div>
                        <div class="sb-select mr5" style="width:110px; float:left;">
                            <wj-combo-box
                                    id="popUpTuClsType"
                                    ng-model="popUpTuClsType"
                                    items-source="_getComboData('popUpTuClsType')"
                                    display-member-path="name"
                                    selected-value-path="value"
                                    is-editable="false"
                                    control="popUpTuClsTypeCombo">
                            </wj-combo-box>
                        </div>
                    </td>
            ...
            <div class="w100 mt10">
                ...
                <div class="wj-gridWrap" style="height: 450px; overflow-y: hidden; overflow-x: hidden;">
                    <wj-flex-grid
                        ...
                        <wj-flex-grid-column header="<s:message code="kioskKeyMap.cd"/>" binding="tuClsType" width="40" is-read-only="true" align="center"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="kioskKeyMap.nm"/>" binding="tuClsTypeNm" width="80" is-read-only="true" align="left"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/base/prod/kioskKeyMap/popUpSalePrice.js?ver=20250124.01" charset="utf-8"></script>
