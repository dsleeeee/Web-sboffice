        ...
        <div class="wj-gridWrap" style="height:370px; overflow-y: hidden; overflow-x: hidden;">
            <div class="row">
                <wj-flex-grid
                    ...
                    <wj-flex-grid-column header="<s:message code="weight.weightKg"/>" binding="saleScaleWtKg" width="80" is-read-only="true" align="right"></wj-flex-grid-column>
                    <wj-flex-grid-column header="<s:message code="weight.weight"/>" binding="saleScaleWt" width="80" is-read-only="true" align="right"></wj-flex-grid-column>
                    ...
                    <wj-flex-grid-column header="<s:message code="weight.totSaleScaleWt"/>" binding="totSaleScaleWt" width="60" is-read-only="true" align="right" aggregate="Sum"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/weight/weight.js?ver=20240605.01" charset="utf-8"></script>
