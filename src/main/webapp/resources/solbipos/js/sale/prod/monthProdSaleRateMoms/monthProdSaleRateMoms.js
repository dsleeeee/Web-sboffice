...
app.controller('monthProdSaleRateMomsCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchList = function(){
       ...
       $.postJSON("/sale/prod/monthProdSaleRateMoms/monthProdSaleRateMoms/getProdSaleRateList.sb", params, function (response){
            var grid = $scope.flex;
...
app.controller('monthProdSaleRateMomsExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $.postJSON("/sale/prod/monthProdSaleRateMoms/monthProdSaleRateMoms/getProdSaleRateExcelList.sb", params, function(response) {
