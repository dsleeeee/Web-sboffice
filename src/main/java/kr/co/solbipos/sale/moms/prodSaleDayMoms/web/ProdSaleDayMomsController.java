package kr.co.solbipos.sale.moms.prodSaleDayMoms.web;
...
/**
 * @Class Name : ProdSaleDayMomsController.java
 ...
 */
@Controller
@RequestMapping("/sale/moms/prodSaleDayMoms")
public class ProdSaleDayMomsController {

    private final SessionService sessionService;
    private final ProdSaleDayMomsService prodSaleDayMomsService;
     ...
     */
    @Autowired
    public ProdSaleDayMomsController(SessionService sessionService, ProdSaleDayMomsService prodSaleDayMomsService, CmmCodeUtil cmmCodeUtil, DayProdService dayProdService, CmmEnvUtil cmmEnvUtil) {
        this.sessionService = sessionService;
        this.prodSaleDayMomsService = prodSaleDayMomsService;
     ...
     * @param model
     */
    @RequestMapping(value = "/prodSaleDayMoms/list.sb", method = RequestMethod.GET)
    public String prodSaleDayMomsView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/moms/prodSaleDayMoms/prodSaleDayMoms";
    }

    /**
     * 상품매출일별 - 조회
     *
     * @param prodSaleDayMomsVO
     * @param request
     * @param response
     * @param model
     * @return  Object
     ...
     * @since   2024. 01. 15.
     */
    @RequestMapping(value = "/prodSaleDayMoms/getProdSaleDayMomsList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getProdSaleDayMomsList(ProdSaleDayMomsVO prodSaleDayMomsVO, HttpServletRequest request,
                                              HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = prodSaleDayMomsService.getProdSaleDayMomsList(prodSaleDayMomsVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, result, prodSaleDayMomsVO);
    }
     ...
     * @since   2024. 01. 15.
     */
    @RequestMapping(value = "/prodSaleDayMoms/getProdSaleDayMomsExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getProdSaleDayMomsExcelList(ProdSaleDayMomsVO prodSaleDayMomsVO, HttpServletRequest request,
                                                   HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = prodSaleDayMomsService.getProdSaleDayMomsExcelList(prodSaleDayMomsVO, sessionInfoVO);
