...
<div class="subCon" ng-controller="storeListCtrl">
  ...
  <div class="searchBar">
    ...
    <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
      <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('storeListCtrl',1)">
...
<script type="text/javascript" src="/resource/solbipos/js/base/store/view/view.js?ver=20230317.01" charset="utf-8"></script>
