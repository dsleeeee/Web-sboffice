...
app.controller('saleProdRankMomsCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchList = function(){
       ...
       $.postJSON("/sale/prod/saleProdRankMoms/saleProdRankMoms/getSaleProdRankList.sb", params, function (response){
           var grid = $scope.flex;
...
app.controller('saleProdRankMomsExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $.postJSON("/sale/prod/saleProdRankMoms/saleProdRankMoms/getSaleProdRankExcelList.sb", params, function(response) {
