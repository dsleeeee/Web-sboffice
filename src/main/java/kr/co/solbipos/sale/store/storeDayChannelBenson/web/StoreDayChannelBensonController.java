package kr.co.solbipos.sale.store.storeDayChannelBenson.web;
...
/**
 * @Class Name : StoreDayChannelBensonController.java
 ...
 */
@Controller
@RequestMapping("/sale/store/storeDayChannelBenson")
public class StoreDayChannelBensonController {

    private final DayService dayService;
    private final TodayDtlService todayDtlService;
    private final SessionService sessionService;
    private final StoreDayChannelBensonService storeDayChannelBensonService;
    private final StoreChannelService storeChannelService;
    private final DayProdService dayProdService;

    @Autowired
    public StoreDayChannelBensonController(DayService dayService, TodayDtlService todayDtlService, SessionService sessionService, StoreDayChannelBensonService storeDayChannelBensonService, StoreChannelService storeChannelService, DayProdService dayProdService) {
        this.dayService = dayService;
        this.todayDtlService = todayDtlService;
        this.sessionService = sessionService;
        this.storeDayChannelBensonService = storeDayChannelBensonService;
     ...
     * @return
     */
    @RequestMapping(value = "/storeDayChannelBenson/view.sb", method = RequestMethod.GET)
    public String empMonthView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/store/storeDayChannelBenson/storeDayChannelBenson";
    }
     ...
     * @return
     */
    @RequestMapping(value = "/storeDayChannelBenson/getStoreDayChannelBensonList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getStoreDayChannelBensonList(HttpServletRequest request, HttpServletResponse response,
                                                Model model, StoreDayChannelBensonVO storeDayChannelBensonVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<String>> list = storeDayChannelBensonService.getStoreDayChannelBensonList(storeDayChannelBensonVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, list, storeDayChannelBensonVO);
    }
     ...
     * @return
     */
    @RequestMapping(value = "/storeDayChannelBenson/getStoreDayChannelBensonExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getStoreDayChannelBensonExcelList(HttpServletRequest request, HttpServletResponse response,
                                                     Model model, StoreDayChannelBensonVO storeDayChannelBensonVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<String>> list = storeDayChannelBensonService.getStoreDayChannelBensonExcelList(storeDayChannelBensonVO, sessionInfoVO);
