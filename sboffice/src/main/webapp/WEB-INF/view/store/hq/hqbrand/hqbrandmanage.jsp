...
<script>
  ...
  var hData =
    ...
    <c:if test="${orgnFg == 'MASTER'}">
      ...
      {binding:"useYn", header:"<s:message code='hqBrand.useYn' />", isReadOnly:false, dataMap:useYnDataMap}
    ];
  ...
  grid.formatItem.addHandler(function(s, e) {
    if (e.panel == s.cells) {
      ...
      if( col.binding == "hqOfficeCd" || col.binding == "hqOfficeNm" || col.binding == "hqBrandNm") {
  ...
  grid.addEventListener(grid.hostElement, 'mousedown', function(e) {
    ...
    if( ht.cellType == wijmo.grid.CellType.Cell) {
      ...
      if(grid.rows[ht.row].dataItem.hqBrandCd == null) {
  ...
  function search(index) {
    ...
    $.postJSON("/store/hq/hqbrand/hqbrandmanage/list.sb", param, function(result) {
