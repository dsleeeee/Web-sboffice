...
<div class="subCon" ng-controller="dstmnCtrl">
    ...
    <div class="tr mt10 fr">
        <p class="s14 bk fl mr10 lh30"><s:message code="dstmn.reqNoConfirm"/> : </p><p class="s14 bk fl mr10 lh30 red" id="reqNoConfirmCnt"></p>
        <p class="s14 bk fl mr10 lh30"><s:message code="dstmn.outstockNoCreate"/> : </p><p class="s14 bk fl mr10 lh30 red" id="outstockNoCreateCnt"></p>
    </div>
    ...
    <div class="w100 mt10" >
        ...
        <div class="wj-gridWrap" style="height: 350px;">
            <wj-flex-grid
                ...
                <wj-flex-grid-column header="<s:message code="dstmn.slipFg"/>"       binding="slipFg"        width="100" align="center" is-read-only="true" visible="false"></wj-flex-grid-column>
