       ...
       <%-- 할부구분 --%>
        ...
        <td>
          <div class="sb-select">
              <span class="txtIn">
                    <wj-combo-box
                      id="srchPartnerInstCntFgDisplay"
                      ng-model="instCntFg"
                      items-source="_getComboData('srchPartnerInstCntFgDisplay')"
        ...
        <td>
          <div class="sb-select">
              <span class="txtIn">
                    <wj-combo-box
                      id="srchPartnerApprFgDisplay"
                      ng-model="apprFg"
                      items-source="_getComboData('srchPartnerApprFgDisplay')"
                      display-member-path="name"
                      selected-value-path="value"
                      is-editable="false"
                      initialized="_initComboBox(s)">
