package kr.co.solbipos.sale.moms.timeSaleStoreDtMoms.web;
...
/**
 * @Class Name : TimeSaleStoreDtMomsController.java
 ...
 */
@Controller
@RequestMapping("sale/moms/timeSaleStoreDtMoms")
public class TimeSaleStoreDtMomsController {

    private final SessionService sessionService;
    private final TimeSaleStoreDtMomsService timeSaleStoreDtMomsService;
     ...
     */
    @Autowired
    public TimeSaleStoreDtMomsController(SessionService sessionService, TimeSaleStoreDtMomsService timeSaleStoreDtMomsService, CmmCodeUtil cmmCodeUtil, DayProdService dayProdService, CmmEnvUtil cmmEnvUtil) {
        this.sessionService = sessionService;
        this.timeSaleStoreDtMomsService = timeSaleStoreDtMomsService;
     ...
     * @param model
     */
    @RequestMapping(value = "/timeSaleStoreDtMoms/list.sb", method = RequestMethod.GET)
    public String timeSaleStoreMomsView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/moms/timeSaleStoreDtMoms/timeSaleStoreDtMoms";
    }

    /**
     * 시간대매출(매장) DT포장 - 조회
     *
     * @param   timeSaleStoreDtMomsVO
     * @param   request
     * @param   response
     * @param   model
     * @return  Object
     ...
     * @since   2025. 04. 17.
     */
    @RequestMapping(value = "/timeSaleStoreDtMoms/getTimeSaleStoreDtMomsList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getTimeSaleStoreDtMomsList(TimeSaleStoreDtMomsVO timeSaleStoreDtMomsVO, HttpServletRequest request,
                                           HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = timeSaleStoreDtMomsService.getTimeSaleStoreDtMomsList(timeSaleStoreDtMomsVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, result, timeSaleStoreDtMomsVO);
    }
     ...
     * @since   2025. 04. 17.
     */
    @RequestMapping(value = "/timeSaleStoreDtMoms/getTimeSaleStoreDtMomsExcelDivisionList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getTimeSaleStoreMomsExcelDivisionList(TimeSaleStoreDtMomsVO timeSaleStoreDtMomsVO, HttpServletRequest request,
                                                        HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = timeSaleStoreDtMomsService.getTimeSaleStoreMomsExcelDivisionList(timeSaleStoreDtMomsVO, sessionInfoVO);
