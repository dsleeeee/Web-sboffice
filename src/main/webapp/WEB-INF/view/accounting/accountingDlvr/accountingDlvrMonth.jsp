...
<div id="accountingDlvrMonthView" class="subCon" ng-controller="accountingDlvrMonthCtrl" style="display: none;padding: 10px 20px 40px;">

    <div class="searchBar flddUnfld">
        <a href="#" class="open fl"><s:message code="accountingDlvr.monthTitle"/></a>
        <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
            <button class="btn_blue fr" ng-click="_pageView('accountingDlvrMonthCtrl', 1)" id="accountingDlvrMonthBtnSearch">
    ...
    <table class="searchTbl">
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="sb-select">
                    <span class="txtIn"><input id="srchAccountingDlvrMonthStartDate" class="w110px"/></span>
                    <span class="rg">~</span>
                    <span class="txtIn"><input id="srchAccountingDlvrMonthEndDate" class="w110px"/></span>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                    ...
                    <jsp:param name="targetId" value="accountingDlvrMonthStore"/>
                </jsp:include>
            </td>
        </tr>
        </tbody>
    ...
    <div class="w100 mt10 mb20">
        <div class="wj-gridWrap" style="height:420px; overflow-y: hidden; overflow-x: hidden;">
            <wj-flex-grid
                    ...
                    ime-enabled="true"
                    id="wjGridAccountingDlvrMonthList">

                <wj-flex-grid-column header="<s:message code="accountingDlvr.saleYm"/>" binding="saleYm" width="80" align="center"></wj-flex-grid-column>
    ...
    <div class="pageNum mt20">
        <ul id="accountingDlvrMonthCtrlPager" data-size="10"></ul>
    </div>

    <div class="w100 mt10" style="display:none;" ng-controller="accountingDlvrMonthExcelCtrl">
        <wj-flex-grid
                autoGenerateColumns="false"
                control="excelFlex"
                initialized="initGrid(s,e)"
                items-source="data"
                is-read-only="true"
                id="wjGridAccountingDlvrMonthExcelList">
...
<script type="text/javascript" src="/resource/solbipos/js/accounting/accountingDlvr/accountingDlvrMonth.js?ver=20260716.01" charset="utf-8"></script>
