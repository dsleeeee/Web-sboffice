    ...
    <div id="gridDetail" class="w50 fr" style="width:60%" ng-controller="configCtrl_2">
        <div class="wj-TblWrapBr ml10 pd20" style="height: 700px;">
	        ...
	        <span class="fl bk lh30"><s:message code='dailyReport.cfgNm' /></span>	<%-- 영업일보 구성내역 --%>
				...
				<button class="btn_up" 		style="display: none;" id="btnUp"		ng-click="rowUp()"	><s:message code="cmm.up" 		/></button>	<%-- ng-show="btnShowFg" --%>
				<button class="btn_down" 	style="display: none;" id="btnDown" 	ng-click="rowDown()"><s:message code="cmm.down"	 	/></button>
...
--%>
        	<div class="wj-gridWrap" style="height:680px; overflow-x: hidden; overflow-y: hidden;">	<%-- 개발시 높이 조절해서 사용   &   tbody영역의 셀 배경이 들어가는 부분은 .bdBg를 넣어서 사용 --%>
		        <wj-flex-grid	autoGenerateColumns	="false"
						        ...
						        --%>
					<%--						        
					<wj-flex-grid-column header="<s:message code="dailyReport.cfgChkDispSeq"		/>"	binding="gChkDispSeq" 			width="40"	is-read-only="false"	align="center"	format="checkBox"		></wj-flex-grid-column>
					<wj-flex-grid-column header="<s:message code="dailyReport.cfgDispSeq"			/>"	binding="cfgDispSeq"			width="50"	is-read-only="true"		align="center"	                		></wj-flex-grid-column>
					
					<wj-flex-grid-column header="<s:message code="dailyReport.cfgDispSeq"			/>"	binding="gChkDispSeq" 			width="40"	is-read-only="false"	align="center"	format="checkBoxText"	></wj-flex-grid-column>
					<wj-flex-grid-column header="<s:message code="dailyReport.cfgDispSeq"			/>"	binding="gChkDispSeq" 			width="40"	is-read-only="false"	align="center"	format="checkBox"		></wj-flex-grid-column>

					<wj-flex-grid-column header="<s:message code="outstockReqDate.mon"				/>" binding="mon" 					width="50"	is-read-only="false" 	align="center"	format="checkBoxText"	></wj-flex-grid-column>

					--%>
					<wj-flex-grid-column header=""														binding="cfgDispSeq" 			width="30"	is-read-only="true"		align="left"	visible="false"			></wj-flex-grid-column>
