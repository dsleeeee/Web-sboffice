...
<wj-popup id="wj<c:out value="${param.targetId}"/>LayerM" control="wj<c:out value="${param.targetId}"/>LayerM" show-trigger="Click" hide-trigger="Click" style="display:none;width:85%;">
            ...
            <div class="w100">
                ...
                <div class="popGrid mt5" style="height: 250px;">
                    <wj-flex-grid
                        ...
                        <wj-flex-grid-column header="<s:message code="selectVendr.vatIncldYn"/>" binding="vatIncldYn" width="70" align="center" is-read-only="true" data-map="vatIncldYnMap"></wj-flex-grid-column>
...
<script type="text/javascript">
    ...
    app.controller('${param.targetId}Ctrl', ['$scope', '$http', function ($scope, $http) {
        ...
        $scope.searchVendr = function () {
            // 파라미터
            var params = {};
            $scope._inquirySub("/mobile/stock/com/popup/selectVendrList.sb", params, function () {
                $scope.searchFg = "Y";
            });
        };
