 ...
 *  기간회원 구매내역 그리드 생성
 */
app.controller('periodMembrCtrl', ['$scope', '$http', function ($scope, $http) {
    ...
    $scope.searchPeriodMembr = function(){
        ...
        $scope._inquiryMain("/membr/anals/periodMembr/periodMembr/getPeriodMembrList.sb", params, function() {}, false);
    };
    // <-- //검색 호출 -->
