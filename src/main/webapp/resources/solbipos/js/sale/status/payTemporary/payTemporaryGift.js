...
app.controller('payTemporaryGiftCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchPayTemporaryGift = function(){
        ...
        $.postJSON("/sale/status/payTemporary/payTemporaryGift/getPayTemporaryGiftList.sb", params, function(response) {
            var grid = $scope.flex;
...
app.controller('payTemporaryGiftExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchExcelList = function (params) {
        ...
        $.postJSON("/sale/status/payTemporary/payTemporaryGift/getPayTemporaryGiftExcelList.sb", params, function (response){
