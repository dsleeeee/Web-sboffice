package kr.co.solbipos.sale.status.giftCalc.web;
...
/**
 * @Class Name : GiftCalcController.java
 ...
 */
@Controller
@RequestMapping("/sale/status/giftCalc")
public class GiftCalcController {

    private final SessionService sessionService;
    private final GiftCalcService giftCalcService;
     ...
     */
    @Autowired
    public GiftCalcController(SessionService sessionService, GiftCalcService giftCalcService, CmmCodeUtil cmmCodeUtil, DayProdService dayProdService, CmmEnvUtil cmmEnvUtil) {
        this.sessionService = sessionService;
        this.giftCalcService = giftCalcService;
     ...
     * @param model
     */
    @RequestMapping(value = "/giftCalc/list.sb", method = RequestMethod.GET)
    public String giftCalcView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/status/giftCalc/giftCalc";
    }
     ...
     * @since   2023. 08. 30.
     */
    @RequestMapping(value = "/giftCalc/getGiftCalcList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getGiftCalcList(GiftCalcVO giftCalcVO, HttpServletRequest request,
                                     HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = giftCalcService.getGiftCalcList(giftCalcVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, result, giftCalcVO);
    }
     ...
     * @since   2023. 08. 30.
     */
    @RequestMapping(value = "/giftCalc/getGiftCalcExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getGiftCalcExcelList(GiftCalcVO giftCalcVO, HttpServletRequest request,
                                          HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = giftCalcService.getGiftCalcExcelList(giftCalcVO, sessionInfoVO);
     ...
     * @since   2023. 08. 30.
     */
    @RequestMapping(value = "/giftCalc/getGiftCalcDtlList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getGiftCalcDtlList(GiftCalcVO giftCalcVO, HttpServletRequest request,
                                        HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = giftCalcService.getGiftCalcDtlList(giftCalcVO, sessionInfoVO);
