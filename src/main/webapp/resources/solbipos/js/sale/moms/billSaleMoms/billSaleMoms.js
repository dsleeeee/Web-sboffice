...
app.controller('billSaleMomsCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchBillSaleMomsList = function () {
        ...
        $.postJSON("/sale/moms/billSaleMoms/billSaleMoms/getBillSaleMomsList.sb", params, function(response) {
            var grid = $scope.flex;
...
app.controller('billSaleMomsExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $.postJSON("/sale/moms/billSaleMoms/billSaleMoms/getBillSaleMomsExcelList.sb", params, function(response) {
                ...
                function delay(x){
                    return new Promise(function(resolve, reject){
                        ...
                        $.postJSON("/sale/moms/prodSaleDayStoreMoms/prodSaleDayStoreMoms/getDivisionExcelDownloadSaveUpdate.sb", params, function(response){
                            ...
                            // ajax 통신 설정
                            $.postJSON("/sale/moms/billSaleMoms/billSaleMoms/getBillSaleMomsExcelDivisionList.sb", params, function(response) {
