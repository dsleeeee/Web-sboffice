...
/**
 * @Class Name : SaleRegistChargeKmuVO.java
 ...
 */
public class SaleRegistChargeKmuVO extends PageVO {
    ...
    /** 매출처코드 */
    private String srchCustomerCd;

    /** 매출처명 */
    private String srchCustomerNm;
    ...
    public String getModProdNm() {
        return modProdNm;
    }

    public void setModProdNm(String modProdNm) {
        this.modProdNm = modProdNm;
    }
    ...
    public String getSrchCustomerCd() {
        return srchCustomerCd;
    }

    public void setSrchCustomerNm(String srchCustomerCd) {
        this.srchCustomerCd = srchCustomerCd;
    }
}