          ...
          <table class="searchTbl">
               ...
               <tbody>
                    <tr>
                         <%-- 조회일자 --%>
                         <th>
                              <s:message code="offAdd.day.date" />
                         </th>
                         <td colspan="3">
                              <div class="sb-select">
                    ...
                    <c:if test="${orgnFg == 'HQ'}">
                         <tr>
                              <%-- 매장코드 --%>
                              <th><s:message code="offAdd.day.store"/></th>
                              <td colspan="3">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/offAdd/offAddDay.js?ver=20220314.01" charset="utf-8"></script>