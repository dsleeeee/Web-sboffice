package kr.co.solbipos.sale.moms.timeProdSalePmixStoreMoms.web;
...
/**
 * @Class Name : TimeProdSalePmixStoreMomsController.java
 ...
 */
@Controller
@RequestMapping("/sale/moms/timeProdSalePmixStoreMoms")
public class TimeProdSalePmixStoreMomsController {

    private final SessionService sessionService;
    private final TimeProdSalePmixStoreMomsService timeProdSalePmixStoreMomsService;
     ...
     */
    @Autowired
    public TimeProdSalePmixStoreMomsController(SessionService sessionService, TimeProdSalePmixStoreMomsService timeProdSalePmixStoreMomsService, CmmCodeUtil cmmCodeUtil, DayProdService dayProdService, CmmEnvUtil cmmEnvUtil) {
        this.sessionService = sessionService;
        this.timeProdSalePmixStoreMomsService = timeProdSalePmixStoreMomsService;
     ...
     * @param model
     */
    @RequestMapping(value = "/timeProdSalePmixStoreMoms/list.sb", method = RequestMethod.GET)
    public String timeProdSalePmixStoreMomsView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/moms/timeProdSalePmixStoreMoms/timeProdSalePmixStoreMoms";
    }

    /**
     * 시간대별 상품매출(P.MIX 매장) - 조회
     *
     * @param timeProdSalePmixStoreMomsVO
     * @param request
     * @param response
     * @param model
     * @return  Object
     ...
     * @since   2025. 05. 27.
     */
    @RequestMapping(value = "/timeProdSalePmixStoreMoms/getTimeProdSalePmixStoreMomsList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getTimeProdSalePmixStoreMomsList(TimeProdSalePmixStoreMomsVO timeProdSalePmixStoreMomsVO, HttpServletRequest request,
                                               HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = timeProdSalePmixStoreMomsService.getTimeProdSalePmixStoreMomsList(timeProdSalePmixStoreMomsVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, result, timeProdSalePmixStoreMomsVO);
    }
     ...
     * @since   2025. 05. 27.
     */
    @RequestMapping(value = "/timeProdSalePmixStoreMoms/getTimeProdSalePmixStoreMomsExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getTimeProdSalePmixStoreMomsExcelList(TimeProdSalePmixStoreMomsVO timeProdSalePmixStoreMomsVO, HttpServletRequest request,
                                                    HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = timeProdSalePmixStoreMomsService.getTimeProdSalePmixStoreMomsExcelList(timeProdSalePmixStoreMomsVO, sessionInfoVO);
     ...
     * @since   2025. 05. 27.
     */
    @RequestMapping(value = "/timeProdSalePmixStoreMoms/getTimeProdSalePmixStoreMomsExcelDivisionList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getTimeProdSalePmixStoreMomsExcelDivisionList(TimeProdSalePmixStoreMomsVO timeProdSalePmixStoreMomsVO, HttpServletRequest request,
                                                            HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = timeProdSalePmixStoreMomsService.getTimeProdSalePmixStoreMomsExcelDivisionList(timeProdSalePmixStoreMomsVO, sessionInfoVO);
     ...
     * @return
     */
    @RequestMapping(value = "/timeProdSalePmixStoreMoms/getDateDiff.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getDateDiff(HttpServletRequest request, HttpServletResponse response, Model model, TimeProdSalePmixStoreMomsVO timeProdSalePmixStoreMomsVO) {

        List<HashMap<String, String>> list = timeProdSalePmixStoreMomsService.getDateDiff(timeProdSalePmixStoreMomsVO);
