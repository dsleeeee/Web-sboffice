...
<div class="subCon" ng-controller="installReqListCtrl">
  <div class="searchBar flddUnfld">
    ...
    <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
      <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('installReqListCtrl', 1)">
 ...
 <%-- 매장 그리드 --%>
  <div class="w100 mt10 mb20">
    <div class="wj-gridWrap" style="height:370px; overflow-x: hidden; overflow-y: hidden;">
      <wj-flex-grid
        ...
        <!-- define columns -->
        <wj-flex-grid-column header="<s:message code="instl.storeCd"/>" binding="storeCd" align="center" width="80" is-read-only="true"></wj-flex-grid-column>
        <wj-flex-grid-column header="<s:message code="instl.storeNm"/>" binding="storeNm" width="140" is-read-only="true"></wj-flex-grid-column>
        <wj-flex-grid-column header="<s:message code="instl.posNo"/>" binding="posNo" align="center" width="70" is-read-only="true"></wj-flex-grid-column>
        <wj-flex-grid-column header="<s:message code="instl.instFg"/>" binding="instFg" data-map="instFgDataMap" align="center" width="80" is-read-only="true"></wj-flex-grid-column>
        <wj-flex-grid-column header="<s:message code="instl.agencyCd"/>" binding="agencyCd" align="center" width="75" is-read-only="true"></wj-flex-grid-column>
        ...
        <wj-flex-grid-column header="<s:message code="instl.instReqDt"/>" binding="instReqDt" align="center" width="140" is-read-only="true"></wj-flex-grid-column>
  ...
  <div class="pageNum mt20">
    <%-- id --%>
    <ul id="installReqListCtrlPager" data-size="10">
    </ul>
  </div>
  <%--//페이지 리스트--%>
</div>
