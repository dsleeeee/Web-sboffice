  ...
  <div ng-controller="payDayCtrl">
    <div class="searchBar">
      ...
      <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
        <%-- 조회 --%>
        <button class="btn_blue fr" id="btnSearch" ng-click="_broadcast('payDayCtrl')">
    ...
    <table class="searchTbl">
       ...
       <tr>
          ...
          <td colspan="3">
              ...
              <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                ...
                <jsp:param name="targetId" value="payDayStore"/>
              </jsp:include>
              <%--// 매장선택 모듈 사용시 include --%>
          </td>
        </tr>
      ...
      <c:if test="${sessionInfo.orgnFg == 'STORE'}">
        <input type="hidden" id="payDayStoreCd" value="${sessionInfo.storeCd}"/>
      </c:if>
      </tbody>
    </table>
    <c:if test="${sessionInfo.orgnFg == 'HQ'}">
      ...
      <div class="wj-gridWrap" style="height: 470px; overflow-y: hidden; overflow-x: hidden;">
        <wj-flex-grid
          ...
          <c:forEach var="payCol" items="${payColList}">
            <wj-flex-grid-column header="<s:message code="payDay.payCnt"/>" binding="payCnt${payCol.payCd}" width="100" align="right" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
            <wj-flex-grid-column header="<s:message code="payDay.realSaleAmt"/>" binding="payAmt${payCol.payCd}" width="100" align="right" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
            <wj-flex-grid-column header="<s:message code="payDay.rate"/>" binding="payRate${payCol.payCd}" width="100" align="right" is-read-only="true"></wj-flex-grid-column>
          </c:forEach>
        </wj-flex-grid>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/pay/payDay/payDay.js?ver=20230329.02" charset="utf-8"></script>