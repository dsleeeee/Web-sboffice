 ...
 *  포스버전관리 그리드
 **********************************************************************/
app.controller('verAddrCtrl', ['$scope', '$http', function ($scope, $http) {
  // 상위 객체 상속 : T/F 는 picker
  angular.extend(this, new RootController('verAddrCtrl', $scope, $http, true));
  ...
  // 조회 버튼 클릭
  $scope.$on("verAddrCtrl", function(event, data) {
  ...
  $scope.getVersionList = function(){
    ...
    $scope._inquiryMain("/pos/confg/verAddr/verInfo/list.sb", params, function() {
    });
  };
