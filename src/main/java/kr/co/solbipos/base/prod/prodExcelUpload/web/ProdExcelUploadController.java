...
//        }
     ...
     * @param model
     */
    @RequestMapping(value = "/prodExcelUpload/{urlProdFg}/list.sb", method = RequestMethod.GET)
    public String prodExcelUploadView(HttpServletRequest request, HttpServletResponse response, Model model,  @PathVariable String urlProdFg) {
