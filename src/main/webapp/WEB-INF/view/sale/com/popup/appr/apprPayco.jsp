...
<%--            <wj-flex-grid-column header="<s:message code="saleComPopup.payco.vatAmt"/>" 	binding="vatAmt"		width="80" 	align="right"  is-read-only="true" aggregate="Sum"></wj-flex-grid-column>--%>
            ...
            <wj-flex-grid-column header="<s:message code="saleComPopup.payco.apprNo"/>" 	binding="apprNo" 		width="70" 	align="center" is-read-only="true" format="@"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/com/appr/apprPayco.js?ver=20260409.01" charset="utf-8"></script>