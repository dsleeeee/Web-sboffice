...
<div class="subCon" ng-controller="adminMediaCtrl" id="adminMediaView" style="display: none;padding: 10px 20px 40px">
    <div class="searchBar">
        <a href="#" class="open fl">${menuNm}</a>
        <%-- 조회 --%>
        <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
            <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('adminMediaCtrl', 1)">
    ...
    <div class="mt10 oh sb-select dkbr">
        ...
        <%-- 삭제 --%>
        <button class="btn_skyblue ml5 fr" id="btnDel" ng-click="del()"><s:message code="cmm.del" /></button>
        <%-- 신규버전등록 --%>
    ...
    <div class="pageNum mt20">
        <%-- id --%>
        <ul id="adminMediaCtrlPager" data-size="10">
        </ul>
    </div>
    <%--//페이지 리스트--%>
</div>
