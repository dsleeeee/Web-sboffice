...
<div class="subCon">
    <div ng-controller="dayProdStoreBensonCtrl">
        <div class="searchBar">
            <a href="#" class="open fl"><s:message code="dayProdStoreBenson.dayProdStoreBenson"/></a>
            <%-- 조회 --%>
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('dayProdStoreBensonCtrl', 1)">
    ...
    <table class="searchTbl">
            ...
            <tr>
                ...
                <td>
                    ...
                    <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                        ...
                        <jsp:param name="targetId" value="dayProdStoreBensonStore"/>
                    </jsp:include>
                        <%--// 매장선택 모듈 사용시 include --%>
                </td>
            </tr>
        ...
        <c:if test="${sessionInfo.orgnFg == 'STORE'}">
            <input type="hidden" id="dayProdStoreBensonStoreCd" value="${sessionInfo.storeCd}"/>
        </c:if>
        <tr>
            <c:if test="${sessionInfo.orgnFg == 'HQ'}">
                <%-- 상품브랜드 --%>
            ...
            <td>
                ...
                <jsp:include page="/WEB-INF/view/sale/com/popup/selectProdMMoms.jsp" flush="true">
                    <jsp:param name="targetId" value="dayProdStoreBensonSelect"/>
                </jsp:include>
    ...
    <div class="w100 mt10">
        <div class="wj-gridWrap" style="height: 380px; overflow-x: hidden; overflow-y: hidden;">
            <wj-flex-grid
                ...
                <%--<wj-flex-grid-column header="<s:message code="dayProd.branchNm"/>" binding="branchNm" width="80" align="left" is-read-only="true" visible="false"></wj-flex-grid-column>--%>
    ...
    <div class="pageNum mt20">
        <%-- id --%>
        <ul id="dayProdStoreBensonCtrlPager" data-size="10">
        </ul>
    </div>
    <%-- //페이지 리스트 --%>

    <%--엑셀 리스트--%>
    <div class="w100 mt10" style="display:none;" ng-controller="dayProdStoreBensonExcelCtrl">
        <div class="wj-gridWrap" style="height: 380px; overflow-x: hidden; overflow-y: hidden;">
            <wj-flex-grid
                    id="wjGridExcelList"
                    autoGenerateColumns="false"
...
<script type="text/javascript" src="/resource/solbipos/js/sale/prod/dayProdStoreBenson/dayProdStoreBenson.js?ver=20260708.02" charset="utf-8"></script>
