...
<div class="subCon">
  <div ng-controller="dayPosCtrl">
    <div class="searchBar">
      <a href="#" class="open fl">${menuNm}</a>
      <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
        <%-- 조회 --%>
        <button class="btn_blue fr" id="btnSearch" ng-click="_broadcast('dayPosCtrl')">
    ...
    <table class="searchTbl">
      ...
      <c:if test="${sessionInfo.orgnFg == 'STORE'}">
        <input type="hidden" id="dayPosStoreCd" value="${sessionInfo.storeCd}"/>
      </c:if>
      </tbody>
    </table>
    <c:if test="${sessionInfo.orgnFg == 'HQ'}">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/day/dayPos/dayPos.js?ver=20230329.02" charset="utf-8"></script>
