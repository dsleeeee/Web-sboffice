...
<div id="apprMcouponView" class="subCon3"  ng-controller="apprMcouponCtrl" style="display: none;padding: 10px 20px 40px;">
    ...
    <table class="searchTbl">
      ...
      <tr>
        ...
        <div class="sb-select">
            <span class="txtIn"><input id="srchApprMcouponStartDate" class="w110px"></span>
                <span class="rg">~</span>
            <span class="txtIn"><input id="srchApprMcouponEndDate" class="w110px"></span>
  ...
  <%-- 엑셀 리스트 --%>
    <div class="w100 mt10" id="wjWrapType3" style="display:none;" ng-controller="apprMcouponExcelCtrl">
      <div class="wj-gridWrap">
            <wj-flex-grid
                id="apprMcouponExcelGrid"
                autoGenerateColumns="false"
                selection-mode="Row"
                items-source="data"
                control="excelFlex"
