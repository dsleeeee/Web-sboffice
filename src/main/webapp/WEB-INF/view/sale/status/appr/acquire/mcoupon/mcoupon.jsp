...
<div id="apprAcquireMcouponView" class="subCon3"  ng-controller="apprAcquireMcouponCtrl" style="display: none;padding: 10px 20px 40px;">
    ...
    <table class="searchTbl">
      ...
      <tr>
        ...
        <div class="sb-select">
            <span class="txtIn"><input id="srchApprAcquireMcouponStartDate" class="w110px"></span>
                <span class="rg">~</span>
            <span class="txtIn"><input id="srchApprAcquireMcouponEndDate" class="w110px"></span>
          ...
          <div class="sb-select">
              <span class="txtIn">
                    <wj-combo-box
                      ...
                      ng-model="cashBillApprProcFgModel"
  ...
  <%-- 엑셀 리스트 --%>
  <div class="w100 mt10" id="wjWrapType3" style="display:none;" ng-controller="apprAcquireMcouponExcelCtrl">
    <div class="wj-gridWrap">
          <wj-flex-grid
              id="apprAcquireMcouponExcelGrid"
              autoGenerateColumns="false"
              selection-mode="Row"
              items-source="data"
              control="excelFlex"
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/appr/acquire/mcoupon/mcoupon.js?ver=20250416.01" charset="utf-8"></script>
