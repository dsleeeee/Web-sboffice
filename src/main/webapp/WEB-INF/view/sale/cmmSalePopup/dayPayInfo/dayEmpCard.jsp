...
<wj-popup id="wjDayEmpCardLayer" control="wjDayEmpCardLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:900px;">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/cmmSalePopup/dayPayInfo/dayEmpCard.js?ver=20190219.01" charset="utf-8"></script>
