package kr.co.solbipos.sale.pay.storePayDay.web;
...
/**
 * @Class Name : StorePayDayController.java
 ...
 */
@Controller
@RequestMapping("/sale/pay/storePayDay")
public class StorePayDayController {

    private final SessionService sessionService;
    private final StorePayDayService storePayDayService;
     ...
     */
    @Autowired
    public StorePayDayController(SessionService sessionService, StorePayDayService storePayDayService, DayService dayService, TodayDtlService todayDtlService, CmmCodeUtil cmmCodeUtil, DayProdService dayProdService) {
        this.sessionService = sessionService;
        this.storePayDayService = storePayDayService;
     ...
     * @param model
     */
    @RequestMapping(value = "/storePayDay/list.sb", method = RequestMethod.GET)
    public String storePayDayView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/pay/storePayDay/storePayDay";
    }
     ...
     * @since   2022.12.21
     */
    @RequestMapping(value = "/storePayDay/getStorePayDayList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getStorePayDayList(HttpServletRequest request, HttpServletResponse response, Model model, StorePayDayVO storePayDayVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> list = storePayDayService.getStorePayDayList(storePayDayVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, list, storePayDayVO);
    }
     ...
     * @since   2022.12.21
     */
    @RequestMapping(value = "/storePayDay/getStorePayDayExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getStorePayDayExcelList(HttpServletRequest request, HttpServletResponse response, Model model, StorePayDayVO storePayDayVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> list = storePayDayService.getStorePayDayExcelList(storePayDayVO, sessionInfoVO);
