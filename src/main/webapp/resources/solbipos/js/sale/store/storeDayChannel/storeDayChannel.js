...
app.controller('storeDayChannelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  ...
  $scope.searchDayList = function () {
    ...
    $.postJSON("/sale/store/storeDayChannel/storeDayChannel/getDayList.sb", params, function (response){
      var grid = $scope.flex;
 ...
 *  엑셀다운로드 그리드 생성
 */
app.controller('storeDayChannelExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('storeDayChannelExcelCtrl', $scope, $http, false));
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $.postJSON("/sale/store/storeDayChannel/storeDayChannel/getDayExcelList.sb", params, function (response){
