package kr.co.solbipos.sale.day.dayPos.web;
...
/**
 * @Class Name : DayPosController.java
 ...
 */
@Controller
@RequestMapping("/sale/day/dayPos")
public class DayPosController {

    private final SessionService sessionService;
    private final DayPosService dayPosService;
     ...
     */
    @Autowired
    public DayPosController(SessionService sessionService, DayPosService dayPosService, DayService dayService, StoreChannelService storeChannelService, DayProdService dayProdService, CmmCodeUtil cmmCodeUtil) {
        this.sessionService = sessionService;
        this.dayPosService = dayPosService;
     ...
     * @param model
     */
    @RequestMapping(value = "/dayPos/list.sb", method = RequestMethod.GET)
    public String dayPosView(HttpServletRequest request, HttpServletResponse response, Model model) {
     ...
     * @since   2023.03.13
     */
    @RequestMapping(value = "/dayPos/getDayPosList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getDayPosList(HttpServletRequest request, HttpServletResponse response, Model model, DayPosVO dayPosVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> list = dayPosService.getDayPosList(dayPosVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, list, dayPosVO);
    }
     ...
     * @since   2023.03.13
     */
    @RequestMapping(value = "/dayPos/getDayPosExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getDayPosExcelList(HttpServletRequest request, HttpServletResponse response, Model model, DayPosVO dayPosVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> list = dayPosService.getDayPosExcelList(dayPosVO, sessionInfoVO);
