	    ...
	    $scope.searchSaleTrnsitnExcelList = function(){
	        ...
	        $scope._inquiryMain("/sale/anals/saletrnsitn/excelList.sb",
	    			params, function()	{
	    					...
	    					var dateFrom 	= $scope.excelFlex.columnHeaders.getCellData(global_idxDateHeaderRow, global_idxDateHeaderFrom);
	    					var dateTo		= $scope.excelFlex.columnHeaders.getCellData(global_idxDateHeaderRow, global_idxDateHeaderTo  );
