...
//		$scope.getEmpNmList();
  ...
  $scope.searchEmpDayPeriodList = function (isPageChk) {
	  ...
	  var startDt = new Date(wijmo.Globalize.format($scope.srchEmpDayPeriodStartDate.value, 'yyyy-MM-dd'));
	  var endDt = new Date(wijmo.Globalize.format($scope.srchEmpDayPeriodEndDate.value, 'yyyy-MM-dd'));
