    ...
    <div ng-controller="sideMenuProdCtrl">
        ...
        <div class="searchBar flddUnfld">
            ...
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <button class="btn_blue fr" ng-click="_broadcast('sideMenuProdCtrl',1)">
...
<script type="text/javascript" src="/resource/solbipos/js/base/prod/sideMenuStore/sideMenuProd.js?ver=20230614.01" charset="utf-8"></script>