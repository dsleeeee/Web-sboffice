...
.fixedMenu.t2 ul li a.btn_close {padding-right:0 !important; top:16px !important; right:10px !important}
		...
		<div class="subCon" ng-controller="spTonyCtrl">
			...
			<div class="fixedMenu t2">
				<nav>
					<ul>
						...
						<li>			
							<a href="/sample/tonymory/sample46.sb" class="on">판촉마일리지 내역조회</a>
							<a href="#" class="btn_close histClose"></a>
						</li>
						<li>			
			...
			<div class="searchBar flddUnfld">
				<a href="#" class="open fl">판촉마일리지 내역조회</a>
				<!-- 조회 -->
				<div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
					<button class="btn_blue">조회</button>
					<button class="btn_gray">저장</button>
				...
				<div class="wj-gridWrap mt10" style="height:450px; overflow-y: hidden;">
					<div class="row">
						<wj-flex-grid
							...
							<wj-flex-grid-column header="출고일자" binding="date" width="*" align="center"></wj-flex-grid-column>
							<wj-flex-grid-column header="매장명" binding="str1" width="*"></wj-flex-grid-column>
							<wj-flex-grid-column header="구분" binding="str2" width="*" align="center"></wj-flex-grid-column>
							<wj-flex-grid-column header="마일리지" binding="amount" width="*" aggregate="Sum"></wj-flex-grid-column>
							<wj-flex-grid-column header="비고" binding="str3" width="*"></wj-flex-grid-column>
						</wj-flex-grid>
					</div>
				</div>
...
<script>
  ...
  app.controller('spTonyCtrl', ['$scope', '$http', function ($scope, $http) {
    ...
    var txt1 = '{엔터식스}천호지하점,{NC웨이브}충장점,{롯데백화점}부산센텀시티점,{롯데마트}춘천점,{세이브존}대전점'.split(','),
    	txt2 = '사용'.split(','),
    	txt3 = '주문사용'.split(','),
        data = [];
    for (var i = 0; i < 200; i++) {
