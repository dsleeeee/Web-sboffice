...
<div id="cornerDayPeriodView" class="subCon"  ng-controller="cornerDayPeriodCtrl">
      ...
      <tr>
        ...
        <div class="sb-select">
	        <span class="txtIn"><input id="srchCornerDayPeriodStartDate" class="w120px"></span>
	          <span class="rg">~</span>
	        <span class="txtIn"><input id="srchCornerDayPeriodEndDate" class="w120px"></span>
	        <span class="chk ml10">
    ...
    <div id="gridRepresent" class="w50 fl" style="width:49%;">
     ...
     <div class="w100 mt10">
      ...
      <div class="wj-gridWrap" style="height: 350px;">
        <wj-flex-grid
          ...
          <wj-flex-grid-column header="<s:message code="corner.cornrNm"/>"           binding="cornrNm"           width="250" align="center" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
        ...
        <jsp:include page="/WEB-INF/view/layout/columnPicker.jsp" flush="true">
          <jsp:param name="pickerTarget" value="cornerDayPeriodCtrl"/>
        </jsp:include>
        <%--// ColumnPicker 사용시 include --%>
      </div>
      <%--//위즈모 테이블--%>
     ...
     <%-- 페이지 리스트 --%>
	  <div class="pageNum mt20">
	   <%-- id --%>
	    <ul id="cornerDayPeriodCtrlPager" data-size="10">
	    </ul>
	  </div>
	  <%--//페이지 리스트--%>
    </div>
    ...
    <div id="gridDetail" class="w50 fr" style="width:49%;">
     ...
     <%-- 페이지 리스트 --%>
      <div class="pageNum mt20">
       <%-- id --%>
        <ul id="cornerDayPeriodDtlCtrlPager" data-size="10">
        </ul>
      </div>
      <%--//페이지 리스트--%>
    </div>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/corner/dayPeriod/dayPeriod.js?ver=20190125.02" charset="utf-8"></script>
