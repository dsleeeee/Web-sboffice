...
<div class="subCon" id="touchKeyResve" ng-controller="touchKeyResveCtrl">

    <div class="searchBar">
        <a href="#" class="open fl"><s:message code="touchKeyResve.touchKeyResve" /></a>
        <%-- 조회 --%>
        <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
            <button class="btn_blue fr" id="nxBtnSearch" ng-click="_pageView('touchKeyResveCtrl', 1)">
        ...
        <tr class="brt">
            ...
            <th class="oh gr">
                <div class="sb-select" style="width:120px; float:left;">
                    <wj-combo-box
                            id="touchKeyGrpCombo2"
                            ng-model="touchKeyGrpChange"
                            control="touchKeyGrpCombo2"
                            items-source="_getComboData('touchKeyGrpCombo2')"
                            display-member-path="name"
                            selected-value-path="value"
                            is-editable="false"
                            initialized="_initComboBox(s)">
    ...
    <div class="pageNum mt20">
        <%-- id --%>
        <ul id="touchKeyResveCtrlPager" data-size="10">
        </ul>
    </div>
    <%--//페이지 리스트--%>
    </div>
...
<script>
    ...
    var touchKeyGrpDataAll = ${touchKeyGrpAll};
...
<script type="text/javascript" src="/resource/solbipos/js/base/prod/touchKeyResve/touchKeyResve.js?ver=20230327.03" charset="utf-8"></script>
