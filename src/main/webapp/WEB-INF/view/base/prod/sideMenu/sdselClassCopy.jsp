            ...
            <table class="tblType01">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" id="srchHalfAndHalfYn" />
                    </td>
                    <td>
                        <%-- 선택분류복사 --%>
...
<script type="text/javascript" src="/resource/solbipos/js/base/prod/sideMenu/sdselClassCopy.js?ver=20250925.01" charset="utf-8"></script>