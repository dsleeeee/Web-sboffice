...
<div id="todayGnrlzView" class="subCon" ng-controller="storeCtrl" style="padding: 10px 20px 40px;">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/today/todayGnrlz/todayGnrlz.js?ver=20251223.01" charset="utf-8"></script>
