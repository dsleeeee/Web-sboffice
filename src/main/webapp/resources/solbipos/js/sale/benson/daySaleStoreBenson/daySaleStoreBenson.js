/****************************************************************
 *
 * 파일명 : daySaleStoreBenson.js
 * 설  명 : (벤슨) 간소화화면 > 일별매출(매장) JavaScript
 *
 ...
 *  일별매출(매장) 그리드 생성
 */
app.controller('daySaleStoreBensonCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('daySaleStoreBensonCtrl', $scope, $http, false));
    ...
    $scope.initGrid = function (s, e) {
        ...
        // 첫째줄 헤더 생성
        var dataItem = {};
        dataItem.saleDate = messages["daySaleStoreBenson.saleDate"];
        dataItem.storeCd = messages["daySaleStoreBenson.storeCd"];
        dataItem.storeNm = messages["daySaleStoreBenson.storeNm"];
        dataItem.totSaleAmt = messages["daySaleStoreBenson.tot"];
        dataItem.totRealSaleAmt = messages["daySaleStoreBenson.tot"];
        dataItem.totBillCnt = messages["daySaleStoreBenson.tot"];
        dataItem.stinTotSaleAmt = messages["daySaleStoreBenson.stin"];
        dataItem.stinRealSaleAmt = messages["daySaleStoreBenson.stin"];
        dataItem.stinBillCnt = messages["daySaleStoreBenson.stin"];
        dataItem.dlvrTotSaleAmt = messages["daySaleStoreBenson.dlvr"];
        dataItem.dlvrRealSaleAmt = messages["daySaleStoreBenson.dlvr"];
        dataItem.dlvrBillCnt = messages["daySaleStoreBenson.dlvr"];
        dataItem.packTotSaleAmt = messages["daySaleStoreBenson.pack"];
        dataItem.packRealSaleAmt = messages["daySaleStoreBenson.pack"];
        dataItem.packBillCnt = messages["daySaleStoreBenson.pack"];
        dataItem.baeminTotSaleAmt = messages["daySaleStoreBenson.baemin"];
        dataItem.baeminRealSaleAmt = messages["daySaleStoreBenson.baemin"];
        dataItem.baeminBillCnt = messages["daySaleStoreBenson.baemin"];
        dataItem.yogiyoTotSaleAmt = messages["daySaleStoreBenson.yogiyo"];
        dataItem.yogiyoRealSaleAmt = messages["daySaleStoreBenson.yogiyo"];
        dataItem.yogiyoBillCnt = messages["daySaleStoreBenson.yogiyo"];
        dataItem.coupangeatsTotSaleAmt = messages["daySaleStoreBenson.coupangeats"];
        dataItem.coupangeatsRealSaleAmt = messages["daySaleStoreBenson.coupangeats"];
        dataItem.coupangeatsBillCnt = messages["daySaleStoreBenson.coupangeats"];
        dataItem.etcTotSaleAmt = messages["daySaleStoreBenson.etc"];
        dataItem.etcRealSaleAmt = messages["daySaleStoreBenson.etc"];
        dataItem.etcBillCnt = messages["daySaleStoreBenson.etc"];
    ...
    // <-- 검색 호출 -->
    $scope.$on("daySaleStoreBensonCtrl", function (event, data) {
        $scope.searchDaySaleStoreBensonList();
        event.preventDefault();
    });

    $scope.searchDaySaleStoreBensonList = function () {
        ...
        params.storeCds = $("#daySaleStoreBensonStoreCd").val();
        // '전체' 일때
        ...
        $scope._inquiryMain("/sale/benson/daySaleStoreBenson/daySaleStoreBenson/getDaySaleStoreBensonList.sb", params, function (){
    ...
    $scope.excelDownload = function (excelType) {
        ...
        if(params.excelType === '1') {
            ...
            $scope._popConfirm(messages["cmm.excel.totalExceDownload"], function() {
                $scope._broadcast('daySaleStoreBensonExcelCtrl', params);
            });
        }else{
            // 분할 엑셀다운로드 사용자 제한 체크
 ...
 *  엑셀다운로드 그리드 생성
 */
app.controller('daySaleStoreBensonExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('daySaleStoreBensonExcelCtrl', $scope, $http, false));
    ...
    // <-- 검색 호출 -->
    $scope.$on("daySaleStoreBensonExcelCtrl", function (event, data) {
        if(data.excelType === '1') {
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $.postJSON("/sale/benson/daySaleStoreBenson/daySaleStoreBenson/getDaySaleStoreBensonExcelList.sb", params, function(response) {
    ...
    $scope.searchExcelDivisionList = function (params) {
        ...
        $.postJSON("/sale/benson/daySaleStoreBenson/daySaleStoreBenson/getDaySaleStoreBensonList.sb", params, function(response){
                ...
                function delay(x){
                    return new Promise(function(resolve, reject){
                        ...
                        $.postJSON("/sale/benson/prodSaleDayStoreBenson/prodSaleDayStoreBenson/getDivisionExcelDownloadSaveUpdate.sb", params, function(response){
                            ...
                            // ajax 통신 설정
                            $.postJSON('/sale/benson/daySaleStoreBenson/daySaleStoreBenson/getDaySaleStoreBensonExcelDivisionList.sb', params, function(response) {
