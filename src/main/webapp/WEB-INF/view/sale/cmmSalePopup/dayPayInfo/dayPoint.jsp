...
<wj-popup id="wjDayPointLayer" control="wjDayPointLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:700px;">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/cmmSalePopup/dayPayInfo/dayPoint.js?ver=20191219" charset="utf-8"></script>
