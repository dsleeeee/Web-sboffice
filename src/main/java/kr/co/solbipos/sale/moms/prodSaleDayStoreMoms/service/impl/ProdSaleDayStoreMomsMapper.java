...
public interface ProdSaleDayStoreMomsMapper {
    ...
    /** 상품매출일별(매장) - 순번(자동채번) */
    String getDownloadSeq(ProdSaleDayStoreMomsVO prodSaleDayStoreMomsVO);
    ...
    int getDivisionExcelDownloadSaveUpdate(ProdSaleDayStoreMomsVO prodSaleDayStoreMomsVO);
}