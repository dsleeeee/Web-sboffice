        ...
        <div class="wj-gridWrap" style="height:370px">
          <div class="row">
            <wj-flex-grid
              ...
              <wj-flex-grid-column header="<s:message code="envConfg.envstCd"/>" binding="envstCd" width="70" align="center" is-read-only="true" ></wj-flex-grid-column>
              ...
              <wj-flex-grid-column header="<s:message code="envConfg.envstRemark"/>" binding="envstRemark" width="200" is-read-only="true" ></wj-flex-grid-column>
  ...
  <div id="gridDetail" class="w40 fr mt10" style="width: 40%" ng-controller="envstRemarkCtrl">
    ...
    <div class="wj-TblWrapBr ml10 pd20" style="height: 480px;">
      <div class="updownSet oh mb10">
        ...
        <input type="text" id="envstCd" ng-model="envstCd" style="display: none">
      </div>
      <%-- 개발시 높이 조절해서 사용--%>
      <%-- tbody영역의 셀 배경이 들어가는 부분은 .bdBg를 넣어주세요. --%>
      <div class="wj-gridWrap" style="height:370px;">
        <textarea id="envstRemark"  class="w100" cols="42" style="height:300px;resize: none;" ng-model="envstRemark"></textarea>
      </div>
