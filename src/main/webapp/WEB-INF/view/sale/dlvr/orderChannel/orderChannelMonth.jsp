...
<div id="orderChannelMonthView" class="subCon" ng-controller="orderChannelMonthCtrl" style="padding: 10px 20px 40px;">
    <div class="searchBar">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/dlvr/orderChannel/orderChannelMonth.js?ver=20240605.01" charset="utf-8"></script>