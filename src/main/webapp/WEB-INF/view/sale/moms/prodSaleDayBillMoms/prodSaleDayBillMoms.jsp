    ...
    <div ng-controller="prodSaleDayBillMomsCtrl">
        <div class="searchBar">
            ...
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('prodSaleDayBillMomsCtrl', 1)">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/moms/prodSaleDayBillMoms/prodSaleDayBillMoms.js?ver=20251229.02" charset="utf-8"></script>