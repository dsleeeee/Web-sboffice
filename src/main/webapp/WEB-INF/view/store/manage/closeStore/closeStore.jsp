...
<div id="closeStore" class="subCon" ng-controller="closeStoreCtrl">

  <div class="searchBar flddUnfld">
    <a href="#" class="open fl"><s:message code="closeStore.store" /></a>
    <%-- 조회 --%>
    <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
      <button class="btn_blue fr" ng-click="_pageView('closeStoreCtrl',1)" id="nxBtnSearch1">
    ...
    <tbody>
      ...
      <c:if test="${orgnFg == 'MASTER'}">
        <tr>
          ...
          <td>
            <input type="text" class="sb-input w100" id="srchAgencyCd" ng-model="agencyCd" onkeyup="fnNxBtnSearch('1');"/>
          </td>
          <%-- 관리업체명 --%>
          <th><s:message code="closeStore.agencyNm" /></th>
          <td>
            <input type="text" class="sb-input w100" id="srchAgencyNm" ng-model="agencyNm" onkeyup="fnNxBtnSearch('1');"/>
          </td>
        </tr>
      </c:if>
      <tr>
  ...
  <div id="grid" class="w100">
    <div class="mt10 oh sb-select dkbr">
      ...
      <br/>
      <span class="s12 fl red">※ 제외([H0393])</span>
...
<script type="text/javascript" src="/resource/solbipos/js/store/manage/closeStore/closeStore.js?ver=20240216.01" charset="utf-8"></script>
