      ...
      <div id="gridMapng" class="wj-TblWrapBr ml10 pd5" style="height: 480px;" ng-controller="sideMenuSelectProdCtrl">
        ...
        <div style="height:370px;">
          <wj-flex-grid
            ...
            <wj-flex-grid-column header="<s:message code="soldOut.soldOutYn"/>" binding="soldOutYn" width="80" data-map="soldOutYnDataMap" <c:if test="${hqOfficeCd == 'DS021' or hqOfficeCd == 'DS034' or hqOfficeCd == 'H0393' or hqOfficeCd == 'DS079' or hqOfficeCd == 'H0665'}">is-read-only="true"</c:if>></wj-flex-grid-column>
