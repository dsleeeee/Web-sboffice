            ...
            <div class="w100">
                ...
                <div class="theGrid mt10" style="height: 400px;">
                    <wj-flex-grid
                        ...
                        <wj-flex-grid-column header="<s:message code="selectDcfg.storeNm"/>" binding="storeNm" width="*" align="left" is-read-only="true"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="selectDcfg.dcDisplay"/>" binding="dcNm" width="120" align="center" is-read-only="true"></wj-flex-grid-column>
...
//     });
        ...
        $scope.searchTable = function () {
            ...
            if(params.storeCd !== $scope.oldStoreCd || $scope.searchFg === "N"){
                $scope._inquirySub("/common/popup/selectDcfg/getSelectDcfgList.sb", params, function () {
                    $scope.searchFg = "Y";
