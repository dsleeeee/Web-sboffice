...
/** 조정관리 그리드 controller */
app.controller('stockAdjustCtrl', ['$scope', '$http', function ($scope, $http) {
    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('stockAdjustCtrl', $scope, $http, true));
    ...
    $scope.initGrid = function (s, e) {
        ...
        $scope._makePickColumns("stockAdjustCtrl");
        ...
        s.addEventListener(s.hostElement, 'mousedown', function (e) {
            ...
            if (ht.cellType === wijmo.grid.CellType.Cell) {
                ...
                if (col.binding === "adjTitle") { // 제목 클릭
                    ...
                    $scope._broadcast('stockAdjustDtlCtrl', params);
                }
            }
        });
    };
    ...
    $scope.$on("stockAdjustCtrl", function (event, data) {
        $scope.getSearchAdjustList();
        // 기능수행 종료 : 반드시 추가
    ...
    // 주문 리스트 조회
    $scope.getSearchAdjustList = function () {
        // 파라미터
        var params       = {};
        ...
        $scope._inquiryMain("/kookmin/stock/stockAdjust/stockAdjust/getSearchAdjustList.sb", params);
    };
    ...
    $scope.deleteAdj = function () {
        ...
        s_alert.popConf(msg, function () {
            ...
            $scope._save("/kookmin/stock/stockAdjust/stockAdjust/deleteAdjust.sb", params, function () {
                $scope.getSearchAdjustList();
            });
        });
    };
