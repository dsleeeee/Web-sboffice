...
<div id="dcDcfgView" class="subCon" ng-controller="dcDcfgCtrl">
	<div class="searchBar flddUnfld">
		...
		<%-- 조회 --%>
		<button class="btn_blue fr mt5 mr10" id="btnDcDcfgSearch" ng-click="_broadcast('dcDcfgCtrl')">
		...
		<tbody>
			...
			<tr>
				<c:if test="${sessionInfo.orgnFg == 'HQ'}">
					...
					<td>
                        ...
                        <jsp:includepage="/WEB-INF/view/iostock/cmm/selectStoreM.jsp" flush="true">
			...
			<tr>
				...
				<td colspan="3">
					<div class="sb-select">
						<span class="txtIn"> 
							<wj-combo-box id="srchDcDcfgDisplay" ng-model="dcCd" 
								items-source="_getComboData('srchDcDcfgDisplay')" 
						...
						<%-- 할인유형 전체보기 --%>
						<span class="chk ml10"> 
							<input type="checkbox" id="totalDcDcfg" ng-model="isAll" ng-change="totalDcDcfg()" /> 
							<label for="totalDcDcfg">전체선택</label>
						</span>
					</div>
				</td>
			</tr>
