    ...
    <div class="wj-dialog-body" ng-controller="<c:out value="${param.targetId}"/>Ctrl">
      <div class="w100">
        ...
        <table class="tblType01 mt5">
          ...
          <tr>
            <%-- 매장브랜드 --%>
            <th id="th<c:out value="${param.targetId}"/>MStoreHqBrand" style="display: none;"><s:message code="outstockReqDate.storeHqBrand" /></th>
            <td id="td<c:out value="${param.targetId}"/>MStoreHqBrand" style="display: none;">
              <div class="sb-select">
                <wj-combo-box
            ...
            <th><s:message code="outstockReqDate.storeChgNot" /></th>
            <td>
              <div class="sb-select">
                <wj-combo-box
                        id="srchStoreChgNotCombo"
                        ng-model="popStoreChgNot"
                        items-source="_getComboData('popMStoreChgNotCombo')"
                        display-member-path="name"
                        selected-value-path="value"
                        is-editable="false"
...
<script type="text/javascript">
  ...
  app.controller('${param.targetId}Ctrl', ['$scope', '$http', function ($scope, $http) {
    ...
    $scope._setComboData("popMStoreChgNotCombo", storeChgFgData);
    ...
    $scope.searchStore = function () {
      ...
      console.log($scope.popStoreChgNot);
