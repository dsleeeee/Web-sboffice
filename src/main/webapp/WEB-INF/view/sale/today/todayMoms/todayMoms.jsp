  ...
  <div ng-controller="todayMomsCtrl">
    <div class="searchBar">
      ...
      <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
        <%-- 조회 --%>
        <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('todayMomsCtrl', 1)">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/today/todayMoms/todayMoms.js?ver=20240530.01" charset="utf-8"></script>