            ...
            <div class="wj-TblWrapBr pd10">
                ...
                <div class="wj-gridWrap" style="height:550px; overflow-x: hidden; overflow-y: hidden;">
                    <wj-flex-grid
                        ...
                        <wj-flex-grid-column header="<s:message code="artiseeProdMapping.prodCd"/>" binding="prodCd" width="105" align="center" is-read-only="true" format="@"></wj-flex-grid-column>
                        ...
                        <wj-flex-grid-column header="<s:message code="artiseeProdMapping.erpProdCd"/>" binding="erpProdCd" align="center" width="105" is-read-only="true" format="@"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/base/prod/artiseeProdMapping/artiseeProdMapping.js?ver=20260410.01" charset="utf-8"></script>
