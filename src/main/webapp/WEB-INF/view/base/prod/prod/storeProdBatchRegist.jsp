            ...
            <table class="tblType01" ng-controller="srchProdCtrl">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <jsp:param name="targetId" value="srchProd"/>
                        </jsp:include>
                        <%--// 분류선택 모듈 멀티 선택 사용시 include --%>
                    </td>
                </tr>
...
<script type="text/javascript" src="/resource/solbipos/js/base/prod/prod/storeProdBatchRegist.js?ver=20250820.01" charset="utf-8"></script>