...
<div class="subCon" ng-controller="outstockConfmCtrl">
    ...
    <div class="tr mt10 fr">
        <p class="s14 bk fl mr10 lh30"><s:message code="outstockConfm.reqNoConfirm"/> : </p><p class="s14 bk fl mr10 lh30 red" id="reqNoConfirmCnt"></p>
        <p class="s14 bk fl mr10 lh30"><s:message code="outstockConfm.outstockNoCreate"/> : </p><p class="s14 bk fl mr20 lh30 red" id="outstockNoCreateCnt"></p>
        <%-- 출고일자 --%>
        ...
        <%-- 출고자료생성 --%>
        <button type="button" id="btnConfirm" class="btn_skyblue ml5 fl" ng-click="saveOutstockConfirm()"><s:message code="outstockConfm.outstockConfirm" /></button>
    </div>
    ...
    app.controller('outstockConfmCtrl', ['$scope', '$http', function ($scope, $http) {
      ...
      $scope.getReqNoConfirmCnt = function() {
        ...
        $scope.saveOutstockConfirm = function () {
          ...
          $scope._save("/iostock/order/outstockConfm/outstockConfm/saveOutstockConfirm.sb", params, function() { $scope.getReqNoConfirmCnt() });
        };
