    ...
    <div ng-controller="contentPop1Ctrl">
        ...
        <div class="subCon">
            ...
            <div style="width: 710px; height: 520px; overflow-x: auto; overflow-y: auto; border: 1px solid #e8e8e8;" class="tl s14 lh15 pd10">
                <p>
                    <strong>[ 불법스팸 방지·서비스 이용제한 정책 ]</strong><br>
                    <br>
                    <br>
                    ...
                    <br>
                    <br>
                    4. 서비스 제한 및 역무제공 거부<br>
                    - 회사는 회원이 본 정책 또는 정보통신망법 제50조 등 관계 법령을 위반하거나 위반이 의심되는 경우, 사전 통지 없이 해당 메시지의 발송을 제한하거나 발신번호 사용을 정지하고, 회원에 대한 서비스 제공을 거부·정지 또는 이용계약을 해지할 수 있습니다.<br>
                    - 회사는 제한·거부·해지 등의 조치를 취한 경우 그 사유와 조치 내용을 회원에게 통지하며, 조치 결과를 관계 법령이 정한 기간 동안 보관합니다.<br>
                    - 회원이 본 정책을 위반하여 회사 또는 제3자에게 손해가 발생한 경우 그에 대한 민사상·형사상 책임은 회원 본인에게 있으며, 회사는 관계 법령에 따라 방송통신위원회, 한국인터넷진흥원(불법스팸대응센터) 등에 관련 사실 및 자료를 신고·제공할 수 있습니다.<br>
                    <br>
                    <br>
                    5. 문자 내 URL 검사 및 차단<br>
                    <br>
