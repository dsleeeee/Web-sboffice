...
<div class="con" id="saleAnalsTabView" name="saleAnalsTabView">
  <div class="tabType1" ng-controller="saleAnalsTabCtrl" ng-init="init()">
    <ul>
      <%-- 일별 탭 --%>
      <li>
        <a id="dayTab" href="#" class="on" ng-click="dayShow()"><s:message code="saleAnals.day"/></a>
      </li>
      <%-- 월별 탭 --%>
      <li>
        <a id="monthTab" href="#" ng-click="monthShow()"><s:message code="saleAnals.month"/></a>
      </li>
    </ul>
  </div>
</div>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/anals/saleAnals/saleAnalsTab.js?ver=20220922.01" charset="utf-8"></script>

<%-- 탭페이지 레이어 시작 --%>
<%-- 일별 레이어 --%>
<c:import url="/WEB-INF/view/sale/anals/saleAnals/day.jsp">
  <c:param name="menuCd" value="${menuCd}"/>
  <c:param name="menuNm" value="${menuNm}"/>
</c:import>

<%-- 월별 레이어 --%>
<c:import url="/WEB-INF/view/sale/anals/saleAnals/month.jsp">
  <c:param name="menuCd" value="${menuCd}"/>
  <c:param name="menuNm" value="${menuNm}"/>
</c:import>
<%-- //탭페이지 레이어 --%>
