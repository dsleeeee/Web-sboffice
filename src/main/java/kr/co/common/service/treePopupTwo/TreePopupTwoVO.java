...
/**
 * @Class Name  : TreePopupTwoVO.java
 ...
 */
public class TreePopupTwoVO extends PageVO {
    private static final long serialVersionUID = 2543466560525981878L;
    ...
    private List<TreePopupTwoVO> items;
    ...
    public List<TreePopupTwoVO> getItems() {
        return items;
    }

    public void setItems(List<TreePopupTwoVO> items) {
        this.items = items;
    }
}
