  ...
  <div class="w100 mt10">
    ...
    <div class="wj-gridWrap" style="height: 350px;">
      <wj-flex-grid
        ...
        <wj-flex-grid-column header="<s:message code="hqCurr.poUnitFg"/>" binding="poUnitFg" width="60" align="center" is-read-only="true"></wj-flex-grid-column>
...
<script type="text/javascript">
  ...
  app.controller('hqCurrCtrl', ['$scope', '$http', function ($scope, $http) {
