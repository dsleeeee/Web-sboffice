...
<!--
    ...
    <div class="divMainWrap">
        ...
        <div style="margin-top:30px; text-align:center;">
            <span onclick="top.BlankFrm.location.href='/etc/manual/down_manual.jsp?file_name=manual_virtual_login.pdf';" style="color:blue; cursor:pointer; margin-right:20px;">IE 보안 세팅하기 매뉴얼</span>
            |
            <span onclick="window.open('https://www.google.com/chrome/');" style="color:blue; cursor:pointer; margin-left:20px;">크롬(Chrome) 설치하기</span>
        </div>
