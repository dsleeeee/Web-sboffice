/****************************************************************
 *
 * 파일명 : salePerfCompareBensonAll.js
 * 설  명 : 벤슨 > 배출분석 > 대비기간 매출실적 > 전체점포 탭 JavaScript
 *
...
/** 전체점포 controller */
app.controller('salePerfCompareBensonAllCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('salePerfCompareBensonAllCtrl', $scope, $http, $timeout, true));
    ...
    $scope.initGrid = function (s, e) {
        ...
        s.refresh();
        // picker 사용시 호출 : 미사용시 호출안함
        $scope._makePickColumns("salePerfCompareBensonAllCtrl");
        ...
        // 첫째줄 헤더 생성
        var dataItem         = {};
        dataItem.dlvrOrderFg        = messages["salePerfCompareBenson.dlvrOrderFg"];
        dataItem.compSaleCntFran    = messages["salePerfCompareBenson.compDate"];
        dataItem.compSaleAmtFran    = messages["salePerfCompareBenson.compDate"];
        dataItem.compSaleCntDm      = messages["salePerfCompareBenson.compDate"];
        dataItem.compSaleAmtDm      = messages["salePerfCompareBenson.compDate"];
        dataItem.compTotSaleCnt     = messages["salePerfCompareBenson.compDate"];
        dataItem.compTotSaleAmt     = messages["salePerfCompareBenson.compDate"];
        dataItem.srchSaleCntFran    = messages["salePerfCompareBenson.srchDate"];
        dataItem.srchSaleAmtFran    = messages["salePerfCompareBenson.srchDate"];
        dataItem.srchSaleCntDm      = messages["salePerfCompareBenson.srchDate"];
        dataItem.srchSaleAmtDm      = messages["salePerfCompareBenson.srchDate"];
        dataItem.srchTotSaleCnt     = messages["salePerfCompareBenson.srchDate"];
        dataItem.srchTotSaleAmt     = messages["salePerfCompareBenson.srchDate"];
        dataItem.grSaleCntFran      = messages["salePerfCompareBenson.growthRate"];
        dataItem.grSaleAmtFran      = messages["salePerfCompareBenson.growthRate"];
        dataItem.grSaleCntDm        = messages["salePerfCompareBenson.growthRate"];
        dataItem.grSaleAmtDm        = messages["salePerfCompareBenson.growthRate"];
        dataItem.grTotSaleCnt       = messages["salePerfCompareBenson.growthRate"];
        dataItem.grTotSaleAmt       = messages["salePerfCompareBenson.growthRate"];
    ...
    $scope.$on("salePerfCompareBensonAllCtrl", function (event, data) {
        $scope.searchSalePerfCompareBensonList();
        // 기능수행 종료 : 반드시 추가
        event.preventDefault();
    });

    // 코너별매출일자별 리스트 조회
    $scope.searchSalePerfCompareBensonList = function () {
        ...
        if(dateFg === 'day' || dateFg === 'dayPeriod'){
            ...
            if(dateFg === 'yearPeriod') {
                ...
                $scope._popMsg(messages['salePerfCompareBenson.msg.yearPeriod']);
                return false;
        ...
        $scope._inquiryMain("/sale/anals/salePerfCompareBenson/salePerfCompareBenson/getSalePerfCompareBensonList.sb", params, function (){
            var grid = wijmo.Control.getControl("#salePerfCompareBensonAllMainGrid");
            var dataItem         = {};
            var srchDate = '';
            var compDate = '';
            if(dateFg === 'day' || dateFg  === 'month' || dateFg === 'year'){
            ...
            dataItem.dlvrOrderFg        = messages["salePerfCompareBenson.dlvrOrderFg"];
            dataItem.compSaleCntFran    = messages["salePerfCompareBenson.compDate"] + compDate;
            dataItem.compSaleAmtFran    = messages["salePerfCompareBenson.compDate"] + compDate;
            dataItem.compSaleCntDm      = messages["salePerfCompareBenson.compDate"] + compDate;
            dataItem.compSaleAmtDm      = messages["salePerfCompareBenson.compDate"] + compDate;
            dataItem.compTotSaleCnt     = messages["salePerfCompareBenson.compDate"] + compDate;
            dataItem.compTotSaleAmt     = messages["salePerfCompareBenson.compDate"] + compDate;
            dataItem.srchSaleCntFran    = messages["salePerfCompareBenson.srchDate"] + srchDate;
            dataItem.srchSaleAmtFran    = messages["salePerfCompareBenson.srchDate"] + srchDate;
            dataItem.srchSaleCntDm      = messages["salePerfCompareBenson.srchDate"] + srchDate;
            dataItem.srchSaleAmtDm      = messages["salePerfCompareBenson.srchDate"] + srchDate;
            dataItem.srchTotSaleCnt     = messages["salePerfCompareBenson.srchDate"] + srchDate;
            dataItem.srchTotSaleAmt     = messages["salePerfCompareBenson.srchDate"] + srchDate;
            dataItem.grSaleCntFran      = messages["salePerfCompareBenson.growthRate"];
            dataItem.grSaleAmtFran      = messages["salePerfCompareBenson.growthRate"];
            dataItem.grSaleCntDm        = messages["salePerfCompareBenson.growthRate"];
            dataItem.grSaleAmtDm        = messages["salePerfCompareBenson.growthRate"];
            ...
            // $scope._broadcast('salePerfCompareBensonAllDtlCtrl',params);
    ...
    $scope.excelDownload = function () {
        ...
        // var vScope = agrid.getScope("salePerfCompareBensonAllDtlCtrl");
        //
        // // 합계 행(GroupRow) 가져오기
...
app.controller('salePerfCompareBensonAllDtlCtrl', ['$scope', '$http','$timeout', function ($scope, $http, $timeout) {
    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('salePerfCompareBensonAllDtlCtrl', $scope, $http, $timeout, true));
    ...
    $scope.initGrid = function (s, e) {
        ...
        // picker 사용시 호출 : 미사용시 호출안함
        $scope._makePickColumns("salePerfCompareBensonAllDtlCtrl");
        ...
        // 첫째줄 헤더 생성
        var dataItem         = {};
        dataItem.dlvrInFg           = messages["salePerfCompareBenson.dlvrInFg"];
        dataItem.compSaleCntFran    = messages["salePerfCompareBenson.compDate"];
        dataItem.compSaleAmtFran    = messages["salePerfCompareBenson.compDate"];
        dataItem.compSaleCntDm      = messages["salePerfCompareBenson.compDate"];
        dataItem.compSaleAmtDm      = messages["salePerfCompareBenson.compDate"];
    ...
    // 다른 컨트롤러의 broadcast 받기
    $scope.$on("salePerfCompareBensonAllDtlCtrl", function (event, data) {
        if(data != undefined){
        ...
        $scope.searchSalePerfCompareBensonDtlList();
        // 기능수행 종료 : 반드시 추가
        event.preventDefault();
    });

    // 코너별매출일자별 리스트 조회
    $scope.searchSalePerfCompareBensonDtlList = function () {
        // 파라미터
        var params       = {};
        ...
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $scope._inquiryMain("/sale/anals/salePerfCompareBenson/salePerfCompareBenson/getSalePerfCompareBensonDtlList.sb", params,function (){
            var grid = wijmo.Control.getControl("#salePerfCompareBensonAllDtlGrid");
            var dataItem         = {};
            var srchDate = '';
            var compDate = '';
