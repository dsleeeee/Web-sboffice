...
app.controller('dayTemporaryCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  // 상위 객체 상속 : T/F 는 picker
  angular.extend(this, new RootController('dayTemporaryCtrl', $scope, $http, true));
  ...
  $scope.excelDownload = function () {
    ...
    $timeout(function () {
      ...
      }, '가승인결제내역_' + getToday() + '.xlsx', function () {
        $timeout(function () {
