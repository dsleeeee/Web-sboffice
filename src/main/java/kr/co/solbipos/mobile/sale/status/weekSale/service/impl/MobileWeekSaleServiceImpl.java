...
public class MobileWeekSaleServiceImpl implements MobileWeekSaleService {
     ...
     */
    @Autowired
    public MobileWeekSaleServiceImpl(MobileWeekSaleMapper mobileWeekSaleMapper, PopupMapper popupMapper) {
    ...
    public DefaultMap<String> getMobileWeekSaleTotalList(MobileWeekSaleVO mobileWeekSaleVO, SessionInfoVO sessionInfoVO) {
        ...
        if(!StringUtil.getOrBlank(mobileWeekSaleVO.getSrchStoreCd()).equals("")) {
            ...
            storeVO.setArrSplitStoreCd(CmmUtil.splitText(mobileWeekSaleVO.getSrchStoreCd(), 3900));
            mobileWeekSaleVO.setStoreCdQuery(popupMapper.getSearchMultiStoreRtn(storeVO));
        }
