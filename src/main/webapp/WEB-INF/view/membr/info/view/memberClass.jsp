        ...
        <div ng-controller="memberClassCtrl">
            ...
            <table class="searchTbl">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input type="text" id="membrClassCd" class="sb-input w10 fl mr10" ng-model="detailData.membrClassCd" maxlength="3" readonly <%--ng-readonly="detailData.regDt !== undefined"--%> />
            ...
            <div class="wj-TblWrap mt20 mb20 w70 fl">
                ...
                <div class="wj-TblWrapBr mr10 pd20" style="height: 470px; overflow-y: hidden;">
                    <div class="updownSet oh mb10">
                        ...
                        <%--삭제--%>
                        <button class="btn_skyblue" id="btnDel" ng-click="classDel()"><s:message code='cmm.del' /></button>
                    </div>
                    <%-- 회원목록 그리드 --%>
        ...
        <div class="wj-TblWrap mt20 mb20 w30 fr" ng-controller="memberClassDetailCtrl">
            ...
            <div class="wj-TblWrapBr ml10 pd20" style="height: 470px; overflow-y: hidden;">
                <div class="updownSet oh mb10" ng-switch="classData.pointSaveFg">
                    ...
                    <%--추가--%>
                    <button class="btn_skyblue" id="membrPointAdd" ng-click="pointAdd()"><s:message code="cmm.add"/></button>
                    <%--저장--%>
                    <button class="btn_skyblue" id="membrPointSave" ng-click="pointSave()"><s:message code="cmm.save"/></button>
                    <%--삭제--%>
                    <button class="btn_skyblue" id="membrPointDel" ng-click="pointDel()"><s:message code="cmm.del"/></button>

                    <input type="text" class="sb-input fl w15"
                           ng-attr-placeholder="{{classData.pointSaveFg === '2' ? '원당1Point' : '%적립'}}"
                           ng-style="{'font-size':'0.8em'}"
                           ng-attr-maxlength="{{classData.pointSaveFg === '2' ? '5' : '6'}}"
                           ng-model="membrTotal"
                           onkeyup="this.value=this.value.replace(/[^0-9.]/g,'');"/>

                    <%--일괄등록--%>
                    <button class="btn_skyblue fl ml10" id="membrTotalbtn" ng-click="pointTotal()"><s:message code="grade.membr.total.button"/></button>
                </div>
...
<script>
    ...
    // '회원등급 관리구분[1237]'에 따른 화면 사용여부
    if(orgnFg === "STORE" && hqOfficeCd !== "00000"){
        if(membrClassManageFg === "0" || membrClassManageFg === 0){
...
<script type="text/javascript" src="/resource/solbipos/js/membr/info/view/memberClass.js?ver=20260213.01" charset="utf-8"></script>