...
<div class="subCon" id="kioskKeyMapView" ng-controller="kioskKeyMapCtrl" style="display: none;padding: 10px 20px 40px;">
  <%--searchTbl--%>
  <div class="searchBar">
    ...
    <div class="wj-TblWrapBr mt10">
      ...
      <div class="wj-gridWrap" style="height: 450px; overflow-x: hidden; overflow-y: hidden;">
        <wj-flex-grid
          ...
          <wj-flex-grid-column header="<s:message code="prodInfoSearch.kioskKeyMap.prodCd"/>" binding="prodCd" width="100" align="center" is-read-only="true" format="d"></wj-flex-grid-column>
