...
<div class="subCon3" ng-controller="mobileStoreCurrCtrl">
    <div class="searchBar">
        <a href="#" class="open fl">${menuNm}</a>

        <%-- 조회 --%>
        <button class="btn_blue fr mt5 mr10" id="btnSearch" ng-click="_broadcast('mobileStoreCurrCtrl')">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <jsp:include page="/WEB-INF/view/mobile/sale/com/popup/selectStore.jsp" flush="true">
                    <jsp:param name="targetId" value="mobileStoreCurrSelectStore"/>
                </jsp:include>
                <%--// 매장선택 모듈 사용시 include --%>
            </td>
            <c:choose>
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <jsp:include page="/WEB-INF/view/mobile/sale/com/popup/selectVendrM.jsp" flush="true">
                    <jsp:param name="targetId" value="mobileStoreCurrSelectVendr"/>
                </jsp:include>
                <%--// 거래처선택 모듈 싱글 선택 사용시 include --%>
            </td>
        </tr>
    ...
    <div class="w100 mt10">
        ...
        <div class="wj-gridWrap" style="height: 350px; overflow-x: hidden; overflow-y: hidden;">
            <wj-flex-grid
                ...
                <div class="gridMsg" id="mobileStoreCurrMsg" style="line-height: 150px; display: none;"><s:message code="mobile.cmm.search.result.empty"/></div>
            </wj-flex-grid>
            <%-- ColumnPicker 사용시 include --%>
            <jsp:include page="/WEB-INF/view/layout/columnPicker.jsp" flush="true">
                <jsp:param name="pickerTarget" value="mobileStoreCurrCtrl"/>
            </jsp:include>
            <%--// ColumnPicker 사용시 include --%>
        </div>
        <%--//위즈모 테이블--%>
...
<script type="text/javascript" src="/resource/solbipos/js/mobile/stock/curr/storeCurr/mobileStoreCurr.js?ver=20240723.01" charset="utf-8"></script>
