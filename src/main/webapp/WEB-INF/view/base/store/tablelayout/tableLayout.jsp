...
<script>
    ...
    window.TABLELAYOUT_SAVE_URL = window.TABLELAYOUT_SAVE_URL || '/base/store/tableLayout/tableLayout/saveLayout.sb';
    window.TABLELAYOUT_UPLOADIMAGE_URL = window.TABLELAYOUT_UPLOADIMAGE_URL || '/base/store/tableLayout/tableLayout/uploadImageFile.sb';
    window.TABLELAYOUT_UPLOAD_PATH = window.TABLELAYOUT_UPLOAD_PATH || '/resource/images/tableLayout';

    window.TABLEATTR_OPEN_URL = window.TABLEATTR_OPEN_URL || '/base/store/tableLayout/tableLayout/attrView.sb';
    window.TABLEATTR_SAVE_URL = window.TABLEATTR_SAVE_URL || '/base/store/tableLayout/tableLayout/saveTblAttr.sb';
