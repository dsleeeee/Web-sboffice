...
<c:set var="baseUrl" value="/store/manage/status/store"/>

<div class="con">
    <div class="tabType1" ng-controller="storeStatusCtrl" ng-init="init()">
        <ul>
            <%-- 매장 탭 --%>
            <li>
...
<script type="text/javascript" src="/resource/solbipos/js/store/manage/status/status.js?ver=20190920" charset="utf-8"></script>
