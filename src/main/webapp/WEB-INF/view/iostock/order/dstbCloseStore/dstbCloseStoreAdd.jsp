            ...
            <div class="w100 mt10 mb20">
                ...
                <div class="wj-gridWrap" style="height: 500px;">
                    <wj-flex-grid
                        ...
                        <wj-flex-grid-column header="<s:message code="dstbCloseStore.add.prevMgrUnitQty"/>"   binding="prevMgrUnitQty"      width="70"  align="right"  is-read-only="true" data-type="Number" format="n0" aggregate="Sum" allow-merging="true"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="dstbCloseStore.add.prevMgrEtcQty"/>"    binding="prevMgrEtcQty"       width="70"  align="right"  is-read-only="true" data-type="Number" format="n0" aggregate="Sum" allow-merging="true"></wj-flex-grid-column>
                        ...
                        <wj-flex-grid-column header="<s:message code="dstbCloseStore.add.mgrUnitQty"/>"       binding="mgrUnitQty"          width="70"  align="right"  max-length=8 data-type="Number" format="n0" aggregate="Sum" allow-merging="true"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="dstbCloseStore.add.mgrEtcQty"/>"        binding="mgrEtcQty"           width="70"  align="right"  max-length=8 data-type="Number" format="n0" aggregate="Sum" allow-merging="true"></wj-flex-grid-column>
...
<script type="text/javascript">
    ...
    app.controller('dstbCloseStoreAddCtrl', ['$scope', '$http', function ($scope, $http) {
        ...
        $scope.saveDstbCloseStoreAdd = function () {
            ...
            $scope._save("/iostock/order/dstbCloseStore/dstbCloseStoreAdd/save.sb", params, function() { $scope.saveAddProdCallback() });
        };
