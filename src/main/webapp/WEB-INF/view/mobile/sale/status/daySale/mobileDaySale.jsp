    ...
    <div class="w100" id="mobileDaySalePayGrid">
        <div class="wj-gridWrap" style="overflow-x: hidden; overflow-y: hidden;">
            <wj-flex-grid
                ...
                <wj-flex-grid-column header="<s:message code="mobile.daySale.totSaleQty"/>" binding="totSaleQty" width="1.*" align="right" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
    ...
    <div class="w100" id="mobileDaySaleShopGrid" ng-controller="mobileDaySaleShopCtrl">
        <table class="tblType01">
            ...
            <tr>
                <%-- 테이블평균 --%>
                <th class="tc br bl">
                    <s:message code="mobile.daySale.tblAvr"/>
                </th>
                <%-- 주문테이블수 --%>
                <th class="tc br">
                    <s:message code="mobile.daySale.tblCnt"/>
                </th>
                <%-- 테이블단가 --%>
                <th class="tc br">
                    <s:message code="mobile.daySale.tblUprc"/>
                </th>
                <th class="tc br">
                </th>
            </tr>
