...
<div class="subCon" id="chgCostPriceView" style="padding: 10px 20px 40px;" ng-controller="chgCostPriceCtrl">
    <div class="searchBar">
        <a href="#" class="open fl"><s:message code="chgCostPrice.chgCostPrice"/></a>
        <%-- 조회 --%>
        <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
            <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('chgCostPriceCtrl', 1)">
                <s:message code="cmm.search"/>
            </button>
            <button class="btn_blue mr5 fl" id="btnShow" ng-click="changeShow()">
                <s:message code="chgCostPrice.select.changeAll"/>
            </button>
        </div>
    </div>
    ...
    <table class="searchTbl">
        ...
        <tr>
            ...
            <%--분류 선택--%>
            <th><s:message code="chgCostPrice.prodClass"/></th>
            <td>
        ...
        <tr>
            <%-- 상품코드 --%>
            <th>
                <s:message code="chgCostPrice.prodCd"/>
            </th>
            <td>
            ...
            <%-- 상품명 --%>
            <th>
                <s:message code="chgCostPrice.prodNm"/>
            </th>
            <td>
    ...
    <table class="searchTbl mt10" id="tblHqChange" style="display: none;">
        ...
        <tr class="brt">
            <th>
                <s:message code="chgCostPrice.costUprc"/>
            </th>
            <th class="oh gr">
                <%-- 매장판매가/본사판매가 선택 --%>
                ...
                <a href="#" class="btn_grayS ml10" ng-click="changeAmt()"><s:message code="chgCostPrice.batch"/></a>
                <!-- // todo -->
            </th>
        </tr>
        <tr>
    ...
    <div class="mt10 oh sb-select dkbr">
        ...
        <%-- 저장 --%>
        <button class="btn_skyblue mr5 fr" ng-click="saveCostPrice()">
    ...
    <div class="wj-TblWrapBr mt10">
        <div id="theGridStore" style="height: 450px; overflow-y: hidden; overflow-x: hidden;">
            <wj-flex-grid
                ...
                <wj-flex-grid-column header="<s:message code="chgCostPrice.costUprc"/> " binding="bCostUprc" is-read-only="true" width="100" align="right"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="chgCostPrice.update"/>" binding="costUprc" width="100" align="right"></wj-flex-grid-column>
    ...
    <div class="pageNum mt20">
        <%-- id --%>
        <ul id="chgCostPriceCtrlPager" data-size="10">
        </ul>
    </div>
    <%--//페이지 리스트--%>
...
<%--엑셀 리스트--%>
<div class="w100 mt10" style="display:none;" ng-controller="chgCostPriceExcelCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/base/price/chgCostPrice/chgCostPrice.js?ver=20240516.01" charset="utf-8"></script>
