        ...
        (function (hierarchical) {
            ...
            var Sunburst = /** @class */ (function (_super) {
                ...
                Sunburst.prototype.hitTest = function (pt, y) {
                    ...
                    if (chart.FlexChart._contains(this._rectChart, cpt)) {
                        var idx = hti.pointIndex;
                        var item = this._processedItem[idx];
                        var dp = new chart._DataPoint(null, idx, null, null);
                        dp['item'] = item;
        ...
        (function (hierarchical) {
            ...
            var TreeMap = /** @class */ (function (_super) {
                ...
                function TreeMap(element, options) {
                    ...
                    _this._legend.position = chart.Position.None;
                    ...
                    _this._lbl.position = chart.LabelPosition.Center;
                    ...
                    _this.hostElement.addEventListener('contextmenu', function (evt) {
                        if (_this.maxDepth > 0) {
                            var ht = _this.hitTest(evt);
                            var threshold = chart.FlexChart._SELECTION_THRESHOLD;
                            if (_this.tooltip && _this.tooltip.threshold)
                ...
                Object.defineProperty(TreeMap.prototype, "type", {
                    ...
                    set: function (value) {
                        if (value != this._type) {
                            this._type = wijmo.asEnum(value, TreeMapType);
                            this.invalidate();
                        }
                    },
                    enumerable: true,
                ...
                TreeMap.prototype._renderText = function (engine, area, rect, s, pt, halign, valign, className) {
                    ...
                    if (this.type === TreeMapType.Horizontal && item.isTitle) {
                        ...
                        chart.FlexChart._renderRotatedText(engine, content, pt, halign, valign, pt, -90, className);
                        return null;
                    }
                    else {
                        ...
                        return chart.FlexChart._renderText(engine, content, pt, halign, valign, className);
                    }
                };
                ...
                TreeMap.prototype._measureLegendItem = function (engine, text) {
                    ...
                    if (text) {
                        var tsz = engine.measureString(text, chart.FlexChart._CSS_LABEL, chart.FlexChart._CSS_LEGEND);
                        sz.width += tsz.width;
