...
<wj-popup id="wjStockAdjustRegistLayer" control="wjStockAdjustRegistLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:1000px;height:750px;">
    <div id="adjRegistLayer" class="wj-dialog wj-dialog-columns" ng-controller="stockAdjustRegistCtrl">
        ...
        <div class="wj-dialog-body sc2" style="height: 700px;">
            ...
            <form name="myForm" novalidate>
                <table class="tblType01" style="position: relative;">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <jsp:include page="/WEB-INF/view/kookmin/acquire/acquireSlipRegist/acquireSelectVendr.jsp" flush="true">
                                <jsp:param name="targetId" value="stockAdjustRegistVendr"/>
                                <jsp:param name="targetStoreCd" value="stockAdjustRegistStoreCd"/>
                        ...
                        <td colspan="2">
                            ...
                            <jsp:include page="/WEB-INF/view/kookmin/acquire/acquireSlipRegist/acquireSelectStore.jsp" flush="true">
                                ...
                                <jsp:param name="targetId" value="stockAdjustRegistStore"/>
                                <jsp:param name="targetVendrCd" value="stockAdjustRegistVendrCd"/>
                            </jsp:include>
                            <%--// 매장선택 모듈 사용시 include --%>
                        </td>
                    </tr>
                    <tr>
                        <%-- 조정제목 --%>
                        <th><s:message code="stockAdjust.reg.adjTitle"/><em class="imp">*</em></th>
                        <td colspan="3">
                            <input type="text" id="adjTitle" name="adjTitle" ng-model="adjTitle" class="sb-input w100" maxlength="33"
                                   ...
                                   uib-popover="<s:message code="stockAdjust.reg.adjTitle"/>은(는) 필수 입력항목 입니다."/>
                        </td>
                        <th><s:message code="stockAdjust.reg.adjReason"/></th>
                        <td>
            <span class="txtIn w150px sb-select fl mr5">
               <wj-combo-box
                       id="adjRegReason"
                       ng-model="adjReason"
                       items-source="_getComboData('adjRegReason')"
                    ...
                    <tr>
                        <%-- 상품분류 --%>
                        <th><s:message code="stockAdjust.reg.prodClass"/></th>
                        <td>
                        ...
                        <%-- 조정구분 --%>
                        <th><s:message code="stockAdjust.reg.adjFg"/></th>
                        <td>
                            <div class="sb-select">
              ...
              <span class="txtIn w150px sb-select fl mr5">
                <wj-combo-box
                    ...
                    <tr>
                        <td colspan="4">
                            <a href="#" class="btn_grayS" ng-click="excelTextUpload('excelFormDown')"><s:message code="stockAdjust.reg.excelFormDownload"/></a>
                ...
                <wj-combo-box
                        ...
                        initialized="_initComboBox(s)">
                            ...
                            <a href="#" class="btn_grayS" ng-click="excelTextUpload('excelUp')"><s:message code="stockAdjust.reg.excelFormUpload"/></a>
                            <%--               <a href="#" class="btn_grayS" ng-click="excelTextUpload('textUp')"><s:message code="stockAdjust.reg.textFormUpload"/></a> --%>
                            <a href="#" class="btn_grayS" ng-click="excelDownload()"><s:message code="cmm.excel.down"/></a>
                            <a href="#" class="btn_grayS" ng-click="excelUploadErrInfo()"><s:message code="stockAdjust.reg.excelFormUploadErrorInfo"/></a>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <div class="mt10 oh">
                ...
                <button type="button" class="btn_blue fr ml5" id="btnProdFind" ng-click="prodFind();">
                    <s:message code="stockAdjust.reg.prodFind"/></button>
            </div>
            ...
            <table id="prodFind" class="tblType01 mt10 tc" style="position: relative;display:none;">
                ...
                <tr>
                    <%-- 상품코드/바코드 --%>
                    <th class="tc">
                        <s:message code="stockAdjust.reg.prodCd"/>/<s:message code="stockAdjust.reg.barcd"/></th>
                    <%-- 추가수량 --%>
                    <th class="tc"><s:message code="stockAdjust.reg.addQty"/></th>
                </tr>
                <tr>
                    <td>
                        ...
                        <%-- 찾기 --%>
                        <a href="#" class="btn_grayS" ng-click="prodFindPop()"><s:message code="stockAdjust.reg.prodFind"/></a>
                        <span class="chk txtIn lh30 ml5" style="top: -2px;">
              <input type="checkbox" name="autoAddChk" id="autoAddChk" ng-model="autoAddChk"/>
              <label for="autoAddChk"><s:message code="stockAdjust.reg.autoAdd"/></label>
            </span>
                    </td>
                    <td>
                        ...
                        <%-- 추가 --%>
                        <a href="#" class="btn_grayS" ng-click="fnAddQty()"><s:message code="stockAdjust.reg.add"/></a>
                    </td>
                </tr>
                </tbody>
            </table>
            ...
            <div class="mt10 tr">
                <div class="oh sb-select">
                    ...
                    <ul class="txtSty3">
                        <li class="red fl"><s:message code="stockAdjust.reg.txt3"/></li>
                    </ul>
            ...
            <div class="w100 mt10 mb20">
                ...
                <div class="wj-gridWrap" style="height: 400px; overflow-x: hidden; overflow-y: hidden;">
                    <wj-flex-grid
                        ...
                        <wj-flex-grid-column header="<s:message code="stockAdjust.reg.adjQty"/>" binding="adjQty" width="70" align="right" max-length=8 data-type="Number" format="n0" aggregate="Sum"></wj-flex-grid-column>
            ...
            <div class="pageNum mt20">
                <%-- id --%>
                <ul id="stockAdjustRegistCtrlPager" data-size="10">
                </ul>
            </div>
            <%--//페이지 리스트--%>
        </div>
...
<script type="text/javascript" src="/resource/solbipos/js/kookmin/stock/stockAdjust/stockAdjustRegist.js?ver=20251216.01" charset="utf-8"></script>
