...
<wj-popup control="prodClassPopUpLayer2" show-trigger="Click" hide-trigger="Click" style="display: none;width:400px;" onload="window.self.focus();">
  <div class="wj-dialog wj-dialog-columns" ng-controller="prodClassPopUpCtrl2">
...
<script type="text/javascript" src="/resource/solbipos/js/application/layer/searchProdClassCd2.js?ver=20181120.05" charset="utf-8"></script>
