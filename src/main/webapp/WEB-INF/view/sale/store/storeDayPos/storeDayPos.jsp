...
<div class="subCon" ng-controller="storeDayPosCtrl">
  <div class="searchBar">
    ...
    <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
      <%-- 조회 --%>
      <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('storeDayPosCtrl', 1)">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/store/storeDayPos/storeDayPos.js?ver=20240530.01" charset="utf-8"></script>
