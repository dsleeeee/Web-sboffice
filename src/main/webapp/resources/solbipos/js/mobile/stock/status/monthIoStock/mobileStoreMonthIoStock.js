/****************************************************************
 *
 * 파일명 : mobileStoreMonthIoStock.js
 * 설  명 : (모바일) 재고현황 > 월수불현황(매장) JavaScript
 *
...
app.controller('mobileMonthIoStockCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('mobileMonthIoStockCtrl', $scope, $http, true));
    ...
    $scope.mobileMonthIoStockSelectVendrShow = function () {
        $scope._broadcast('mobileMonthIoStockSelectVendrCtrl');
    };
...
/** 주문대비 입고현황 그리드 controller */
app.controller('mobileMonthIoStockMainCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('mobileMonthIoStockMainCtrl', $scope, $http, true));
    ...
    $scope.initGrid = function (s, e) {
        ...
        $scope._makePickColumns("mobileMonthIoStockMainCtrl");
    ...
    $scope.$on("mobileMonthIoStockMainCtrl", function (event, data) {
    ...
    //다른 컨트롤러의 broadcast 받기
    $scope.$on("mobileMonthIoStockMainCtrlSrch", function (event, data) {
    ...
    $scope.searchMobileMonthIoStockList = function (isPageChk) {
        ...
        params.vendrCd 	   = $("#mobileMonthIoStockSelectVendrCd").val();
        ...
        $scope._inquirySub("/mobile/stock/status/monthIoStock/mobileMonthIoStock/viewList.sb", params, function () {
            ...
            gridShowMsgNoData("mobileStoreMonthIoStock", $scope.flex, "Y");
        }, true);
        $scope.excelFg = true;
    };
    ...
    $scope.excelDownloadMonthIostock = function () {
        ...
        $scope._broadcast('mobileMonthIoStockExcelCtrl', params);
    };
}]);


/** 주문대비 입고현황 그리드 controller */
app.controller('mobileMonthIoStockExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('mobileMonthIoStockExcelCtrl', $scope, $http, true));
    ...
    // 다른 컨트롤러의 broadcast 받기
    $scope.$on("mobileMonthIoStockExcelCtrl", function (event, data) {
