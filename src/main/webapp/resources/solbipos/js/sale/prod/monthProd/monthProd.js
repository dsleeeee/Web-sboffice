...
app.controller('monthProdCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchMonthProdList = function () {
        ...
        $.postJSON("/sale/prod/monthProd/monthProd/getMonthProdList.sb", params, function (response){
            var grid = $scope.flex;
...
app.controller('monthProdExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $.postJSON("/sale/prod/monthProd/monthProd/getMonthProdExcelList.sb", params, function(response) {
            var grid = $scope.flex;
            grid.itemsSource = response.data.list;
            grid.itemsSource.trackChanges = true;
