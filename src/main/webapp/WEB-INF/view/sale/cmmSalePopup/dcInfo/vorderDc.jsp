...
<c:set var="baseUrl" value="/sale/cmmSalePopup/payInfo/vorderDc/"/>

<wj-popup id="wjVorderDcLayer" control="wjVorderDcLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:500px;">
  <div id="vorderDcLayer" class="wj-dialog wj-dialog-columns" ng-controller="vorderDcCtrl">
    <div class="wj-dialog-header wj-dialog-header-font">
      <s:message code="vorderDc.vorderDcPay"/>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/cmmSalePopup/dcInfo/vorderDc.js?ver=20210811.01" charset="utf-8"></script>
