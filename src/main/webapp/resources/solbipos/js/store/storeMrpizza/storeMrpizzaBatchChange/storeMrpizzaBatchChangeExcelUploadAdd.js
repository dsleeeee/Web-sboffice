/****************************************************************
 *
 * 파일명 : storeMrpizzaBatchChangeExcelUploadAdd.js
...
app.controller('storeExcelUploadAddCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.save = function (jsonData) {
        ...
        $http({
            method : 'POST', //방식
            url    : '/store/storeMrpizza/storeMrpizzaBatchChange/storeMrpizzaBatchChange/getStoreExcelUploadCheckSave.sb', /* 통신할 URL */
