...
<div class="subCon3" ng-controller="storeMonthCtrl">
    ...
    <div ng-controller="storeMonthMainCtrl">
	    ...
	    <div class="w100 mt10" id="wjWrapType2">
            ...
            <%-- 엑셀 리스트 --%>
            <div class="w100 mt10" id="wjWrapType3" style="display:none;" ng-controller="storeMonthMainExcelCtrl">
                <div class="wj-gridWrap">
                    <wj-flex-grid
...
<script type="text/javascript" src="/resource/solbipos/js/stock/status/storemonth/storeMonth.js?ver=20240611.01" charset="utf-8"></script>
