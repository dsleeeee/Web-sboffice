      ...
      <div class="w100 mt10 mb20">
        ...
        <div class="wj-gridWrap" style="height: 400px;">
          <wj-flex-grid
            ...
            <wj-flex-grid-column header="<s:message code="rtnOutstockConfm.dtl.poUnitFg"/>" binding="poUnitFg" width="70" align="center" is-read-only="true"></wj-flex-grid-column>
...
<script type="text/javascript">
  ...
  app.controller('rtnOutstockConfmDtlCtrl', ['$scope', '$http', function ($scope, $http) {
