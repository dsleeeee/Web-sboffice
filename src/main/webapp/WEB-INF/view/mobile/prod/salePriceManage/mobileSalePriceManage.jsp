...
<div class="subCon" ng-controller="mobileSalePriceManageCtrl">
    ...
    <div id="divContents" style="display: none;">
        <%-- 조회조건 --%>
        <div class="searchBar">
            <a href="#" class="open fl"><s:message code="mobile.salePriceManage"/></a>
            <%-- 조회 --%>
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <button class="btn_blue fr" ng-click="_pageView('mobileSalePriceManageCtrl',1)" id="nxBtnSearch">
                    <s:message code="cmm.search" />
                </button>
                <button class="btn_blue mr5 fl" id="btnShow" ng-click="changeShow()" style="display: none;">
        ...
        <div class="mt5 oh sb-select dkbr">
            ...
            <%-- 저장 --%>
            <button class="btn_blue fr" ng-click="saveProdPrice()"><s:message code="cmm.save" /></button>
        </div>
        ...
        <div class="w100 mt5">
            <div class="wj-gridWrap" style="overflow-x: hidden; overflow-y: hidden; min-height:100px; height: 100%;">
                <wj-flex-grid
                    ...
                    <!-- define columns -->
                    <wj-flex-grid-column header="<s:message code="cmm.chk"/>" binding="gChk" width="34" visible="false"></wj-flex-grid-column>
                    ...
                    <c:if test="${hqOfficeCd != '00000'}">
                        <wj-flex-grid-column header="<s:message code="salePriceManage.hq"/>" binding="hqSaleUprc" is-read-only="true" width="50" align="right"></wj-flex-grid-column>
                    </c:if>
                    <wj-flex-grid-column header="<s:message code="salePriceManage.store"/>" binding="storeSaleUprc" is-read-only="true" width="50" align="right"></wj-flex-grid-column>
                    <wj-flex-grid-column header="<s:message code="salePriceManage.update"/>" binding="saleUprc" width="50" align="right"></wj-flex-grid-column>

                    <c:if test="${subPriceFg == '1'}">
                        <c:if test="${hqOfficeCd != '00000'}">
                            <wj-flex-grid-column header="<s:message code="salePriceManage.hq"/>" binding="hqStinSaleUprc" width="50" is-read-only="true" align="right" max-length="10" ></wj-flex-grid-column>
                        </c:if>
                        <wj-flex-grid-column header="<s:message code="salePriceManage.store"/>" binding="storeStinSaleUprc" width="50" is-read-only="true" align="right" max-length="10" ></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="salePriceManage.update"/>" binding="stinSaleUprc" width="50" align="right" max-length="10" ></wj-flex-grid-column>
                        <c:if test="${hqOfficeCd != '00000'}">
                            <wj-flex-grid-column header="<s:message code="salePriceManage.hq"/>" binding="hqDlvrSaleUprc" width="50" is-read-only="true" align="right" max-length="10" ></wj-flex-grid-column>
                        </c:if>
                        <wj-flex-grid-column header="<s:message code="salePriceManage.store"/>" binding="storeDlvrSaleUprc" width="50" is-read-only="true" align="right" max-length="10" ></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="salePriceManage.update"/>" binding="dlvrSaleUprc" width="50" align="right" max-length="10" ></wj-flex-grid-column>
                        <c:if test="${hqOfficeCd != '00000'}">
                            <wj-flex-grid-column header="<s:message code="salePriceManage.hq"/>" binding="hqPackSaleUprc" width="50" is-read-only="true" align="right" max-length="10" ></wj-flex-grid-column>
                        </c:if>
                        <wj-flex-grid-column header="<s:message code="salePriceManage.store"/>" binding="storePackSaleUprc" width="50" is-read-only="true" align="right" max-length="10" ></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="salePriceManage.update"/>" binding="packSaleUprc" width="50" align="right" max-length="10" ></wj-flex-grid-column>
                    </c:if>

                    <c:if test="${hqOfficeCd != '00000'}">
                        <wj-flex-grid-column header="<s:message code="salePriceManage.prcCtrlFg"/>" binding="prcCtrlFg" data-map="prcCtrlFgDataMap" is-read-only="true" width="80" align="center"></wj-flex-grid-column>
                    </c:if>
        ...
        <div class="pageNum3 mt20">
            <%-- id --%>
            <ul id="mobileSalePriceManageCtrlPager" data-size="10">
            </ul>
        </div>
        <%--//페이지 리스트--%>
    </div>
...
<script type="text/javascript" src="/resource/solbipos/js/mobile/prod/salePriceManage/mobileSalePriceManage.js?ver=20220823.01" charset="utf-8"></script>
