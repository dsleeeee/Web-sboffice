...
<div class="subCon" id="storeSalePriceResveArea" style="display:none;padding: 10px 20px 40px;">

    <div ng-controller="storeStoreSalePriceResveCtrl">
        <div class="searchBar">
        ...
        <div class="mt10 oh sb-select dkbr">
            ...
            <%-- 조회조건 엑셀다운로드 --%>
            <button class="btn_skyblue ml5 fr" ng-click="excelDownloadProdPrice2()"><s:message code="cmm.excel.downCondition"/></button>
            <%-- 저장 --%>
            <button class="btn_skyblue ml5 fr" ng-click="addProdPrice2()"><s:message code="salePriceResve.priceResve" /></button>
            <%-- 수정 --%>
            <button class="btn_skyblue ml5 fr" ng-click="saveProdPrice2()"><s:message code="cmm.edit" /></button>
            <%-- 삭제 --%>
            <button class="btn_skyblue ml5 fr" ng-click="delProdPrice2()"><s:message code="cmm.del" /></button>
        </div>
        ...
        <div class="wj-TblWrapBr mt10">
            <div style="height: 300px; overflow-y: hidden; overflow-x: hidden;">
                <wj-flex-grid
                    ...
                    <wj-flex-grid-column header="<s:message code="salePriceResve.prodCd"/>" binding="prodCd" width="100" is-read-only="true" align="center" format="d"></wj-flex-grid-column>
    ...
    <%-- 엑셀 리스트 --%>
    <div class="w100 mt10" style="display:none;" ng-controller="storeStoreSalePriceResveExcelCtrl">
        <div class="wj-gridWrap" style="height: 370px; overflow-x: hidden; overflow-y: hidden;">
            <wj-flex-grid
                    ...
                    selection-mode="Row"
                    items-source="data"
                    control="excelFlexStoreStoreSalePriceResveExcel"
                    initialized="initGrid(s,e)"
                    is-read-only="true"
                    item-formatter="_itemFormatter">
...
<script type="text/javascript" src="/resource/solbipos/js/base/price/salePriceResve/storeStoreSalePriceResve.js?ver=20260212.01" charset="utf-8"></script>
