    ...
    <div ng-controller="prodSalePmixStoreMomsCtrl">
        <div class="searchBar">
            ...
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('prodSalePmixStoreMomsCtrl', 1)">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/moms/prodSalePmixStoreMoms/prodSalePmixStoreMoms.js?ver=20251230.02" charset="utf-8"></script>