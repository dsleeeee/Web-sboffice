package kr.co.solbipos.sale.moms.monthSaleStoreMoms.web;
...
/**
 * @Class Name : MonthSaleStoreMomsController.java
 ...
 */
@Controller
@RequestMapping("/sale/moms/monthSaleStoreMoms")
public class MonthSaleStoreMomsController {

    private final SessionService sessionService;
    private final MonthSaleStoreMomsService monthSaleStoreMomsService;
     ...
     */
    @Autowired
    public MonthSaleStoreMomsController(SessionService sessionService, MonthSaleStoreMomsService monthSaleStoreMomsService, CmmCodeUtil cmmCodeUtil, DayProdService dayProdService, CmmEnvUtil cmmEnvUtil) {
        this.sessionService = sessionService;
        this.monthSaleStoreMomsService = monthSaleStoreMomsService;
     ...
     * @param model
     */
    @RequestMapping(value = "/monthSaleStoreMoms/list.sb", method = RequestMethod.GET)
    public String monthSaleStoreMomsView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/moms/monthSaleStoreMoms/monthSaleStoreMoms";
    }

    /**
     * 월별매출(매장) - 조회
     *
     * @param monthSaleStoreMomsVO
     * @param request
     * @param response
     * @param model
     * @return  Object
     ...
     * @since   2024. 12. 17.
     */
    @RequestMapping(value = "/monthSaleStoreMoms/getMonthSaleStoreMomsList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getMonthSaleStoreMomsList(MonthSaleStoreMomsVO monthSaleStoreMomsVO, HttpServletRequest request,
                                          HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = monthSaleStoreMomsService.getMonthSaleStoreMomsList(monthSaleStoreMomsVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, result, monthSaleStoreMomsVO);
    }
     ...
     * @since   2024. 12. 17.
     */
    @RequestMapping(value = "/monthSaleStoreMoms/getMonthSaleStoreMomsExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getMonthSaleStoreMomsExcelList(MonthSaleStoreMomsVO monthSaleStoreMomsVO, HttpServletRequest request,
                                               HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = monthSaleStoreMomsService.getMonthSaleStoreMomsExcelList(monthSaleStoreMomsVO, sessionInfoVO);
     ...
     * @since   2024. 12. 17.
     */
    @RequestMapping(value = "/monthSaleStoreMoms/getMonthSaleStoreMomsExcelDivisionList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getMonthSaleStoreMomsExcelDivisionList(MonthSaleStoreMomsVO monthSaleStoreMomsVO, HttpServletRequest request,
                                                       HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = monthSaleStoreMomsService.getMonthSaleStoreMomsExcelDivisionList(monthSaleStoreMomsVO, sessionInfoVO);
