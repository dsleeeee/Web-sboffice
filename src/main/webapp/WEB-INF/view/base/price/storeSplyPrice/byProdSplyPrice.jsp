...
<div class="subCon" id="byProdSplyPriceView" style="padding: 10px 20px 40px;" ng-controller="byProdSplyPriceCtrl">
    <div class="searchBar">
        <a href="#" class="open fl"><s:message code="storeSplyPrice.byProdSplyPrice"/></a>
        <%-- 조회 --%>
        <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
            <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('byProdSplyPriceCtrl', 1)">
    ...
    <div class="mt10 oh sb-select dkbr">
        ...
        <%-- 저장 --%>
        <button class="btn_skyblue mr5 fr" ng-click="saveProdSplyPrice()">
    ...
    <div class="wj-TblWrapBr mt10">
        <div id="theGridStore" style="height: 450px; overflow-y: hidden; overflow-x: hidden;">
            <wj-flex-grid
                ...
                <wj-flex-grid-column header="<s:message code="storeSplyPrice.storeNm"/>" binding="storeNm" width="150" is-read-only="true" align="left"></wj-flex-grid-column>
    ...
    <div class="pageNum mt20">
        <%-- id --%>
        <ul id="byProdSplyPriceCtrlPager" data-size="10">
        </ul>
    </div>
    <%--//페이지 리스트--%>
...
<%--엑셀 리스트--%>
<div class="w100 mt10" style="display:none;" ng-controller="byProdSplyPriceExcelCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/base/price/storeSplyPrice/byProdSplyPrice.js?ver=20260212.01" charset="utf-8"></script>