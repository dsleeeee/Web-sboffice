...
<%--                                    <wj-flex-grid-column header="<s:message code="cmm.chk"/>" binding="gChk" width="40"></wj-flex-grid-column>--%>
                                    ...
                                    <wj-flex-grid-column header="<s:message code="prod.vendrStoreRegist.acquireUprc"/>" binding="acquireUprc"   width="60" align="center"></wj-flex-grid-column>
                                    <wj-flex-grid-column header="<s:message code="prod.vendrStoreRegist.acquireRate"/>" binding="acquireRate"   width="60" align="center"></wj-flex-grid-column>
