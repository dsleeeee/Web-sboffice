    ...
    <div ng-controller="monthProdCtrl">
        <div class="searchBar">
            ...
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('monthProdCtrl', 1)">
            ...
            <tr>
                ...
                <td>
                    <jsp:include page="/WEB-INF/view/application/layer/searchProdClassCd3.jsp" flush="true">
                        <jsp:param name="targetId" value="monthProdSelectClass"/>
                    </jsp:include>
                </td>
            </tr>
            <tr>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/prod/monthProd/monthProd.js?ver=20250605.01" charset="utf-8"></script>
