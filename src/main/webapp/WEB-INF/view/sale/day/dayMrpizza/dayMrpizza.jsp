...
<div class="subCon">
    <div ng-controller="dayMrpizzaCtrl">
        <div class="searchBar">
            <a href="#" class="open fl"><s:message code="dayMrpizza.dayMrpizza"/></a>
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <%-- 조회 --%>
                <button class="btn_blue fr" id="btnSearch" ng-click="_broadcast('dayMrpizzaCtrl')">
        ...
        <table class="searchTbl">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                            ...
                            <jsp:param name="targetId" value="dayMrpizzaStore"/>
                        </jsp:include>
                        <%--// 매장선택 모듈 사용시 include --%>
                    </td>
                </tr>
            ...
            <c:if test="${sessionInfo.orgnFg == 'STORE'}">
                <input type="hidden" id="dayMrpizzaStoreCd" value="${sessionInfo.storeCd}"/>
            </c:if>
            </tbody>
        </table>
            ...
            <div class="wj-gridWrap" style="height: 480px; overflow-x: hidden; overflow-y: hidden;">
                <wj-flex-grid
                    ...
                    <c:forEach var="dlvrInFgCol" items="${dlvrInFgColList}">
                        <wj-flex-grid-column header="<s:message code="dayMrpizza.billCnt"/>" binding="realSaleCnt${dlvrInFgCol.dlvrInFg}" width="80" align="right" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="dayMrpizza.prodSaleQty"/>" binding="saleQty${dlvrInFgCol.dlvrInFg}" width="80" align="right" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="dayMrpizza.realSaleAmt"/>" binding="realSaleAmt${dlvrInFgCol.dlvrInFg}" width="80" align="right" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
                    </c:forEach>
                </wj-flex-grid>
            </div>
            <%--//위즈모 테이블--%>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/day/dayMrpizza/dayMrpizza.js?ver=20250611.01" charset="utf-8"></script>
