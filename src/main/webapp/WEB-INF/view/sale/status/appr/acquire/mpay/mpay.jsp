...
<div id="apprAcquireMpayView" class="subCon"  ng-controller="apprAcquireMpayCtrl">
    ...
    <table class="searchTbl">
      ...
      <tr>
        ...
        <td colspan="3">
        <div class="sb-select">
            <span class="txtIn"><input id="srchApprAcquireMpayStartDate" class="w120px"></span>
                <span class="rg">~</span>
            <span class="txtIn"><input id="srchApprAcquireMpayEndDate" class="w120px"></span>
            <span class="chk ml10">
       ...
       <%-- 할부구분 --%>
        ...
        <td>
          <div class="sb-select">
              <span class="txtIn">
                    <wj-combo-box
                      id="srchAcquireMpayApprFgDisplay"
                      ng-model="apprFg"
                      items-source="_getComboData('srchAcquireMpayApprFgDisplay')"
                      display-member-path="name"
                      selected-value-path="value"
                      is-editable="false"
                      initialized="_initComboBox(s)">
...
<%--             </jsp:include> --%>
      ...
      <c:if test="${sessionInfo.orgnFg == 'STORE'}">  
        ...
        <input type="hidden" id="apprAcquireMpaySelectCornrNo" value=""/>
