...
<div id="frnchsStoreProdView" class="subCon3" ng-controller="frnchsStoreProdCtrl">
    ...
    <table class="searchTbl">
        ...
        <tr>
            ...
            <td><input type="text" id="srchProdNm" class="sb-input w100" maxlength="100" ng-model="prodNmModel" onkeyup="fnNxBtnSearch();"/></td>
            <%-- 상품코드 --%>
            <th><s:message code="frnchsStoreProd.prodCd" /></th>
            <td><input type="text" id="srchProdCd" class="sb-input w100" maxlength="13" ng-model="prodCdModel" onkeyup="fnNxBtnSearch();"/></td>
        </tr>
        </tbody>
    </table>
...
<script type="text/javascript" src="/resource/solbipos/js/iostock/frnchs/storeProd/frnchsStoreProd.js?ver=20240611.01" charset="utf-8"></script>

<%-- 레이어 팝업 : 상품정보 입력/수정 --%>
<c:import url="/WEB-INF/view/iostock/frnchs/storeProd/frnchsStoreProdDtl.jsp">
