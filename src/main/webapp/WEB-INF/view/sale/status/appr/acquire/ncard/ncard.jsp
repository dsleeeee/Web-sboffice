...
<div id="apprAcquireNcardView" class="subCon"  ng-controller="apprAcquireNcardCtrl">
    ...
    <table class="searchTbl">
      ...
      <tr>
        ...
        <td colspan="3">
        <div class="sb-select">
            <span class="txtIn"><input id="srchApprAcquireNcardStartDate" class="w120px"></span>
                <span class="rg">~</span>
            <span class="txtIn"><input id="srchApprAcquireNcardEndDate" class="w120px"></span>
            <span class="chk ml10">
      ...
      <tr>
        ...
        <td>
            <jsp:include page="/WEB-INF/view/sale/com/popup/selectCornerM.jsp" flush="true">
                <jsp:param name="targetId" value="apprAcquireNcardSelectCorner"/>
                <jsp:param name="targetStoreId" value="apprAcquireNcardSelectStore"/>
       ...
       <%-- 할부구분 --%>
        ...
        <td>
          <div class="sb-select">
              <span class="txtIn">
                    <wj-combo-box
                      id="srchNcardProdDcFgDisplay"
                      ng-model="prodDcFg"
                      items-source="_getComboData('srchNcardProdDcFgDisplay')"
...
<%--             </jsp:include> --%>
      ...
      <c:if test="${sessionInfo.orgnFg == 'STORE'}">  
        ...
        <input type="hidden" id="apprAcquireNcardSelectCornrNo" value=""/>
        <input type="hidden" id="apprAcquireNcardSelectCornrName" value=""/>
      </tr>
      </tbody>
    </table>
