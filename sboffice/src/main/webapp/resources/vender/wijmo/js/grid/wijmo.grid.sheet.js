...
(function (wijmo) {
    ...
    (function (grid) {
        ...
        (function (sheet_1) {
            ...
            var _CalcEngine = /** @class */ (function () {
                ...
                _CalcEngine.prototype._registerMathFunction = function () {
                    ...
                    self._functionTable['power'] = new _FunctionDefinition(function (params, sheet) {
                        return Math.pow(sheet_1._Expression.toNumber(params[0], self._rowIndex, self._columnIndex, sheet), sheet_1._Expression.toNumber(params[1], self._rowIndex, self._columnIndex, sheet));
                    }, 2, 2);
                    self._functionTable['atan2'] = new _FunctionDefinition(function (params, sheet) {
                        var x = sheet_1._Expression.toNumber(params[0], self._rowIndex, self._columnIndex, sheet), y = sheet_1._Expression.toNumber(params[1], self._rowIndex, self._columnIndex, sheet);
                        if (x === 0 && y === 0) {
                    ...
                    self._functionTable['mod'] = new _FunctionDefinition(function (params, sheet) {
                        return sheet_1._Expression.toNumber(params[0], self._rowIndex, self._columnIndex, sheet) % sheet_1._Expression.toNumber(params[1], self._rowIndex, self._columnIndex, sheet);
                    }, 2, 2);
                    self._functionTable['trunc'] = new _FunctionDefinition(function (params, sheet) {
                        var num = sheet_1._Expression.toNumber(params[0], self._rowIndex, self._columnIndex, sheet), precision = params.length === 2 ? sheet_1._Expression.toNumber(params[1], self._rowIndex, self._columnIndex, sheet) : 0, multiple;
                        if (precision === 0) {
                            if (num >= 0) {
                    ...
                    ceilingFloorFuncs.forEach(function (val) {
                        self._functionTable[val] = new _FunctionDefinition(function (params, sheet) {
                            var num = sheet_1._Expression.toNumber(params[0], self._rowIndex, self._columnIndex, sheet), significance = params.length === 2 ? sheet_1._Expression.toNumber(params[1], self._rowIndex, self._columnIndex, sheet) : 1, diff, precision, multiple;
                            if (isNaN(num)) {
                    ...
                    roundFuncs.forEach(function (val) {
                        self._functionTable[val] = new _FunctionDefinition(function (params, sheet) {
                            var num = sheet_1._Expression.toNumber(params[0], self._rowIndex, self._columnIndex, sheet), precision = sheet_1._Expression.toNumber(params[1], self._rowIndex, self._columnIndex, sheet), result, format, multiple;
                            if (precision === 0) {
                                switch (val) {
                                    case 'rounddown':
                                        if (num >= 0) {
                    ...
                    unaryFuncs.forEach(function (val) {
                        self._functionTable[val] = new _FunctionDefinition(function (params, sheet) {
                            if (val === 'ln') {
                                return Math.log(sheet_1._Expression.toNumber(params[0], self._rowIndex, self._columnIndex, sheet));
                            }
                            else {
                                return Math[val](sheet_1._Expression.toNumber(params[0], self._rowIndex, self._columnIndex, sheet));
                            }
                        }, 1, 1);
                    });
                };
                ...
                _CalcEngine.prototype._registerLogicalFunction = function () {
                    ...
                    self._functionTable['and'] = new _FunctionDefinition(function (params, sheet) {
                        ...
                        for (index = 0; index < params.length; index++) {
                            result = result && sheet_1._Expression.toBoolean(params[index], self._rowIndex, self._columnIndex, sheet);
                            if (!result) {
                                break;
                            }
                        }
                    ...
                    self._functionTable['not'] = new _FunctionDefinition(function (params, sheet) {
                        return !sheet_1._Expression.toBoolean(params[0], self._rowIndex, self._columnIndex, sheet);
                    }, 1, 1);
                    // if(true,a,b)
                    self._functionTable['if'] = new _FunctionDefinition(function (params, sheet) {
                        if (params.length === 3) {
                            return sheet_1._Expression.toBoolean(params[0], self._rowIndex, self._columnIndex, sheet) ? params[1].evaluate(self._rowIndex, self._columnIndex, sheet) : params[2].evaluate(self._rowIndex, self._columnIndex, sheet);
                        }
                        else {
                            return sheet_1._Expression.toBoolean(params[0], self._rowIndex, self._columnIndex, sheet) ? params[1].evaluate(self._rowIndex, self._columnIndex, sheet) : false;
                        }
                    }, 3, 2);
                    // true()
                ...
                _CalcEngine.prototype._registerTextFunction = function () {
                    ...
                    self._functionTable['char'] = new _FunctionDefinition(function (params, sheet) {
                        var index, result = '';
                        for (index = 0; index < params.length; index++) {
                            result += String.fromCharCode(sheet_1._Expression.toNumber(params[index], self._rowIndex, self._columnIndex, sheet));
                        }
                        return result;
                    }, Number.MAX_VALUE, 1);
                    // code("A")
                    self._functionTable['code'] = new _FunctionDefinition(function (params, sheet) {
                        var str = sheet_1._Expression.toString(params[0], self._rowIndex, self._columnIndex, sheet);
                        if (str && str.length > 0) {
                    ...
                    self._functionTable['concatenate'] = new _FunctionDefinition(function (params, sheet) {
                        var index, result = '';
                        for (index = 0; index < params.length; index++) {
                            result = result.concat(sheet_1._Expression.toString(params[index], self._rowIndex, self._columnIndex, sheet));
                        }
                        return result;
                    }, Number.MAX_VALUE, 1);
                    // left("Abcdefgh", 5) => "Abcde"
                    self._functionTable['left'] = new _FunctionDefinition(function (params, sheet) {
                        var str = sheet_1._Expression.toString(params[0], self._rowIndex, self._columnIndex, sheet), length = Math.floor(sheet_1._Expression.toNumber(params[1], self._rowIndex, self._columnIndex, sheet));
                        if (str && str.length > 0) {
                    ...
                    self._functionTable['find'] = new _FunctionDefinition(function (params, sheet) {
                        var search = sheet_1._Expression.toString(params[0], self._rowIndex, self._columnIndex, sheet), text = sheet_1._Expression.toString(params[1], self._rowIndex, self._columnIndex, sheet), startIndex = params[2] != null ? wijmo.asInt(sheet_1._Expression.toNumber(params[2], self._rowIndex, self._columnIndex, sheet)) : 0, result;
                    ...
                    self._functionTable['search'] = new _FunctionDefinition(function (params, sheet) {
                        var search = sheet_1._Expression.toString(params[0], self._rowIndex, self._columnIndex, sheet), text = sheet_1._Expression.toString(params[1], self._rowIndex, self._columnIndex, sheet), startIndex = params[2] != null ? wijmo.asInt(sheet_1._Expression.toNumber(params[2], self._rowIndex, self._columnIndex, sheet)) : 0, adjustNum, searchRegExp, result;
                        if (text != null && search != null) {
                    ...
                    self._functionTable['mid'] = new _FunctionDefinition(function (params, sheet) {
                        var text = sheet_1._Expression.toString(params[0], self._rowIndex, self._columnIndex, sheet), start = Math.floor(sheet_1._Expression.toNumber(params[1], self._rowIndex, self._columnIndex, sheet)), length = Math.floor(sheet_1._Expression.toNumber(params[2], self._rowIndex, self._columnIndex, sheet));
                    ...
                    self._functionTable['replace'] = new _FunctionDefinition(function (params, sheet) {
                        var text = sheet_1._Expression.toString(params[0], self._rowIndex, self._columnIndex, sheet), start = Math.floor(sheet_1._Expression.toNumber(params[1], self._rowIndex, self._columnIndex, sheet)), length = Math.floor(sheet_1._Expression.toNumber(params[2], self._rowIndex, self._columnIndex, sheet)), replaceText = sheet_1._Expression.toString(params[3], self._rowIndex, self._columnIndex, sheet);
                        if (text && text.length > 0 && start > 0) {
                    ...
                    self._functionTable['substitute'] = new _FunctionDefinition(function (params, sheet) {
                        var text = sheet_1._Expression.toString(params[0], self._rowIndex, self._columnIndex, sheet), oldText = sheet_1._Expression.toString(params[1], self._rowIndex, self._columnIndex, sheet), newText = sheet_1._Expression.toString(params[2], self._rowIndex, self._columnIndex, sheet), instanceNum = params.length === 4 ? sheet_1._Expression.toNumber(params[3], self._rowIndex, self._columnIndex, sheet) : null, replaceCnt = 0, searhRegExp;
                    ...
                    self._functionTable['rept'] = new _FunctionDefinition(function (params, sheet) {
                        var text = sheet_1._Expression.toString(params[0], self._rowIndex, self._columnIndex, sheet), repeatTimes = Math.floor(sheet_1._Expression.toNumber(params[1], self._rowIndex, self._columnIndex, sheet)), result = '', i;
                    ...
                    self._functionTable['text'] = new _FunctionDefinition(function (params, sheet) {
                        var value = params[0].evaluate(self._rowIndex, self._columnIndex, sheet), format = sheet_1._Expression.toString(params[1], self._rowIndex, self._columnIndex, sheet), matches;
                    ...
                    self._functionTable['value'] = new _FunctionDefinition(function (params, sheet) {
                        var strVal = sheet_1._Expression.toString(params[0], self._rowIndex, self._columnIndex, sheet), val;
                        ...
                        val = +strVal;
                        return isNaN(val) ? sheet_1._Expression.toNumber(params[0], self._rowIndex, self._columnIndex, sheet) : val;
                    }, 1, 1);
                };
                ...
                _CalcEngine.prototype._registerDateFunction = function () {
                    ...
                    self._functionTable['year'] = new _FunctionDefinition(function (params, sheet) {
                        var date = sheet_1._Expression.toDate(params[0], self._rowIndex, self._columnIndex, sheet);
                    ...
                    self._functionTable['hour'] = new _FunctionDefinition(function (params, sheet) {
                        ...
                        val = sheet_1._Expression.toDate(params[0], self._rowIndex, self._columnIndex, sheet);
                    ...
                    self._functionTable['datedif'] = new _FunctionDefinition(function (params, sheet) {
                        var startDate = sheet_1._Expression.toDate(params[0], self._rowIndex, self._columnIndex, sheet), endDate = sheet_1._Expression.toDate(params[1], self._rowIndex, self._columnIndex, sheet), unit = params[2].evaluate(self._rowIndex, self._columnIndex, sheet), startDateTime, endDateTime, diffDays, diffMonths, diffYears;
                ...
                _CalcEngine.prototype._registLookUpReferenceFunction = function () {
                    ...
                    self._functionTable['choose'] = new _FunctionDefinition(function (params, sheet) {
                        var index = sheet_1._Expression.toNumber(params[0], self._rowIndex, self._columnIndex, sheet);
                        if (isNaN(index)) {
                    ...
                    self._functionTable['index'] = new _FunctionDefinition(function (params, sheet) {
                        var cellExpr = params[0], cells, rowNum = sheet_1._Expression.toNumber(params[1], self._rowIndex, self._columnIndex, sheet), colNum = params[2] != null ? sheet_1._Expression.toNumber(params[2], self._rowIndex, self._columnIndex, sheet) : 0;
                        ...
                        case _TokenType.IDENTIFIER:
                            ...
                            if (funcDefinition) {
                                ...
                                if (this._token.tokenType === _TokenType.GROUP && this._token.tokenID === _TokenID.CLOSE) {
                                    ...
                                    x = new sheet_1._FunctionExpression(funcDefinition, params, false);
                                    break;
                                }
                            }
                ...
                _CalcEngine.prototype._getTableReference = function (table, sheetRef) {
                    ...
                    this._containsCellRef = true;
                    return new sheet_1._CellRangeExpression(refRange, sheetRef.toLowerCase(), this._owner);
                };
                            ...
                            switch (ref) {
                                ...
                                case '#this row':
                                    if (this._rowIndex >= table.range.topRow && this._rowIndex <= table.range.bottomRow) {
                                        tmpRange = new grid.CellRange(this._rowIndex, table.range.leftCol, this._rowIndex, table.range.rightCol);
                                    }
                                    else {
                ...
                _CalcEngine.prototype._getFlexSheetAggregateResult = function (aggType, params, sheet) {
                    ...
                    switch (aggType) {
                        ...
                        case _FlexSheetAggregate.Rank:
                            num = sheet_1._Expression.toNumber(params[0], this._rowIndex, this._columnIndex, sheet);
                            order = params[2] ? sheet_1._Expression.toNumber(params[2], this._rowIndex, this._columnIndex, sheet) : 0;
                            if (isNaN(num)) {
                                throw 'Invalid number.';
                            }
                            if (isNaN(order)) {
                    ...
                    for (index = 0; index < params.length; index++) {
                        ...
                        if (param instanceof sheet_1._CellRangeExpression) {
                            ...
                            cells: for (cellIndex = 0; cellIndex < cellValues.length; cellIndex++) {
                                ...
                                item = needParseToNum && !wijmo.isBoolean(item) ? +item : item;
                                items.push(item);
                            }
                        }
                        else {
                            item = param instanceof sheet_1._Expression ? param.evaluate(this._rowIndex, this._columnIndex, sheet) : param;
                            if (!wijmo.isPrimitive(item)) {
                                item = item.value;
                            }
                            if (!isGetEmptyValue && (item == null || item === '')) {
                                continue;
                ...
                _CalcEngine.prototype._countCellsByCriterias = function (itemsList, criterias, sheet, countItems) {
                    ...
                    for (; j < criterias.length; j++) {
                        rightExpr = sheet_1._Expression.toString(criterias[j], this._rowIndex, this._columnIndex, sheet);
                        if (rightExpr === '*') {
                ...
                _CalcEngine.prototype._handleSubtotal = function (params, sheet) {
                    ...
                    func = sheet_1._Expression.toNumber(params[0], this._rowIndex, this._columnIndex, sheet);
                ...
                _CalcEngine.prototype._calculateRate = function (params, sheet) {
                    ...
                    nper = sheet_1._Expression.toNumber(params[0], this._rowIndex, this._columnIndex, sheet);
                    pmt = sheet_1._Expression.toNumber(params[1], this._rowIndex, this._columnIndex, sheet);
                    pv = sheet_1._Expression.toNumber(params[2], this._rowIndex, this._columnIndex, sheet);
                    fv = params[3] != null ? sheet_1._Expression.toNumber(params[3], this._rowIndex, this._columnIndex, sheet) : 0;
                    type = params[4] != null ? sheet_1._Expression.toNumber(params[4], this._rowIndex, this._columnIndex, sheet) : 0;
                    guess = params[5] != null ? sheet_1._Expression.toNumber(params[5], this._rowIndex, this._columnIndex, sheet) : 0.1;
                    rate = guess;
                ...
                _CalcEngine.prototype._handleHLookup = function (params, sheet) {
                    var lookupVal = params[0].evaluate(this._rowIndex, this._columnIndex, sheet), cellExpr = params[1], rowNum = sheet_1._Expression.toNumber(params[2], this._rowIndex, this._columnIndex, sheet), approximateMatch = params[3] != null ? sheet_1._Expression.toBoolean(params[3], this._rowIndex, this._columnIndex, sheet) : true, cells, colNum;
                ...
                // Gets the name of sheet where the table is located in.
            ...
            })(_TokenType = sheet_1._TokenType || (sheet_1._TokenType = {}));
            /*
            ...
            })(_TokenID = sheet_1._TokenID || (sheet_1._TokenID = {}));
            /*
        ...
        (function (sheet_1) {
            ...
            var _BinaryExpression = /** @class */ (function (_super) {
                ...
                _BinaryExpression.prototype._isDateValue = function (val) {
                    if (wijmo.isPrimitive(val)) {
                        return wijmo.isDate(val);
                    }
                    else {
                        return wijmo.isDate(val.value);
                    }
                };
    ...
    (function (grid) {
        ...
        (function (sheet) {
            ...
            var _RowsChangedAction = /** @class */ (function (_super) {
                ...
                function _RowsChangedAction(owner) {
                    ...
                    if (owner.itemsSource) {
                        if (owner.itemsSource instanceof wijmo.collections.CollectionView) {
            ...
            var _TableSettingAction = /** @class */ (function (_super) {
                ...
                /*
                 * Initializes a new instance of the @see:_TableSettingAction class.
                 *
                 * @param owner The @see:FlexSheet control that the _TableSettingAction works for.
                 * @param table The @see:Table need do undo/redo action.
                 */
            ...
            var _TableAction = /** @class */ (function (_super) {
                 ...
                 * Initializes a new instance of the @see:_TableSettingAction class.
                 *
                 * @param owner The @see:FlexSheet control that the _TableAction works for.
                 * @param table The @see:Table need do undo/redo action.
                 */
            ...
            var _FilteringAction = /** @class */ (function (_super) {
                ...
                /*
                 * Initializes a new instance of the @see:_FilteringAction class.
                 *
                 * @param owner The @see: FlexSheet control that the _FilteringAction works for.
                 */
        ...
        (function (sheet) {
            ...
            var _ContextMenu = /** @class */ (function (_super) {
                ...
                _ContextMenu.prototype._showTableOperation = function () {
                    ...
                    if (tempIsEnabled /*!selectionInTable && !selection.isSingleCell && !this._owner._containsMergedCells(selection)*/) {
                ...
                _ContextMenu.prototype._addTable = function () {
                    var range = this._owner.selection, table = this._owner.addTable(range.topRow, range.leftCol, range.rowSpan, range.columnSpan), undoAction = new sheet._TableAction(this._owner, table);
        ...
        (function (sheet) {
            ...
            var _FlexSheetCellFactory = /** @class */ (function (_super) {
                ...
                _FlexSheetCellFactory.prototype.updateCell = function (panel, r, c, cell, rng) {
                    ...
                    if (panel.cellType === grid.CellType.Cell) {
                    ...
                    switch (panel.cellType) {
                        ...
                        case grid.CellType.ColumnHeader:
                            ...
                            if (cell.textContent) {
                                cell.innerHTML = cell.innerHTML.replace(wijmo.escapeHtml(cell.textContent.trim()), content).replace(cell.textContent, content);
                            }
                            else {
                        ...
                        case grid.CellType.Cell:
                            ...
                            if (panel.rows[r] instanceof sheet.HeaderRow) {
                                ...
                                isGroupRow = panel.rows[r] instanceof grid.GroupRow;
                                    ...
                                    if (panel.columns[c].dataType === wijmo.DataType.Boolean) {
                                        ...
                                        if (cell.childElementCount === 0 && cell.textContent === flex.getCellData(r, c, true)) {
                                            ...
                                            if (val !== '' && wijmo.isNumber(+val) && !isNaN(+val) && /[hsmy\:]/i.test(format)) {
                                                dateVal = sheet._Expression._fromOADate(+val);
                                    ...
                                    for (var styleProp in styleInfo) {
                                        if (styleProp === 'className') {
                                            ...
                                            if ((wijmo.hasClass(cell, 'wj-state-selected') || wijmo.hasClass(cell, 'wj-state-multi-selected'))
                                                ...
                                                if (styleProp.toLowerCase().indexOf('color') > -1 && !wijmo.isString(styleInfoVal)) {
                ...
                _FlexSheetCellFactory.prototype._getFirstVisibleCell = function (g, rng) {
                    ...
                    return new grid.CellRange(firstVisibleRow, firstVisibleColumn);
                };
        ...
        (function (sheet_1) {
            ...
            var FlexSheet = /** @class */ (function (_super) {
                ...
                function FlexSheet(element, options) {
                    ...
                    _this['_cf'] = new sheet_1._FlexSheetCellFactory();
                    ...
                    _this.showSelectedHeaders = grid_1.HeadersVisibility.All;
                    _this.allowResizing = grid_1.AllowResizing.Both;
                    _this.allowDragging = grid_1.AllowDragging.None;
                    _this._needCopyToSheet = true;
                    return _this;
                }
                ...
                Object.defineProperty(FlexSheet.prototype, "tables", {
                    /*
                     * Gets the tables define in FlexSheet.
                     */
                    get: function () {
                        return this._tables;
                    },
                ...
                FlexSheet.prototype.onPrepareChangingRow = function () {
                    this.prepareChangingRow.raise(this, new wijmo.EventArgs());
                };
                /**
                 * Raises the prepareChangingColumn event.
                 */
                FlexSheet.prototype.onPrepareChangingColumn = function () {
                    this.prepareChangingColumn.raise(this, new wijmo.EventArgs());
                };
                /**
                ...
                FlexSheet.prototype.insertColumns = function (index, count) {
                    var columnIndex = wijmo.isNumber(index) && index >= 0 ? index :
                        this.selection && this.selection.leftCol > -1 ? this.selection.leftCol : 0, colCount = wijmo.isNumber(count) ? count : 1, insColumnAction = new sheet_1._ColumnsChangedAction(this), column, i;
                    if (!this.selectedSheet) {
                        return;
                    }
                        ...
                        if (!this._resetMergedRange(range)) {
                            for (rowIndex = range.topRow; rowIndex <= range.bottomRow; rowIndex++) {
                                ...
                                for (colIndex = range.leftCol; colIndex <= range.rightCol; colIndex++) {
                                    ...
                                    this.selectedSheet._mergedRanges[cellIndex] = new grid_1.CellRange(firstVisibleRow, range.leftCol, range.bottomRow, range.rightCol);
                                }
                            }
                            if (!cells && !isCopyMergeCell) {
                ...
                FlexSheet.prototype.setClipString = function (text, rng) {
                    ...
                    if (isMultiLine || !this._copiedRanges || this._copiedRanges.length > 1 || this._copiedRanges.length === 0) {
                        row = rng.topRow;
                        copiedRange = this._copiedRanges && this._copiedRanges.length > 1 ? this._copiedRanges[0] : new grid_1.CellRange();
                ...
                /*
                 * Add empty table to FlexSheet.
                 *
                 * @param rowIndex The top row position of the table.
                 * @param colIndex The left column position of the table.
                 * @param rowSpan The number of the rows in the table.
                 * @param colSpan The number of the columns in the table.
                 * @param tableName The name of the table.
                 * @param tableStyle The table style is applied to the table.
                 * @param options The options of the table.
                 * @param sheet Indicates the table will be added in which sheet.  If the sheet is omitted, it will be added in current sheet.
                 */
                FlexSheet.prototype.addTable = function (rowIndex, colIndex, rowSpan, colSpan, tableName, tableStyle, options, sheet) {
                    var table, range = new grid_1.CellRange(rowIndex, colIndex, rowIndex + rowSpan - 1, colIndex + colSpan - 1), flex = sheet == null ? this : sheet.grid;
                ...
                /*
                 * Add the table from the data source in FlexSheet.
                 *
                 * @param rowIndex The top row position of the table.
                 * @param colIndex The left column position of the table.
                 * @param dataSource The dataSource load to the table.
                 * @param tableName The name of the table.
                 * @param tableStyle The table style is applied to the table.
                 * @param options The options of the table.
                 * @param sheet Indicates the table will be added in which sheet.  If the sheet is omitted, it will be added in current sheet.
                ...
                FlexSheet.prototype.addTableFromDataSource = function (rowIndex, colIndex, dataSource, tableName, tableStyle, options, sheet) {
                    ...
                    showTotal = !!(options && options.showTotalRow), dataRowFirst = rowIndex + (showHeader ? 1 : 0), dataRowLast = dataRowFirst + dataSource.length - 1, tableRowLast = dataRowLast + (showTotal ? 1 : 0);
                    ...
                    for (c = 0; c < keys.length; c++) {
                        ...
                        column = new sheet_1.TableColumn(key);
                        if (c === 0) {
                    ...
                    flex.endUpdate();
                    tableRange = new grid_1.CellRange(rowIndex, colIndex, tableRowLast, colIndex + keys.length - 1);
                ...
                FlexSheet.prototype._init = function () {
                    ...
                    self.loadedRows.addHandler(function () {
                        if (self.itemsSource && !(self.rows[0] instanceof HeaderRow)) {
                            ...
                            if (self.rows[0] instanceof grid_1._NewRowTemplate) {
                    ...
                    self.rows.collectionChanged.addHandler(function (sender, e) {
                        ...
                        if (!self.itemsSource && self.selectedSheet && self._needCopyToSheet && !self._isCopying && !self._isUndoing && !(e.item instanceof grid_1._NewRowTemplate)) {
                    ...
                    self.addEventListener(self.hostElement, 'keydown', function (e) {
                        ...
                        if (e.ctrlKey) {
                            ...
                            if (e.keyCode === wijmo.Key.Space && self.selection.isValid && self.selectionMode === grid_1.SelectionMode.CellRange) {
                                self.select(new grid_1.CellRange(_this.itemsSource ? 1 : 0, self.selection.col, self.rows.length - 1, self.selection.col));
                            }
                        }
                ...
                FlexSheet.prototype._addSheet = function (sheetName, rows, cols, pos, grid) {
                    var self = this, sheet = new sheet_1.Sheet(self, grid, sheetName, rows, cols);
                ...
                FlexSheet.prototype._loadFromWorkbook = function (workbook) {
                    ...
                    if (workbook.tables && workbook.tables.length > 0) {
                        ...
                        this._tables = new wijmo.collections.ObservableArray(tables);
                ...
                FlexSheet.prototype._saveToWorkbook = function () {
                    ...
                    for (i = 0; i < this.definedNames.length; i++) {
                        ...
                        definedName = new wijmo.xlsx.DefinedName();
                ...
                FlexSheet.prototype._mouseUp = function (e) {
                    ...
                    if (this._htDown && this._htDown.cellType !== grid_1.CellType.None && this.selectedSheet) {
                        if (this._htDown.cellType === grid_1.CellType.TopLeft && this.selectionMode === grid_1.SelectionMode.CellRange) {
                            this.selection = new grid_1.CellRange(this.selectedSheet.itemsSource ? 1 : 0, 0, this.rows.length - 1, this.columns.length - 1);
                            this.selectedSheet.selectionRanges.push(this.selection);
                        }
                ...
                FlexSheet.prototype._touchStart = function (e) {
                    ...
                    self._longClickTimer = setTimeout(function () {
                        var ht;
                        ht = self.hitTest(e);
                        if (ht && ht.cellType !== grid_1.CellType.None && !self.itemsSource && !self._resizing) {
                            self._contextMenu.show(null, new wijmo.Point(e.pageX + 10, e.pageY + 10));
                        }
                    }, 500);
                };
                ...
                FlexSheet.prototype._delSeletionContent = function (evt) {
                    var selections = this.selectedSheet.selectionRanges.slice(), selection, evtRange, index, colIndex, rowIndex, tableIndex, tableNames, tableName, table, bcol, contentDeleted = false, e, delAction = new sheet_1._EditAction(this);
                    if (this.isReadOnly) {
                        return;
                    }
                    if (this.allowDelete) {
                    ...
                    for (index = 0; index < selections.length; index++) {
                        ...
                        evtRange = new grid_1.CellRange();
                        e = new grid_1.CellEditEndingEventArgs(this.cells, evtRange, evt);
                        if (tableNames) {
                        ...
                        for (rowIndex = selection.topRow; rowIndex <= selection.bottomRow; rowIndex++) {
                            if (this.rows[rowIndex] && !this.rows[rowIndex].isReadOnly) {
                                for (colIndex = selection.leftCol; colIndex <= selection.rightCol; colIndex++) {
                                    ...
                                    if (!bcol.isReadOnly && bcol.isRequired === false || (bcol.isRequired == null && bcol.dataType == wijmo.DataType.String)) {
                    ...
                    for (sheetIndex = 0; sheetIndex < this.sheets.length; sheetIndex++) {
                        ...
                        for (rowIndex = 0; rowIndex < grid.rows.length; rowIndex++) {
                            for (colIndex = 0; colIndex < grid.columns.length; colIndex++) {
                                ...
                                if (!!cellData && wijmo.isString(cellData) && cellData[0] === '=') {
                ...
                FlexSheet.prototype._getRangeString = function (ranges, sheet, isGetCellValue) {
                    ...
                    if (wijmo.isArray(ranges) && ranges.length > 1) {
                    ...
                    // scan rows
                    rng = wijmo.asType(wijmo.isArray(ranges) ? ranges[0] : ranges, grid_1.CellRange);
                    for (var r = rng.topRow; r <= rng.bottomRow; r++) {
                        // skip invisible, add separator
                    ...
                    for (var i = 0; i < ranges.length; i++) {
                        ...
                        for (var rowIndex = rng.topRow; rowIndex <= rng.bottomRow && rowIndex < sheet.grid.rows.length; rowIndex++) {
                            for (var colIndex = rng.leftCol; colIndex <= rng.rightCol && colIndex < sheet.grid.columns.length; colIndex++) {
                                ...
                                if (wijmo.isString(cellData) && cellData[0] === '=' && cellData.search(/rand/i) !== -1) {
                                    return true;
                                }
                            }
                        }
                ...
                FlexSheet.prototype._postSetClipStringProcess = function (cellData, row, col, copiedRow, copiedCol) {
                    ...
                    if (copiedRow >= 0 && copiedCol >= 0) {
                        ...
                        if (!!megredCell && megredCell.topRow === copiedRow && megredCell.leftCol === copiedCol) {
                            ...
                            this.mergeRange(new grid_1.CellRange(row, col, rowSpan, colSpan), true);
                        }
                    }
                ...
                FlexSheet.prototype._updateCellRefForDropping = function (cellData, sheetIndex) {
                    ...
                    // Match the cell range paramter of the formula.  i.e. 'A1:B1'
                    matches = cellData.match(/((\w+)\!)?\$?[A-Za-z]{1,2}\$?\d+:((\w+)\!)?\$?[A-Za-z]{1,2}\$?\d+/g);
                    // If there is no cell range parameter, we will match the single cell paramter. i.e. 'A1'
                    if (!matches || matches.length === 0) {
                        matches = cellData.match(/((\w+)\!)?\$?[A-Za-z]{1,2}\$?\d+/g);
                    }
                    if (!!matches && matches.length > 0) {
                        for (cellRefIndex = 0; cellRefIndex < matches.length; cellRefIndex++) {
                            ...
                            if (cellRef.indexOf(':') > 0) {
                                ...
                                cellAddress1 = wijmo.xlsx.Workbook.tableAddress(cellRef1);
                                cellRange = new grid_1.CellRange(cellAddress1.row, cellAddress1.col);
                                cellAddress2 = wijmo.xlsx.Workbook.tableAddress(cellRef2);
                            ...
                            if (cellRange && this._draggingCells.contains(cellRange)) {
                                ...
                                if (!cellAddress2) {
                                    ...
                                    updatedCellRef += wijmo.xlsx.Workbook.xlsxAddress(cellRange.row, cellRange.col, cellAddress1.absRow, cellAddress1.absCol);
                                }
                                else {
                                    updatedCellRef = sheetRef1 ? sheetRef1 + '!' : '';
                                    updatedCellRef += wijmo.xlsx.Workbook.xlsxAddress(cellRange.row, cellRange.col, cellAddress1.absRow, cellAddress1.absCol) + ':';
                                    updatedCellRef += (sheetRef2 ? sheetRef2 + '!' : '') + wijmo.xlsx.Workbook.xlsxAddress(cellRange.row2, cellRange.col2, cellAddress2.absRow, cellAddress2.absCol);
                                }
                ...
                FlexSheet.prototype._scanFormulas = function () {
                    ...
                    for (var i = 0; i < this.rows.length; i++) {
                        for (var j = 0; j < this.columns.length; j++) {
                            ...
                            if (data && wijmo.isString(data) && data[0] === '=') {
                                formulas.push({
                                    row: i,
                                    column: j,
                                    formula: data
                ...
                // Check whether the deined name already existed.
                ...
                // Update the relate table name for each sheet via the change of the table name.
                ...
                FlexSheet.prototype._sheetSortConverter = function (sd, item, value, init) {
                    ...
                    if (wijmo.isString(value) && value.length > 0 && value[0] === '=') {
                ...
                FlexSheet.prototype._formatEvaluatedResult = function (result, col, format) {
                    if (wijmo.isPrimitive(result)) {
                        ...
                        if (wijmo.isInt(result) && !col.format && !col.dataMap && !format) {
                            result = result.toString();
                        }
                        else {
                            result = result != null ? wijmo.Globalize.format(result, format || col.format) : '';
                        }
                    }
                    else if (result) {
                        if (wijmo.isInt(result.value) && !col.format && !col.dataMap && !format && !result.format) {
                            result = result.value.toString();
                        }
                        else {
                            result = result.value != null ? wijmo.Globalize.format(result.value, format || result.format || col.format) : '';
                        }
                    }
                    return result;
                };
                            ...
                            if (cellRange) {
                                ...
                                if (changed) {
                                    ...
                                    updatedCellData = updatedCellData.replace(new RegExp(cellRef.replace(/\$/g, '\\$'), 'gi'), function (content, index) {
                                        // Avoid to replace the replaced cell reference, when the updated the cell reference is tha same with the replaced cell reference. (TFS 275117)
                ...
                FlexSheet.prototype._parseFromWorkbookTable = function (table) {
                    ...
                    tableRange = new grid_1.CellRange(tableAddress1.row, tableAddress1.col);
                    ...
                    if (table.columns && table.columns.length > 0) {
                        ...
                        for (var i = 0; i < table.columns.length; i++) {
                            ...
                            sheetTableColumns[i] = new sheet_1.TableColumn(tableColumn.name, tableColumn.totalRowLabel, tableColumn.totalRowFunction, tableColumn.showFilterButton);
                        }
                    }
                    if (table.style != null) {
                    ...
                    return new sheet_1.Table(this, table.name, tableRange, tableStyle, sheetTableColumns, table.showHeaderRow, table.showTotalRow, table.showBandedColumns, table.showBandedRows, table.showFirstColumn, table.showLastColumn);
                };
                ...
                FlexSheet.prototype._parseFromWorkbookTableStyle = function (tableStyle) {
                    var sheetTableStyle = new sheet_1.TableStyle(tableStyle.name);
                ...
                FlexSheet.prototype._parseFromWorkbookTableStyleElement = function (tableStyleElement) {
                    ...
                    if (tableStyleElement.borders) {
                        if (tableStyleElement.borders.left) {
                            grid_1.xlsx.FlexGridXlsxConverter._parseBorderStyle(tableStyleElement.borders.left.style, 'Left', sheetTableStyleEle);
                            sheetTableStyleEle.borderLeftColor = tableStyleElement.borders.left.color;
                        }
                        if (tableStyleElement.borders.right) {
                            grid_1.xlsx.FlexGridXlsxConverter._parseBorderStyle(tableStyleElement.borders.right.style, 'Right', sheetTableStyleEle);
                            sheetTableStyleEle.borderRightColor = tableStyleElement.borders.right.color;
                        }
                        if (tableStyleElement.borders.top) {
                            grid_1.xlsx.FlexGridXlsxConverter._parseBorderStyle(tableStyleElement.borders.top.style, 'Top', sheetTableStyleEle);
                            sheetTableStyleEle.borderTopColor = tableStyleElement.borders.top.color;
                        }
                        if (tableStyleElement.borders.bottom) {
                            grid_1.xlsx.FlexGridXlsxConverter._parseBorderStyle(tableStyleElement.borders.bottom.style, 'Bottom', sheetTableStyleEle);
                            sheetTableStyleEle.borderBottomColor = tableStyleElement.borders.bottom.color;
                        }
                        if (tableStyleElement.borders.vertical) {
                            grid_1.xlsx.FlexGridXlsxConverter._parseBorderStyle(tableStyleElement.borders.vertical.style, 'Vertical', sheetTableStyleEle);
                            sheetTableStyleEle.borderVerticalColor = tableStyleElement.borders.vertical.color;
                        }
                        if (tableStyleElement.borders.horizontal) {
                            grid_1.xlsx.FlexGridXlsxConverter._parseBorderStyle(tableStyleElement.borders.horizontal.style, 'Horizontal', sheetTableStyleEle);
                ...
                FlexSheet.prototype._parseToWorkbookTable = function (table) {
                    var workbookTable = new wijmo.xlsx.WorkbookTable(), tableRange = table.range, cellRef1, cellRef2;
                    ...
                    for (var i = 0; i < table.columns.length; i++) {
                        var column = table.columns[i], workbookTableColumn = new wijmo.xlsx.WorkbookTableColumn();
                ...
                FlexSheet.prototype._parseToWorkbookTableStyleElement = function (tableStyleElement, isBandedStyle) {
                    ...
                    var workbookTableStyleEle, workbookTableStyleEleOM = grid_1.xlsx.FlexGridXlsxConverter._parseCellStyle(tableStyleElement, true);
                    if (isBandedStyle) {
                ...
                FlexSheet.prototype._addTable = function (range, tableName, tableStyle, columns, options, sheet) {
                    ...
                    if (options == null) {
                        table = new sheet_1.Table(this, tableName, range, tableStyle, columns);
                    }
                    else {
                        ...
                        table = new sheet_1.Table(this, tableName, range, tableStyle, columns, showHeaderRow, showTotalRow, showBandedColumns, showBandedRows, showFirstColumn, showLastColumn);
                    }
                ...
                // Check whether the reference is table column reference 
                ...
                FlexSheet.prototype._generateTableLightStyle1 = function (styleIndex, styleName, isLowerStyle) {
                    var tableStyle = new sheet_1.TableStyle(styleName, true), colorTheme = styleIndex === 0 ? 1 : styleIndex + 3, headerBorderWidth = isLowerStyle ? '1px' : '2px', totalBorderStyle = isLowerStyle ? 'solid' : 'double', totalBorderWidth = isLowerStyle ? '1px' : '3px';
                ...
                FlexSheet.prototype._generateTableLightStyle2 = function (styleIndex, styleName) {
                    var tableStyle = new sheet_1.TableStyle(styleName, true), colorTheme = styleIndex === 0 ? 1 : styleIndex + 3;
                    tableStyle.wholeTableStyle = {
                        borderTopColor: { theme: colorTheme },
                        borderTopStyle: 'solid',
                        borderTopWidth: '1px',
                ...
                FlexSheet.prototype._generateTableDarkStyle1 = function (styleIndex, styleName) {
                    var tableStyle = new sheet_1.TableStyle(styleName, true), colorTheme = styleIndex === 0 ? 1 : styleIndex + 3, tint = styleIndex === 0 ? 0.25 : -0.25;
                    tableStyle.wholeTableStyle = {
                        color: { theme: 0 }
                    };
                    tableStyle.firstBandedRowStyle = {
                ...
                FlexSheet.prototype._generateTableDarkStyle2 = function (styleIndex, styleName) {
                    var tableStyle = new sheet_1.TableStyle(styleName, true), colorTheme = styleIndex === 0 ? 0 : 2 * styleIndex + 2, colorTheme2 = styleIndex === 0 ? 1 : 2 * styleIndex + 3, tint = styleIndex === 0 ? -0.15 : 0.8;
                    tableStyle.wholeTableStyle = {
                        backgroundColor: { theme: colorTheme, tint: tint }
                    };
                    tableStyle.firstBandedRowStyle = {
            ...
            sheet_1.RowColumnChangedEventArgs = RowColumnChangedEventArgs;
            /**
            ...
            var FlexSheetPanel = /** @class */ (function (_super) {
                ...
                FlexSheetPanel.prototype.getSelectedState = function (r, c, rng) {
                    ...
                    if (selectedState === grid_1.SelectedState.None && selectionCnt > 0) {
                        for (index = 0; index < selections.length; index++) {
                            selection = selections[index];
                ...
                FlexSheetPanel.prototype.getCellData = function (r, c, formatted) {
                    ...
                    col = this.columns[wijmo.asNumber(c, false, true)];
                    ...
                    if (formatted) {
                        ...
                        if (wijmo.isNumber(data) && data !== 0 && !!bcol && !bcol.format && !bcol.dataMap && !cellStyle) {
                            value = data.toString();
                        }
                    }
                    return value;
                ...
                FlexSheetPanel.prototype.setCellData = function (r, c, value, coerce, invalidate) {
                    ...
                    if (coerce && value && wijmo.isString(value) && value[0] !== '\'') {
                        if (this.grid.columns[c].dataType !== wijmo.DataType.String && !wijmo.isNullOrWhiteSpace(value) && !isNaN(+value)) {
                            value = +value;
                        }
                        else if (this.grid.columns[c].dataType === wijmo.DataType.Boolean) {
                    ...
                    if ((value && wijmo.isString(value) && (value[0] === '=' || value[0] === '\'')) || wijmo.isString(orgVal)) {
                        coerce = false;
                    }
            ...
            sheet_1.DefinedName = DefinedName;
        ...
        (function (sheet_1) {
            ...
            var Sheet = /** @class */ (function () {
                        ...
                        if (wijmo.isNumber(value) && !isNaN(value) && value >= 0 && this._rowCount !== value) {
                            if (this._rowCount < value) {
                                for (rowIndex = 0; rowIndex < (value - this._rowCount); rowIndex++) {
                                    this.grid.rows.push(new grid_1.Row());
                                }
                            }
                            else {
                    ...
                    for (; rowIdx < this._grid.rows.length; rowIdx++) {
                        ...
                        if (row) {
                            this._rowSettings[rowIdx] = {
                                ...
                                isCollapsed: row instanceof grid_1.GroupRow ? row.isCollapsed : null,
                                visible: row.visible
                            };
                        }
                    }
                    ...
                    return function (a, b) {
                        for (var i = 0; i < sortDesc.length; i++) {
                            ...
                            if (wijmo.isString(v1) && v1[0] === '=') {
                                ...
                                if (v1 != null && !wijmo.isPrimitive(v1)) {
                                    v1 = v1.value;
                                }
                            }
                            if (wijmo.isString(v2) && v2[0] === '=') {
                                v2 = self._owner.evaluate(v2);
                                if (v2 != null && !wijmo.isPrimitive(v2)) {
                                    v2 = v2.value;
                                }
                            }
                ...
                Sheet.prototype._addHeaderRow = function () {
                    var row, col;
                    if (this._grid.itemsSource && !(this._grid.rows[0] instanceof sheet_1.HeaderRow)) {
                        var row = new sheet_1.HeaderRow(), col;
                ...
                _SheetTabs.prototype._adjustNavigationButtons = function (rtl) {
                    ...
                    if (navBtns && navBtns.length === 4) {
                        if (rtl) {
                            ...
                            wijmo.addClass(btnGlyph, 'wj-glyph-step-backward-rtl');
                            btnGlyph = navBtns[1].querySelector('span');
                            wijmo.removeClass(btnGlyph, 'wj-glyph-left');
                            wijmo.addClass(btnGlyph, 'wj-glyph-left-rtl');
                            btnGlyph = navBtns[2].querySelector('span');
                            wijmo.removeClass(btnGlyph, 'wj-glyph-right');
                            wijmo.addClass(btnGlyph, 'wj-glyph-right-rtl');
                            btnGlyph = navBtns[3].querySelector('span');
                            wijmo.removeClass(btnGlyph, 'wj-glyph-step-forward');
                            wijmo.addClass(btnGlyph, 'wj-glyph-step-forward-rtl');
                        }
                        else {
                            btnGlyph = navBtns[0].querySelector('span');
                            wijmo.removeClass(btnGlyph, 'wj-glyph-step-backward-rtl');
                            wijmo.addClass(btnGlyph, 'wj-glyph-step-backward');
                            btnGlyph = navBtns[1].querySelector('span');
                            wijmo.removeClass(btnGlyph, 'wj-glyph-left-rtl');
                            wijmo.addClass(btnGlyph, 'wj-glyph-left');
                            btnGlyph = navBtns[2].querySelector('span');
                            wijmo.removeClass(btnGlyph, 'wj-glyph-right-rtl');
                            wijmo.addClass(btnGlyph, 'wj-glyph-right');
                            btnGlyph = navBtns[3].querySelector('span');
                            wijmo.removeClass(btnGlyph, 'wj-glyph-step-forward-rtl');
        ...
        (function (sheet) {
            ...
            var SortManager = /** @class */ (function () {
                ...
                SortManager.prototype.commitSort = function (undoable) {
                    ...
                    var sd, newSortDesc, bindSortDesc, dataBindSortDesc, i, unSortDesc, sortAction, unboundRows, ecv, isCVItemsSource = this._owner.itemsSource && this._owner.itemsSource instanceof wijmo.collections.CollectionView;
                    if (!this._owner.selectedSheet) {
                        return;
                    }
                ...
                SortManager.prototype._scanUnboundRows = function () {
                    ...
                    for (rowIndex = 0; rowIndex < this._owner.rows.length; rowIndex++) {
                        ...
                        if (!processingRow.dataItem) {
                            if (!(processingRow instanceof sheet.HeaderRow) && !(processingRow instanceof grid._NewRowTemplate)) {
                                if (!unboundRows) {
                                    unboundRows = {};
                                }
    ...
    (function (grid) {
        ...
        (function (sheet) {
            ...
            var Table = /** @class */ (function () {
                 ...
                 * @param showHeaderRow Indicates whether show the header row for the table.  The default showHeaderRow is true, if the showHeaderRow is omitted.
                 * @param showTotalRow Indicates whether show the total row for the table.  The default showTotalRow is false, if the showTotalRow is omitted.
                 * @param showBandedColumns Indicating whether banded column formatting is applied.  The default showBandedColumns is false, if the showBandedColumns is omitted.
                 * @param showBandedRows Indicating whether banded row formatting is applied.  The default showBandedRows is true, if the showBandedRows is omitted.
                 * @param showFirstColumn Indicating whether the first column in the table should have the style applied.  The default showFirstColumn is false, if the showFirstColumn is omitted.
                 * @param showLastColumn Indicating whether the last column in the table should have the style applied.  The default showLastColumn is false, if the showLastColumn is omitted.
                 */
                    ...
                    set: function (value) {
                        ...
                        if (this._name.toLowerCase() !== value.toLowerCase()) {
                            if (!this._owner._isUndoing) {
                                undoAction = new sheet._TableSettingAction(this._owner, this);
                            }
                            oldName = this._name;
                            this._name = value;
                ...
                Object.defineProperty(Table.prototype, "range", {
                    /*
                     * Gets the range on the relevant sheet that the table occupies.
                     *
                     * The reference includes the totals row if it is visible.
                     */
                    get: function () {
                ...
                Object.defineProperty(Table.prototype, "showBandedColumns", {
                    /*
                     * Gets or sets a value that determines whether banded column
                ...
                /*
                 * Gets the range of a specific column in the table.
                 *
                ...
                Table.prototype.getColumnRange = function (columnName) {
                    for (var i = 0; i < this._columns.length; i++) {
                        if (this._columns[i].name.toLowerCase() === columnName) {
                            ...
                            return new grid.CellRange(topRow, col, bottomRow, col);
                        }
                    }
                    return null;
                };
                ...
                Table.prototype.getDataRange = function () {
                    ...
                    return new grid.CellRange(topRow, this._range.leftCol, bottomRow, this._range.rightCol);
                };
                /*
                ...
                Table.prototype.getHeaderRange = function () {
                    if (this._showHeaderRow) {
                        return new grid.CellRange(this._range.topRow, this._range.leftCol, this._range.topRow, this._range.rightCol);
                    }
                    return null;
                };
                /*
                ...
                Table.prototype.getTotalRange = function () {
                    if (this._showTotalRow) {
                        return new grid.CellRange(this._range.bottomRow, this._range.leftCol, this._range.bottomRow, this._range.rightCol);
                    }
                    return null;
                };
                ...
                // Check whether other table is located below the table.
                    ...
                    if (this._showHeaderRow) {
                        if (this._needMoveDownTable()) {
                            ...
                            if (this._needAddNewRow()) {
                                this._owner.rows.push(new grid.Row());
                            }
                ...
                Object.defineProperty(TableColumn.prototype, "totalRowLabel", {
                    ...
                    set: function (value) {
                        if (value !== this._totalRowLabel) {
                            ...
                            // Todo:
                            // Update the value for the total cell in the column.
                        }
                    },
                    enumerable: true,
                    configurable: true
...
(function (wijmo) {
    ...
    (function (grid) {
        ...
        (function (sheet) {
             ...
             */
            var _FlexSheetValueFilter = /** @class */ (function (_super) {
                ...
                _FlexSheetValueFilter.prototype.apply = function (value) {
                    ...
                    if (flexSheet.rows[value] instanceof grid._NewRowTemplate) {
                        return true;
                    }
...
(function (wijmo) {
    ...
    (function (grid) {
        ...
        (function (sheet) {
             ...
             */
            var _FlexSheetValueFilterEditor = /** @class */ (function (_super) {
                ...
                _FlexSheetValueFilterEditor.prototype.updateEditor = function () {
                    ...
                    for (var i = 0; i < flexSheet.rows.length; i++) {
                        ...
                        if (row instanceof sheet.HeaderRow || row instanceof grid.GroupRow || row instanceof grid._NewRowTemplate || (!row.visible && (currentFilterResult || !otherFilterResult))) {
                            continue;
                        }
...
(function (wijmo) {
    ...
    (function (grid) {
        ...
        (function (sheet) {
             ...
             * rarely use it directly.
             */
            var _FlexSheetConditionFilter = /** @class */ (function (_super) {
...
(function (wijmo) {
    ...
    (function (grid) {
        ...
        (function (sheet) {
             ...
             * rarely use it directly.
             */
            var _FlexSheetColumnFilter = /** @class */ (function (_super) {
                ...
                function _FlexSheetColumnFilter(owner, column) {
                    ...
                    _this['_valueFilter'] = new sheet._FlexSheetValueFilter(column);
                    _this['_conditionFilter'] = new sheet._FlexSheetConditionFilter(column);
                    return _this;
                }
...
(function (wijmo) {
    ...
    (function (grid) {
        ...
        (function (sheet) {
             ...
             * rarely use it directly.
             */
            var _FlexSheetColumnFilterEditor = /** @class */ (function (_super) {
...
(function (wijmo) {
    ...
    (function (grid) {
        ...
        (function (sheet) {
             ...
             * constructor.
             */
            var _FlexSheetFilter = /** @class */ (function (_super) {
                ...
                _FlexSheetFilter.prototype.editColumnFilter = function (col, ht) {
                    ...
                    var e = new grid.CellRangeEventArgs(self.grid.cells, new grid.CellRange(-1, col.index));
                    self.onFilterChanging(e);
                    if (e.cancel) {
                        return;
                    }
                    e.cancel = true; // assume the changes will be canceled
                    self._undoAcion = new sheet._FilteringAction(self.grid);
                    // get the filter and the editor
                    var div = document.createElement('div'), flt = self.getColumnFilter(col), edt = new sheet._FlexSheetColumnFilterEditor(div, flt, self.showSortButtons);
