...
public class MobileDaySaleServiceImpl implements MobileDaySaleService {
     ...
     */
    @Autowired
    public MobileDaySaleServiceImpl(MobileDaySaleMapper mobileDaySaleMapper, PopupMapper popupMapper) {
    ...
    public DefaultMap<String> getMobileDaySaleTotalList(MobileDaySaleVO mobileDaySaleVO, SessionInfoVO sessionInfoVO) {
        ...
        mobileDaySaleVO.setOrgnFg(sessionInfoVO.getOrgnFg().getCode());
        mobileDaySaleVO.setHqOfficeCd(sessionInfoVO.getHqOfficeCd());
        mobileDaySaleVO.setEmpNo(sessionInfoVO.getEmpNo());
        if(!StringUtil.getOrBlank(mobileDaySaleVO.getSrchStoreCd()).equals("")) {
            ...
            storeVO.setArrSplitStoreCd(CmmUtil.splitText(mobileDaySaleVO.getSrchStoreCd(), 3900));
            mobileDaySaleVO.setStoreCdQuery(popupMapper.getSearchMultiStoreRtn(storeVO));
        }
