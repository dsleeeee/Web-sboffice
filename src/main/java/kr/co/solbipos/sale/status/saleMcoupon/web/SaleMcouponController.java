package kr.co.solbipos.sale.status.saleMcoupon.web;
...
/**
 * @Class Name : SaleMcouponController.java
 ...
 */
@Controller
@RequestMapping("/sale/status/saleMcoupon")
public class SaleMcouponController {
     ...
     * @param model
     */
    @RequestMapping(value = "/saleMcoupon/list.sb", method = RequestMethod.GET)
    public String saleMcouponView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/status/saleMcoupon/saleMcoupon";
    }
     ...
     * @since   2023. 04. 11.
     */
    @RequestMapping(value = "/saleMcoupon/getSaleMcouponList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getSaleMcouponList(SaleMcouponVO saleMcouponVO, HttpServletRequest request,
                                              HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = saleMcouponService.getSaleMcouponList(saleMcouponVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, result, saleMcouponVO);
    }
     ...
     * @since   2023. 04. 11.
     */
    @RequestMapping(value = "/saleMcoupon/getSaleMcouponExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getSaleMcouponExcelList(SaleMcouponVO saleMcouponVO, HttpServletRequest request,
                                     HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = saleMcouponService.getSaleMcouponExcelList(saleMcouponVO, sessionInfoVO);
     ...
     * @since   2023. 04. 11.
     */
    @RequestMapping(value = "/saleMcoupon/getSaleMcouponDtlList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getSaleMcouponDtlList(SaleMcouponVO saleMcouponVO, HttpServletRequest request,
                                          HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = saleMcouponService.getSaleMcouponDtlList(saleMcouponVO, sessionInfoVO);
