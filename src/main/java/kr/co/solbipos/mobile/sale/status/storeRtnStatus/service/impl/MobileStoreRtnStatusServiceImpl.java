...
public class MobileStoreRtnStatusServiceImpl implements MobileStoreRtnStatusService {
     ...
     */
    @Autowired
    public MobileStoreRtnStatusServiceImpl(MobileStoreRtnStatusMapper mobileStoreRtnStatusMapper, PopupMapper popupMapper) {
    ...
    public List<DefaultMap<Object>> getMobileStoreRtnStatusDtlList(MobileStoreRtnStatusVO mobileStoreRtnStatusVO, SessionInfoVO sessionInfoVO) {
        ...
        mobileStoreRtnStatusVO.setEmpNo(sessionInfoVO.getEmpNo());
        if (!StringUtil.getOrBlank(mobileStoreRtnStatusVO.getSrchStoreCd()).equals("")) {
            ...
            storeVO.setArrSplitStoreCd(CmmUtil.splitText(mobileStoreRtnStatusVO.getSrchStoreCd(), 3900));
            mobileStoreRtnStatusVO.setStoreCdQuery(popupMapper.getSearchMultiStoreRtn(storeVO));
        }
