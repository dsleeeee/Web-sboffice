...
public class IostockCmmController {
     ...
     * @since   2018. 09. 03.
     */
    @RequestMapping(value = "/selectHqStoreList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result selectHqStoreList(HttpServletRequest request, HttpServletResponse response,
        Model model, IostockCmmVO iostockCmmVO) {
    ...
    public Result selectSdselGrpList(HttpServletRequest request, HttpServletResponse response,
        ...
        List<DefaultMap<String>> list = iostockCmmService.selectSdselGrpList(iostockCmmVO, sessionInfoVO);
    ...
    public Result selectSdselProdList(HttpServletRequest request, HttpServletResponse response,
        ...
        List<DefaultMap<String>> list = iostockCmmService.selectSdselProdList(iostockCmmVO, sessionInfoVO);
     ...
     * @since   2018. 09. 03.
     */
    @RequestMapping(value = "/selectEmpList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result selectEmpList(HttpServletRequest request, HttpServletResponse response,
                                  Model model, IostockCmmVO iostockCmmVO) {
