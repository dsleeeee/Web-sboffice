...
app.controller('storeMonthPosCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchMonthTotal = function() {
        ...
        $.postJSON("/sale/store/storeMonthPos/storeMonthPos/getMonthList.sb", params, function(response) {
            var grid = $scope.flex;
...
app.controller('storeMonthPosExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchExcelList = function (params) {
        ...
        $.postJSON("/sale/store/storeMonthPos/storeMonthPos/getMonthExcelList.sb", params, function(response) {
