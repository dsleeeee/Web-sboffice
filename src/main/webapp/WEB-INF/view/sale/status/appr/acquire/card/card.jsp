...
<div id="apprAcquireCardView" class="subCon3"  ng-controller="apprAcquireCardCtrl" style="display: none;padding: 10px 20px 40px;">
    ...
    <table class="searchTbl">
      ...
      <tr>
        ...
        <div class="sb-select">
            <span class="txtIn"><input id="srchApprAcquireCardStartDate" class="w110px"></span>
                <span class="rg">~</span>
            <span class="txtIn"><input id="srchApprAcquireCardEndDate" class="w110px"></span>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/appr/acquire/card/card.js?ver=20241219.01" charset="utf-8"></script>
