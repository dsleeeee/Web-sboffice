...
app.controller('monthProdStoreCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchMonthProdList = function () {
        ...
        $.postJSON("/sale/prod/monthProdStore/monthProdStore/getMonthProdStoreList.sb", params, function (response){
            var grid = $scope.flex;
...
app.controller('monthProdStoreExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $.postJSON("/sale/prod/monthProdStore/monthProdStore/getMonthProdStoreExcelList.sb", params, function(response) {
