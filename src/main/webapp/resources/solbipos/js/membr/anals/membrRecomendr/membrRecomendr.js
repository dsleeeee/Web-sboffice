 ...
 *  회원 유치사원 그리드 생성
 */
app.controller('membrRecomendrCtrl', ['$scope', '$http', function ($scope, $http) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('membrRecomendrCtrl', $scope, $http, true));
    ...
    // <-- 검색 호출 -->
    $scope.$on("membrRecomendrCtrl", function(event, data) {
