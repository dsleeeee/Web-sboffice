...
<%-- 양식다운로드/엑셀업로드 관련 --%>
<div style="display: none;" ng-controller="cmPosFnkeyExcelCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/base/multilingual/fnkeyCmNmcd/cmPosFnkey.js?ver=20260504.01" charset="utf-8"></script>