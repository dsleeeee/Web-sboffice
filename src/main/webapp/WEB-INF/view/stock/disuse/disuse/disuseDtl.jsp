      ...
      <form name="myForm" novalidate>
        <table class="tblType01" style="position: relative;">
          ...
          <tr>
            ...
            <th><s:message code="disuse.dtl.disuseReason"/></th>
            <td>
...
<script type="text/javascript" src="/resource/solbipos/js/stock/disuse/disuse/disuseDtl.js?ver=20220830.01" charset="utf-8"></script>
