...
app.controller('optionValCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.sampleDownload = function () {
        ...
        var vScope = agrid.getScope('optionValExcelDownCtrl');
 ...
 */
app.controller('optionValExcelDownCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('optionValExcelDownCtrl', $scope, $http, false));
 ...
 * 옵션(옵션명) 엑셀업로드 그리드 생성
 */
app.controller('optionValExcelUploadCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('optionValExcelUploadCtrl', $scope, $http, false));
