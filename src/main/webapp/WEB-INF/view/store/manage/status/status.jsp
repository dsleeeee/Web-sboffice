...
<div class="con">
    <div class="tabType1" ng-controller="statusCtrl" ng-init="init()">
        <ul>
            <%-- 관리매장 승인내역 탭 --%>
            <li>
                <a id="statusApprListTab" href="#" class="on" ng-click="statusApprListShow()"><s:message code="storeStatus.apprList"/></a>
            </li>
            <%-- 매장 탭 --%>
            <%--<li>--%>
                <%--<a id="statusStoreTab" href="#" ng-click="statusStoreShow()"><s:message code="storeStatus.store"/></a>--%>
            <%--</li>--%>
            <%-- 관리업체 탭 --%>
            <%--<li>--%>
...
<script type="text/javascript" src="/resource/solbipos/js/store/manage/status/status.js?ver=20190920.09" charset="utf-8"></script>
