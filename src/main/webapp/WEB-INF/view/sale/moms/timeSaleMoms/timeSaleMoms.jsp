...
<div class="subCon">
    ...
    <div ng-controller="timeSaleMomsCtrl">
        <%--<div class="searchBar flddUnfld">--%>
        <div class="searchBar">
            <a href="#" class="open fl">${menuNm}</a>
            <%-- 조회 --%>
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <button class="btn_blue fr" id="btnSearch" ng-click="_broadcast('timeSaleMomsCtrl', 1)">
        ...
        <table class="searchTbl">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                            ...
                            <jsp:param name="targetId" value="timeSaleMomsStore"/>
                        </jsp:include>
                        <%--// 매장선택 모듈 사용시 include --%>
                    </td>
                </tr>
            ...
            <c:if test="${sessionInfo.orgnFg == 'STORE'}">
                <input type="hidden" id="timeSaleMomsStoreCd" value="${sessionInfo.storeCd}"/>
            </c:if>
            <tr>
                <c:if test="${sessionInfo.orgnFg == 'HQ'}">
                    <%-- 상품브랜드 --%>
                ...
                <td>
                    ...
                    <jsp:include page="/WEB-INF/view/sale/com/popup/selectProdMMoms.jsp" flush="true">
                        <jsp:param name="targetId" value="timeSaleMomsSelect"/>
                    </jsp:include>
        ...
        <div class="w100 mt10">
            <div class="wj-gridWrap" style="height: 370px; overflow-x: hidden; overflow-y: hidden;">
                <wj-flex-grid
                    ...
                    <!-- define columns -->
                    <wj-flex-grid-column header="<s:message code="timeSaleMoms.saleDate"/>" binding="saleDate" width="80" align="center" is-read-only="true"></wj-flex-grid-column>
                    <wj-flex-grid-column header="<s:message code="timeSaleMoms.saleHour"/>" binding="saleHour" width="60" align="center" is-read-only="true"></wj-flex-grid-column>
        ...
        <div class="pageNum mt20">
            <%-- id --%>
            <ul id="timeSaleMomsCtrlPager" data-size="10">
            </ul>
        </div>
        <%-- //페이지 리스트 --%>
    </div>
    ...
    <%-- 엑셀 리스트 --%>
    <div class="w100 mt10" style="display:none;" ng-controller="timeSaleMomsExcelCtrl">
        <div class="wj-gridWrap" style="height: 370px; overflow-x: hidden; overflow-y: hidden;">
            <wj-flex-grid
                    id="wjGridExcelList"
                    autoGenerateColumns="false"
...
<script type="text/javascript" src="/resource/solbipos/js/sale/moms/timeSaleMoms/timeSaleMoms.js?ver=20240124.01" charset="utf-8"></script>