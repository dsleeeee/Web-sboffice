...
<div class="subCon" id ="hqSalePriceExcelUploadView" style="display: none;padding: 10px 20px 40px;">
...
<script type="text/javascript" src="/resource/solbipos/js/base/price/salePrice/hqSalePriceExcelUpload.js?ver=20230830.01" charset="utf-8"></script>
