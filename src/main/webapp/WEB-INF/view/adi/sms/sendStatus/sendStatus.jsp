...
<div class="subCon" ng-controller="sendStatusCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/adi/sms/sendStatus/sendStatus.js?ver=20210625.01" charset="utf-8"></script>
