...
<div id="posMonthView" class="subCon" style="display: none;padding: 10px 20px 40px;" ng-controller="posMonthCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/pos/month/month.js?ver=20200904.01" charset="utf-8"></script>
