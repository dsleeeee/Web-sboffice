...
<div class="subCon" ng-controller="storeMonthChannelBensonCtrl">
    <%-- 조회조건 --%>
    <div class="searchBar">
        <a href="#" class="open fl"><s:message code="storeMonthChannelBenson.storeMonthChannelBenson"/></a>
        <%-- 조회 --%>
        <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
            <button class="btn_blue fr" ng-click="_pageView('storeMonthChannelBensonCtrl', 1)">
    ...
    <table class="searchTbl">
        ...
        <c:if test="${sessionInfo.orgnFg == 'HQ'}">
            <tr>
                    <%-- 매장브랜드 --%>
                <th>
                    <s:message code="cmm.moms.storeHqBrand"/></th>
                <td>
                    <div class="sb-select">
                        <wj-combo-box
                ...
                <td>
                    ...
                    <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                        ...
                        <jsp:param name="targetId" value="storeMonthChannelBensonStore"/>
                    </jsp:include>
                        <%--// 매장선택 모듈 사용시 include --%>
                        </td>
                </td>
        ...
        <c:if test="${sessionInfo.orgnFg == 'STORE'}">
            <input type="hidden" id="storeMonthChannelBensonStoreCd" value="${sessionInfo.storeCd}"/>
        </c:if>
        </tbody>
    </table>
    ...
    <div class="pageNum mt20">
        <ul id="storeMonthChannelBensonCtrlPager" data-size="10">
        </ul>
    </div>
    <%--//페이지 리스트--%>

    <div class="wj-gridWrap" style="display: none" ng-controller="storeMonthChannelBensonExcelCtrl">
        <div class="row">
            <wj-flex-grid
...
<script type="text/javascript" src="/resource/solbipos/js/sale/store/storeMonthChannelBenson/storeMonthChannelBenson.js?ver=20251223.01" charset="utf-8"></script>
