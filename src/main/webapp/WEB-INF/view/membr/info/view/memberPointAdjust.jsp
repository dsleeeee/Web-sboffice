        ...
        <div class="wj-dialog-body">
            <table class="tblType01">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="sb-input w70" id="srchMemberNm" ng-model="memberNm" ng-click="popUpMemberClass()" style="float: left;"
                               placeholder="<s:message code="regist.memberPointAdjust.member" /> 선택" readonly/>
                        <input type="hidden" id="_memberNo" name="memberNo" ng-model="memberNo" disabled />
...
<script type="text/javascript" src="/resource/solbipos/js/membr/info/view/memberPointAdjust.js?ver=20210311.01" charset="utf-8"></script>
