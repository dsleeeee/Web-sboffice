...
public interface SoldOutService {
    ...
    /** 품절관리 상품탭 - 품절여부전체저장 */
    int getProdSoldOutAllSave(SoldOutVO[] soldOutVOs, SessionInfoVO sessionInfoVO);
    ...
    /** 사이드메뉴(상품) 목록 조회 */
    List<DefaultMap<String>> getSideMenuProdSoldOutList(SoldOutVO soldOutVO, SessionInfoVO sessionInfoVO);
