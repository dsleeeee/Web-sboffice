...
<div id="prodClassView" class="subCon3" ng-controller="prodClassCtrl" style="padding: 10px 20px 40px;"> <%-- 수정 사항 || 클래스 변경 :: class="subCon" >> class="subCon3"--%>
	<div class="searchBar">
		<a href="#" class="open fl"><s:message code="prodsale.class"/></a>
    	<%-- 조회 --%>
    	<button class="btn_blue fr mt5 mr10" id="nxBtnSearch1" ng-click="_broadcast('prodClassCtrl')">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/prod/class/prodClass.js?ver=20240605.01" charset="utf-8"></script>
