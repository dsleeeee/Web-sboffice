        ...
        <div class="wj-dialog-body sc2" style="height: 600px;">
            ...
            <table class="tblType01">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <input type="text"
                            name="prodCd"
                            class="sb-input w100"
                            placeholder="<s:message code="prod.prodCd" />"
                            ng-model="prodModifyInfo.prodCd"
                            required
                            data-toggle="tooltip"
                            data-placement="bottom"
                            title="상품코드는 필수 값 입니다." />
                    ...
                    <tr>
                        ...
                        <td>
                          <input type="text" id="_prodNm" name="prodNm" class="sb-input w100" ng-model="prodModifyInfo.prodNm" />
                        </td>
                    </tr>
                    <tr>
                        <%--상품분류--%>
                    ...
                    <tr>
                        ...
                        <td>
                          <input type="text" id="_saleProdYn" name="saleProdYn" class="sb-input w100" ng-model="prodModifyInfo.saleProdYn" />
                        </td>
                        <%--원산지--%>
                        <th>
                        ...
                        <td>
                          <input type="text" id="_orgplceCd" name="orgplceCd" class="sb-input w100" ng-model="prodModifyInfo.orgplceCd" />
                        </td>
                    </tr>
                    <tr>
                        <%--최초판매단가--%>
                        ...
                        <td>
                          <input type="text" id="_saleUprc" name="saleUprc" class="sb-input w100" ng-model="prodModifyInfo.saleUprc" />
                        </td>
                        <%--원가단가--%>
                        <th>
                        ...
                        <td>
                          <input type="text" id="_costUprc" name="costUprc" class="sb-input w100" ng-model="prodModifyInfo.costUprc" />
                        </td>
                    </tr>
                    <tr>
                        <%--주문상품구분--%>
                        ...
                        <td>
                          <input type="text" id="_poProdFg" name="poProdFg" class="sb-input w100" ng-model="prodModifyInfo.poProdFg" />
                        </td>
                        <%--주문단위--%>
                        <th>
                        ...
                        <td>
                          <input type="text" id="_poUnitFg" name="poUnitFg" class="sb-input w100" ng-model="prodModifyInfo.poUnitFg" />
                        </td>
                    </tr>
                    <tr>
                        <%--최소주문--%>
                        ...
                        <td>
                          <input type="text" id="_poMinQty" name="poMinQty" class="sb-input w100" ng-model="prodModifyInfo.poMinQty" />
                        </td>
                        <th></th>
                        <td></td>
                    </tr>
            ...
            <table class="tblType01">
                ...
                <tr>
                    ...
                    <td>
                      <input type="text" id="_vatFg" name="vatFg" class="sb-input w100" ng-model="prodModifyInfo.vatFg" />
                    </td>
                    <%--재고관리여부--%>
                    <th>
                    ...
                    <td>
                      <input type="text" id="_stockProdYn" name="stockProdYn" class="sb-input w100" ng-model="prodModifyInfo.stockProdYn" />
                    </td>
                </tr>
                <tr>
                    <%--사용여부--%>
                    ...
                    <td>
                      <input type="text" id="_useYn" name="useYn" class="sb-input w100" ng-model="prodModifyInfo.useYn" />
                    </td>
                    <%--안전재고--%>
                    <th>
                    ...
                    <td>
                      <input type="text" id="_safeStockQty" name="safeStockQty" class="sb-input w100" ng-model="prodModifyInfo.safeStockQty" />
                    </td>
                </tr>
                <tr>
                    <%--품절여부 //TODO --%>
                ...
                <tr>
                    ...
                    <td>
                      <input type="text" id="_setProdFg" name="setProdFg" class="sb-input w100" ng-model="prodModifyInfo.setProdFg" />
                    </td>
                </tr>
                <tr>
                    <%--환급적용여부--%>
