...
app.controller('timeSaleStoreDtMomsCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchtimeSaleStoreDtMomsList = function () {
        ...
        $.postJSON("/sale/moms/timeSaleStoreDtMoms/timeSaleStoreDtMoms/getTimeSaleStoreDtMomsList.sb", params, function (response){
            var grid = $scope.flex;
                ...
                function delay(x){
                    return new Promise(function(resolve, reject){
                        ...
                        $.postJSON("/sale/moms/prodSaleDayStoreMoms/prodSaleDayStoreMoms/getDivisionExcelDownloadSaveUpdate.sb", params, function(response){
                            ...
                            // ajax 통신 설정
                            $.postJSON('/sale/moms/timeSaleStoreDtMoms/timeSaleStoreDtMoms/getTimeSaleStoreDtMomsExcelDivisionList.sb', params, function(response) {
