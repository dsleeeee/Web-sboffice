                        ...
                        <table class="tblType01">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <p class="s12 red mb10" id="fileSizeMax"><s:message code="captionMsg.fileSize.max" /></p>
...
<script type="text/javascript" src="/resource/solbipos/js/base/multilingual/captionMsg/captionMsgGrpReg.js?ver=20231120.01" charset="utf-8"></script>