...
app.controller('monthSaleStoreMomsCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchMonthSaleStoreMomsList = function () {
        ...
        $.postJSON("/sale/moms/monthSaleStoreMoms/monthSaleStoreMoms/getMonthSaleStoreMomsList.sb", params, function (response){
            var grid = $scope.flex;
...
app.controller('monthSaleStoreMomsExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $.postJSON("/sale/moms/monthSaleStoreMoms/monthSaleStoreMoms/getMonthSaleStoreMomsExcelList.sb", params, function(response) {
                ...
                function delay(x){
                    return new Promise(function(resolve, reject){
                        ...
                        $.postJSON("/sale/moms/prodSaleDayStoreMoms/prodSaleDayStoreMoms/getDivisionExcelDownloadSaveUpdate.sb", params, function(response){
                            ...
                            // ajax 통신 설정
                            $.postJSON('/sale/moms/monthSaleStoreMoms/monthSaleStoreMoms/getMonthSaleStoreMomsExcelDivisionList.sb', params, function(response) {
