...
<wj-popup id="wjExcelUploadStoreErrInfoLayer" control="wjExcelUploadStoreErrInfoLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:800px;">
    <div id="excelUploadStoreErrInfoLayer" class="wj-dialog wj-dialog-columns" ng-controller="excelUploadStoreErrInfoCtrl">

        <div class="wj-dialog-header wj-dialog-header-font">
            <s:message code="uploadStoreErrInfo.title"/>
...
<script type="text/javascript" src="/resource/solbipos/js/iostock/cmmExcelUpload/excelUploadStore/excelUploadStoreErrInfo.js?ver=20220704.01" charset="utf-8"></script>