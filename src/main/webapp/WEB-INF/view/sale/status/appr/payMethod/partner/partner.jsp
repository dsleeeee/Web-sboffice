...
<div id="apprPartnerView" class="subCon3"  ng-controller="apprPartnerCtrl" style="display: none;padding: 10px 20px 40px;">
    ...
    <table class="searchTbl">
      ...
      <tr>
        ...
        <div class="sb-select">
            <span class="txtIn"><input id="srchApprPartnerStartDate" class="w110px"></span>
                <span class="rg">~</span>
            <span class="txtIn"><input id="srchApprPartnerEndDate" class="w110px"></span>
  ...
  <%-- 엑셀 리스트 --%>
  <div class="w100 mt10" id="wjWrapType3" style="display:none;" ng-controller="apprPartnerExcelCtrl">
    <div class="wj-gridWrap">
          <wj-flex-grid
              id="apprPartnerExcelGrid"
              autoGenerateColumns="false"
              selection-mode="Row"
              items-source="data"
              control="excelFlex"
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/appr/payMethod/partner/partner.js?ver=20241219.01" charset="utf-8"></script>
