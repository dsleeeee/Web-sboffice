...
/** 폐기관리 그리드 controller */
app.controller('stockDisuseCtrl', ['$scope', '$http', function ($scope, $http) {
    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('stockDisuseCtrl', $scope, $http, true));
    ...
    $scope.initGrid = function (s, e) {
        ...
        $scope._makePickColumns("stockDisuseCtrl");
        ...
        s.addEventListener(s.hostElement, 'mousedown', function (e) {
            ...
            if (ht.cellType === wijmo.grid.CellType.Cell) {
                ...
                if (col.binding === "disuseTitle") { // 제목 클릭
                    ...
                    $scope._broadcast('stockDisuseDtlCtrl', params);
                }
            }
        });
    };
    ...
    $scope.$on("stockDisuseCtrl", function (event, data) {
        $scope.getSearchStockDisuseList();
        // 기능수행 종료 : 반드시 추가
    ...
    // 주문 리스트 조회
    $scope.getSearchStockDisuseList = function () {
        // 파라미터
        var params       = {};
        ...
        $scope._inquiryMain("/kookmin/stock/stockDisuse/stockDisuse/getSearchStockDisuseList.sb", params);
    };
    ...
    $scope.deleteDisuse = function () {
        ...
        s_alert.popConf(msg, function () {
            ...
            $scope._save("/kookmin/stock/stockDisuse/stockDisuse/deleteDisuse.sb", params, function () {
                $scope.getSearchStockDisuseList();
            });
        });
    };
