...
<div class="subCon" style="display: none" ng-controller="storeSalePriceResveExcelUploadAddCtrl">

    <input type="file" class="form-control" id="storeSalePriceResveExcelUpFile"
           ng-model="storeSalePriceResveExcelUpFile"
...
<script type="text/javascript" src="/resource/solbipos/js/base/price/salePriceResve/storeSalePriceResveExcelUploadAdd.js?ver=20260423.01" charset="utf-8"></script>
<%-- excelfile read js --%>
