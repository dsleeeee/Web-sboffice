...
app.controller('uptPmixCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchList = function(){
        ...
        $.postJSON("/sale/prod/uptPmix/uptPmix/getUptPmixList.sb", params, function (response){
            var grid = $scope.flex;
...
app.controller('uptPmixExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $.postJSON("/sale/prod/uptPmix/uptPmix/getUptPmixExcelList.sb", params, function(response) {
