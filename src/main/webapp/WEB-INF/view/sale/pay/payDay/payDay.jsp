      ...
      <div class="wj-gridWrap" style="height: 470px; overflow-y: hidden; overflow-x: hidden;">
        <wj-flex-grid
          ...
          <c:forEach var="payCol" items="${payColList}">
            <wj-flex-grid-column header="<s:message code="payDay.cnt"/>" binding="payCnt${payCol.payCd}" width="100" align="right" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
