...
public class ProdSalePmixStoreMomsServiceImpl implements ProdSalePmixStoreMomsService {
    ...
    public List<DefaultMap<Object>> getProdSalePmixStoreMomsList(ProdSalePmixStoreMomsVO prodSalePmixStoreMomsVO, SessionInfoVO sessionInfoVO) {
        ...
        // 상품 array 값 세팅
        if(!StringUtil.getOrBlank(prodSalePmixStoreMomsVO.getProdCds()).equals("")) {
            ProdVO prodVO = new ProdVO();
            prodVO.setArrSplitProdCd(CmmUtil.splitText(prodSalePmixStoreMomsVO.getProdCds(), 3900));
            prodSalePmixStoreMomsVO.setProdCdQuery(popupMapper.getSearchMultiProdRtn(prodVO));
        }
