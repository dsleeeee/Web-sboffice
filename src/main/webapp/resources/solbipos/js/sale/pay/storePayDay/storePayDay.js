 ...
 *
 * 파일명 : storePayDay.js
 * 설  명 : 맘스터치 > 결제수단매출 > 매장-일별결제수단매출 JavaScript
 *
...
app.controller('storePayDayCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  ...
  $scope.searchStorePayDayList = function () {
    ...
    $.postJSON("/sale/pay/storePayDay/storePayDay/getStorePayDayList.sb", params, function(response){
      var grid = $scope.flex;
...
app.controller('storePayDayExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  ...
  $scope.searchExcelList = function (params) {
    // 조회 수행 : 조회URL, 파라미터, 콜백함수
    $.postJSON("/sale/pay/storePayDay/storePayDay/getStorePayDayExcelList.sb", params, function(response) {
