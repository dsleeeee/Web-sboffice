...
<div id="apprAcquireNcardView" class="subCon3"  ng-controller="apprAcquireNcardCtrl" style="display: none;padding: 10px 20px 40px;">
    <div class="searchBar flddUnfld">
      <a href="#" class="open fl"><s:message code="dailyReport.apprNcard"/></a>
      <%-- 조회 --%>
      <button class="btn_blue fr mt5 mr10" id="btnApprAcquireNcardSearch" ng-click="_broadcast('apprAcquireNcardCtrlSrch')">
    ...
    <table class="searchTbl">
      ...
      <tr>
        ...
        <td>
        <div class="sb-select">
            <span class="txtIn"><input id="srchApprAcquireNcardStartDate" class="w110px"></span>
                <span class="rg">~</span>
            <span class="txtIn"><input id="srchApprAcquireNcardEndDate" class="w110px"></span>
    ...
    <c:if test="${sessionInfo.orgnFg == 'HQ'}">
        ...
        <td>
            ...
            <jsp:include page="/WEB-INF/view/sale/com/popup/selectStoreM.jsp" flush="true">
                ...
                <jsp:param name="targetPosId" value="apprAcquireNcardSelectPos"/>
                <jsp:param name="targetCornerId" value="apprAcquireNcardSelectCorner"/>
      ...
      <tr>
        ...
        <td <c:if test="${sessionInfo.orgnFg == 'HQ'}">colspan="3"</c:if> >
            ...
            <jsp:include page="/WEB-INF/view/sale/status/pos/cmm/selectPosM.jsp" flush="true">
                <jsp:param name="targetId" value="apprAcquireNcardSelectPos"/>
                <jsp:param name="targetStoreId" value="apprAcquireNcardSelectStore"/>
                <jsp:param name="closeFunc" value="getPosNmList"/>
            </jsp:include>
            <%--// 매장선택 모듈 멀티 선택 사용시 include --%>
        </td>
    ...
    <wj-combo-box
            class="w100px fl"
            id="apprAcquireNcardListScaleBox"
            ng-model="apprAcquireNcardListScale"
            items-source="_getComboData('apprAcquireNcardListScaleBox')"
            display-member-path="name"
            selected-value-path="value"
        ...
        <c:if test="${sessionInfo.orgnFg == 'HQ'}">
            <input type="hidden" id="apprAcquireNcardSelectStoreStoreNum" ng-model="storeNum">
        </c:if>
    <%-- 엑셀 다운로드 //TODO --%>
    ...
    <div class="w100 mt10">
      ...
      <div class="wj-gridWrap" style="overflow-x: hidden; overflow-y: hidden;">
        <wj-flex-grid
          ...
          <wj-flex-grid-column header="<s:message code="appr.acquire.cardCd"          />"       binding="acquireCd"         width="110" is-read-only="true" align="center" ></wj-flex-grid-column>
          <wj-flex-grid-column header="<s:message code="appr.acquire.cardNm"          />"       binding="acquireNm"         width="100" is-read-only="true" align="center" ></wj-flex-grid-column>
        ...
        <jsp:include page="/WEB-INF/view/layout/columnPicker.jsp" flush="true">
          <jsp:param name="pickerTarget" value="apprAcquireNcardCtrl"/>
        </jsp:include>
        <%--// ColumnPicker 사용시 include --%>
      </div>
      <%--//위즈모 테이블--%>
  ...
  <div class="pageNum mt20">
   <%-- id --%>
    <ul id="apprAcquireNcardCtrlPager" data-size="10">
    </ul>
  </div>
  <%--//페이지 리스트--%>

  <%-- 엑셀 리스트 --%>
  <div class="w100 mt10" id="wjWrapType3" style="display:none;" ng-controller="apprAcquireNcardExcelCtrl">
    <div class="wj-gridWrap">
          <wj-flex-grid
              id="apprAcquireNcardExcelGrid"
              autoGenerateColumns="false"
              selection-mode="Row"
              items-source="data"
              control="excelFlex"
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/appr/acquire/ncard/ncard.js?ver=20250416.01" charset="utf-8"></script>
