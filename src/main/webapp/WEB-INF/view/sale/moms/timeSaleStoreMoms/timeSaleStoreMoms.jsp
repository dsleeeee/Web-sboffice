    ...
    <div ng-controller="timeSaleStoreMomsCtrl">
        <div class="searchBar">
            ...
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('timeSaleStoreMomsCtrl', 1)">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/moms/timeSaleStoreMoms/timeSaleStoreMoms.js?ver=20240530.01" charset="utf-8"></script>