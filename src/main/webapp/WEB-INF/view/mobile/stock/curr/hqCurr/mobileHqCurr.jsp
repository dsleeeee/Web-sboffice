...
<div class="subCon" ng-controller="mobileHqCurrCtrl">
    <div class="searchBar">
        <a href="#" class="open fl">${menuNm}</a>
        <%-- 조회 --%>
        <button class="btn_blue fr mt5 mr10" id="btnSearch" ng-click="_broadcast('mobileHqCurrCtrl')">
    ...
    <table class="searchTbl">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                --%>
                <jsp:include page="/WEB-INF/view/mobile/sale/com/popup/selectVendrM.jsp" flush="true">
                    <jsp:param name="targetId" value="mobileHqCurrSelectVendr"/>
                </jsp:include>
    ...
    <div class="w100 mt10">
        ...
        <div class="wj-gridWrap" style="height: 350px; overflow-x: hidden; overflow-y: hidden;">
            ...
            >
                ...
                <div class="gridMsg" id="mobileHqCurrMsg" style="line-height: 150px; display: none;"><s:message code="mobile.cmm.search.result.empty"/></div>
            </wj-flex-grid>
            <%-- ColumnPicker 사용시 include --%>
            <jsp:include page="/WEB-INF/view/layout/columnPicker.jsp" flush="true">
                <jsp:param name="pickerTarget" value="mobileHqCurrCtrl"/>
            </jsp:include>
            <%--// ColumnPicker 사용시 include --%>
        </div>
        <%--//위즈모 테이블--%>
        ...
        <div class="pageNum3 mt20">
            <%-- id --%>
            <ul id="mobileHqCurrCtrlPager" data-size="10">
            </ul>
        </div>
        <%--//페이지 리스트--%>

        <%--엑셀 리스트--%>
        <div class="wj-gridWrap" style="height: 350px; display:none;" ng-controller="mobileHqCurrExcelCtrl">
            <wj-flex-grid
                    autoGenerateColumns="false"
                    selection-mode="Row"
                    items-source="data"
...
<script type="text/javascript" src="/resource/solbipos/js/mobile/stock/curr/hqCurr/mobileHqCurr.js?ver=20240719.01" charset="utf-8"></script>
