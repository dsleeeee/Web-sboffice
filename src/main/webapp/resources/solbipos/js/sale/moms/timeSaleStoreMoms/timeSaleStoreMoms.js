...
app.controller('timeSaleStoreMomsCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchTimeSaleStoreMomsList = function () {
        ...
        $.postJSON("/sale/moms/timeSaleStoreMoms/timeSaleStoreMoms/getTimeSaleStoreMomsList.sb", params, function (response){
            var grid = $scope.flex;
...
app.controller('timeSaleStoreMomsExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $.postJSON("/sale/moms/timeSaleStoreMoms/timeSaleStoreMoms/getTimeSaleStoreMomsExcelList.sb", params, function(response) {
                ...
                function delay(x){
                    return new Promise(function(resolve, reject){
                        ...
                        $.postJSON("/sale/moms/prodSaleDayStoreMoms/prodSaleDayStoreMoms/getDivisionExcelDownloadSaveUpdate.sb", params, function(response){
                            ...
                            // ajax 통신 설정
                            $.postJSON('/sale/moms/timeSaleStoreMoms/timeSaleStoreMoms/getTimeSaleStoreMomsExcelDivisionList.sb', params, function(response) {
