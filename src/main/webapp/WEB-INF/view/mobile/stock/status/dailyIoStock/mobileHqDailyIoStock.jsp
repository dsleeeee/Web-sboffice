    ...
    <div class="w100 mt10" id="wjWrapType1">
        <div class="wj-gridWrap" style="height: 360px; overflow-x: hidden; overflow-y: hidden;">
            <wj-flex-grid
                ...
                <div class="gridMsg" id="mobileHqDailyIoStockMsg" style="line-height: 150px; display: none;"><s:message code="mobile.cmm.search.result.empty"/></div>
            </wj-flex-grid>
...
<script type="text/javascript" src="/resource/solbipos/js/mobile/stock/status/dailyIoStock/mobileHqDailyIoStock.js?ver=20240723.01" charset="utf-8"></script>
