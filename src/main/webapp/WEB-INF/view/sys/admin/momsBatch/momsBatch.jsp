...
<div class="subCon" ng-controller="momsBatchCtrl">
    ...
    <input type="response_data" id="response_data" value="" style="display: none;"/>
...
<script type="text/javascript" src="/resource/solbipos/js/sys/admin/momsBatch/momsBatch.js?ver=20241219.01" charset="utf-8"></script>
