 ...
 *  엑셀업로드 그리드 생성
 */
app.controller('stockExcelUploadCtrl', ['$scope', '$http','$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('stockExcelUploadCtrl', $scope, $http, true));
    ...
    $scope.deleteExl = function (upFg) {
        ...
        $http({
            method : 'POST', //방식
            url    : "/kookmin/stock/stockAcins/stockCmm/deleteExcelUpload.sb", /* 통신할 URL */
    ...
    $scope.save = function (jsonData) {
        ...
        $http({
            method : 'POST', //방식
            url    : '/kookmin/stock/stockAcins/stockCmm/saveExcelUpload.sb', /* 통신할 URL */
    ...
    $scope.saveUpdateProdCd = function () {
        ...
        $http({
            method : 'POST', //방식
            url    : '/kookmin/stock/stockAcins/stockCmm/saveUpdateProdCd.sb', /* 통신할 URL */
            params : params, /* 파라메터로 보낼 데이터 */
            headers: {'Content-Type': 'application/json; charset=utf-8'} //헤더
        }).then(function successCallback(response) {
            if ($scope._httpStatusCheck(response, true)) {
