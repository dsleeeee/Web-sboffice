        ...
        <div class="wj-dialog-body">
            <div class="w100">
                ...
                <table class="tblType01">
                    ...
                    <tr>
                        <th><s:message code="outstockReqDate.sdselProdCd" /></th>
                        <td>
                            <input type="text" id="srchSdselProdCd" ng-model="srchSdselProdCd"/>
                        </td>
                        <th><s:message code="outstockReqDate.sdselProdNm" /></th>
                        <td>
                ...
                <div class="wj-gridWrap mt10" style="height: 400px; overflow-y: hidden;">
                    <wj-flex-grid
                        ...
                        <wj-flex-grid-column header="<s:message code="outstockReqDate.sdselGrpNm"/>" binding="sdselGrpNm" width="80" align="left" is-read-only="true"></wj-flex-grid-column>
