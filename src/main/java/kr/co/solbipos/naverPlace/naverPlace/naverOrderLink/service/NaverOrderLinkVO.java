...
/**
 * @Class Name  : NaverOrderLinkVO.java
 ...
 */
public class NaverOrderLinkVO extends PageVO {

    private static final long serialVersionUID = -3120457813249887541L;
    ...
    public String getLastResponseDt() { return lastResponseDt; }
    public void setLastResponseDt(String lastResponseDt) { this.lastResponseDt = lastResponseDt; }
    ...
    public String getNaverStoreNm() { return naverStoreNm; }
    public void setNaverStoreNm(String naverStoreNm) { this.naverStoreNm = naverStoreNm; }
    ...
    public String getNaverLinkDt() { return naverLinkDt; }
    public void setNaverLinkDt(String naverLinkDt) { this.naverLinkDt = naverLinkDt; }
