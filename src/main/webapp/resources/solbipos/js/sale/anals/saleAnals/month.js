 ...
 *
 * 파일명 : month.js
 * 설  명 : 매출관리 > 매출분석 > 매장별배출분석2 > 월별탭 JavaScript
 *
...
app.controller('monthCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('monthCtrl', $scope, $http, true));
    ...
    $scope.initGrid = function (s, e) {
        ...
        $scope._makePickColumns("monthCtrl");
    ...
    // <-- 검색 호출 -->
    $scope.$on("monthCtrl", function(event, data) {
    ...
    $scope.searchMonthTotal = function() {
        ...
        $scope._inquiryMain("/sale/anals/store/saleAnals/getMonthList.sb", params, function() {}, false);
    };
    // <-- //검색 호출 -->
    ...
    $scope.excelDownloadInfo = function () {
        ...
        $timeout(function () {
            wijmo.grid.xlsx.FlexGridXlsxConverter.saveAsync($scope.flex, {
                ...
                messages["saleAnals.saleAnals"] + '(' + messages["saleAnals.month"] + ')_' + getCurDateTime() +'.xlsx', function () {
                    $timeout(function () {
