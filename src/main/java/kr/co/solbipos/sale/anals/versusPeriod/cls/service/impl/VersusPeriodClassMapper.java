...
public interface VersusPeriodClassMapper {
    ...
    /** 대비기간매출분석 - 분류상품별 리스트 상세 조회 */
	List<DefaultMap<String>> getVersusPeriodClassDtlExcelList(VersusPeriodClassVO versusPeriodClassVO);
	/** 대비기간매출분석 - 분류상품별 리스트 상세 차트 조회 */
	List<DefaultMap<String>> getVersusPeriodClassDtlChartList(VersusPeriodClassVO versusPeriodClassVO);
