...
<div class="subCon">
  <div ng-controller="monthProdCtrl">
    <div class="searchBar flddUnfld">
      ...
      <%-- 조회 --%>
      <button class="btn_blue fr mt5 mr10" id="btnSearch" ng-click="_broadcast('monthProdCtrl')">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/prod/monthProd/monthProd.js?ver=20221004.01" charset="utf-8"></script>
