    ...
    <div class="wj-gridWrap" style="height:370px; overflow-y: hidden; overflow-x: hidden;">
      <div class="row">
        <wj-flex-grid
          ...
          <!-- define columns -->
          <wj-flex-grid-column header="<s:message code="prepaidDtl.storeCd"/>" binding="storeCd" width="80" is-read-only="true" align="center" visible="{{orgnFg == 'H'}}"></wj-flex-grid-column>
          <wj-flex-grid-column header="<s:message code="prepaidDtl.storeNm"/>" binding="storeNm" width="120" is-read-only="true" align="center" visible="{{orgnFg == 'H'}}"></wj-flex-grid-column>
          <wj-flex-grid-column header="<s:message code="prepaidDtl.membrNo"/>" binding="membrNo" width="80" is-read-only="true" align="center"></wj-flex-grid-column>
          <wj-flex-grid-column header="<s:message code="prepaidDtl.membrNm"/>" binding="membrNm" width="120" is-read-only="true" align="center"></wj-flex-grid-column>
          <wj-flex-grid-column header="<s:message code="prepaidDtl.saleDate"/>" binding="saleDate" width="120" is-read-only="true" align="center"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/membr/anals/prepaidDtl/prepaidDtl.js?ver=20240605.01" charset="utf-8"></script>