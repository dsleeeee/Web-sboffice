...
app.controller('weightProdCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('weightProdCtrl', $scope, $http, true));
    ...
    $scope.initGrid = function (s, e) {
        ...
        $scope._makePickColumns("weightProdCtrl");
    ...
    $scope.$on("weightProdCtrl", function (event, data) {
    ...
    $scope.searchProdClassList = function () {
        ...
        $scope._inquiryMain("/sale/weight/weight/weightProd/getWeightProdList.sb", params, function() {});
    };
...
app.controller('prodClassExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchProdClassExcelList = function (data) {
        ...
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $scope._inquiryMain("/sale/weight/weight/weightProd/getWeightProdExcelList.sb", params, function() {
            ...
            $timeout(function () {
                ...
                }, messages["weight.weightProd"] + '_'+getToday()+'.xlsx', function () {
                    $timeout(function () {
