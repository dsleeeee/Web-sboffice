package kr.co.solbipos.sale.moms.timeProdSalePmixMoms.web;
...
/**
 * @Class Name : TimeProdSalePmixMomsController.java
 ...
 */
@Controller
@RequestMapping("/sale/moms/timeProdSalePmixMoms")
public class TimeProdSalePmixMomsController {

    private final SessionService sessionService;
    private final TimeProdSalePmixMomsService timeProdSalePmixMomsService;
     ...
     */
    @Autowired
    public TimeProdSalePmixMomsController(SessionService sessionService, TimeProdSalePmixMomsService timeProdSalePmixMomsService, CmmCodeUtil cmmCodeUtil, DayProdService dayProdService, CmmEnvUtil cmmEnvUtil) {
        this.sessionService = sessionService;
        this.timeProdSalePmixMomsService = timeProdSalePmixMomsService;
     ...
     * @param model
     */
    @RequestMapping(value = "/timeProdSalePmixMoms/list.sb", method = RequestMethod.GET)
    public String timeProdSalePmixMomsView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/moms/timeProdSalePmixMoms/timeProdSalePmixMoms";
    }

    /**
     * 시간대별 상품매출(P.MIX) - 조회
     *
     * @param timeProdSalePmixMomsVO
     * @param request
     * @param response
     * @param model
     * @return  Object
     ...
     * @since   2025. 05. 27.
     */
    @RequestMapping(value = "/timeProdSalePmixMoms/getTimeProdSalePmixMomsList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getTimeProdSalePmixMomsList(TimeProdSalePmixMomsVO timeProdSalePmixMomsVO, HttpServletRequest request,
                                          HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = timeProdSalePmixMomsService.getTimeProdSalePmixMomsList(timeProdSalePmixMomsVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, result, timeProdSalePmixMomsVO);
    }
     ...
     * @since   2025. 05. 27.
     */
    @RequestMapping(value = "/timeProdSalePmixMoms/getTimeProdSalePmixMomsExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getTimeProdSalePmixMomsExcelList(TimeProdSalePmixMomsVO timeProdSalePmixMomsVO, HttpServletRequest request,
                                               HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = timeProdSalePmixMomsService.getTimeProdSalePmixMomsExcelList(timeProdSalePmixMomsVO, sessionInfoVO);
     ...
     * @return
     */
    @RequestMapping(value = "/timeProdSalePmixMoms/getDateDiff.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getDateDiff(HttpServletRequest request, HttpServletResponse response, Model model, TimeProdSalePmixMomsVO timeProdSalePmixMomsVO) {

        List<HashMap<String, String>> list = timeProdSalePmixMomsService.getDateDiff(timeProdSalePmixMomsVO);
