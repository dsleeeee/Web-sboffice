      ...
      <div class="w100 mt10">
        ...
        <div class="wj-gridWrap" style="height: 320px; overflow-x: hidden; overflow-y: hidden;">
          <wj-flex-grid
            ...
            <wj-flex-grid-column header="<s:message code="saleComPopup.payco.billNo"/>" 	binding="billNo"		width="60" 		align="center" is-read-only="true"></wj-flex-grid-column>
...
<%--            <wj-flex-grid-column header="<s:message code="saleComPopup.payco.vatAmt"/>" 	binding="vatAmt"		width="80" 	align="right"  is-read-only="true" aggregate="Sum"></wj-flex-grid-column>--%>
            ...
            <wj-flex-grid-column header="<s:message code="saleComPopup.payco.apprNo"/>" 	binding="apprNo" 		width="70" 	align="center" is-read-only="true" format="d"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/com/appr/apprPayco.js?ver=20240415.03" charset="utf-8"></script>