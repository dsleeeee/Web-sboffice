...
<wj-popup control="wjDayStoreDtlLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:800px;height:480px;" fade-in="false" fade-out="false">
            ...
            <div class="w100 mt10 mb20">
                <div class="wj-gridWrap" style="height:370px; overflow-y: hidden; overflow-x: hidden;">
                    <wj-flex-grid
                        ...
                        <!-- define columns -->
                        <wj-flex-grid-column header="<s:message code="day.dayStoreDtl.storeCd"/>" binding="storeCd" width="90" is-read-only="true" align="center"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="day.dayStoreDtl.storeNm"/>" binding="storeNm" width="150" is-read-only="true" align="center"></wj-flex-grid-column>
