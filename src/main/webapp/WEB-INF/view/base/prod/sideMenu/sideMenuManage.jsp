    ...
    <div class="w100 mt10 mb20">
        <div class="wj-gridWrap" style="height:280px; overflow-y: hidden; overflow-x: hidden;">
            <wj-flex-grid
                ...
                <wj-flex-grid-column header="<s:message code="sideMenu.manage.prodClassNm"/>" binding="pathNm" width="150" is-read-only="true" align="left"></wj-flex-grid-column>
                <%-- 브랜드를 사용하는 본사/매장인 경우만 변경 가능 --%>
                <c:if test="${orgnFg == 'HQ' and brandUseFg == '1'}">
                    <wj-flex-grid-column header="<s:message code="sideMenu.manage.brand"/>" binding="hqBrandNm" is-read-only="true" width="80" align="center"></wj-flex-grid-column>
                </c:if>
                <wj-flex-grid-column header="<s:message code="sideMenu.manage.saleProdYn"/>" binding="saleProdYn" data-map="saleProdYnDataMap" width="90" is-read-only="true" align="center"></wj-flex-grid-column>
                ...
                <wj-flex-grid-column header="<s:message code="sideMenu.manage.stockProdYn"/>" binding="stockProdYn" data-map="stockProdYnDataMap" width="90" is-read-only="true" align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="sideMenu.manage.vatFg"/>" binding="vatFg" data-map="vatFgDataMap" width="80" is-read-only="true" align="center"></wj-flex-grid-column>
                ...
                <wj-flex-grid-column header="<s:message code="sideMenu.manage.attr"/>" binding="sdattrClassCd" data-map="sdattrClassDataMap" width="120" align="left"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="sideMenu.manage.selectMenu"/>" binding="sdselGrpCd" data-map="sdselGrpDataMap" width="120" align="left"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="sideMenu.manage.useYn"/>" binding="useYn" width="70" data-map="useYnDataMap" is-read-only="true" align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="sideMenu.manage.poProdFg"/>" binding="poProdFg" data-map="poProdFgDataMap" width="110" is-read-only="true" align="center"></wj-flex-grid-column>
                ...
                <wj-flex-grid-column header="<s:message code="sideMenu.manage.remark"/>" binding="remark" width="100" align="left" is-read-only="true"></wj-flex-grid-column>
            </wj-flex-grid>
        </div>
    </div>
    <%-- 페이지 리스트 --%>
