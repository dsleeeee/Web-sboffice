	...
	<table class="searchTbl">
		...
		<tbody>
			<tr>
				...
				<td>
					<div class="sb-select">
						<span class="txtIn"><input id="srchStoreBrandStartDate" class="w110px"></span>
						<span class="rg">~</span>
						<span class="txtIn"><input id="srchStoreBrandEndDate" class="w110px"></span>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/anals/store/brand/storeBrand.js?ver=20250416.01" charset="utf-8"></script>
