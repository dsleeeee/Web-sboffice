...
public class ProdSaleDayStoreMomsServiceImpl implements ProdSaleDayStoreMomsService {
    ...
    public List<DefaultMap<Object>> getProdSaleDayStoreMomsList(ProdSaleDayStoreMomsVO prodSaleDayStoreMomsVO, SessionInfoVO sessionInfoVO) {
        ...
        // 상품 array 값 세팅
        if(!StringUtil.getOrBlank(prodSaleDayStoreMomsVO.getProdCds()).equals("")) {
            ProdVO prodVO = new ProdVO();
            prodVO.setArrSplitProdCd(CmmUtil.splitText(prodSaleDayStoreMomsVO.getProdCds(), 3900));
            prodSaleDayStoreMomsVO.setProdCdQuery(popupMapper.getSearchMultiProdRtn(prodVO));
        }
