...
public interface BarcdService {
	...
	/** 바코드별매출 - 엑셀 전체 리스트 조회 */
    List<DefaultMap<String>> getBarcdExcelList(BarcdVO barcdVO, SessionInfoVO sessionInfoVO);
    
    /** 바코드별매출 - 엑셀 전체 상세 리스트 조회 */
	List<DefaultMap<String>> getBarcdDtlExcelList(BarcdVO barcdVO, SessionInfoVO sessionInfoVO);
}
