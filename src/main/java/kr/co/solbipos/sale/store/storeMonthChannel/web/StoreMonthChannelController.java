...
public class StoreMonthChannelController {
    ...
    @Autowired
    public StoreMonthChannelController(DayService dayService, TodayDtlService todayDtlService, SessionService sessionService, StoreMonthChannelService storeMonthChannelService, StoreChannelService storeChannelService) {
