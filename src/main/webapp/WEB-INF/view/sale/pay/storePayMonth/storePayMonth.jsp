...
<div class="subCon">
    <div ng-controller="storePayMonthCtrl">
        <%-- 조회조건 --%>
        <div class="searchBar">
            <a href="#" class="open fl">${menuNm}</a>
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <%-- 조회 --%>
                <button class="btn_blue fr" id="btnSearch" ng-click="_broadcast('storePayMonthCtrl',1)">
                ...
                <tr>
                    ...
                    <td class="storePayMonth" style="display: none;">
                        ...
                        <jsp:include page="/WEB-INF/view/sale/com/popup/selectStoreMMoms.jsp" flush="true">
                            <jsp:param name="targetId" value="storePayMonthStore"/>
                        </jsp:include>
        ...
        <div class="w100 mt10 mb20">
            <div class="wj-gridWrap" style="height:370px; overflow-y: hidden; overflow-x: hidden;">
                <div class="row">
                    <wj-flex-grid
                        ...
                        <wj-flex-grid-column header="<s:message code="storePayMonth.branchCd"/>" binding="branchCd" width="80" is-read-only="true" align="center"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="storePayMonth.branchNm"/>" binding="branchNm" width="80" is-read-only="true" align="center"></wj-flex-grid-column>
            ...
            <div class="pageNum mt20">
                <%-- id --%>
                <ul id="storePayMonthCtrlPager" data-size="10">
                </ul>
            </div>
            <%--//페이지 리스트--%>

            <%--엑셀 리스트--%>
            <div class="w100 mt10" style="display:none;" ng-controller="storePayMonthExcelCtrl">
                <%--위즈모 테이블--%>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/pay/storePayMonth/storePayMonth.js?ver=20221221.01" charset="utf-8"></script>
