...
<div class="subCon" ng-controller="storeProdNmCtrl" id="storeProdNmView" style="display: none;">
    <div class="searchBar">
        <a href="#" class="open fl"><s:message code="storeProdLang.prodNm"/></a>
        <%-- 조회 --%>
        <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
            <button class="btn_blue fr" id="nxBtnSearch" ng-click="_pageView('storeProdNmCtrl', 1)">
    ...
    <div class="wj-TblWrap mt5">
        <div class="wj-gridWrap" style="height: 420px; overflow-x: hidden; overflow-y: hidden;">
            <wj-flex-grid
                ...
                <wj-flex-grid-column header="<s:message code="storeProdLang.prodNm"/>" binding="prodNm" align="left" width="200" is-read-only="true"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="storeProdLang.prodNm"/>(<s:message code="storeProdLang.en"/>)" binding="prodEnNm" align="left" width="200"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="storeProdLang.prodNm"/>(<s:message code="storeProdLang.cn"/>)" binding="prodCnNm" align="left" width="200"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="storeProdLang.prodNm"/>(<s:message code="storeProdLang.jp"/>)" binding="prodJpNm" align="left" width="200"></wj-flex-grid-column>
...
<%-- 양식다운로드/엑셀업로드 관련 --%>
<div style="display: none;" ng-controller="storeProdNmExcelCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/base/multilingual/storeProdLang/storeProdNm.js?ver=20250925.01" charset="utf-8"></script>
