      ...
      <div class="w100 mt10">
        ...
        <div class="wj-gridWrap" style="height: 320px; overflow-x: hidden; overflow-y: hidden;">
          <wj-flex-grid
            ...
            <wj-flex-grid-column header="<s:message code="saleComPopup.mcoupn.apprNo"/>" 	binding="apprNo" 		width="150" 	align="center" is-read-only="true" format="d"></wj-flex-grid-column>
