...
/**
 * @Class Name : TouchKeyResveVO.java
 ...
 */
public class TouchKeyResveVO extends PageVO {
    ...
    /** 터치키그룹코드 */
    private String touchKeyGrp;
    private String orgTouchKeyGrp;
    ...
    public String getTouchKeyGrp() {
        return touchKeyGrp;
    }

    public void setTouchKeyGrp(String touchKeyGrp) {
        this.touchKeyGrp = touchKeyGrp;
    }

    public String getOrgTouchKeyGrp() {
        return orgTouchKeyGrp;
    }

    public void setOrgTouchKeyGrp(String orgTouchKeyGrp) {
        this.orgTouchKeyGrp = orgTouchKeyGrp;
    }
