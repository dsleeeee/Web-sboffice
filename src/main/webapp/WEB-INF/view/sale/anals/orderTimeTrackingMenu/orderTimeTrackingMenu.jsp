...
<div class="subCon">
    <div ng-controller="orderTimeTrackingMenuCtrl">
        <%--searchTbl--%>
        <div class="searchBar">
            <a href="#" class="open fl">${menuNm}</a>
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <%-- 조회 --%>
                <button class="btn_blue fr" id="nxBtnSearch2" ng-click="_pageView('orderTimeTrackingMenuCtrl',1)">
        ...
        <table class="searchTbl">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                            ...
                            <jsp:param name="targetId" value="orderTimeTrackingMenuStore"/>
                        </jsp:include>
                            <%--// 매장선택 모듈 사용시 include --%>
                    </td>
                </tr>
            ...
            <c:if test="${sessionInfo.orgnFg == 'STORE'}">
                <input type="hidden" id="orderTimeTrackingMenuStoreCd" value="${sessionInfo.storeCd}"/>
            </c:if>
            </tbody>
        </table>
        ...
        <div class="w100 mt10">
            ...
            <div class="wj-gridWrap" style="height: 420px; overflow-x: hidden; overflow-y: hidden;">
                <wj-flex-grid
                    ...
                    <wj-flex-grid-column header="<s:message code="orderTimeTracking.prodCd"/>" binding="prodCd" width="90" align="center" is-read-only="true"></wj-flex-grid-column>
                    <wj-flex-grid-column header="<s:message code="orderTimeTracking.prodNm"/>" binding="prodNm" width="90" align="center" is-read-only="true"></wj-flex-grid-column>
                ...
                <jsp:include page="/WEB-INF/view/layout/columnPicker.jsp" flush="true">
                    <jsp:param name="pickerTarget" value="orderTimeTrackingMenuCtrl"/>
                </jsp:include>
                <%--// ColumnPicker 사용시 include --%>
            </div>
            <%--//위즈모 테이블--%>
    ...
    <div class="pageNum mt20">
        <%-- id --%>
        <ul id="orderTimeTrackingMenuCtrlPager" data-size="10">
        </ul>
    </div>
    <%--//페이지 리스트--%>

    <%--엑셀 리스트--%>
    <div class="w100 mt10" style="display:none;" ng-controller="orderTimeTrackingMenuExcelCtrl">
        <wj-flex-grid
                id="wjGridExcelList"
                autoGenerateColumns="false"
                selection-mode="Row"
...
<script type="text/javascript" src="/resource/solbipos/js/sale/anals/orderTimeTrackingMenu/orderTimeTrackingMenu.js?ver=20240618.01" charset="utf-8"></script>