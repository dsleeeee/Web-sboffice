package kr.co.solbipos.sale.pay.storePayMonth.web;
...
/**
 * @Class Name : StorePayMonthController.java
 ...
 */
@Controller
@RequestMapping("/sale/pay/storePayMonth")
public class StorePayMonthController {

    private final SessionService sessionService;
    private final StorePayMonthService storePayMonthService;
     ...
     */
    @Autowired
    public StorePayMonthController(SessionService sessionService, StorePayMonthService storePayMonthService, DayService dayService, CmmCodeUtil cmmCodeUtil, DayProdService dayProdService) {
        this.sessionService = sessionService;
        this.storePayMonthService = storePayMonthService;
     ...
     * @param model
     */
    @RequestMapping(value = "/storePayMonth/list.sb", method = RequestMethod.GET)
    public String storePayMonthView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/pay/storePayMonth/storePayMonth";
    }
     ...
     * @param   response
     * @param   model
     * @param   storePayMonthVO
     * @return  String
     * @author  권지현
     * @since   2022.12.21
     */
    @RequestMapping(value = "/storePayMonth/getStorePayMonthList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getStorePayMonthList(HttpServletRequest request, HttpServletResponse response, Model model, StorePayMonthVO storePayMonthVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> list = storePayMonthService.getStorePayMonthList(storePayMonthVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, list, storePayMonthVO);
    }
     ...
     * @since   2022.12.21
     */
    @RequestMapping(value = "/storePayMonth/getStorePayMonthExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getStorePayMonthExcelList(HttpServletRequest request, HttpServletResponse response, Model model, StorePayMonthVO storePayMonthVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> list = storePayMonthService.getStorePayMonthExcelList(storePayMonthVO, sessionInfoVO);
