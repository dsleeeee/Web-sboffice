/****************************************************************
 *
 * 파일명 : storeMonthChannelMrpizza.js
 * 설  명 : 미스터피자 > 매장분석 > 매장-월별매출현황(채널별)
 *
...
app.controller('storeMonthChannelMrpizzaCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('storeMonthChannelMrpizzaCtrl', $scope, $http, true));
    ...
    // <-- 검색 호출 -->
    $scope.$on("storeMonthChannelMrpizzaCtrl", function(event, data) {

        // 매장-월별매출현황(채널별) 리스트 조회
        $scope.searchMonthTotalMrpizzaList();

        event.preventDefault();
    });

    // 매장-월별매출현황(채널별) 리스트 조회
    $scope.searchMonthTotalMrpizzaList = function() {
        ...
        if($scope.option === "store"){
            params.storeCds = $("#storeMonthChannelMrpizzaStoreCd").val();
        } else {
            params.storeCds = '';
        }
        ...
        $scope._inquiryMain("/sale/store/storeMonthChannelMrpizza/storeMonthChannelMrpizza/getStoreMonthChannelMrpizzaList.sb", params, function() {
    ...
    $scope.excelDownloadInfo = function () {
        ...
        $scope._broadcast('storeMonthChannelMrpizzaExcelCtrl', params);
    };
 ...
 *  엑셀다운로드 그리드 생성
 */
app.controller('storeMonthChannelMrpizzaExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('storeMonthChannelMrpizzaExcelCtrl', $scope, $http, false));
...
*/
    ...
    $scope.$on("storeMonthChannelMrpizzaExcelCtrl", function (event, data) {
    ...
    $scope.searchExcelList = function (params) {
        ...
        $scope._inquiryMain("/sale/store/storeMonthChannelMrpizza/storeMonthChannelMrpizza/getStoreMonthChannelMrpizzaExcelList.sb", params, function (){
            ...
            $timeout(function () {
                wijmo.grid.xlsx.FlexGridXlsxConverter.saveAsync($scope.excelFlex, {
                    ...
                    messages["storeMonthChannelMrpizza.storeMonthChannelMrpizza"] + '_' + params.startMonth + '_' + params.endMonth + '_' + getCurDateTime() +'.xlsx', function () {
                        $timeout(function () {
