                ...
                <f:form id="viewForm">
                    ...
                    <table class="searchTbl">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <%-- 사이트코드 --%>
                            <th><s:message code="storeManage.siteCd" /></th>
                            <td>
                  ...
                  <span class="chk mr10 pdb5 txtIn"><input type="checkbox" name="copyChk" id="storeEnvChk" value="storeEnv"/><%-- 매장환경 --%>
                    ...
                    <label for="touchKeyChk" ><s:message code="storeManage.touchKey" /></label>
                                        ...
                                        <span class="chk mr10 pdb5 txtIn"><input type="checkbox" name="copyChk" id="prtFormChk" value="prtForm"/><%-- 실제출력물 --%>
                    <label for="prtFormChk" ><s:message code="storeManage.prtForm" /></label>
                  </span>
...
<script type="text/javascript" src="/resource/solbipos/js/store/manage/storeManage/storeInfo.js?ver=20260109.02" charset="utf-8"></script>
