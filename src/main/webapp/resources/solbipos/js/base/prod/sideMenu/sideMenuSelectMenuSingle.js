...
app.controller('sideMenuSelectGroupSingleCtrl', ['$scope', '$http', function ($scope, $http) {
          ...
          if( ht.cellType === wijmo.grid.CellType.Cell) {
            ...
            if ( col.binding === 'sdselGrpCd') {
              if (selectedRow.sdselGrpCd !== '' && selectedRow.sdselGrpCd !== undefined && selectedRow.sdselGrpCd !== '자동채번') {
                ...
                if(brandUseFg === "1"){
                    if(orgnFg === "HQ"){
                      $("#hdSdselGrpBrandCdSingle").val(selectedRow.hqBrandCd);
                    }
                }else{
                    $("#hdSdselGrpBrandCdSingle").val("");
                }
    ...
    $scope.srchSelGroup = function(){
        ...
        if($("#txtSelGroupSingle").val() !== ""){
            if($scope.srchTypeSelGroupSingleCombo.selectedValue === "grpNm"){
                params.sdselGrpCd = "";
                params.sdselGrpNm = $("#txtSelGroupSingle").val();
            }
            else if($scope.srchTypeSelGroupSingleCombo.selectedValue === "grpCd"){
        ...
        if($("#txtSelProdSingle").val() !== ""){
            ...
            else if($scope.srchTypeSelProdSingleCombo.selectedValue === "prodCd"){
