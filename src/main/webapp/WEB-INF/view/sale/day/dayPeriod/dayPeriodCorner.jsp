    ...
    <div ng-controller="dayPeriodCornerCtrl">
        ...
        <table class="searchTbl">
            ...
            <tbody>
                <tr>
                    ...
                    <td colspan="3">
                        <div class="sb-select">
                            <span class="txtIn"> <input id="startDateDayPeriodCorner" name="startDate" class="w200px" /></span>
                            <span class="rg">~</span>
                            <span class="txtIn"> <input id="endDateDayPeriodCorner" name="endDate" class="w200px" /></span>
                        </div>
                    </td>
                </tr>
        ...
        <div class="wj-TblWrap mt20 mb20 w50 fl">
            <div class="wj-TblWrapBr mr10 pd20" style="height:470px;">
                <s:message code="dayPeriod.corner"/>
                <%-- 코너별 엑셀다운로드 --%>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/day/dayPeriod/dayPeriodCorner.js?ver=20200204.08" charset="utf-8"></script>