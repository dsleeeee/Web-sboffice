    ...
    <div ng-controller="storeSalePriceResveExcelUploadSampleCtrl">
        ...
        <div class="wj-gridWrap" style="display: none">
            <wj-flex-grid
                ...
                <wj-flex-grid-column header="<s:message code="storeSalePriceResveExcelUpload.prodCd"/>" binding="prodCd" width="100" is-read-only="true" align="center" format="@"></wj-flex-grid-column>
