      ...
      <table class="tblType01" id="tblSearchAddShow" style="display: none;">
       ...
       <tbody>
        <tr>
          ...
          <%-- 거래처 --%>
          <th <c:if test="${envst1242 == '0' or envst1242 == '2'}">style="display: none;"</c:if>><s:message code="rtnStoreOrder.dtl.vendr"/></th>
...
<script type="text/javascript" src="/resource/solbipos/js/iostock/orderReturn/rtnStoreOrder/rtnStoreOrderRegist.js?ver=20240709.01" charset="utf-8"></script>
