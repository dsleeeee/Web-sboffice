...
<div style="display: none;" ng-controller="stockExcelUploadCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/kookmin/stock/stockCmm/stockExcelUpload.js?ver=20251212.01" charset="utf-8"></script>

<%-- 공통팝업 실사/조정/폐기 엑셀업로드 에러내역 --%>
<c:import url="/WEB-INF/view/kookmin/stock/stockCmm/stockExcelUploadErrInfo.jsp">
</c:import>