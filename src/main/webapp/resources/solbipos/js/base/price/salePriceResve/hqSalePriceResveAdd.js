...
app.controller('hqSalePriceResveAddCtrl', ['$scope', '$http', function ($scope, $http) {
    ...
    $scope.saveProdPrice2 = function(){
        ...
        if($scope.addStoreSaveFgCombo.selectedValue === "choice" && $("#addChoiceSaveStoreCd").val() === "") {
        ...
        for(var i = $scope.flex.collectionView.items.length-1; i >= 0; i-- ) {
            if ($scope.flex.collectionView.items[i].gChk) {
                ...
                $scope.flex.collectionView.items[i].applyFg = $scope.addStoreSaveFgCombo.selectedValue;
                if($scope.addStoreSaveFgCombo.selectedValue === "choice") {
        ...
        if ($scope.addStoreSaveFgCombo.selectedValue !== "none") {
