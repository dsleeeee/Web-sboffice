...
/**
 * @Class Name  : NaverPlacePlusLinkVO.java
 ...
 */
public class NaverPlacePlusLinkVO extends PageVO {

    private static final long serialVersionUID = -2890014257139998448L;
    ...
    public String getNaverStoreNm() {
        return naverStoreNm;
    }

    public void setNaverStoreNm(String naverStoreNm) {
        this.naverStoreNm = naverStoreNm;
    }
