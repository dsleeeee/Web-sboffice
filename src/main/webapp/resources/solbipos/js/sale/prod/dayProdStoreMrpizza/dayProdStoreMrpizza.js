/****************************************************************
 *
 * 파일명 : dayProdStoreMrpizza.js
 * 설  명 : 미스터피자 > 상품매출분석 > 일별상품매출현황(매장별) JavaScript
 *
 ...
 *  일별상품매출현황(매장별) 그리드 생성
 */
app.controller('dayProdStoreMrpizzaCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('dayProdStoreMrpizzaCtrl', $scope, $http, false));
    ...
    $scope.$on("dayProdStoreMrpizzaCtrl", function (event, data) {

        // 일별상품매출현황(매장별) 리스트 조회
        $scope.searchDayProdStoreMrpizzaList();
    ...
    // 일별상품매출현황(매장별) 리스트 조회
    $scope.searchDayProdStoreMrpizzaList = function () {
        ...
        params.storeCds = $("#dayProdStoreMrpizzaStoreCd").val();
        params.prodCds = $("#dayProdStoreMrpizzaSelectCd").val();
        ...
        $scope._inquiryMain("/sale/prod/dayProdStoreMrpizza/dayProdStoreMrpizza/getDayProdStoreMrpizzaList.sb", params, function (){
            // <-- 그리드 visible -->
    ...
    $scope.dayProdStoreMrpizzaSelectShow = function () {
        $scope._broadcast('dayProdStoreMrpizzaSelectCtrl');
    };
    ...
    $scope.excelDownload = function (excelType) {
        ...
        $scope._popConfirm(messages["cmm.excel.totalExceDownload"], function() {
            $scope._broadcast('dayProdStoreMrpizzaExcelCtrl', params);
        });
    };
 ...
 *  엑셀다운로드 그리드 생성
 */
app.controller('dayProdStoreMrpizzaExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('dayProdStoreMrpizzaExcelCtrl', $scope, $http, false));
    ...
    // 다른 컨트롤러의 broadcast 받기
    $scope.$on("dayProdStoreMrpizzaExcelCtrl", function (event, data) {
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $scope._inquiryMain("/sale/prod/dayProdStoreMrpizza/dayProdStoreMrpizza/getDayProdStoreMrpizzaExcelList.sb", params, function() {
    ...
    $scope.searchExcelDivisionList = function (params) {
        ...
        params.limit = 1;
        params.offset = 1;
        $scope._postJSONQuery.withOutPopUp( "/sale/prod/dayProdStoreMrpizza/dayProdStoreMrpizza/getDayProdStoreMrpizzaList.sb", params, function(response){
                    ...
                    return new Promise(function(resolve, reject){
                        //setTimeout(function() {
                            ...
                            $scope._postJSONQuery.withOutPopUp("/sale/moms/prodSaleDayStoreMoms/prodSaleDayStoreMoms/getDivisionExcelDownloadSaveUpdate.sb", params, function(response){
                                ...
                                $http({
                                    method: 'POST', //방식
                                    url: '/sale/prod/dayProdStoreMrpizza/dayProdStoreMrpizza/getDayProdStoreMrpizzaList.sb', /* 통신할 URL */
