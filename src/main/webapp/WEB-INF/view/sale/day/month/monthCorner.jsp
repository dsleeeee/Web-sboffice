    ...
    <table class="searchTbl">
        ...
        <tbody>
            <tr>
                ...
                <td colspan="3">
                    <div class="sb-select">
                        <span class="txtIn"> <input id="startMonthMonthCorner" name="startDate" class="w110px" /></span>
                        <span class="rg">~</span>
                        <span class="txtIn"> <input id="endMonthMonthCorner" name="endDate" class="w110px" /></span>
                    </div>
                </td>
            </tr>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/day/month/monthCorner.js?ver=20200120.10" charset="utf-8"></script>
