package kr.co.solbipos.sale.moms.prodSalePmixStoreMoms.web;
...
/**
 * @Class Name : ProdSalePmixStoreMomsController.java
 ...
 */
@Controller
@RequestMapping("/sale/moms/prodSalePmixStoreMoms")
public class ProdSalePmixStoreMomsController {

    private final SessionService sessionService;
    private final ProdSalePmixStoreMomsService prodSalePmixStoreMomsService;
     ...
     */
    @Autowired
    public ProdSalePmixStoreMomsController(SessionService sessionService, ProdSalePmixStoreMomsService prodSalePmixStoreMomsService, CmmCodeUtil cmmCodeUtil, DayProdService dayProdService, CmmEnvUtil cmmEnvUtil) {
        this.sessionService = sessionService;
        this.prodSalePmixStoreMomsService = prodSalePmixStoreMomsService;
     ...
     * @param model
     */
    @RequestMapping(value = "/prodSalePmixStoreMoms/list.sb", method = RequestMethod.GET)
    public String prodSalePmixStoreMomsView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/moms/prodSalePmixStoreMoms/prodSalePmixStoreMoms";
    }
     ...
     * @since   2023. 12. 21.
     */
    @RequestMapping(value = "/prodSalePmixStoreMoms/getProdSalePmixStoreMomsList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getProdSalePmixStoreMomsList(ProdSalePmixStoreMomsVO prodSalePmixStoreMomsVO, HttpServletRequest request,
                                          HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = prodSalePmixStoreMomsService.getProdSalePmixStoreMomsList(prodSalePmixStoreMomsVO, sessionInfoVO);
     ...
     * @since   2023. 12. 21.
     */
    @RequestMapping(value = "/prodSalePmixStoreMoms/getProdSalePmixStoreMomsExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getProdSalePmixStoreMomsExcelList(ProdSalePmixStoreMomsVO prodSalePmixStoreMomsVO, HttpServletRequest request,
                                               HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = prodSalePmixStoreMomsService.getProdSalePmixStoreMomsExcelList(prodSalePmixStoreMomsVO, sessionInfoVO);
     ...
     * @return
     */
    @RequestMapping(value = "/prodSalePmixStoreMoms/getDateDiff.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getDateDiff(HttpServletRequest request, HttpServletResponse response, Model model, ProdSalePmixStoreMomsVO prodSalePmixStoreMomsVO) {

        List<HashMap<String, String>> list = prodSalePmixStoreMomsService.getDateDiff(prodSalePmixStoreMomsVO);
