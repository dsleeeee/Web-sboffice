...
public class TodayGnrlzController {
    ...
    public Result getTodayGnrlzPayList(HttpServletRequest request, HttpServletResponse response,
        ...
        for(int i=0; i < list.size(); i++) {
            ...
            if(sessionInfoVO.getHqOfficeCd().equals("DS021") || sessionInfoVO.getHqOfficeCd().equals("DS034") || sessionInfoVO.getHqOfficeCd().equals("H0514") || sessionInfoVO.getHqOfficeCd().equals("H0393")){
