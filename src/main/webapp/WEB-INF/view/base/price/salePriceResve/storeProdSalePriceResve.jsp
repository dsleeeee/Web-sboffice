...
<div class="subCon" id="prodSalePriceResveArea" style="padding: 10px 20px 40px;">

    <div ng-controller="storeProdSalePriceResveCtrl">
        <div class="searchBar">
        ...
        <div class="mt10 oh sb-select dkbr">
            ...
            <%-- 가격예약 --%>
            <button class="btn_skyblue ml5 fr" ng-click="addProdPrice()"><s:message code="salePriceResve.priceResve" /></button>
            <%-- 수정 --%>
            <button class="btn_skyblue ml5 fr" ng-click="saveProdPrice()"><s:message code="cmm.edit" /></button>
            <%-- 삭제 --%>
            <button class="btn_skyblue ml5 fr" ng-click="delProdPrice()"><s:message code="cmm.del" /></button>
        </div>
    ...
    <%-- 엑셀 리스트 --%>
    <div class="w100 mt10" style="display:none;" ng-controller="storeProdSalePriceResveExcelCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/base/price/salePriceResve/storeProdSalePriceResve.js?ver=20250410.01" charset="utf-8"></script>
