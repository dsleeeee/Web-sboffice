 ...
 */
public class DailyReportNewVO extends PageVO {
...
//    private String hqBrandNm;
   ...
   // private String	cfgStoreCd;
    ...
    /** 순번 check-box */
    private Boolean gChkDispSeq = false;	//gChk(Grid 공통 check-box)는 CmmVO에 있음.
    /** 순번 */
    private String	cfgDispSeq;
	...
	public Boolean getgChkDispSeq() {
		return gChkDispSeq;
	}
	public void setgChkDispSeq(Boolean gChkDispSeq) {
		this.gChkDispSeq = gChkDispSeq;
	}
	public String getCfgDispSeq() {
		return cfgDispSeq;
	}
	public void setCfgDispSeq(String cfgDispSeq) {
		this.cfgDispSeq = cfgDispSeq;
	}
