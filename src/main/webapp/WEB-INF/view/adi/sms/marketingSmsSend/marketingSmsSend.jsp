    ...
    <div class="subCon" id ="divSmsSendPage" ng-controller="marketingSmsSendCtrl">
        ...
        <table class="searchTbl" id="tblSearchAddShow" style="display: none;">
            ...
            <c:if test="${orgnFg == 'HQ'}">
                <tr>
                    <%-- 등록매장선택 --%>
                    <th><s:message code="marketingSmsSend.regStore"/></th>
                    <td colspan="3">
                        <%-- 매장선택 모듈 사용시 include --%>
                    ...
                    <%-- 사용매장선택 --%>
                    <th><s:message code="marketingSmsSend.useStore"/></th>
                    <td colspan="3">
                        <%-- 매장선택 모듈 사용시 include --%>
                        <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                            <jsp:param name="targetTypeFg" value="M"/>
...
<script type="text/javascript" src="/resource/solbipos/js/adi/sms/marketingSmsSend/marketingSmsSend.js?ver=20241209.01" charset="utf-8"></script>
