...
<div class="subCon">
    <div ng-controller="payMonthCtrl">
        ...
        <div class="searchBar flddUnfld">
            ...
            <%-- 조회 --%>
            <button class="btn_blue fr mt5 mr10" id="btnSearch" ng-click="_broadcast('payMonthCtrl',1)">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/pay/payMonth/payMonth.js?ver=20221013.01" charset="utf-8"></script>
