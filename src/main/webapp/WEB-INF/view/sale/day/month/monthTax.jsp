...
<div id="monthTaxView" name="monthView" class="subCon" style="display: none;padding: 10px 20px 40px;" ng-controller="monthTaxCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/day/month/monthTax.js?ver=20250415.01" charset="utf-8"></script>
