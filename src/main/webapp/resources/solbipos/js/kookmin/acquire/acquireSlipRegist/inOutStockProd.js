/****************************************************************
 *
 * 파일명 : inOutStockProd.js
 * 설  명 : 국민대 > 매입처관리 > 매입전표 등록 > 입고상품 팝업JavaScript
 *
...
app.controller('inOutStockProdCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('inOutStockProdCtrl', $scope, $http, true));
...
//    comboParams         = {};
    ...
    $scope.$on("inOutStockProdCtrl", function (event, data) {
        // 그리드 초기화
    ...
    $scope.procFgCheck = function () {
        ...
        $http({
            method : 'POST', //방식
            url    : '/kookmin/acquire/acquireSlipRegist/inOutStockProd/getChkProcFg.sb', /* 통신할 URL */
            ...
            // "complete" code here
            $scope.getSearchInOutStockProdList();
        });
    };


    // 상품 리스트 조회
    $scope.getSearchInOutStockProdList = function () {
        // 파라미터
        var params     = {};
        params.slipNo  = $scope.slipNo;
        params.slipFg  = $scope.slipFg;
        ...
        $scope._inquirySub("/kookmin/acquire/acquireSlipRegist/inOutStockProd/getSearchInOutStockProdList.sb", params);
    };
...
//      item.outStorageCd	= $scope.save.dtl.outStorageCd;
    ...
    $scope.addProd = function () {
        ...
        params.slipFg  = $scope.slipFg;
        params.vendrCd = $scope.vendrCd;
        $scope._broadcast('inOutStockProdRegCtrl', params);
    };
