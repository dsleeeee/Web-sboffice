...
<wj-popup id="wjStockDisuseRegistLayer" control="wjStockDisuseRegistLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:1000px;height:750px;">
    <div id="disuseRegistLayer" class="wj-dialog wj-dialog-columns" ng-controller="stockDisuseRegistCtrl">
        ...
        <div class="wj-dialog-body sc2" style="height: 700px;">
            ...
            <form name="myForm" novalidate>
                <table class="tblType01" style="position: relative;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <jsp:include page="/WEB-INF/view/kookmin/acquire/acquireSlipRegist/acquireSelectVendr.jsp" flush="true">
                                    <jsp:param name="targetId" value="stockDisuseRegistVendr"/>
                                    <jsp:param name="targetStoreCd" value="stockDisuseRegistStoreCd"/>
                            ...
                            <td colspan="2">
                                ...
                                <jsp:include page="/WEB-INF/view/kookmin/acquire/acquireSlipRegist/acquireSelectStore.jsp" flush="true">
                                    ...
                                    <jsp:param name="targetId" value="stockDisuseRegistStore"/>
                                    <jsp:param name="targetVendrCd" value="stockDisuseRegistVendrCd"/>
                                </jsp:include>
                                <%--// 매장선택 모듈 사용시 include --%>
                            </td>
                        </tr>
                        <tr>
                            <%-- 폐기제목 --%>
                            <th><s:message code="stockDisuse.reg.disuseTitle"/><em class="imp">*</em></th>
                            <td colspan="3">
                                <input type="text" id="disuseTitle" name="disuseTitle" ng-model="disuseTitle" class="sb-input w100" maxlength="33"
                                       ...
                                       uib-popover="<s:message code="stockDisuse.reg.disuseTitle"/>은(는) 필수 입력항목 입니다."/>
                            </td>
                            <th><s:message code="stockDisuse.reg.disuseReason"/></th>
                            <td>
                        ...
                        <tr>
                            <%-- 상품분류 --%>
                            <th><s:message code="stockDisuse.reg.prodClass"/></th>
                            <td>
                            ...
                            <%-- 폐기구분 --%>
                            <th><s:message code="stockDisuse.reg.disuseFg"/></th>
                            <td>
                                <div class="sb-select">
                        ...
                        <tr>
                            <td colspan="4">
                                <a href="#" class="btn_grayS" ng-click="excelTextUpload('excelFormDown')"><s:message code="stockDisuse.reg.excelFormDownload"/></a>
                                ...
                                <a href="#" class="btn_grayS" ng-click="excelTextUpload('excelUp')"><s:message code="stockDisuse.reg.excelFormUpload"/></a>
                                <%--               <a href="#" class="btn_grayS" ng-click="excelTextUpload('textUp')"><s:message code="stockDisuse.reg.textFormUpload"/></a> --%>
                                <a href="#" class="btn_grayS" ng-click="excelDownload()"><s:message code="cmm.excel.down"/></a>
                                <a href="#" class="btn_grayS" ng-click="excelUploadErrInfo()"><s:message code="stockDisuse.reg.excelFormUploadErrorInfo"/></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <table id="prodFind" class="tblType01 mt10 tc" style="position: relative;display:none;">
                ...
                <tbody>
                    <tr>
                        <%-- 상품코드/바코드 --%>
                        <th class="tc">
                            <s:message code="stockDisuse.reg.prodCd"/>/<s:message code="stockDisuse.reg.barcd"/></th>
                        <%-- 추가수량 --%>
                        <th class="tc"><s:message code="stockDisuse.reg.addQty"/></th>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <%-- 찾기 --%>
                            <a href="#" class="btn_grayS" ng-click="prodFindPop()"><s:message code="stockDisuse.reg.prodFind"/></a>
                            <span class="chk txtIn lh30 ml5" style="top: -2px;">
                                <input type="checkbox" name="autoAddChk" id="autoAddChk" ng-model="autoAddChk"/>
                                <label for="autoAddChk"><s:message code="stockDisuse.reg.autoAdd"/></label>
                            </span>
                        </td>
                        <td>
                            ...
                            <%-- 추가 --%>
                            <a href="#" class="btn_grayS" ng-click="fnAddQty()"><s:message code="stockDisuse.reg.add"/></a>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="mt10 tr">
                <div class="oh sb-select">
                    ...
                    <ul class="txtSty3">
                        <li class="red fl"><s:message code="stockDisuse.reg.txt3"/></li>
                    </ul>
            ...
            <div class="w100 mt10 mb20">
                ...
                <div class="wj-gridWrap" style="height: 400px;">
                    <wj-flex-grid
                        ...
                        <wj-flex-grid-column header="<s:message code="stockDisuse.reg.lastCostUprc"/>" binding="lastCostUprc" width="70" align="right" is-read-only="true"></wj-flex-grid-column>
                        ...
                        <wj-flex-grid-column header="<s:message code="stockDisuse.reg.disuseQty"/>" binding="disuseQty" width="70" align="right" max-length=8 data-type="Number" format="n0" aggregate="Sum"></wj-flex-grid-column>
                        ...
                        <wj-flex-grid-column header="<s:message code="stockDisuse.reg.seq"/>" binding="seq" width="0" align="center" is-read-only="true" visible="false"></wj-flex-grid-column>
            ...
            <div class="pageNum mt20">
                <%-- id --%>
                <ul id="stockDisuseRegistCtrlPager" data-size="10">
                </ul>
            </div>
            <%--//페이지 리스트--%>
        </div>
...
<script type="text/javascript" src="/resource/solbipos/js/kookmin/stock/stockDisuse/stockDisuseRegist.js?ver=20251217.01" charset="utf-8"></script>
