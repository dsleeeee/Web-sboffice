...
<div id="msgManageView" class="subCon" style="display: none;padding: 10px 20px 40px;">
...
<script type="text/javascript" src="/resource/solbipos/js/adi/sms/msgManage/msgManage.js?ver=20260112.01" charset="utf-8"></script>
