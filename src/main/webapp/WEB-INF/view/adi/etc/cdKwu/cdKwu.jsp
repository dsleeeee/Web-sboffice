...
<div class="subCon">
    ...
    <div id="gridRepresent" class="w40 mt10 fl" ng-controller="cdKwuCtrl">
        <%--위즈모 테이블--%>
    ...
    <div id="gridDetail" class="w60 mt10 fr" ng-controller="cdKwuDetailCtrl">
        <%--위즈모 테이블--%>
...
<script type="text/javascript" src="/resource/solbipos/js/adi/etc/cdKwu/cdKwu.js?ver=20260306.03" charset="utf-8"></script>