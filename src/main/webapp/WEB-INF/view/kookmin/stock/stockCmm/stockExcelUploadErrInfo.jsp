...
<wj-popup id="wjStockExcelUploadErrInfoLayer" control="wjStockExcelUploadErrInfoLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:800px;">
    <div id="excelUploadStoreErrInfoLayer" class="wj-dialog wj-dialog-columns" ng-controller="stockExcelUploadErrInfoCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/kookmin/stock/stockCmm/stockExcelUploadErrInfo.js?ver=20251212.01" charset="utf-8"></script>