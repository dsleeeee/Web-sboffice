...
app.controller('timeProdCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  ...
  angular.extend(this, new RootController('timeProdCtrl', $scope, $http, true));
  ...
  $scope.initGrid = function (s, e) {
    ...
    $scope._makePickColumns("timeProdCtrl");
    ...
    dataItem.prodNm     = messages["timeProd.prodNm"];
    dataItem.totSaleQty = messages["timeProd.totSale"];
    dataItem.totSaleAmt = messages["timeProd.totSale"];
  ...
  $scope.searchTimeProdList = function () {
    ...
    $scope._inquiryMain("/sale/time/timeProd/timeProd/getTimeProdList.sb", params);
  };
...
app.controller('timeProdExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  ...
  // 상위 객체 상속 : T/F 는 picker
  angular.extend(this, new RootController('timeProdExcelCtrl', $scope, $http, true));
  ...
  $scope.searchExcelList = function (data) {
    ...
    $scope._inquiryMain("/sale/time/timeProd/timeProd/getTimeProdExcelList.sb", params, function() {
      ...
      $timeout(function () {
        ...
        }, messages["timeProdMoms.timeProdMoms"]+getToday()+'.xlsx', function () {
          $timeout(function () {
