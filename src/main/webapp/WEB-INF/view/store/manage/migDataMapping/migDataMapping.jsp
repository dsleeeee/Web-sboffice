...
<div class="subCon" ng-controller="migDataMappingCtrl">
    ...
    <div class="mt10 oh">
        <p class="tl s14 mt5 lh15">- 단독매장만 이관 가능합니다. ( 단, 다중 사업자번호 사용매장, 회원관리 및 특수기능 사용매장은 이관에 제한이 있을 수 있습니다. )</p>
        <p class="tl s14 mt5 lh15">- 이관 대상 데이터는 매장정보, 포스정보, 상품분류정보, 상품정보, 상품가격정보, 매출일집계 입니다.</p>
        <p class="tl s14 mt5 lh15">- 신규이관요청 클릭 -> OKPOS-KCP 웹정보 로그인 아이디와 비밀번호 입력 -> 조회 -> 대상 매장 체크 -> 링크 매장환경 복사 선택 -> 이관 등록 클릭</p>
