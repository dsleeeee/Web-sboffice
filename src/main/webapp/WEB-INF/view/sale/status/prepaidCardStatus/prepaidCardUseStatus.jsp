...
<div class="subCon" id="prepaidCardUseStatusView" style="padding: 10px 20px 40px;" ng-controller="prepaidCardUseStatusCtrl">
    <div class="searchBar">
        <a href="#" class="open fl"><s:message code="prepaidCardStatus.prepaidCardUseStatus"/></a>
        <%-- 조회 --%>
        <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
            <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('prepaidCardUseStatusCtrl', 1)">
    ...
    <table class="searchTbl">
        ...
        <tr>
            ...
            <td>
                <div class="sb-select">
                    <span class="txtIn"><input id="srchStartUseDate" class="w110px"/></span>
                    <span class="rg">~</span>
                    <span class="txtIn"><input id="srchEndUseDate" class="w110px"/></span>
                </div>
            </td>
            <%-- 사용구분 --%>
            <th><s:message code="prepaidCardStatus.useFg"/></th>
            <td>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                        ...
                        <jsp:param name="targetId" value="prepaidCardUseStatusStore"/>
                    </jsp:include>
                        <%--// 매장선택 모듈 사용시 include --%>
                </td>
            </tr>
        ...
        <c:if test="${sessionInfo.orgnFg == 'STORE'}">
            <input type="hidden" id="prepaidCardUseStatusStoreCd" value="${sessionInfo.storeCd}"/>
        </c:if>
        </tbody>
    </table>
    ...
    <div class="w100 mt10">
        ...
        <div class="wj-gridWrap" style="overflow-y: hidden; overflow-x: hidden; height:500px;">
            <wj-flex-grid
                ...
                <wj-flex-grid-column header="<s:message code="prepaidCardStatus.useCnt"/>" binding="useCnt" width="100" align="center" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="prepaidCardStatus.totUseAmt"/>" binding="totUseAmt" width="120" align="center" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="prepaidCardStatus.useCancelCnt"/>" binding="useCancelCnt" width="100" align="center" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="prepaidCardStatus.totUseCancelAmt"/>" binding="totUseCancelAmt" width="120" align="center" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
    ...
    <div class="pageNum mt20">
        <%-- id --%>
        <ul id="prepaidCardUseStatusCtrlPager" data-size="10">
        </ul>
    </div>
    <%--//페이지 리스트--%>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/prepaidCardStatus/prepaidCardUseStatus.js?ver=20260408.01" charset="utf-8"></script>
