    ...
    <div class="mt10 oh sb-select dkbr">
      <%-- 분할 엑셀다운로드 --%>
        <button class="btn_skyblue ml5 fr" ng-click="excelDownload()">
          <s:message code="cmm.excel.downDivision"/>
        </button>
      <%-- 엑셀다운로드 --%>
<%--      <button class="btn_skyblue fr" ng-click="excelDownload2()">--%>
...
<%--      </button>--%>
    ...
    <div class="wj-TblWrapBr mt10">
      <div id="theGridStore" style="height: 450px; overflow-y: hidden; overflow-x: hidden;">
        <wj-flex-grid
          ...
          <!-- define columns -->
          <wj-flex-grid-column header="<s:message code="salePrice.prodCd"/>" binding="prodCd" width="100" is-read-only="true" align="center" format="d"></wj-flex-grid-column>
    ...
    <div class="w100 mt10" style="display:none;" ng-controller="storeSalePriceExcelCtrl">
      <div class="wj-gridWrap" style="height: 380px; overflow-x: hidden; overflow-y: hidden;"> <%-- 수정 사항 || 그리드 높이값 스타일 제거 :: style="height: 000px;" --%>
        <wj-flex-grid
                id="wjGridExcelList"
                autoGenerateColumns="false"
                control="excelFlex"
...
<script type="text/javascript" src="/resource/solbipos/js/base/price/storeSalePrice/storeSalePrice.js?ver=20240530.01" charset="utf-8"></script>
