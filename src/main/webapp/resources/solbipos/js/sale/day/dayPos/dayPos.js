...
app.controller('dayPosCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  ...
  // 영수증별매출상세현황 리스트 조회
  $scope.searchDayPosList = function () {
    ...
    params.storeCds     = $("#dayPosStoreCd").val();
    ...
    $.postJSON("/sale/day/dayPos/dayPos/getDayPosList.sb", params, function (response) {
      var grid = $scope.flex;
    ...
    $timeout(function () {
      wijmo.grid.xlsx.FlexGridXlsxConverter.saveAsync($scope.flex, {
        ...
        includeColumns: function (column) {
          ...
          messages["dayPos.dayPos"] + '_' + wijmo.Globalize.format(startDate.value, 'yyyyMMdd') + '_' + wijmo.Globalize.format(endDate.value, 'yyyyMMdd') + '_' + getCurDateTime() + '.xlsx', function () {
            $timeout(function () {
