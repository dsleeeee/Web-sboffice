    ...
    <table class="searchTbl">
        ...
        <tbody>
            <tr>
                ...
                <td colspan="3">
                    <div class="sb-select">
                        <span class="txtIn"> <input id="startDateDayPos" name="startDate" class="w120px" /></span>
                        <span class="rg">~</span>
                        <span class="txtIn"> <input id="endDateDayPos" name="endDate" class="w120px" /></span>
                    </div>
                </td>
            </tr>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/day/day/dayPos.js?ver=20210604.01" charset="utf-8"></script>