        ...
        <div class="wj-gridWrap" style="height:370px; overflow-y: hidden; overflow-x: hidden;">
            ...
            >
                ...
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh00" width="75" is-read-only="true"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh01" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh02" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh03" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh04" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh05" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh06" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh07" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh08" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh09" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh10" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh11" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                                     binding="makeHh112" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     binding="picHh11" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh12" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh13" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh14" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh15" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh16" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh17" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh18" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh19" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh20" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh21" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh22" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
                ...
                <wj-flex-grid-column header="<s:message code="kds.avgPicDate"/>"
                                     ...
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.totalOrderCnt"/>"
                                     binding="cntHh23" width="75" is-read-only="true"
                                     align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="kds.avgMakeDate"/>"
...
<script type="text/javascript" src="/resource/solbipos/js/kds/anals/chart/kdsDayTime.js?ver=2020070801.08"
