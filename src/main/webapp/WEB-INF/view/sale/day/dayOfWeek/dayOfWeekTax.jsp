...
<div id="dayOfWeekTaxView" name="dayOfWeekView" class="subCon" style="display: none;" ng-controller="dayOfWeekTaxCtrl">
    ...
    <table class="searchTbl">
        ...
        <tbody>
            <tr>
                ...
                <td colspan="3">
                    <div class="sb-select">
                        <span class="txtIn"> <input id="startDateDayOfWeekTax" name="startDate" class="w200px" /></span>
                        <span class="rg">~</span>
                        <span class="txtIn"> <input id="endDateDayOfWeekTax" name="endDate" class="w200px" /></span>
                    </div>
                </td>
            </tr>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/day/dayOfWeek/dayOfWeekTax.js?ver=20191119.06" charset="utf-8"></script>