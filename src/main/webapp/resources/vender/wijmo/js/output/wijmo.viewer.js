...
(function (wijmo) {
    ...
    (function (viewer) {
        ...
        }, viewer._hiddenCss = 'hidden', viewer._commandTagAttr = 'command-tag';
        ...
        viewer._hasScrollbar = _hasScrollbar;
        ...
        var _DocumentSource = /** @class */ (function () {
            ...
            _DocumentSource.prototype._rotate = function (doc, rotations) {
                ...
                for (var i = 0; i < svgs.length; i++) {
                    ...
                    svg.appendChild(g);
                    var sz = { width: new _Unit(svg.width.baseVal.value), height: new _Unit(svg.height.baseVal.value) }, szr = viewer._getRotatedSize(sz, r), section = svg.parentNode;
    ...
    (function (viewer) {
        ...
        var _ReportService = /** @class */ (function (_super) {
            ...
            _ReportService.prototype.getBookmark = function (name) {
                ...
                viewer._httpRequest(this._getReportInstancesUrl(_ReportService._bookmarkAction, name), {
                    success: function (xhr) {
                        promise.resolve(JSON.parse(xhr.responseText));
                    }
                });
            ...
            _ReportService.prototype.getStatus = function () {
                var promise = new viewer._Promise();
                viewer._httpRequest(this._statusLocation, {
                    success: function (xhr) {
            ...
            _ReportService.prototype._getReportCache = function () {
                ...
                viewer._httpRequest(this._getReportInstancesUrl(), {
                    success: function (xhr) {
            ...
            _ReportService.prototype.getParameters = function () {
                ...
                viewer._httpRequest(this._getReportInstancesUrl(_ReportService._parametersAction), {
                    success: function (xhr) {
                        promise.resolve(JSON.parse(xhr.responseText));
                    }
                });
            ...
            _ReportService.prototype.render = function (data) {
                ...
                viewer._httpRequest(this._getReportInstancesUrl(_ReportService._renderAction), {
                    method: 'POST',
                    data: data,
                    success: function (xhr) {
                        if (xhr.status === 202) {
            ...
            _ReportService.prototype.cancel = function () {
                ...
                viewer._httpRequest(this._getReportInstancesUrl(_ReportService._cancelAction), {
                    method: 'POST',
                    success: function (xhr) {
                        promise.resolve(_parseReportExecutionInfo(xhr.responseText));
                    }
            ...
            _ReportService.prototype.getOutlines = function () {
                ...
                viewer._httpRequest(this._getReportInstancesUrl(_ReportService._outlinesAction), {
                    success: function (xhr) {
                        promise.resolve(JSON.parse(xhr.responseText));
                    }
                });
            ...
            _ReportService.prototype.search = function (searchOptions) {
                ...
                viewer._httpRequest(this._getReportInstancesUrl(_ReportService._searchAction), {
                    success: function (xhr) {
                        promise.resolve(JSON.parse(xhr.responseText));
                    },
                    data: searchOptions
            ...
            _ReportService.prototype.getSupportedExportDescriptions = function () {
                ...
                viewer._httpRequest(this._getReportInstancesUrl(_ReportService._supportedFormatsAction), {
                    success: function (xhr) {
                        promise.resolve(JSON.parse(xhr.responseText));
                    }
                });
            ...
            _ReportService.prototype.getFeatures = function () {
                ...
                viewer._httpRequest(this._featuresLocation, {
                    success: function (xhr) {
                        promise.resolve(JSON.parse(xhr.responseText));
                    }
                });
    ...
    (function (viewer) {
        ...
        var _PdfDocumentService = /** @class */ (function (_super) {
            ...
            _PdfDocumentService.prototype._getPdfStatus = function (data) {
                ...
                viewer._httpRequest(this._getPdfUrl(), {
                    data: data,
                    success: function (xhr) {
            ...
            _PdfDocumentService.prototype.search = function (searchOptions) {
                ...
                viewer._httpRequest(this._getPdfUrl(_PdfDocumentService._searchAction), {
                    success: function (xhr) {
                        promise.resolve(JSON.parse(xhr.responseText));
                    },
                    data: searchOptions
...
wijmo.culture.Viewer = window['wijmo'].culture.Viewer || {
    // for ViewerBase
    cancel: 'Cancel',
    ok: 'OK',
    bottom: 'Bottom:',
    ...
    (function (viewer) {
        ...
        var _SearchManager = /** @class */ (function () {
            ...
            _SearchManager.prototype._onCurrentChanged = function () {
                this.currentChanged.raise(this, new wijmo.EventArgs());
            };
            _SearchManager.prototype._onSearchStarted = function () {
                this.searchStarted.raise(this, new wijmo.EventArgs());
            };
            _SearchManager.prototype._onSearchCompleted = function () {
                this.searchCompleted.raise(this, new wijmo.EventArgs());
            };
    ...
    (function (viewer) {
        ...
        var _PageSetupEditor = /** @class */ (function (_super) {
            ...
            function _PageSetupEditor(ele) {
                ...
                _this._numMarginsLeft = new wijmo.input.InputNumber(_this._divMarginsLeft);
                _this._numMarginsLeft.valueChanged.addHandler(_this._updateValue, _this);
                _this._numMarginsRight = new wijmo.input.InputNumber(_this._divMarginsRight);
                _this._numMarginsRight.valueChanged.addHandler(_this._updateValue, _this);
                _this._numMarginsTop = new wijmo.input.InputNumber(_this._divMarginsTop);
                _this._numMarginsTop.valueChanged.addHandler(_this._updateValue, _this);
                _this._numMarginsBottom = new wijmo.input.InputNumber(_this._divMarginsBottom);
            ...
            Object.defineProperty(_PageSetupEditor.prototype, "pageSettings", {
                ...
                set: function (pageSettings) {
                    var value = viewer._clonePageSettings(pageSettings);
            ...
            Object.defineProperty(_ExportOptionEditor.prototype, "_optionLabelsText", {
                get: function () {
                    if (!this._optionLabels) {
                        this._optionLabels = {
                            title: wijmo.culture.Viewer.docInfoTitle,
                            author: wijmo.culture.Viewer.docInfoAuthor,
                            manager: wijmo.culture.Viewer.docInfoManager,
                            operator: wijmo.culture.Viewer.docInfoOperator,
                            company: wijmo.culture.Viewer.docInfoCompany,
                            subject: wijmo.culture.Viewer.docInfoSubject,
                            comment: wijmo.culture.Viewer.docInfoComment,
                            creator: wijmo.culture.Viewer.docInfoCreator,
                            producer: wijmo.culture.Viewer.docInfoProducer,
                            creationTime: wijmo.culture.Viewer.docInfoCreationTime,
                            revisionTime: wijmo.culture.Viewer.docInfoRevisionTime,
                            keywords: wijmo.culture.Viewer.docInfoKeywords,
                            embedFonts: wijmo.culture.Viewer.embedFonts,
                            pdfACompatible: wijmo.culture.Viewer.pdfACompatible,
                            useCompression: wijmo.culture.Viewer.useCompression,
                            useOutlines: wijmo.culture.Viewer.useOutlines,
                            allowCopyContent: wijmo.culture.Viewer.allowCopyContent,
                            allowEditAnnotations: wijmo.culture.Viewer.allowEditAnnotations,
                            allowEditContent: wijmo.culture.Viewer.allowEditContent,
                            allowPrint: wijmo.culture.Viewer.allowPrint,
                            ownerPassword: wijmo.culture.Viewer.ownerPassword,
                            userPassword: wijmo.culture.Viewer.userPassword,
                            encryptionType: wijmo.culture.Viewer.encryptionType,
                            paged: wijmo.culture.Viewer.paged,
                            showNavigator: wijmo.culture.Viewer.showNavigator,
                            navigatorPosition: wijmo.culture.Viewer.navigatorPosition,
                            singleFile: wijmo.culture.Viewer.singleFile,
                            tolerance: wijmo.culture.Viewer.tolerance,
                            pictureLayer: wijmo.culture.Viewer.pictureLayer,
                            metafileType: wijmo.culture.Viewer.metafileType,
                            monochrome: wijmo.culture.Viewer.monochrome,
                            resolution: wijmo.culture.Viewer.resolution,
                            outputRange: wijmo.culture.Viewer.outputRange,
                            outputRangeInverted: wijmo.culture.Viewer.outputRangeInverted
                        };
                    }
    ...
    (function (viewer_1) {
        ...
        var _Toolbar = /** @class */ (function (_super) {
            ...
            function _Toolbar(element) {
                ...
                viewer_1._addEvent(_this._toolbarLeft, 'mouseover', function () { _this._scrollLeft(); });
                viewer_1._addEvent(_this._toolbarLeft, 'mouseout', function () { _this._clearToolbarMoveTimer(); });
                viewer_1._addEvent(_this._toolbarRight, 'mouseover', function () { _this._scrollRight(); });
                viewer_1._addEvent(_this._toolbarRight, 'mouseout', function () { _this._clearToolbarMoveTimer(); });
                return _this;
            }
            _Toolbar.prototype.applyTemplate = function (css, tpl, parts) {
                var host = this.hostElement;
                wijmo.addClass(host, css);
                host.appendChild(viewer_1._toDOMs(tpl));
            ...
            _Toolbar.prototype.addCustomItem = function (element, commandTag) {
                if (wijmo.isString(element)) {
                    element = viewer_1._toDOM(element);
                }
                if (commandTag != null) {
                    element.setAttribute(viewer_1._commandTagAttr, commandTag.toString());
                }
                this._toolbarWrapper.appendChild(element);
            };
            _Toolbar.prototype.addSvgButton = function (title, svgContent, commandTag, isToggle) {
                var _this = this;
                var button = viewer_1._createSvgBtn(svgContent);
                button.title = title;
                button.setAttribute(viewer_1._commandTagAttr, commandTag.toString());
                this._toolbarWrapper.appendChild(button);
                viewer_1._addEvent(button, 'click,keydown', function (event) {
                    var e = event || window.event, needExe = (e.type === 'keydown' && e.keyCode === wijmo.Key.Enter) || e.type === 'click';
                    if (!needExe || viewer_1._isDisabledImageButton(button) || (!isToggle && viewer_1._isCheckedImageButton(button))) {
                        return;
                    }
        ...
        var _ViewerToolbarBase = /** @class */ (function (_super) {
            ...
            _ViewerToolbarBase._initToolbarZoomValue = function (hostToolbar, viewer) {
                ...
                viewer_1._addEvent(zoomDiv, 'keypress', function (e) {
                    ...
                    if (event.keyCode === wijmo.Key.Enter) {
                        ...
                        if (!isNaN(zoomFactor)) {
                            ...
                            zoomValueCombo.text = wijmo.Globalize.format(viewer.zoomFactor, 'p0');
                        }
                    }
                });
                viewer_1._addEvent(zoomDiv.querySelector('.wj-form-control'), 'blur', function (e) {
                    zoomValueCombo.text = wijmo.Globalize.format(viewer.zoomFactor, 'p0');
                });
        ...
        var _ViewerToolbar = /** @class */ (function (_super) {
            ...
            _ViewerToolbar.prototype._initToolbarItems = function () {
                this._gPaginated = this.addSvgButton(wijmo.culture.Viewer.paginated, viewer_1.icons.paginated, viewer_1._ViewerActionType.TogglePaginated, true);
                this._gPrint = this.addSvgButton(wijmo.culture.Viewer.print, viewer_1.icons.print, viewer_1._ViewerActionType.Print);
                this._gExports = this.addSvgButton(wijmo.culture.Viewer.exports, viewer_1.icons.exports, viewer_1._ViewerActionType.ShowExportsPanel);
                this.addSeparator();
                this._gPortrait = this.addSvgButton(wijmo.culture.Viewer.portrait, viewer_1.icons.portrait, viewer_1._ViewerActionType.Portrait);
                this._gLandscape = this.addSvgButton(wijmo.culture.Viewer.landscape, viewer_1.icons.landscape, viewer_1._ViewerActionType.Landscape);
                this._gPageSetup = this.addSvgButton(wijmo.culture.Viewer.pageSetup, viewer_1.icons.pageSetup, viewer_1._ViewerActionType.ShowPageSetupDialog);
                this.addSeparator();
                this._gFirstPage = this.addSvgButton(wijmo.culture.Viewer.firstPage, viewer_1.icons.firstPage, viewer_1._ViewerActionType.FirstPage);
                this._gPreviousPage = this.addSvgButton(wijmo.culture.Viewer.previousPage, viewer_1.icons.previousPage, viewer_1._ViewerActionType.PrePage);
                this._gNextPage = this.addSvgButton(wijmo.culture.Viewer.nextPage, viewer_1.icons.nextPage, viewer_1._ViewerActionType.NextPage);
                this._gLastPage = this.addSvgButton(wijmo.culture.Viewer.lastPage, viewer_1.icons.lastPage, viewer_1._ViewerActionType.LastPage);
                _ViewerToolbarBase._initToolbarPageNumberInput(this.hostElement, this.viewer);
                this.addSeparator();
                this._gBackwardHistory = this.addSvgButton(wijmo.culture.Viewer.backwardHistory, viewer_1.icons.backwardHistory, viewer_1._ViewerActionType.Backward);
                this._gForwardHistory = this.addSvgButton(wijmo.culture.Viewer.forwardHistory, viewer_1.icons.forwardHistory, viewer_1._ViewerActionType.Forward);
                this.addSeparator();
                this._gSelectTool = this.addSvgButton(wijmo.culture.Viewer.selectTool, viewer_1.icons.selectTool, viewer_1._ViewerActionType.SelectTool);
                this._gMoveTool = this.addSvgButton(wijmo.culture.Viewer.moveTool, viewer_1.icons.moveTool, viewer_1._ViewerActionType.MoveTool);
                this._gContinuousMode = this.addSvgButton(wijmo.culture.Viewer.continuousMode, viewer_1.icons.continuousView, viewer_1._ViewerActionType.Continuous);
                this._gSingleMode = this.addSvgButton(wijmo.culture.Viewer.singleMode, viewer_1.icons.singleView, viewer_1._ViewerActionType.Single);
                this.addSeparator();
                this._gWholePage = this.addSvgButton(wijmo.culture.Viewer.wholePage, viewer_1.icons.fitWholePage, viewer_1._ViewerActionType.FitWholePage);
                this._gPageWidth = this.addSvgButton(wijmo.culture.Viewer.pageWidth, viewer_1.icons.fitPageWidth, viewer_1._ViewerActionType.FitPageWidth);
                this._gZoomOut = this.addSvgButton(wijmo.culture.Viewer.zoomOut, viewer_1.icons.zoomOut, viewer_1._ViewerActionType.ZoomOut);
                this._gZoomIn = this.addSvgButton(wijmo.culture.Viewer.zoomIn, viewer_1.icons.zoomIn, viewer_1._ViewerActionType.ZoomIn);
                //todo change rubberband icon.
                this._gRubberbandTool = this.addSvgButton(wijmo.culture.Viewer.rubberbandTool, viewer_1.icons.rubberbandTool, viewer_1._ViewerActionType.RubberbandTool);
                this._gMagnifierTool = this.addSvgButton(wijmo.culture.Viewer.magnifierTool, viewer_1.icons.magnifierTool, viewer_1._ViewerActionType.MagnifierTool);
                this._gRotateDocument = this.addSvgButton(wijmo.culture.Viewer.rotateDocument, viewer_1.icons.rotateDocument, viewer_1._ViewerActionType.RotateDocument);
                this._gRotatePage = this.addSvgButton(wijmo.culture.Viewer.rotatePage, viewer_1.icons.rotatePage, viewer_1._ViewerActionType.RotatePage);
                _ViewerToolbarBase._initToolbarZoomValue(this.hostElement, this.viewer);
                this._gFullScreen = this.addSvgButton(wijmo.culture.Viewer.fullScreen, viewer_1.icons.fullScreen, viewer_1._ViewerActionType.ToggleFullScreen, true);
            };
        ...
        var _ViewerMiniToolbar = /** @class */ (function (_super) {
            ...
            _ViewerMiniToolbar.prototype._initToolbarItems = function () {
                ...
                this._gZoomOut = this.addSvgButton(wijmo.culture.Viewer.zoomOut, viewer_1.icons.zoomOut, viewer_1._ViewerActionType.ZoomOut);
                this._gZoomIn = this.addSvgButton(wijmo.culture.Viewer.zoomIn, viewer_1.icons.zoomIn, viewer_1._ViewerActionType.ZoomIn);
                this._gExitFullScreen = this.addSvgButton(wijmo.culture.Viewer.exitFullScreen, viewer_1.icons.exitFullScreen, viewer_1._ViewerActionType.ToggleFullScreen, true);
            };
        ...
        viewer_1._ViewerMobileToolbarBase = _ViewerMobileToolbarBase;
        var _ViewerMobileToolbar = /** @class */ (function (_super) {
            ...
            _ViewerMobileToolbar.prototype._initToolbarItems = function () {
                this._gShowHamburgerMenu = this.addSvgButton(wijmo.culture.Viewer.hamburgerMenu, viewer_1.icons.hamburgerMenu, viewer_1._ViewerActionType.ShowHamburgerMenu);
                this.viewer._initHamburgerMenu(this._gShowHamburgerMenu);
                this._gPrevPage = this.addSvgButton(wijmo.culture.Viewer.previousPage, viewer_1.icons.previousPage, viewer_1._ViewerActionType.PrePage);
                this._gNextPage = this.addSvgButton(wijmo.culture.Viewer.nextPage, viewer_1.icons.nextPage, viewer_1._ViewerActionType.NextPage);
                _ViewerToolbarBase._initToolbarPageNumberInput(this.hostElement, this.viewer);
                this._gShowViewMenu = this.addSvgButton(wijmo.culture.Viewer.viewMenu, viewer_1.icons.viewMenu, viewer_1._ViewerActionType.ShowViewMenu);
                this.viewer._initViewMenu(this._gShowViewMenu);
                this._gShowSearchBar = this.addSvgButton(wijmo.culture.Viewer.showSearchBar, viewer_1.icons.search, viewer_1._ViewerActionType.ShowSearchBar, true);
                this._gFullScreen = this.addSvgButton(wijmo.culture.Viewer.fullScreen, viewer_1.icons.fullScreen, viewer_1._ViewerActionType.ToggleFullScreen, true);
            };
        ...
        viewer_1._ViewerMobileToolbar = _ViewerMobileToolbar;
        ...
        viewer_1._ViewerZoomBar = _ViewerZoomBar;
        var _SearchBar = /** @class */ (function (_super) {
            ...
            _SearchBar.prototype._initToolbarItems = function () {
                this._gSearchOptions = this.addSvgButton(wijmo.culture.Viewer.searchOptions, viewer_1.icons.searchOptions, viewer_1._ViewerActionType.ShowSearchOptions);
            ...
            _SearchBar.prototype._initSearchInput = function () {
                ...
                var searchContainerHtml = '<div class="wj-searchcontainer">' +
                    ...
                    '<button class="wj-btn wj-btn-search">' + viewer_1._createSvgBtn(viewer_1.icons.search).innerHTML + '</button>' +
                    '</div>' +
                    '</div>', searchContainer = viewer_1._toDOM(searchContainerHtml), input = searchContainer.querySelector('input[type="text"]'), searchBtn = searchContainer.querySelector('.wj-btn-search');
                viewer_1._addEvent(input, 'input', function () { _this.viewer._searchManager.text = input.value; });
                viewer_1._addEvent(searchBtn, 'click', function () { _this.viewer._searchManager.search(); });
            ...
            _SearchBar.prototype._initSearchBtnGroups = function () {
                var searchBtnGroupsHtml = '<div class="wj-searchbtn-groups wj-btn-group wj-toolbarwrapper">' +
                    '</div>', searchBtnGroups = viewer_1._toDOM(searchBtnGroupsHtml);
                this._gSearchPrev = this.addSvgButton(wijmo.culture.Viewer.searchPrev, viewer_1.icons.searchLeft, viewer_1._ViewerActionType.SearchPrev);
                this._gSearchNext = this.addSvgButton(wijmo.culture.Viewer.searchNext, viewer_1.icons.searchRight, viewer_1._ViewerActionType.SearchNext);
        ...
        viewer_1._SearchBar = _SearchBar;
    })(viewer = wijmo.viewer || (wijmo.viewer = {}));
})(wijmo || (wijmo = {}));
    ...
    (function (viewer) {
        ...
        var _Page = /** @class */ (function () {
            ...
            _Page.prototype.getContent = function () {
                var _this = this;
                var promise = new viewer._Promise(), documentSource = this._documentSource;
                if (!documentSource) {
                ...
                documentSource.renderToFilter({
                    ...
                    if (section && section.style) {
                        pageSize = { width: new viewer._Unit(section.style.width), height: new viewer._Unit(section.style.height) };
                    }
                    ...
                    if (url.indexOf('navigate') > 0) {
                        ...
                        if (result) {
                            if (result[1] && result[1].length > 0) {
                                ...
                                viewer._addEvent(a, 'click', function () { self._onLinkClicked(new viewer._LinkClickedEventArgs(this)); });
                            }
                            else {
        ...
        var _PageViewBase = /** @class */ (function (_super) {
            ...
            _PageViewBase.prototype.moveToPosition = function (position) {
                var _this = this;
                var pageIndex = position.pageIndex || 0, promise = new viewer._Promise();
        ...
        var _SinglePageView = /** @class */ (function (_super) {
            ...
            Object.defineProperty(_SinglePageView.prototype, "_hasPageVScrollBar", {
                get: function () {
                    return viewer._hasScrollbar(this._pagesContainer);
                },
                enumerable: true,
                configurable: true
            });
            Object.defineProperty(_SinglePageView.prototype, "_hasPageHScrollBar", {
                get: function () {
                    return viewer._hasScrollbar(this._pagesContainer, true);
                },
                enumerable: true,
                configurable: true
            });
            ...
            _SinglePageView.prototype._moveToPagePosition = function (position) {
                ...
                margin = position.pageBounds ? _PageViewBase._pageMargin : 0, currentPage = this.pages[this.pageIndex], offsetPoint = viewer._getTransformedPosition(bound, currentPage.size, currentPage.rotateAngle, this.zoomFactor);
        ...
        var _ContinuousPageView = /** @class */ (function (_super) {
            ...
            _ContinuousPageView.prototype._moveToPagePosition = function (position) {
                this._stopSwip();
                var pageHeight, scrollTop = 0, scrollLeft = 0, moveToPage = !position.pageBounds, bound = position.pageBounds || { x: 0, y: 0, width: 0, height: 0 }, margin = moveToPage ? 0 : _PageViewBase._pageMargin, // if navigate to page then should scroll to the top of page container
...
(function (wijmo) {
    ...
    (function (viewer_1) {
        ...
        var _ViewerMenuBase = /** @class */ (function (_super) {
            ...
            function _ViewerMenuBase(viewer, owner, options) {
                ...
                _this._viewer._viewerActionStatusChanged.addHandler(function (s, e) {
                    var actionElement = _this.dropDown.querySelector('[' + viewer_1._commandTagAttr + '="' + e.action.actionType.toString() + '"]');
            ...
            _ViewerMenuBase.prototype._internalFormatItem = function (item, itemElement) {
                ...
                viewer_1._removeChildren(itemElement);
                if (item.icon) {
                    var iconSpan = document.createElement('span');
                    iconSpan.appendChild(viewer_1._createSvgBtn(item.icon));
                    itemElement.insertBefore(iconSpan, itemElement.firstChild);
                }
                itemElement.setAttribute(viewer_1._commandTagAttr, item.commandTag.toString());
            ...
            _ViewerMenuBase.prototype._updateItemsStatus = function () {
                var elements = this.dropDown.querySelectorAll('[' + viewer_1._commandTagAttr + ']');
                for (var i = 0; i < elements.length; i++) {
                    var actionElement = elements[i], commandTagValue = actionElement.getAttribute(viewer_1._commandTagAttr);
                    if (commandTagValue == null) {
                        continue;
                    }
                    this._updateActionStatus(actionElement, parseInt(commandTagValue));
                }
                viewer_1._checkSeparatorShown(this.dropDown);
            };
        ...
        viewer_1._ViewerMenuBase = _ViewerMenuBase;
        var _HamburgerMenu = /** @class */ (function (_super) {
            ...
            _HamburgerMenu.prototype._initItems = function () {
                var items = [];
                items.push({ title: wijmo.culture.Viewer.thumbnails, icon: viewer_1.icons.thumbnails, commandTag: viewer_1._ViewerActionType.ShowThumbnails });
                items.push({ title: wijmo.culture.Viewer.outlines, icon: viewer_1.icons.outlines, commandTag: viewer_1._ViewerActionType.ShowOutlines });
                items.push({ title: wijmo.culture.Viewer.exports, icon: viewer_1.icons.exports, commandTag: viewer_1._ViewerActionType.ShowExportsPanel });
                items.push({ title: viewer_1.ViewerBase._seperatorHtml });
                items.push({ title: wijmo.culture.Viewer.portrait, icon: viewer_1.icons.portrait, commandTag: viewer_1._ViewerActionType.Portrait });
                items.push({ title: wijmo.culture.Viewer.landscape, icon: viewer_1.icons.landscape, commandTag: viewer_1._ViewerActionType.Landscape });
                items.push({ title: wijmo.culture.Viewer.pageSetup, icon: viewer_1.icons.pageSetup, commandTag: viewer_1._ViewerActionType.ShowPageSetupPanel });
                items.push({ title: viewer_1.ViewerBase._seperatorHtml });
                items.push({ title: wijmo.culture.Viewer.showZoomBar, icon: viewer_1.icons.showZoomBar, commandTag: viewer_1._ViewerActionType.ShowZoomBar });
                items.push({ title: viewer_1.ViewerBase._seperatorHtml });
                items.push({ title: wijmo.culture.Viewer.paginated, icon: viewer_1.icons.paginated, commandTag: viewer_1._ViewerActionType.TogglePaginated });
                items.push({ title: wijmo.culture.Viewer.print, icon: viewer_1.icons.print, commandTag: viewer_1._ViewerActionType.Print });
                items.push({ title: viewer_1.ViewerBase._seperatorHtml });
                items.push({ title: wijmo.culture.Viewer.backwardHistory, icon: viewer_1.icons.backwardHistory, commandTag: viewer_1._ViewerActionType.Backward });
                items.push({ title: wijmo.culture.Viewer.forwardHistory, icon: viewer_1.icons.forwardHistory, commandTag: viewer_1._ViewerActionType.Forward });
                return items;
            };
            return _HamburgerMenu;
        }(_ViewerMenuBase));
        viewer_1._HamburgerMenu = _HamburgerMenu;
        var _ViewMenu = /** @class */ (function (_super) {
            ...
            _ViewMenu.prototype._initItems = function () {
                var items = [];
                items.push({ title: wijmo.culture.Viewer.singleMode, icon: viewer_1.icons.singleView, commandTag: viewer_1._ViewerActionType.Single });
                items.push({ title: wijmo.culture.Viewer.continuousMode, icon: viewer_1.icons.continuousView, commandTag: viewer_1._ViewerActionType.Continuous });
                items.push({ title: viewer_1.ViewerBase._seperatorHtml });
                items.push({ title: wijmo.culture.Viewer.wholePage, icon: viewer_1.icons.fitWholePage, commandTag: viewer_1._ViewerActionType.FitWholePage });
                items.push({ title: wijmo.culture.Viewer.pageWidth, icon: viewer_1.icons.fitPageWidth, commandTag: viewer_1._ViewerActionType.FitPageWidth });
                return items;
            };
            return _ViewMenu;
        }(_ViewerMenuBase));
        viewer_1._ViewMenu = _ViewMenu;
        var _SearchOptionsMenu = /** @class */ (function (_super) {
            ...
            _SearchOptionsMenu.prototype._initItems = function () {
                var items = [];
                items.push({ title: wijmo.culture.Viewer.wholeWordMenuItem, commandTag: viewer_1._ViewerActionType.SearchMatchWholeWord });
                items.push({ title: wijmo.culture.Viewer.matchCaseMenuItem, commandTag: viewer_1._ViewerActionType.SearchMatchCase });
                return items;
            };
        ...
        viewer_1._SearchOptionsMenu = _SearchOptionsMenu;
    })(viewer = wijmo.viewer || (wijmo.viewer = {}));
})(wijmo || (wijmo = {}));
        ...
        */
        ...
        var ViewerBase = /** @class */ (function (_super) {
            ...
            function ViewerBase(element, options) {
                 ...
                 */
                _this.selectMouseModeChanged = new wijmo.Event();
                /**
            ...
            ViewerBase.prototype._initSidePanelExports = function () {
                ...
                exportsPage.format(function (t) {
                    var settingsHtml = '<div class="wj-exportcontainer">' +
                        ...
                        '</div>', settingsElement = viewer._toDOMs(settingsHtml), searchResults;
                    t.outContent.querySelector('.wj-tabtitle-wrapper').appendChild(settingsElement);
                    ...
                    var footerHtml = '<div class="wj-exportformats-footer">' +
                        '<a wj-part="btn-apply" href="javascript:void(0)" tabindex="-1" draggable="false">' + wijmo.culture.Viewer.exportOk + '</a>' +
                        '</div>';
            ...
            ViewerBase.prototype._initSidePanelPageSetup = function () {
                ...
                pageSetupPage.format(function (t) {
                    ...
                    var footerHtml = '<div class="wj-pagesetup-footer">' +
                        '<a wj-part="btn-apply" href="javascript:void(0)" tabindex="-1" draggable="false">' + wijmo.culture.Viewer.ok + '</a>' +
                        '</div>';
                    var footerElement = viewer._toDOMs(footerHtml);
                    t.content.appendChild(footerElement);
                    var applyBtn = t.content.querySelector('[wj-part="btn-apply"]');
            ...
            ViewerBase.prototype._executeAction = function (action) {
                ...
                switch (action) {
                    ...
                    case _ViewerActionType.Continuous:
                        this._addHistory(false, true); // Is it necessary? (#294064)
            ...
            ViewerBase.prototype._hyperlinkClicked = function (a) {
                var bookmarkAttr = a.getAttribute(viewer._Page._bookmarkAttr);
                if (bookmarkAttr) {
                    this._goToBookmark(bookmarkAttr);
                    return;
                }
                var customActionAttr = a.getAttribute(viewer._Page._customActionAttr);
                if (customActionAttr) {
            ...
            ViewerBase.prototype._onDocumentSourceLoadCompleted = function () {
                ...
                if (this._documentSource.isLoadCompleted) {
                    ...
                    for (var i = 0; i < this._documentSource.pageCount; i++) {
                        var page = new viewer._Page(this._documentSource, i, defaultPageSize);
            ...
            Object.defineProperty(ViewerBase.prototype, "selectMouseMode", {
                ...
                */
                ...
                set: function (value) {
                    wijmo._deprecated('selectMouseMode', 'mouseMode');
            ...
            ViewerBase.prototype.onPageIndexChanged = function (e) {
                this.pageIndexChanged.raise(this, e || new wijmo.EventArgs());
                this._updatePageNavActions();
            };
            /**
            ...
            ViewerBase.prototype.onMouseModeChanged = function (e) {
                this.mouseModeChanged.raise(this, e || new wijmo.EventArgs());
    ...
    (function (viewer_1) {
        ...
        var ReportViewer = /** @class */ (function (_super) {
            ...
            ReportViewer.getReportNames = function (serviceUrl, reportFilePath) {
                return viewer_1._Report.getReportNames(serviceUrl, reportFilePath);
            };
            /**
            ...
            ReportViewer.getReports = function (serviceUrl, path, data) {
                return viewer_1._Report.getReports(serviceUrl, path, data);
            };
            ...
            ReportViewer.prototype._initSidePanelParameters = function () {
                var _this = this;
                var sideTabs = wijmo.Control.getControl(this._sidePanel), page = sideTabs.addPage(wijmo.culture.Viewer.parameters, parametersIcon, 2);
                ...
                page.format(function (t) {
                    ...
                    _this._paramsEditor.commit.addHandler(function () {
                        ...
                        _this._innerDocumentSource.setParameters(_this._paramsEditor.parameters).then(function (v) {
                            ...
                            _this._showViewPanelErrorMessage(viewer_1._getErrorMessage(reason));
                        });
                        if (_this._isMobileTemplate()) {
                            sideTabs.collapse();
                        }
                    ...
                    var updateParametersPanel = function () {
                        ...
                        if (documentSource.status === viewer_1._ExecutionStatus.cleared ||
                            documentSource.status === viewer_1._ExecutionStatus.notFound) {
                            viewer_1._removeChildren(t.content);
                        }
                        else if (documentSource.status === viewer_1._ExecutionStatus.rendering) {
                            _this._paramsEditor.isDisabled = true;
                        }
                        else if (documentSource.status === viewer_1._ExecutionStatus.completed) {
                            _this._paramsEditor.isDisabled = false;
                        }
                        if (documentSource.status !== viewer_1._ExecutionStatus.loaded) {
                            return;
                        }
                        ...
                        viewer_1._addWjHandler(_this._documentEventKey, _this._innerDocumentSource.statusChanged, updateParametersPanel);
            ...
            ReportViewer.prototype._loadDocument = function (value) {
                ...
                if (value && isChanged) {
                    viewer_1._addWjHandler(this._documentEventKey, value.statusChanged, this._onDocumentStatusChanged, this);
                }
                return promise;
            };
            ...
            ReportViewer.prototype._onDocumentStatusChanged = function () {
                if (!this._innerDocumentSource
                    || this._innerDocumentSource.status !== viewer_1._ExecutionStatus.loaded
            ...
            ReportViewer.prototype._disposeDocument = function () {
                if (this._innerDocumentSource) {
                    viewer_1._removeAllWjHandlers(this._documentEventKey, this._innerDocumentSource.statusChanged);
                }
                _super.prototype._disposeDocument.call(this);
            };
            ReportViewer.prototype._setDocumentRendering = function () {
                this._innerDocumentSource._updateStatus(viewer_1._ExecutionStatus.rendering);
        ...
        viewer_1.ReportViewer = ReportViewer;
        var _ParametersEditor = /** @class */ (function (_super) {
            ...
            _ParametersEditor.prototype._render = function () {
                ...
                viewer_1._removeChildren(this.hostElement, function (e) {
                ...
                this._itemSources.forEach(function (p) {
                    ...
                    if (wijmo.isArray(p.allowedValues)) {
                        ...
                        switch (p.dataType) {
                            case viewer_1._ParameterType.Boolean:
                                parameterControl = _this._generateBoolEditor(p);
                                break;
                            case viewer_1._ParameterType.DateTime:
                            case viewer_1._ParameterType.Time:
                            case viewer_1._ParameterType.Date:
                                parameterControl = _this._generateDateTimeEditor(p);
                                break;
                            case viewer_1._ParameterType.Integer:
                            case viewer_1._ParameterType.Float:
                                parameterControl = _this._generateNumberEditor(p);
                                break;
                            case viewer_1._ParameterType.String:
                ...
                viewer_1._addEvent(applyBtn, 'click', function () {
            ...
            _ParametersEditor.prototype._generateBoolEditor = function (parameter) {
                ...
                if (parameter.nullable) {
                    ...
                    viewer_1._addEvent(element, 'click', function () {
            ...
            _ParametersEditor.prototype._createTextarea = function (value, dataType) {
                ...
                if (dataType === viewer_1._ParameterType.DateTime || dataType === viewer_1._ParameterType.Time || dataType === viewer_1._ParameterType.Date) {
            ...
            _ParametersEditor.prototype._bindTextChangedEvent = function (element, parameter) {
                var _this = this;
                viewer_1._addEvent(element, 'change,keyup,paste,input', function () {
            ...
            _ParametersEditor.prototype._generateNumberEditor = function (parameter) {
                ...
                if (parameter.multiValue) {
                    ...
                    element = document.createElement('div');
                    inputNumber = new wijmo.input.InputNumber(element);
                    inputNumber.format = parameter.dataType === viewer_1._ParameterType.Integer ? 'n0' : 'n2';
                    inputNumber.isRequired = !parameter.nullable;
                    if (parameter.value) {
                        inputNumber.value = parameter.dataType === viewer_1._ParameterType.Integer ? parseInt(parameter.value) : parseFloat(parameter.value);
                    }
                    inputNumber.valueChanged.addHandler(function (sender) {
            ...
            _ParametersEditor.prototype._generateDateTimeEditor = function (parameter) {
                ...
                if (parameter.multiValue) {
                    ...
                    element = document.createElement('div');
                    if (parameter.dataType == viewer_1._ParameterType.Date) {
                        input = new wijmo.input.InputDate(element);
                    }
                    else {
                        if (parameter.dataType == viewer_1._ParameterType.DateTime) {
                    ...
                    if (parameter.value != null) {
                        ...
                        input.value = null; // to display blank value instead of current date.
                    }
        ...
        viewer_1._ParametersEditor = _ParametersEditor;
        ...
        viewer_1._MultiSelectEx = _MultiSelectEx;
        ...
        }(viewer_1._HamburgerMenu));
        viewer_1._ReportHamburgerMenu = _ReportHamburgerMenu;
    })(viewer = wijmo.viewer || (wijmo.viewer = {}));
})(wijmo || (wijmo = {}));
