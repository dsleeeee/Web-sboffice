...
<!-- contents start -->
<div class="subCon" ng-controller="mobileHqDayIoStockCtrl">

    <div class="searchBar flddUnfld">
        <a href="#" class="open fl">${menuNm}</a>
        <%-- 조회 --%>
        <button class="btn_blue fr mt5 mr10" id="btnSearch" ng-click="_broadcast('mobileHqDayIoStockMainCtrlSrch')">
        ...
        <tr style="display: none">
            ...
            <td style="display: none">
                ...
                <jsp:include page="/WEB-INF/view/iostock/cmm/selectVendrM.jsp" flush="true">
                    <jsp:param name="targetId" value="mobileHqDayIoStockSelectVendr"/>
                </jsp:include>
                <input type="hidden" id="mobileHqDayIoStockSelectVendrCd" value=""/>
            </td>
        </tr>
        <tr>
            <%-- 기초/마감재고표시 --%>
    ...
    <div ng-controller="mobileHqDayIoStockMainCtrl">
        ...
        <div class="w100 mt10" id="wjWrapType2">
            <div class="wj-gridWrap" style="height: 360px; overflow-x: hidden; overflow-y: hidden;">
                <wj-flex-grid
                    ...
                    <div class="gridMsg" id="mobileHqDayIoStockMsg" style="line-height: 150px; display: none;"><s:message code="mobile.cmm.search.result.empty"/></div>
                </wj-flex-grid>
                <%-- ColumnPicker 사용시 include --%>
                <jsp:include page="/WEB-INF/view/layout/columnPicker.jsp" flush="true">
                    <jsp:param name="pickerTarget" value="mobileHqDayIoStockMainCtrl"/>
                </jsp:include>
                <%--// ColumnPicker 사용시 include --%>
            </div>
            <%-- 페이지 리스트 --%>
            <div class="pageNum3 mt20">
                <%-- id --%>
                <ul id="mobileHqDayIoStockMainCtrlPager" data-size="10">
                </ul>
            </div>
            <%--//페이지 리스트--%>

            <%-- 엑셀 리스트 --%>
            <div class="w100 mt10" id="wjWrapType3" style="display:none;" ng-controller="mobileHqDayIoStockMainExcelCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/mobile/stock/status/dayIoStock/mobileHqDayIoStock.js?ver=20240719.01" charset="utf-8"></script>
