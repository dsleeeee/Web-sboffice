/****************************************************************
 *
 * 파일명 : monthProdStoreMrpizza.js
 * 설  명 : 미스터피자 > 상품매출분석 > 월별상품매출현황(매장별) JavaScript
 *
 ...
 *  월별상품매출현황(매장별) 그리드 생성
 */
app.controller('monthProdStoreMrpizzaCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('monthProdStoreMrpizzaCtrl', $scope, $http, false));
    ...
    $scope.$on("monthProdStoreMrpizzaCtrl", function (event, data) {

        // 월별상품매출현황(매장별) 리스트 조회
        $scope.searchMonthProdStoreMrpizzaList();
    ...
    // 월별상품매출현황(매장별) 리스트 조회
    $scope.searchMonthProdStoreMrpizzaList = function () {
        ...
        params.prodClassCd = $("#monthProdStoreMrpizzaSelectClassCd").val();
        params.prodCd = $scope.prodCd;
        params.prodNm = $scope.prodNm;
        /*params.storeHqBrandCd = $scope.storeHqBrandCd;*/
        params.storeCds = $("#monthProdStoreMrpizzaStoreCd").val();
        params.prodCds = $("#monthProdStoreMrpizzaSelectCd").val();
        ...
        $scope._inquiryMain("/sale/prod/monthProdStoreMrpizza/monthProdStoreMrpizza/getMonthProdStoreMrpizzaList.sb", params, function (){
            // <-- 그리드 visible -->
    ...
    $scope.monthProdStoreMrpizzaSelectShow = function () {
        $scope._broadcast('monthProdStoreMrpizzaSelectCtrl');
    };
    ...
    $scope.excelDownload = function (excelType) {
        ...
        $scope._popConfirm(messages["cmm.excel.totalExceDownload"], function() {
            $scope._broadcast('monthProdStoreMrpizzaExcelCtrl', params);
        });
    };
 ...
 *  엑셀다운로드 그리드 생성
 */
app.controller('monthProdStoreMrpizzaExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('monthProdStoreMrpizzaExcelCtrl', $scope, $http, false));
    ...
    // 다른 컨트롤러의 broadcast 받기
    $scope.$on("monthProdStoreMrpizzaExcelCtrl", function (event, data) {
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $scope._inquiryMain("/sale/prod/monthProdStoreMrpizza/monthProdStoreMrpizza/getMonthProdStoreMrpizzaExcelList.sb", params, function () {
    ...
    $scope.searchExcelDivisionList = function (params) {
        ...
        params.limit = 1;
        params.offset = 1;
        $scope._postJSONQuery.withOutPopUp("/sale/prod/monthProdStoreMrpizza/monthProdStoreMrpizza/getMonthProdStoreMrpizzaList.sb", params, function (response) {
                ...
                function delay(x) {
                    return new Promise(function (resolve, reject) {
                        ...
                        $scope._postJSONQuery.withOutPopUp("/sale/moms/prodSaleDayStoreMoms/prodSaleDayStoreMoms/getDivisionExcelDownloadSaveUpdate.sb", params, function (response) {
                            ...
                            $http({
                                method: 'POST', //방식
                                url: '/sale/prod/monthProdStoreMrpizza/monthProdStoreMrpizza/getMonthProdStoreMrpizzaList.sb', /* 통신할 URL */
