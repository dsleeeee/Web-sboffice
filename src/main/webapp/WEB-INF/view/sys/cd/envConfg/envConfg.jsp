...
<div class="subCon">
    ...
    <div ng-controller="representCtrl">
        <div class="searchBar">
        ...
        <div>
            ...
            <div class="ml10 mt10 oh">
                <div class="mt10"><span style="color:#ff0000;"><b><s:message code="systemCd.prefixInfo"/></b></span>
                </div>
...
<script type="text/javascript" src="/resource/solbipos/js/sys/cd/envConfg/envConfg.js?ver=20240402.01" charset="utf-8"></script>
