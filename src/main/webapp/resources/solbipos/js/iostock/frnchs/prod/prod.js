...
app.controller('prodExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  // 상위 객체 상속 : T/F 는 picker
  angular.extend(this, new RootController('prodExcelCtrl', $scope, $http, true));
...
//다른 컨트롤러의 broadcast 받기
  $scope.$on("prodExcelCtrl", function (event, data) {
  ...
  $scope.searchProdList = function (isPageChk) {
    ...
    // 조회 수행 : 조회URL, 파라미터, 콜백함수
    $scope._inquirySub("/iostock/frnchs/prod/prod/excelList.sb", params, function() {
