    ...
    <div ng-controller="hqSalePriceResveExcelUploadSampleCtrl">
        ...
        <div class="wj-gridWrap" style="display: none">
            <wj-flex-grid
                ...
                <!-- define columns -->
                <wj-flex-grid-column header="<s:message code="hqSalePriceResveExcelUpload.prodCd"/>" binding="prodCd" width="100" is-read-only="true" align="center" format="@"></wj-flex-grid-column>
