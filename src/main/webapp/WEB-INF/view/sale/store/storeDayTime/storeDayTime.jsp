...
<div class="subCon" ng-controller="storeDayTimeCtrl">
    ...
    <table class="searchTbl">
        ...
        <tr>
            ...
            <%-- 매장선택 --%>
            <th class="dayTimeStore" style="display: none; <c:if test="${hqOfficeCd == 'H0614' or hqOfficeCd == 'H0616'}">border-left:1px solid #ccc</c:if>"><s:message code="cmm.store.select"/></th>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/store/storeDayTime/storeDayTime.js?ver=20240530.01" charset="utf-8"></script>
