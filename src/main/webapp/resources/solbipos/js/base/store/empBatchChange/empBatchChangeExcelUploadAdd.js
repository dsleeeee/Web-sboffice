/****************************************************************
 *
 * 파일명 : empBatchChangeExcelUploadAdd.js
 * 설  명 : 사원엑셀업로드 팝업 JavaScript
 *
...
app.controller('storeExcelUploadAddCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.save = function (jsonData) {
        ...
        // 업로드시 임시테이블 저장
        $scope._postJSONSave.withOutPopUp("/base/store/empBatchChange/empBatchChange/getEmpExcelUploadCheckSave.sb", jsonData, function () {
