package kr.co.solbipos.sale.store.storeDayPos.web;
...
@Controller
@RequestMapping("/sale/store/storeDayPos")
public class StoreDayPosController {
    private final DayService dayService;
    private final TodayDtlService todayDtlService;
    private final SessionService sessionService;
    private final StoreDayPosService storeDayPosService;
    private final StoreChannelService storeChannelService;
    private final DayProdService dayProdService;
    private final CmmCodeUtil cmmCodeUtil;

    @Autowired
    public StoreDayPosController(DayService dayService, TodayDtlService todayDtlService, SessionService sessionService, StoreDayPosService storeDayPosService, StoreChannelService storeChannelService, DayProdService dayProdService, CmmCodeUtil cmmCodeUtil) {
        this.dayService = dayService;
        this.todayDtlService = todayDtlService;
        this.sessionService = sessionService;
        this.storeDayPosService = storeDayPosService;
     ...
     * @since   2023.03.14
     */
    @RequestMapping(value = "/storeDayPos/view.sb", method = RequestMethod.GET)
    public String empMonthView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/store/storeDayPos/storeDayPos";
    }
     ...
     * @since   2023.03.14
     */
    @RequestMapping(value = "/storeDayPos/getDayList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getDayList(HttpServletRequest request, HttpServletResponse response,
                             Model model, StoreDayPosVO storeDayPosVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<String>> list = storeDayPosService.getDayList(storeDayPosVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, list, storeDayPosVO);
    }
     ...
     * @since   2023.03.14
     */
    @RequestMapping(value = "/storeDayPos/getDayExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getDayExcelList(HttpServletRequest request, HttpServletResponse response,
        ...
        List<DefaultMap<String>> list = storeDayPosService.getDayExcelList(storeDayPosVO, sessionInfoVO);
