...
/** 현금영수증 승인 controller */
app.controller('prodRankStoreCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  // 상위 객체 상속 : T/F 는 picker
  angular.extend(this, new RootController('prodRankStoreCtrl', $scope, $http, true));
  ...
  $scope.initGrid = function (s, e) {
    ...
    $scope._makePickColumns("prodRankStoreCtrl");
  ...
  $scope.$on("prodRankStoreCtrl", function (event, data) {
...
app.controller('prodRankStoreExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

  // 상위 객체 상속 : T/F 는 picker
  angular.extend(this, new RootController('prodRankStoreExcelCtrl', $scope, $http, true));
  ...
  // 다른 컨트롤러의 broadcast 받기
  $scope.$on("prodRankStoreExcelCtrl", function (event, data) {
  ...
  $scope.searchExcelList = function (data) {
    ...
    $scope._inquiryMain("/sale/prod/prodRankStore/prodRankStore/getProdRankStoreExcelList.sb", params, function() {
      ...
      $timeout(function () {
        ...
        }, messages["prodRankStoreMoms.prodRankStoreMoms"]+getToday()+'.xlsx', function () {
          $timeout(function () {
