...
<div class="subCon" ng-controller="monthProdSaleRateMomsCtrl">
    <div class="searchBar">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/prod/monthProdSaleRateMoms/monthProdSaleRateMoms.js?ver=20230703.01" charset="utf-8"></script>