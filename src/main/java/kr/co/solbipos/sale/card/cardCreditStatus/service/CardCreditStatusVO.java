...
/**
 * @Class Name : CardCreditStatusVO.java
 ...
 */
public class CardCreditStatusVO extends PageVO {
    ...
    public String getCreditFg() { return creditFg; }

    public void setCreditFg(String creditFg) { this.creditFg = creditFg; }
