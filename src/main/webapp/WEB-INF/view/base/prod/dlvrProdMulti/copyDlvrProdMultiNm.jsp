...
<wj-popup control="copyDlvrProdMultiNmLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:600px;">
    <div class="wj-dialog wj-dialog-columns title" ng-controller="copyDlvrProdMultiNmCtrl">
        ...
        <div class="wj-dialog-body">
            ...
            <div class="searchBar_s">
                <a href="#" class="open"><s:message code="dlvrProdMulti.selectStore" /></a><!--하단 검색테이블 열기 .open, 하단 검색테이블 닫기 .close-->
                <p class="noFolding" style="display:none;"><s:message code="dlvrProdMulti.selectStore" /></p><!-- 접기기능 사용하지 않을경우 -->
            </div>
            <div class="tblBr mb40" >
                <table class="tblType01">
                    ...
                    <!-- 기준매장 -->
                    <tr>
                        <th><s:message code="dlvrProdMulti.original.storeCd" /></th>
                        <td>
                    ...
                    <!-- 적용대상매장 -->
                    <tr>
                        <th><s:message code="dlvrProdMulti.target.storeCd" /></th>
                        <td>
                            <!-- 본사권한은 전매장에 복사가능 -->
                            <c:if test="${orgnFg == 'HQ'}">
                    ...
                    <tr>
                        <td colspan="2">
                            <p class="s12 bk mt10 lh20">
                                <s:message code="dlvrProdMulti.selectMsg" /><br />
                                <s:message code="dlvrProdMulti.selectMsg2" /><br />
                            </p>
                        </td>
                    </tr>
                    </tbody>
...
<script type="text/javascript" src="/resource/solbipos/js/base/prod/dlvrProdMulti/copyDlvrProdMultiNm.js?ver=20240130.01" charset="utf-8"></script>
