...
!function (t) {
  ...
  function l(e, r, i) {
    if (null != e) {
      ...
      if (r == P.String) return t.Globalize.format(e, i)
    }
    return e
  }
  ...
  !function (t) {
  ...
  }(P = t.DataType || (t.DataType = {})), t.tryCast = e, t.isPrimitive = function (t) {
    ...
    if (t.touches && t.touches.length > 0 && (t = t.touches[0]), r(t.clientX) && r(t.clientY)) return new M(t.clientX + pageXOffset, t.clientY + pageYOffset);
    throw "Mouse or touch event expected."
  }, t.getType = function (t) {
    return r(t) ? P.Number : o(t) ? P.Boolean : a(t) ? P.Date : n(t) ? P.String : u(t) ? P.Array : P.Object
    ...
    var i = e[t];
    return p(null != i, "Invalid enum value."), r(i) ? i : t
  ...
  t.hasClass = _, t.addClass = v, t.removeClass = y, t.toggleClass = b, t.setAttribute = C, t.setAriaLabel = function (t, e) {
    ...
    if (void 0 === r && (r = n), p(e instanceof HTMLInputElement || e instanceof HTMLTextAreaElement, "INPUT or TEXTAREA element expected"), x(document.body, e) && !e.disabled && "none" != e.style.display) try {
    ...
    void 0 === n && (n = t.Control._ANIM_DEF_DURATION), void 0 === r && (r = t.Control._ANIM_DEF_STEP), e = m(e), n = d(n, !1, !0), r = d(r, !1, !0);
    var i, o = Date.now(),
  ...
  var D = function () {
    ...
    return Object.defineProperty(t.prototype, "right", {
      ...
      if (e instanceof M) return e.x >= this.left && e.x <= this.right && e.y >= this.top && e.y <= this.bottom;
      if (e instanceof t) {
        var n = e;
...
!function (t) {
  ...
  var e = function () {
    ...
    return e.format = function (n, r, i, o) {
      ...
      if ("p" == c && (n = e._mul100(n), n = t.toFixed(n, l, o)), o && "p" != c && (n = t.toFixed(n, l, !0)), s = e._toFixedStr("c" == c || "p" == c ? Math.abs(n) : n, l), (i || "g" == c) && s.indexOf(".") > -1 && (s = (s = s.replace(/(\.[0-9]*?)0+$/g, "$1")).replace(/\.$/, "")), "." != p && (s = s.replace(".", p)), "-" != d && (s = s.replace("-", d)), f && ("n" == c || "c" == c || "p" == c)) {
        var g = s.indexOf(p),
          m = /\B(?=(\d\d\d)+(?!\d))/g;
      ...
      for (var T = 0; T < v.length && _; T++) {
        ...
        switch (v[T]) {
          ...
          case "yy":
          case "y":
            M > 1 && I.length > M && (_[P] = I.substr(M), I = I.substr(0, M), y++), b = parseInt(I), p = 4 == I.length;
            break;
          case "MMMM":
          case "MMM":
            h = !0;
            ...
            C = -1;
            for (var D = 0; D < 12; D++)
              if (0 == d.months[D].toLowerCase().indexOf(F)) {
                C = D;
                break
              }
            if (C > -1) break;
          case "MM":
          case "M":
            h = !0, M > 1 && I.length > M && (_[P] = I.substr(M), I = I.substr(0, M), y++), C = parseInt(I) - 1;
            break;
          case "dddd":
          case "ddd":
            u = !0;
          ...
          case "dd":
          case "d":
            M > 1 && I.length > M && (_[P] = I.substr(M), I = I.substr(0, M), y++), w = parseInt(I), c = !0;
            break;
          case "hh":
          case "h":
            M > 1 && I.length > M && (_[P] = I.substr(M), I = I.substr(0, M), y++), E = 12 == (E = parseInt(I)) ? 0 : E;
            break;
          case "HH":
            M > 1 && I.length > M && (_[P] = I.substr(M), I = I.substr(0, M), y++), E = parseInt(I);
            break;
          case "H":
            E = parseInt(I);
            break;
          case "mm":
          case "m":
            M > 1 && I.length > M && (_[P] = I.substr(M), I = I.substr(0, M), y++), A = parseInt(I);
            break;
          case "ss":
          case "s":
            M > 1 && I.length > M && (_[P] = I.substr(M), I = I.substr(0, M), y++), x = parseInt(I);
            break;
          case "fffffff":
          case "FFFFFFF":
          case "ffffff":
          ...
          case "f":
          case "F":
            S = parseInt(I) / Math.pow(10, M - 3);
            break;
          case "tt":
          case "t":
            I = I.toUpperCase(), E < 12 && d.pm.indexOf(I) > -1 && (E += 12);
            break;
          case "q":
          case "Q":
          case "u":
          ...
          case "gg":
          case "g":
            O = d.eras.length > 1 ? e._getEra(I, d) : -1;
            break;
          case d["/"]:
          case d[":"]:
            if (I && I != v[T]) return null;
            break;
          case "K":
            break;
          default:
            e._unquote(v[T]).trim() != I.trim() && y++
        }
      }
      ...
      if (u && !c) return null;
      if (l && !h) return null;
      if (b < 0 && (b = t.isDate(i) ? i.getFullYear() : (new Date).getFullYear()), O > -1) b = b + d.eras[O].start.getFullYear() - 1;
      else if (b < 100 && !p) {
      ...
      switch (i) {
        ...
        case "gg":
        case "g":
          return s.eras.length > 1 && (a = e._getEra(n, s)) > -1 ? "ggg" == i ? s.eras[a].name : "gg" == i ? s.eras[a].name[0] : s.eras[a].symbol : s.eras[0];
        case ":":
        case "/":
          return s[i];
        case "K":
        ...
        case "z":
          ...
          switch (i) {
            case "zzz":
              d = e.format(f / 60, "d2", !1, !0) + s[":"] + e.format(f % 60, "d2", !1, !0);
              break;
            case "zz":
              d = e.format(f / 60, "d2", !1, !0);
              break;
            case "z":
              d = e.format(f / 60, "d", !1, !0)
          }
          return f >= 0 ? "+" + d : d
      }
...
!function (t) {
  ...
  var o = function (e) {
    function n(r, i, o) {
      ...
      s._pristine = !0, s._focus = !1, s._updating = 0, s._fullUpdate = !1, s.gotFocus = new t.Event, s.lostFocus = new t.Event, s.refreshing = new t.Event, s.refreshed = new t.Event, s._updateWme(), t.assert(null == n.getControl(r), "Element is already hosting a control.");
      var a = t.getElement(r);
      if (t.assert(null != a, "Cannot find the host element."), s._orgTabIndex = a.hasAttribute("tabindex") ? a.tabIndex : 0, s._orgOuter = a.outerHTML, s._orgTag = a.tagName, s._orgAtts = a.attributes, "INPUT" != a.tagName && "SELECT" != a.tagName || (a = s._replaceWithDiv(a)), s._e = a, a[n._CTRL_KEY] = s, 1 == o) {
        s._szCtl = new t.Size(a.offsetWidth, a.offsetHeight);
        var u = s._handleResize.bind(s);
        s.addEventListener(window, "resize", u)
      }
      var c;
      s.addEventListener(a, "focus", function (t) {
        c && clearTimeout(c), c = setTimeout(function () {
          c = null, s._updateFocusState()
        }, n._FOCUS_INTERVAL)
      }, !0), s.addEventListener(a, "blur", function (t) {
        c && clearTimeout(c), c = setTimeout(function () {
          c = null, s._updateFocusState()
        }, n._FOCUS_INTERVAL)
      }, !0);
      var l = s._handleDisabled.bind(s),
        h = s.addEventListener.bind(s);
      if (h(a, "mousedown", l, !0), h(a, "mouseup", l, !0), h(a, "click", l, !0), h(a, "dblclick", l, !0), h(a, "keydown", l, !0), h(a, "wheel", l, t.getEventOptions(!0, !0)), null == n._touching && (n._touching = !1, "ontouchstart" in window || "onpointerdown" in window)) {
        var p = document.body,
    ...
    return __extends(n, e), n.prototype.getTemplate = function () {
      ...
      for (var i = r; i;) {
        if (i == e) return !0;
        i = i[n._OWNR_KEY] || i.parentElement
      }
      return !1
      ...
      r && (this._rtlDir = "rtl" == getComputedStyle(r).direction, t.toggleClass(r, "wj-rtl", this._rtlDir)), this.isUpdating || (this.onRefreshing(), setTimeout(function () {
        n.onRefreshed()
      ...
      set: function (e) {
        (e = t.asBoolean(e, !0)) != this.isDisabled && t.enable(this._e, !e)
      },
      enumerable: !0,
      configurable: !0
      ...
      setTimeout(function () {
        ...
        if (o)
          for (var s = !0, a = o; a;) {
            ...
            u && !u._focus && u.containsFocus() && (s && (t.addClass(a, "wj-state-focus"), s = !1), u._focus = !0, u._updateState(), u.onGotFocus(e)), a = a[n._OWNR_KEY] || a.parentElement
          }
      })
    }, n.prototype._updateState = function () {
      var e = this.hostElement;
      if (e) {
        t.toggleClass(e, "wj-state-focused", this._focus);
      ...
      return n.prototype._copy = function (n, r) {
        ...
        return function (s, a) {
          for (var u = 0; u < t.length; u++) {
            var c = t[u],
              l = c._bnd.getValue(s),
              h = c._bnd.getValue(a);
            if (e && (l = e(c, s, l, i), h = e(c, a, h, !1), i = !1), r && null != (o = r(l, h))) return c.ascending ? +o : -o;
        ...
        if (i && t.isPrimitive(o)) {
          ...
          for (var c = 0; c < n.length; c++)
            if (e.namesMatch(n[c].name, o)) return n[c];
        var l = new r(e, o, s, a);
      ...
      if (!e.defaultPrevented)
        if ("click" != e.type || t.Control._touching) {
          ...
          this._clearTimeouts(), this._toShow = setTimeout(function () {
            ...
            if (r > -1) {
              var i = n._tips[r],
                o = n._showAtMouse ? new t.Rect(e.clientX, e.clientY, 0, 0) : null;
              n.show(i.element, i.content, o), n._hideDelay > 0 && (n._toHide = setTimeout(function () {
                n.hide()
              }, n._hideDelay))
            }
          }, r)
        } else this._hideAutoTip()
    }, e.prototype._hideAutoTip = function () {
  ...
  t.showPopup = function (r, i, o, s, a) {
    ...
    if (i instanceof HTMLElement) {
      ...
      for (var c = i; c; c = c.parentElement)
        if (n(c) || "fixed" == getComputedStyle(c).position) {
          u = c;
          break
        }
    }
    ...
    if (u != l || f > 1.005) {
      ...
      if (n(u) && u.offsetParent && (d = u.offsetParent), d) {
        var g = d.getBoundingClientRect();
        h = new t.Point(d.scrollLeft - g.left, d.scrollTop - g.top)
      }
    }
    r.offsetHeight && r.offsetWidth && t.contains(u, r) || u.lastChild != r && u.appendChild(r);
    var m = null;
    i instanceof HTMLElement && (m = getComputedStyle(i), a && new t.Color(m.backgroundColor).a && t.setCss(r, {
      color: m.color,
    ...
    var _ = getComputedStyle(r),
      v = parseFloat(_.marginTop) + parseFloat(_.marginBottom),
      y = parseFloat(_.marginLeft) + parseFloat(_.marginRight),
      b = new t.Size(r.offsetWidth + y, r.offsetHeight + v),
      C = new t.Point,
      w = null,
      E = p.clientWidth,
      A = p.clientHeight;
    if (i && null != i.clientX && null != i.clientY && null != i.pageX && null != i.pageY) i.clientX <= 0 && i.clientY <= 0 && i.target ? w = i.target.getBoundingClientRect() : (C.x = Math.max(0, i.pageX - pageXOffset), C.y = Math.max(0, i.pageY - pageYOffset));
    else if (i instanceof t.Point) C = i;
    else if (i instanceof HTMLElement) w = i.getBoundingClientRect();
    else if (i && null != i.top && null != i.left) w = i;
    else {
      if (null != i) throw "Invalid ref parameter.";
      C.x = Math.max(0, (E - b.width) / 2), C.y = Math.max(0, Math.round((A - b.height) / 2 * .7))
    }
    var x = parseFloat(_.minWidth);
    if (w) {
      x = Math.max(x, w.width), t.isIE() && (x -= r.offsetWidth - (r.clientWidth + parseInt(_.borderLeftWidth) + parseInt(_.borderRightWidth)));
      var S = w.top,
        O = A - w.bottom;
      C.x = Math.max(0, Math.min(w.left, E - b.width)), C.y = o ? S > b.height || S > O ? Math.max(0, w.top - b.height) : w.bottom : O > b.height || O > S ? w.bottom : Math.max(0, w.top - b.height)
    } else C.y + b.height > A - 20 && (C.y = Math.max(0, A - 20 - b.height)), C.x + b.width > E - 20 && (C.x = Math.max(0, E - 20 - b.width));
    var T = {
      position: "absolute",
      opacity: "",
      left: C.x + h.x,
    ...
    i instanceof HTMLElement && (r[t.Control._OWNR_KEY] = i);
    var P = null;
    s && (T.opacity = "0", P = t.animate(function (t) {
      r.style.opacity = t < 1 ? t.toString() : ""
    })), t.setCss(r, T);
    var I = i instanceof MouseEvent ? i.target : i;
    if (I instanceof HTMLElement && I.parentElement != document.body) {
      var M = Date.now(),
        F = I.getBoundingClientRect(),
        D = new t.Control(document.createElement("div"));
      r[t.Control._SCRL_KEY] = D, D.addEventListener(document, "scroll", function (n) {
        if (Date.now() - M > 100 && t.contains(document, I) && !t.contains(r, n.target) && (n.target != document || null != i && "fixed" == r.style.position)) {
          var o = I.getBoundingClientRect(),
            s = Math.abs(o.left - F.left),
            a = Math.abs(o.top - F.top);
          (s > 1 || a > 1) && e(r, !0)
        }
      }, !0)
    }
...
!function (t) {
  ...
  function l(e, n, r) {
    if (n = p(e, n, r), !M[" "] && !c() && !u(e, r)) {
      M[" "] = !0;
      var i = t.culture.Licensing || I,
  ...
  function p(e, r, i) {
    (!r || r.trim().length < 15) && (r = (t.culture.Licensing || I).evl), (!r || r.trim().length < 15) && (r = atob("V2lqbW8gRXZhbHVhdGlvbiBWZXJzaW9uICh7dmVyc2lvbn0p"));
    var o = null;
    if (i && i.Exp) {
      var s = i.Exp;
  ...
  function w(t) {
    return String.fromCharCode.apply(null, new F(t))
  }

  function E(t) {
    for (var e = atob(t), n = e.length, r = new F(n), i = 0; i < n; i++) r[i] = e.charCodeAt(i);
    return r.buffer
  }
  ...
  function S(t) {
    for (var e = new ArrayBuffer(t.length), n = new F(e), r = 0, i = t.length; r < i; r++) n[r] = t.charCodeAt(r);
    return e
  }
  ...
  var P = "The Wijmo license in this application ",
    I = {
      evl: "Wijmo Evaluation Version ({version})",
      prd: P + "is not valid for the <b>{control}</b> control.",
      ver: P + "is not valid for the version in use. The license version is <b>{licVer}</b>; the product version is <b>{version}</b>.",
      dmn: P + "is not valid for the current domain. The license domain is <b>{licDomain}</b>; the current domain is <b>{domain}</b>.",
      exp: P + "has expired. The license expiration date is <b>{expDate:d}</b>.",
      lic: P + "is invalid.",
      mss: P + "is not set.",
  ...
  var F = "undefined" == typeof window ? null : window.Uint8Array || window.TypedArray
}(wijmo || (wijmo = {}));
var wijmo;
!function (t) {
  "use strict";
  var e = function () {
    ...
    return Object.defineProperty(e.prototype, "input", {
      ...
      this._composing && (this._composing = !1, setTimeout(function () {
        n._tbx && (n._valueChanged() || t.setSelectionRange(n._tbx, n._tbx.value.length), n._tbx.dispatchEvent(n._evtInput))
      }))
  ...
  var e = function () {
    ...
    return Object.defineProperty(e.prototype, "element", {
      ...
      this._isDown && this._mouseup(null), this._disabled || (this._isDown = !0, e._stopEvents.forEach(function (t) {
        ...
        r._isDown && (r._onClick(), r._toRepeat = setTimeout(r._onClickBnd, t.Control._CLICK_REPEAT))
      ...
      this._clearTimeouts(), this._e && (this._e.click(), this._isDown && (this._toRepeat = setTimeout(this._onClickBnd, t.Control._CLICK_REPEAT)))
...
!function (t) {
  ...
  }, "undefined" != typeof document && document.doctype && navigator.appVersion.indexOf("MSIE 9") > -1 && (a = !0, document.addEventListener("mousemove", function (e) {
    if (1 == e.which) {
    ...
    if (!window[l]) {
      ...
      window[l] = function (t) {
        var e = Date.now(),
          n = 16 - (e - h),
          r = n > 0 ? n : 0;
        return h = e + r, setTimeout(function () {
          t(h)
        }, r)
    ...
    if (!window.atob) {
      ...
      window.atob = function (t) {
        var e, n, r, i, o = [],
          s = 0,
          a = t.length;
        if (f.test(t) || /=/.test(t) && (/=[^=]/.test(t) || /={3}/.test(t))) throw new Error("Invalid base64 data");
        for (a % 4 > 0 && (a = (t += Array(4 - a % 4 + 1).join("=")).length); s < a;) {
          for (n = [], i = s; s < i + 4;) n.push(p.indexOf(t.charAt(s++)));
        ...
        for (var e, n, r = [], i = 0, o = t.length; i < o;) e = ((n = [t.charCodeAt(i++), t.charCodeAt(i++), t.charCodeAt(i++)])[0] << 16) + ((n[1] || 0) << 8) + (n[2] || 0), r.push(p.charAt((e & 63 << 18) >> 18), p.charAt((258048 & e) >> 12), p.charAt(isNaN(n[1]) ? 64 : (4032 & e) >> 6), p.charAt(isNaN(n[2]) ? 64 : 63 & e));
        return r.join("")
      }
    }
  }
