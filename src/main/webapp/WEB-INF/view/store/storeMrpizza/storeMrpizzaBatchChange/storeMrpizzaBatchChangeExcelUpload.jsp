...
<div class="subCon" id ="storeMrpizzaBatchChangeExcelUploadView" style="display: none;padding: 10px 20px 40px;">
    <div ng-controller="storeMrpizzaBatchChangeExcelUploadCtrl">
        <%-- 조회조건 --%>
        <div class="searchBar flddUnfld">
            <a href="#" class="open fl"><s:message code="storeMrpizzaBatchChange.storeMrpizzaBatchChangeExcelUpload" /></a>
        </div>
        ...
        <div class="mt10 oh">
            ...
            <p class="tl s14 mt5 lh15 red">※ 업로드시 '매장코드, 팀별, 지역구분, 상권, 정포유형' 기준으로 처리됩니다.</p>
        ...
        <div class="wj-gridWrap" style="display: none;">
            <wj-flex-grid
                ...
                <wj-flex-grid-column header="<s:message code="storeMrpizzaBatchChange.storeNm"/>" binding="storeNm" width="150" is-read-only="true" align="center"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/store/storeMrpizza/storeMrpizzaBatchChange/storeMrpizzaBatchChangeExcelUpload.js?ver=20250708.01" charset="utf-8"></script>

<%-- 상품엑셀업로드 팝업 --%>
<c:import url="/WEB-INF/view/store/storeMrpizza/storeMrpizzaBatchChange/storeMrpizzaBatchChangeExcelUploadAdd.jsp">
