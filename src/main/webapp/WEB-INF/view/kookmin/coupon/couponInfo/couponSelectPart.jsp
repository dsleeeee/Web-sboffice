...
<wj-popup control="couponSelectPartLayer" show-trigger="Click" hide-trigger="Click" style="display: none; width:550px;">
    <div class="wj-dialog wj-dialog-columns title">
        ...
        <%-- body --%>
        <div class="wj-dialog-body" ng-controller="couponSelectPartCtrl">
            <div class="w100">
                <%-- 조회조건 --%>
...
<script type="text/javascript" src="/resource/solbipos/js/kookmin/coupon/couponInfo/couponSelectPart.js?ver=20251022.01" charset="utf-8"></script>
