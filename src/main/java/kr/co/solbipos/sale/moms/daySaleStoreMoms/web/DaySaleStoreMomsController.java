package kr.co.solbipos.sale.moms.daySaleStoreMoms.web;
...
/**
 * @Class Name : DaySaleStoreMomsController.java
 ...
 */
@Controller
@RequestMapping("/sale/moms/daySaleStoreMoms")
public class DaySaleStoreMomsController {

    private final SessionService sessionService;
    private final DaySaleStoreMomsService daySaleStoreMomsService;
     ...
     */
    @Autowired
    public DaySaleStoreMomsController(SessionService sessionService, DaySaleStoreMomsService daySaleStoreMomsService, CmmCodeUtil cmmCodeUtil, DayProdService dayProdService, CmmEnvUtil cmmEnvUtil) {
        this.sessionService = sessionService;
        this.daySaleStoreMomsService = daySaleStoreMomsService;
     ...
     * @param model
     */
    @RequestMapping(value = "/daySaleStoreMoms/list.sb", method = RequestMethod.GET)
    public String daySaleStoreMomsView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/moms/daySaleStoreMoms/daySaleStoreMoms";
    }

    /**
     * 일별매출(매장) - 조회
     *
     * @param daySaleStoreMomsVO
     * @param request
     * @param response
     * @param model
     * @return  Object
     ...
     * @since   2023. 12. 28.
     */
    @RequestMapping(value = "/daySaleStoreMoms/getDaySaleStoreMomsList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getDaySaleStoreMomsList(DaySaleStoreMomsVO daySaleStoreMomsVO, HttpServletRequest request,
                                     HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = daySaleStoreMomsService.getDaySaleStoreMomsList(daySaleStoreMomsVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, result, daySaleStoreMomsVO);
    }
     ...
     * @since   2023. 12. 28.
     */
    @RequestMapping(value = "/daySaleStoreMoms/getDaySaleStoreMomsExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getDaySaleStoreMomsExcelList(DaySaleStoreMomsVO daySaleStoreMomsVO, HttpServletRequest request,
                                          HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = daySaleStoreMomsService.getDaySaleStoreMomsExcelList(daySaleStoreMomsVO, sessionInfoVO);
     ...
     * @since   2024. 01. 19.
     */
    @RequestMapping(value = "/daySaleStoreMoms/getDaySaleStoreMomsExcelDivisionList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getDaySaleStoreMomsExcelDivisionList(DaySaleStoreMomsVO daySaleStoreMomsVO, HttpServletRequest request,
                                               HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = daySaleStoreMomsService.getDaySaleStoreMomsExcelDivisionList(daySaleStoreMomsVO, sessionInfoVO);
