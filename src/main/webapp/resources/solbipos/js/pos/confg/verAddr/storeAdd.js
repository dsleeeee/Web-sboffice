 ...
 *
 * 파일명 : storeAdd.js
 * 설  명 : 주소버전관리 > 매장추가 상세보기 JavaScript
 *
...
app.controller('addStoreCtrl', ['$scope', '$http', function ($scope, $http) {
  ...
  $scope.addStoreSearch = function(){
    ...
    var params = {};
    var scope  = agrid.getScope('verAddrCtrl');
    ...
    $scope._inquiryMain("/pos/confg/verAddr/applcStore/srchStoreList.sb", params, function() {
      // 적용매장 조회 후, 미적용 매장 조회
  ...
  $scope.delete = function(){
    ...
    $scope._save("/pos/confg/verAddr/applcStore/removeStore.sb", params, function(){
      // 적용매장 조회 후, 미적용 매장 조회
...
app.controller('allStoreCtrl', ['$scope', '$http', function ($scope, $http) {
  ...
  $scope.save = function(){
    ...
    // 저장기능 수행 : 저장URL, 파라미터, 콜백함수
    $scope._save("/pos/confg/verAddr/applcStore/regist.sb", params, function(){
      // 적용매장 조회 후, 미적용 매장 조회
      var addStoreScope = agrid.getScope("addStoreCtrl");
      addStoreScope._broadcast('addStoreCtrl');
    });
