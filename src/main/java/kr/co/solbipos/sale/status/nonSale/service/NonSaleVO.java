 ...
 */
public class NonSaleVO extends PageVO {
    ...
    public String getNonSaleFg() {
        return nonSaleFg;
    }

    public void setNonSaleFg(String nonSaleFg) {
        this.nonSaleFg = nonSaleFg;
    }
