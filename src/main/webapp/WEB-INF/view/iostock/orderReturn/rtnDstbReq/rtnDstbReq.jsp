  ...
  <div class="w100 mt10">
    ...
    <div class="wj-gridWrap" style="height: 420px; overflow-y: hidden; overflow-x: hidden;">
      <wj-flex-grid
        ...
        <wj-flex-grid-column header="<s:message code="rtnDstbReq.orderSlipNo"/>" binding="orderSlipNo" width="100" align="center" is-read-only="true"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/iostock/orderReturn/rtnDstbReq/rtnDstbReq.js?ver=20240711.01" charset="utf-8"></script>
