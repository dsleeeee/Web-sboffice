...
<div class="subCon">
    <div ng-controller="monthProdStoreMrpizzaCtrl">
        <div class="searchBar">
            <a href="#" class="open fl"><s:message code="monthProdStoreMrpizza.monthProdStoreMrpizza"/></a>
            <%-- 조회 --%>
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('monthProdStoreMrpizzaCtrl', 1)">
            ...
            <tr>
                ...
                <td>
                    <jsp:include page="/WEB-INF/view/application/layer/searchProdClassCd3.jsp" flush="true">
                        <jsp:param name="targetId" value="monthProdStoreMrpizzaSelectClass"/>
                    </jsp:include>
                </td>
            </tr>
            <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                            ...
                            <jsp:param name="targetId" value="monthProdStoreMrpizzaStore"/>
                        </jsp:include>
                        <%--// 매장선택 모듈 사용시 include --%>
                    </td>
                </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <jsp:include page="/WEB-INF/view/sale/com/popup/selectProdMMoms.jsp" flush="true">
                        <jsp:param name="targetId" value="monthProdStoreMrpizzaSelect"/>
                    </jsp:include>
    ...
    <div class="pageNum mt20">
        <%-- id --%>
        <ul id="monthProdStoreMrpizzaCtrlPager" data-size="10">
        </ul>
    </div>
    <%-- //페이지 리스트 --%>

    <%--엑셀 리스트--%>
    <div class="w100 mt10" style="display:none;" ng-controller="monthProdStoreMrpizzaExcelCtrl">
        <div class="wj-gridWrap" style="height: 380px; overflow-x: hidden; overflow-y: hidden;">
            <wj-flex-grid
                    id="wjGridExcelList"
                    autoGenerateColumns="false"
...
<script type="text/javascript" src="/resource/solbipos/js/sale/prod/monthProdStoreMrpizza/monthProdStoreMrpizza.js?ver=20250616.01" charset="utf-8"></script>
