                ...
                <tr>
                    ...
                    <td>
                        <div class="sb-select mr5" style="width:110px; float:left;">
                            <wj-combo-box
                                    id="hqTuClsType"
                                    ng-model="hqTuClsType"
                                    items-source="_getComboData('hqTuClsType')"
                                    display-member-path="name"
                                    selected-value-path="value"
                                    is-editable="false"
                                    control="hqTuClsTypeCombo">
                            </wj-combo-box>
                        </div>
                    </td>
...
<script type="text/javascript" src="/resource/solbipos/js/base/prod/kioskKeyMap/popUpHqSalePrice.js?ver=20230830.01" charset="utf-8"></script>
