...
<div style="display: none;" ng-controller="excelUploadCtrl">
    ...
    <div class="wj-gridWrap" style="height: 350px;">
        <wj-flex-grid
            ...
            <wj-flex-grid-column header="<s:message code="member.excel.telNo"/>" binding="telNo" width="100"
                                 align="left"
            ...
            <wj-flex-grid-column header="<s:message code="member.excel.shortNo"/>" binding="shortNo" width="100"
                                 align="left"
                                 data-type="String" visible="{{shortNo}}"></wj-flex-grid-column>
            <wj-flex-grid-column header="<s:message code="member.excel.email"/>" binding="email" width="100"
                                 align="left"
                                 data-type="String" visible="{{email}}"></wj-flex-grid-column>
            <wj-flex-grid-column header="<s:message code="member.excel.postNo"/>" binding="postNo" width="100"
                                 align="left"
            ...
            <wj-flex-grid-column header="<s:message code="member.excel.addrDtl"/>" binding="addrDtl" width="100"
                                 align="left"
