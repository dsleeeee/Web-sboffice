...
<div class="con" id="kioskKeyMapView" name="kioskKeyMapView">
    <div class="tabType1" ng-controller="kioskKeyMapCtrl" ng-init="init()">
        <ul>
            <%-- 일별종합 탭 --%>
            <li>
...
<script type="text/javascript" src="/resource/solbipos/js/base/prod/kioskKeyMap/kioskKeyMap.js?ver=20200903.02" charset="utf-8"></script>
<%-- 탭페이지 레이어 시작 --%>
<%-- 키오스크키맵등록 레이어 --%>
