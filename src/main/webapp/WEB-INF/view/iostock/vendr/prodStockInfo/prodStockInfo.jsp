    ...
    <div class="wj-TblWrapBr">
      ...
      <div class="wj-gridWrap" style="height: 350px;">
        <wj-flex-grid
          ...
          <wj-flex-grid-column header="<s:message code="prodStockInfo.poUnitFg"/>" binding="poUnitFg" width="50" align="center" is-read-only="true"></wj-flex-grid-column>
...
<script type="text/javascript">
  ...
  app.controller('prodStockInfoCtrl', ['$scope', '$http', function ($scope, $http) {
    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('prodStockInfoCtrl', $scope, $http, true));
    ...
    $scope.initGrid = function (s, e) {
      ...
      $scope._makePickColumns("prodStockInfoCtrl");
      ...
      s.columnHeaders.rows[0].dataItem = {
        ...
        poUnitFg : messages["prodStockInfo.poUnitFg"],
        poUnitQty: messages["prodStockInfo.poUnitQty"],
        inCnt    : messages["prodStockInfo.inCnt"],
        inTotQty : messages["prodStockInfo.inOut"],
        inAmt    : messages["prodStockInfo.inOut"],
        inVat    : messages["prodStockInfo.inOut"],
        inTot    : messages["prodStockInfo.inOut"],
      };
    ...
    $scope.$on("prodStockInfoCtrl", function (event, data) {
      $scope.searchProdStockInfoList();
      // 기능수행 종료 : 반드시 추가
    ...
    // 상품별 입출고내역 리스트 조회
    $scope.searchProdStockInfoList = function () {
    ...
    $scope.prodStockInfoSelectVendrShow = function () {
      $scope._broadcast('prodStockInfoSelectVendrCtrl');
    };
