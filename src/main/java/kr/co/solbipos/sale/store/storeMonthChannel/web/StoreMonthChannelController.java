package kr.co.solbipos.sale.store.storeMonthChannel.web;
...
/**
 * @Class Name : StoreMonthChannelController.java
...
@Controller
@RequestMapping("/sale/store/storeMonthChannel")
public class StoreMonthChannelController {
    private final DayService dayService;
    private final TodayDtlService todayDtlService;
    private final SessionService sessionService;
    private final StoreMonthChannelService storeMonthChannelService;
    ...
    @Autowired
    public StoreMonthChannelController(DayService dayService, TodayDtlService todayDtlService, SessionService sessionService, StoreMonthChannelService storeMonthChannelService, StoreChannelService storeChannelService, DayProdService dayProdService, CmmCodeUtil cmmCodeUtil) {
        this.dayService = dayService;
        this.todayDtlService = todayDtlService;
        this.sessionService = sessionService;
        this.storeMonthChannelService = storeMonthChannelService;
    ...
    public String empMonthView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/store/storeMonthChannel/storeMonthChannel";
    }
     ...
     * @param   response
     * @param   model
     * @param   storeMonthChannelVO
     * @return  String
     * @author  권지현
     * @since   2022.11.18
     */
    @RequestMapping(value = "/storeMonthChannel/getMonthList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getMonthList(HttpServletRequest request, HttpServletResponse response,
                             Model model, StoreMonthChannelVO storeMonthChannelVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<String>> list = storeMonthChannelService.getMonthList(storeMonthChannelVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, list, storeMonthChannelVO);
    }
     ...
     * @since   2022.11.18
     */
    @RequestMapping(value = "/storeMonthChannel/getMonthExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getMonthExcelList(HttpServletRequest request, HttpServletResponse response,
                             Model model, StoreMonthChannelVO storeMonthChannelVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<String>> list = storeMonthChannelService.getMonthExcelList(storeMonthChannelVO, sessionInfoVO);
