...
<div class="con">
    <div class="tabType1" ng-controller="dayPeriodSaleCtrl" ng-init="init()">
        <ul>
            <%-- 시간대별 탭 --%>
            <li>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/dayPeriodSale/dayPeriodSale.js?ver=20200924.01" charset="utf-8"></script>
