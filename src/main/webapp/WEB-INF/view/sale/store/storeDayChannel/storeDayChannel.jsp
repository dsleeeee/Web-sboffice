...
<div class="subCon" ng-controller="storeDayChannelCtrl">
  <div class="searchBar">
    ...
    <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
      <%-- 조회 --%>
      <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('storeDayChannelCtrl', 1)">
  ...
  <div class="w100 mt10">
    ...
    <%--위즈모 테이블--%>
    <div class="wj-gridWrap" style="display: none;" ng-controller="storeDayChannelExcelCtrl">
      <wj-flex-grid
              id="wjGridExcelList"
              autoGenerateColumns="false"
              selection-mode="Row"
  ...
  <div class="pageNum mt20">
    <ul id="storeDayChannelCtrlPager" data-size="10">
    </ul>
  </div>
  <%--//페이지 리스트--%>
</div>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/store/storeDayChannel/storeDayChannel.js?ver=20241217.01" charset="utf-8"></script>
