...
<script type="text/javascript">
    <%-- angularJs --%>
    app.controller('agencyMainPopupCtrl', ['$scope', '$http', function ($scope, $http) {
...
<script type="text/javascript" src="/resource/solbipos/js/mobile/application/main/agencyMain.js?ver=20210218.02" charset="utf-8"></script>
