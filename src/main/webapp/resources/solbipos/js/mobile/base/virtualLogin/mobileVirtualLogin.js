/****************************************************************
 *
 * 파일명 : mobileVirtualLogin.js
 * 설  명 : (모바일) 가상로그인 JavaScript
 *
 ...
 * (모바일) 가상로그인 그리드 생성
 */
app.controller('mobileGridCtrl',  ['$scope', '$http', function ($scope, $http) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('mobileGridCtrl', $scope, $http, true));
    ...
    $scope.initGrid = function (s, e) {
        ...
        // $scope._makePickColumns("mobileGridCtrl");
        // 그리드 포맷
    ...
    // 가상로그인 그리드 조회
    $scope.$on("mobileGridCtrl", function(event, data) {
        // 파라미터
        var params = {};
        ...
        $scope._inquiryMain("/mobile/base/virtualLogin/mobileVirtualLogin/list.sb", params, function() {
