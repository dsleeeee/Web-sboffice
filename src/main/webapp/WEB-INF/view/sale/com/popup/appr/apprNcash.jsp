      ...
      <div class="w100 mt10">
        ...
        <div class="wj-gridWrap" style="height: 320px; overflow-x: hidden; overflow-y: hidden;">
          <wj-flex-grid
            ...
            <wj-flex-grid-column header="<s:message code="saleComPopup.ncash.apprNo"/>" 		binding="apprNo" 		width="70" 	align="center" is-read-only="true" format="@"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/com/appr/apprNcash.js?ver=20260409.01" charset="utf-8"></script>