...
<div id="storeOpenCloseBensonDayView" class="subCon" style="padding: 10px 20px 40px;">

    <div ng-controller="storeOpenCloseBensonDayTimeCtrl">
        <div class="searchBar">
            <a href="#" class="open fl"><s:message code="storeOpenCloseBenson.day"/></a>
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <%-- 조회 --%>
                <button class="btn_blue fr" id="btnSearch" ng-click="_broadcast('storeOpenCloseBensonDayTimeCtrl')"><s:message code="cmm.search"/></button>
            </div>
        </div>
        <table class="searchTbl">
            ...
            <tr>
                ...
                <%-- 옵션 --%>
                <th><s:message code="storeOpenCloseBenson.optionFg"/></th>
                <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                            ...
                            <jsp:param name="targetId" value="storeOpenCloseBensonDayStore"/>
                        </jsp:include>
                        <%--// 매장선택 모듈 사용시 include --%>
                    </td>
                </tr>
            ...
            <c:if test="${sessionInfo.orgnFg == 'STORE'}">
                <input type="hidden" id="storeOpenCloseBensonDayStoreCd" value="${sessionInfo.storeCd}"/>
            </c:if>
            </tbody>
        </table>
    </div>

    <div class="w40 mt10 fl" ng-controller="storeOpenCloseBensonDayCtrl">
            ...
            <div class="wj-TblWrapBr">
                ...
                <div style="height: 400px; overflow-x: hidden; overflow-y: hidden;">
                    <wj-flex-grid
                        ...
                        <wj-flex-grid-column header="<s:message code="storeOpenCloseBenson.time"/>" binding="time" width="80" align="center"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="storeOpenCloseBenson.openCnt"/>" binding="openCnt" width="80" align="center"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="storeOpenCloseBenson.closeCnt"/>" binding="closeCnt" width="80" align="center"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="storeOpenCloseBenson.open"/>" binding="open" width="50" align="center"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="storeOpenCloseBenson.close"/>" binding="close" width="50" align="center"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="storeOpenCloseBenson.noOpen"/>" binding="none" width="60" align="center"></wj-flex-grid-column>
    ...
    <div class="w60 mt10 fl" ng-controller="storeOpenCloseBensonDayDtlCtrl">
            ...
            <div class="wj-TblWrapBr">
                ...
                <div style="height: 400px; overflow-x: hidden; overflow-y: hidden;">
                    <wj-flex-grid
                        ...
                        <wj-flex-grid-column header="<s:message code="storeOpenCloseBenson.posNo"/>" binding="posNo" width="70" align="center" is-read-only="true"></wj-flex-grid-column>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/benson/storeOpenCloseBenson/storeOpenCloseBensonDay.js?ver=20260909.01" charset="utf-8"></script>
