...
app.controller('menuSaleMrpizzaCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.excelDownload = function () {
        ...
        $scope._popConfirm(messages["cmm.excel.totalExceDownload"], function () {
            $scope._broadcast('menuSaleMrpizzaExcelCtrl', params);
        });
    }
...
/**
 *   메뉴별매출 엑셀 다운로드 그리드 생성
 */
app.controller('menuSaleMrpizzaExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('menuSaleMrpizzaExcelCtrl', $scope, $http, false));
    ...
    // 다른 컨트롤러의 broadcast 받기
    $scope.$on("menuSaleMrpizzaExcelCtrl", function (event, data) {
    ...
    $scope.searchExcelList = function (params) {
        ...
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $scope._inquiryMain("/sale/mrpizza/menuSaleMrpizza/getMenuSaleMrpizzaExcelList.sb", params, function () {
            ...
            $timeout(function () {
                ...
                }, "메뉴별판매" + '_' + params.startDate + '_' + params.endDate + '_' + getCurDateTime() + '.xlsx', function () {
                    $timeout(function () {
