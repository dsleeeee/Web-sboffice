...
<div id="adminMediaPlaySeqView" class="subCon" style="display: none;padding: 10px 20px 40px">
    <div ng-controller="adminMediaPlaySeqCtrl">
        ...
        <div class="searchBar">
            ...
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <button class="btn_blue fr" ng-click="_broadcast('adminMediaPlaySeqCtrl',1)">
