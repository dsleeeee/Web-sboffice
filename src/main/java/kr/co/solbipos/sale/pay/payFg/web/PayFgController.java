...
public class PayFgController {
     ...
     */
    @Autowired
    public PayFgController(SessionService sessionService, PayFgService payFgService, DayProdService dayProdService, CmmCodeUtil cmmCodeUtil, DayService dayService) {
