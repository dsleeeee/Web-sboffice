...
<div class="subCon" ng-controller="dstbCloseStoreCtrl">
    ...
    <table class="searchTbl">
        ...
        <td colspan="3">
            ...
            <a href="javascript:;" class="btn_grayS" ng-click="addProd()"><s:message code="dstbCloseStore.addRegist" /></a>
        </td>
        </tbody>
    </table>
...
<script type="text/javascript">
    ...
    app.controller('dstbCloseStoreCtrl', ['$scope', '$http', function ($scope, $http) {
        ...
        $scope.addProd = function () {
            ...
            params.slipFg   = $scope.slipFg;
            $scope._broadcast('dstbAddProdCtrl', params);
        };
    }]);
</script>
...
<%-- 분배마감 추가등록 레이어 --%>
<c:import url="/WEB-INF/view/iostock/order/dstbCloseStore/dstbAddProd.jsp">
    <c:param name="menuCd" value="${menuCd}"/>
    <c:param name="menuNm" value="${menuNm}"/>
</c:import>
