...
public class ProdSaleDayBillMomsServiceImpl implements ProdSaleDayBillMomsService {
    ...
    public List<DefaultMap<Object>> getProdSaleDayBillMomsList(ProdSaleDayBillMomsVO prodSaleDayBillMomsVO, SessionInfoVO sessionInfoVO) {
        ...
        // 상품 array 값 세팅
        if(!StringUtil.getOrBlank(prodSaleDayBillMomsVO.getProdCds()).equals("")) {
            ProdVO prodVO = new ProdVO();
            prodVO.setArrSplitProdCd(CmmUtil.splitText(prodSaleDayBillMomsVO.getProdCds(), 3900));
            prodSaleDayBillMomsVO.setProdCdQuery(popupMapper.getSearchMultiProdRtn(prodVO));
        }
