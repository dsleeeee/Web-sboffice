...
<wj-popup control="wjSaleRegistKmuMemberLayer" show-trigger="Click" hide-trigger="Click" style="display:none;width:400px;height:500px;" fade-in="false" fade-out="false">
    <div ng-controller="saleRegistKmuMemberCtrl">

        <%-- header --%>
        <div class="wj-dialog-header wj-dialog-header-font">
            <s:message code="saleRegistKmuMember.info"/>
...
<script type="text/javascript" src="/resource/solbipos/js/excclc/excclc/saleRegistKmu/saleRegistKmuMember.js?ver=20251024.01" charset="utf-8"></script>