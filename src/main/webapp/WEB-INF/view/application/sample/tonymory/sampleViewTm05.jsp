...
.fixedMenu.t2 ul li a.btn_close {padding-right:0 !important; top:16px !important; right:10px !important}
		...
		<div class="subCon" ng-controller="spTonyCtrl">
			...
			<div class="fixedMenu t2">
				<nav>
					<ul>
						...
						<li>			
							<a href="/sample/tonymory/sample44.sb" class="on">판촉마일리지 관리</a>
							<a href="#" class="btn_close histClose"></a>
						</li>
						<li>			
			...
			<div class="searchBar flddUnfld">
				<a href="#" class="open fl">판촉마일리지 관리</a>
				<!-- 조회 -->
				...
				<tbody>
					<tr>
						...
						<td>
							...
							<span class="fl">
								<a href="#" class="btn_grayS ml5">추가</a>
								<a href="#" class="btn_grayS">지움</a>
							</span>
						</td>						
					</tr>
				</tbody>
			...
			<div class="wj-TblWrap">
				...
				<div class="w65 fl">
					...
					<div class="wj-TblWrapBr mr10 pd20">
						<p class="bk lh30">판촉마일리지정보(일괄적용)</p>
						...
						<table class="searchTbl">
							...
							<tbody>
								<tr>
									...
									<th>마일리지</th>
									<td colspan="3">
										<input type="text" id="" name="" ng-model="" class="sb-input"/>
										<span class="rdo ml10">
											<input type="radio" id="rdo1" name="1" checked/>
											<label for="rdo1"> 가산</label>
										</span>
										<span class="rdo ml10">
											<input type="radio" id="rdo2" name="1" />
											<label for="rdo2"> 감산</label>
										</span>
									</td>					
								</tr>
								<tr>
						...
						<div class="updownSet oh mb10 mt10">
							<button id="" class="btn_skyblue">일괄적용</button>
							<button id="" class="btn_skyblue">초기화</button>
							<button id="" class="btn_skyblue">엑셀</button>
							<button id="" class="btn_skyblue">파일업로드</button>
						</div>	
				...
				<div class="w35 fr">
					...
					<div class="wj-TblWrapBr ml10 pd20">
							...
							<tbody>
								<tr>
									...
									<td style="height:71px">
										<input type="text" id="" name="" ng-model="" class="sb-input mb10" placeholder="(2호선당산역2호점)"/><br>

										<span class="rdo fl">
											<input type="radio" id="rdo3" name="2" checked/>
											<label for="rdo3"> 가산</label>
										</span>
										<span class="rdo fl ml5">
											<input type="radio" id="rdo4" name="2" />
											<label for="rdo4"> 감산</label>
										</span>

										<span class="fl" style="position:relative; top:-3px;">
											<a href="#" class="btn_grayS ml5" id="" style="line-height:25px">신규</a>
										</span>										
									</td>				
								</tr>
						...
						<div class="updownSet oh mb10 mt10">
							...
							<button id="" class="btn_skyblue">삭제</button>
							<button id="" class="btn_skyblue">엑셀</button>
						</div>		
