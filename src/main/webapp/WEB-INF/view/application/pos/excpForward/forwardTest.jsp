...
<f:form modelAttribute="sessionInfo" method="post" action="/application/pos/excpForward/posLogin.sb">
    ...
    요청url : <input type="text" id="url" name="url" value="excpForwardView"/>
