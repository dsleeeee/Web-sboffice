...
<div class="subCon3" ng-controller="unusualCtrl">
  ...
  <table class="searchTbl">
    ...
    <tr>
      ...
      <td colspan="3">
        <div class="sb-select">
          <span class="txtIn"><input id="srchUnusualStartDate" class="w110px"></span>
          <span class="rg">~</span>
          <span class="txtIn"><input id="srchUnusualEndDate" class="w110px"></span>
        </div>
      </td>
    </tr>
    <tr>
...
<script type="text/javascript" src="/resource/solbipos/js/iostock/frnchs/unusual/unusual.js?ver=20240611.01" charset="utf-8"></script>
