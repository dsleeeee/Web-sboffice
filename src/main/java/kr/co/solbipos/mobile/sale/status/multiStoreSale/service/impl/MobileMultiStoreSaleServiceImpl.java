...
public class MobileMultiStoreSaleServiceImpl implements MobileMultiStoreSaleService {
     ...
     */
    @Autowired
    public MobileMultiStoreSaleServiceImpl(MobileMultiStoreSaleMapper mobileMultiStoreSaleMapper, PopupMapper popupMapper) {
    ...
    public List<DefaultMap<Object>> getMobileMultiStoreSaleList(MobileMultiStoreSaleVO mobileMultiStoreSaleVO, SessionInfoVO sessionInfoVO) {
        ...
        if(!StringUtil.getOrBlank(mobileMultiStoreSaleVO.getSrchStoreCd()).equals("")) {
            ...
            storeVO.setArrSplitStoreCd(CmmUtil.splitText(mobileMultiStoreSaleVO.getSrchStoreCd(), 3900));
            mobileMultiStoreSaleVO.setStoreCdQuery(popupMapper.getSearchMultiStoreRtn(storeVO));
        }
