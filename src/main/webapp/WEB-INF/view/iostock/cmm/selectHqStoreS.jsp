...
<input type="text"
       ...
       readonly/>
<input type="hidden" id="<c:out value="${param.targetId}Fg"/>" />
<c:if test="${empty param.modiFg}">
    ...
    <div class="wj-dialog-body">
      <div class="w100">
        ...
        <table class="tblType01">
          ...
          <tbody>
          <tr>
            <th><s:message code="envstHqMsMng.orgnCd" /></th>
            <td>
              <input type="text" id="srchStoreCd" ng-model="srchStoreCd"/>
            </td>
            <th><s:message code="envstHqMsMng.orgnNm" /></th>
            <td>
        ...
        <%--위즈모 테이블--%>
          ...
          <wj-flex-grid
            ...
            <!-- define columns -->
            <wj-flex-grid-column header="<s:message code="envstHqMsMng.orgnCd"/>" binding="orgnCd" width="100" align="center" is-read-only="true"></wj-flex-grid-column>
            <wj-flex-grid-column header="<s:message code="envstHqMsMng.orgnNm"/>" binding="orgnNm" width="*" align="left" is-read-only="true"></wj-flex-grid-column>
            <wj-flex-grid-column header="<s:message code="envstHqMsMng.orgnFg"/>" binding="orgnFg" width="100" align="center" is-read-only="true" data-map="orgnFgDataMap"></wj-flex-grid-column>
...
<script type="text/javascript">
  ...
  app.controller('${param.targetId}Ctrl', ['$scope', '$http', function ($scope, $http) {
    ...
    $scope.initGrid = function (s, e) {
      // 입력구분
      $scope.orgnFgDataMap = new wijmo.grid.DataMap(inFg, 'value', 'name');
      ...
      s.addEventListener(s.hostElement, 'mousedown', function (e) {
        ...
        if (ht.cellType === wijmo.grid.CellType.Cell) {
          ...
          if (col.binding === "orgnCd") {
            $("#" + $scope.targetId + "Cd").val(selectedRow.orgnCd);
            $("#" + $scope.targetId + "Nm").val("[" + selectedRow.orgnCd + "] " + selectedRow.orgnNm);
    ...
    $scope.searchStore = function () {
      ...
      $scope._inquirySub("/iostock/cmm/iostockCmm/selectHqStoreList.sb", params, function () {
        $scope.searchFg = "Y";
      });
    };
  }]);
