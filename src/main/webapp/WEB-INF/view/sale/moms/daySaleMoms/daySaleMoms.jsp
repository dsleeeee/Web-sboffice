    ...
    <div ng-controller="daySaleMomsCtrl">
        <div class="searchBar">
            ...
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('daySaleMomsCtrl', 1)">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/moms/daySaleMoms/daySaleMoms.js?ver=20251229.01" charset="utf-8"></script>