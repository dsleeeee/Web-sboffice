...
<div class="subCon" ng-controller="sideMenuSalePriceCtrl">
  ...
  <div class="searchBar">
    ...
    <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
      <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('sideMenuSalePriceCtrl',1)">
...
<script type="text/javascript" src=/resource/solbipos/js/base/price/sideMenuSalePrice/sideMenuSalePrice.js?ver=20260213.01" charset="utf-8"></script>
