...
app.controller('stockCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    angular.extend(this, new RootController('stockCtrl', $scope, $http, true));
    ...
    $scope.initGrid = function (s, e) {
        ...
        $scope._makePickColumns("stockCtrl");
    ...
    // <-- 검색 호출 -->
    $scope.$on("stockCtrl", function(event, data) {
        $scope.searchStock();
    ...
    $scope.searchStock = function() {
        var params = {};
        params.storeCd = $("#stockSelectStoreCd").val();
    ...
    $scope.excelDownload = function () {
        ...
        $timeout(function () {
            ...
            }, '재고현황(매장)_' + getToday() + '.xlsx', function () {
                $timeout(function () {
