...
<div id="timeSaleBensonMonthView" class="subCon" ng-controller="timeSaleBensonMonthCtrl" style="display: none;padding: 10px 20px 40px;">

    <div class="searchBar flddUnfld">
        <a href="#" class="open fl"><s:message code="timeSaleBenson.monthTitle"/></a>
        <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
            <button class="btn_blue fr" ng-click="_pageView('timeSaleBensonMonthCtrl', 1)" id="timeSaleBensonMonthBtnSearch">
    ...
    <table class="searchTbl">
        ...
        <tr>
            ...
            <td>
                <div class="sb-select">
                    <span class="txtIn"><input id="srchTimeSaleBensonMonthStartDate" class="w110px"/></span>
                    <span class="rg">~</span>
                    <span class="txtIn"><input id="srchTimeSaleBensonMonthEndDate" class="w110px"/></span>
                </div>
            </td>
            <%-- 일자옵션 --%>
            ...
            <td>
                <div class="sb-select">
                    <wj-combo-box
                            id="srchTimeSaleBensonMonthDateOptionCombo"
                            ng-model="dayOption"
                            items-source="_getComboData('monthOptionCombo')"
        ...
        <tr>
            ...
            <td>
                <div class="sb-select">
                    <wj-combo-box
                            id="srchTimeSaleBensonMonthStoreOptionCombo"
                            ng-model="storeOption"
                            items-source="_getComboData('monthStoreOptionCombo')"
                            display-member-path="name"
                            selected-value-path="value"
                            is-editable="false"
            ...
            <%-- 매장선택 --%>
            <th id="timeSaleBensonMonthStoreSelectTh" style="display: none;"><s:message code="cmm.store.select"/></th>
            <td id="timeSaleBensonMonthStoreSelectTd" style="display: none;">
                <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                    <jsp:param name="targetTypeFg" value="M"/>
                    <jsp:param name="targetId" value="timeSaleBensonMonthStore"/>
                </jsp:include>
            </td>
        </tr>
        </tbody>
    ...
    <div class="w100 mt10 mb20">
        <div class="wj-gridWrap" style="height:420px; overflow-y: hidden; overflow-x: hidden;">
            <wj-flex-grid
                    ...
                    ime-enabled="true"
                    id="wjGridTimeSaleBensonMonthList">

                <wj-flex-grid-column header="<s:message code="timeSaleBenson.saleYm"/>" binding="saleYm" width="80" align="center"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="timeSaleBenson.dayFrom"/>" binding="dayFrom" width="80" align="center" visible="false"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="timeSaleBenson.dayTo"/>" binding="dayTo" width="80" align="center" visible="false"></wj-flex-grid-column>
    ...
    <div class="pageNum mt20">
        <ul id="timeSaleBensonMonthCtrlPager" data-size="10"></ul>
    </div>

    <div class="w100 mt10" style="display:none;" ng-controller="timeSaleBensonMonthExcelCtrl">
        <wj-flex-grid
                autoGenerateColumns="false"
                control="excelFlex"
                initialized="initGrid(s,e)"
                items-source="data"
                is-read-only="true"
                id="wjGridTimeSaleBensonMonthExcelList">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/anals/timeSaleBenson/timeSaleBensonMonth.js?ver=20260720.01" charset="utf-8"></script>
