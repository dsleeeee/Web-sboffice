package kr.co.solbipos.sale.store.storeMonthChannelBenson.web;
...
/**
 * @Class Name : StoreMonthChannelBensonController.java
 ...
 */
@Controller
@RequestMapping("/sale/store/storeMonthChannelBenson")
public class StoreMonthChannelBensonController {

    private final StoreMonthChannelBensonService storeMonthChannelBensonService;
    ...
    @Autowired
    public StoreMonthChannelBensonController(StoreMonthChannelBensonService storeMonthChannelBensonService, DayService dayService, TodayDtlService todayDtlService, SessionService sessionService, StoreChannelService storeChannelService, DayProdService dayProdService) {
        this.storeMonthChannelBensonService = storeMonthChannelBensonService;
    ...
    @RequestMapping(value = "/storeMonthChannelBenson/view.sb", method = RequestMethod.GET)
    public String view(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/store/storeMonthChannelBenson/storeMonthChannelBenson";
    }
     ...
     * @return
     */
    @RequestMapping(value = "/storeMonthChannelBenson/getStoreMonthChannelBensonList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getStoreMonthChannelBensonList(HttpServletRequest request, HttpServletResponse response,
                                                  Model model, StoreMonthChannelBensonVO storeMonthChannelBensonVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<String>> list = storeMonthChannelBensonService.getStoreMonthChannelBensonList(storeMonthChannelBensonVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, list, storeMonthChannelBensonVO);
    }

    /**
     * 매장-월별매출현황(채널별) 엑셀 다운로드 조회
     * @param request
     * @param response
     * @param model
     * @param storeMonthChannelBensonVO
     * @return
     */
    @RequestMapping(value = "/storeMonthChannelBenson/getStoreMonthChannelBensonExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getStoreMonthChannelBensonExcelList(HttpServletRequest request, HttpServletResponse response,
                                                 Model model, StoreMonthChannelBensonVO storeMonthChannelBensonVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<String>> list = storeMonthChannelBensonService.getStoreMonthChannelBensonExcelList(storeMonthChannelBensonVO, sessionInfoVO);
