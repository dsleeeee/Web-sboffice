    ...
    <div class="w100" id="mobileWeekSaleDcGrid" ng-controller="mobileWeekSaleDcCtrl">
        <div class="wj-gridWrap" style="overflow-x: hidden; overflow-y: hidden; min-height:80px;">
            <wj-flex-grid
                ...
                <!-- define columns -->
                <wj-flex-grid-column header="<s:message code="mobile.weekSale.nm"/>" binding="nm" width="1.*" align="center" is-read-only="true"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="mobile.weekSale.dcRealSaleAmt"/>" binding="realSaleAmt" width="1.*" align="right" is-read-only="true" aggregate="Sum"></wj-flex-grid-column>
                <wj-flex-grid-column header="<s:message code="mobile.weekSale.amtRate"/>" binding="amtRate" width="1.*" align="right" is-read-only="true"></wj-flex-grid-column>
                <!-- 조회 결과가 없을 때, msg 띄우기 -->
    ...
    <div class="w100" id="mobileWeekSaleDtlGrid" ng-controller="mobileWeekSaleDtlCtrl">
        <div class="wj-gridWrap" style="overflow-x: hidden; overflow-y: hidden; min-height:100px;">
            <wj-flex-grid
                ...
                <wj-flex-grid-column header="<s:message code="mobile.weekSale.billUprc"/>" binding="shopBillUprc" width="55" align="right" is-read-only="true"></wj-flex-grid-column>
                <%-- 배달 --%>
                ...
                <wj-flex-grid-column header="<s:message code="mobile.weekSale.billUprc"/>" binding="dlvrBillUprc" width="55" align="right" is-read-only="true"></wj-flex-grid-column>
                <%-- 포장 --%>
                ...
                <wj-flex-grid-column header="<s:message code="mobile.weekSale.billUprc"/>" binding="packBillUprc" width="55" align="right" is-read-only="true"></wj-flex-grid-column>
                ...
                <wj-flex-grid-column header="<s:message code="mobile.weekSale.guestUprc"/>" binding="guestUprc" width="55" align="right" is-read-only="true"></wj-flex-grid-column>
                <%-- 결제수단 --%>
