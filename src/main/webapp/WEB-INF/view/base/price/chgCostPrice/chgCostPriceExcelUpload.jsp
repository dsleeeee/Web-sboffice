        ...
        <div class="w100 mt10 mb20">
            <div class="wj-gridWrap" style="height:50px; overflow-y: hidden; overflow-x: hidden;">
                <wj-flex-grid
                    ...
                    <!-- define columns -->
                    <wj-flex-grid-column header="<s:message code="chgCostPrice.prodCd"/>" binding="prodCd" width="100" is-read-only="true" align="center" format="@"></wj-flex-grid-column>
                    <wj-flex-grid-column header="<s:message code="chgCostPrice.change.costUprc"/>" binding="costUprc" width="100" align="right"></wj-flex-grid-column>
                </wj-flex-grid>
            </div>
        </div>
...
<script type="text/javascript" src="/resource/solbipos/js/base/price/chgCostPrice/chgCostPriceExcelUpload.js?ver=20260424.01" charset="utf-8"></script>
<%-- excelfile read js --%>
