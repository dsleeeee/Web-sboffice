...
<div class="subCon" ng-controller="mobilePeriodIoStockCtrl">
    <div class="searchBar flddUnfld">
        <a href="#" class="open fl"><s:message code="periodIostock.periodIostock"/></a>
        <%-- 조회 --%>
        <button class="btn_blue fr mt5 mr10" id="btnSearch" ng-click="_broadcast('mobilePeriodIoStockCtrl')"><s:message code="cmm.search"/></button>
    </div>
        ...
        <tr>
            ...
            <td style="display: none;">
                ...
                <jsp:include page="/WEB-INF/view/iostock/cmm/selectVendrM.jsp" flush="true">
                    <jsp:param name="targetId" value="mobilePeriodIoStockSelectVendr"/>
                </jsp:include>
                <input type="hidden" id="mobilePeriodIoStockSelectVendrCd" value=""/>
            </td>
        </tr>
        <tr>
            <%-- 기초/마감재고표시 --%>
    ...
    <div id="wjGridWrap" class="w100 mt10">
        <div class="wj-gridWrap" style="height: 350px; overflow-x: hidden; overflow-y: hidden;">
            <wj-flex-grid
                ...
                <div class="gridMsg" id="mobileStorePeriodIoStockMsg" style="line-height: 150px; display: none;"><s:message code="mobile.cmm.search.result.empty"/></div>
            </wj-flex-grid>
            <%-- ColumnPicker 사용시 include --%>
            <jsp:include page="/WEB-INF/view/layout/columnPicker.jsp" flush="true">
                <jsp:param name="pickerTarget" value="mobilePeriodIoStockCtrl"/>
            </jsp:include>
            <%--// ColumnPicker 사용시 include --%>
        </div>
    </div>
    ...
    <div class="pageNum3 mt20">
        <%-- id --%>
        <ul id="mobilePeriodIoStockCtrlPager" data-size="10">
        </ul>
    </div>
    <%--//페이지 리스트--%>

    <%--엑셀 리스트--%>
    <div id="wjGridWrap" class="w100 mt10" style="display:none;" ng-controller="mobilePeriodIoStockExcelCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/mobile/stock/status/periodIoStock/mobileStorePeriodIoStock.js?ver=20240801.01" charset="utf-8"></script>
