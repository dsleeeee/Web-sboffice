...
alert(0);
app.controller('tblmsListCtrl2', ['$scope', '$http', function ($scope, $http) {
  // 상위 객체 상속 : T/F 는 picker
  angular.extend(this, new RootController('tblmsListCtrl2', $scope, $http, false));

alert(1);
  // 버튼사용여부 필터 콤보
  $scope._setComboData("styleCombo", styleData);

  $scope.$on("tblmsListCtrl2", function(event, data) {
...
alert("url('/resource/solbipos/css/img/table/ie_setting_01.PNG')");
    viewStyleLayer.style.backgroundImage = "url('/resource/solbipos/css/img/table/ie_setting_01.PNG')";
