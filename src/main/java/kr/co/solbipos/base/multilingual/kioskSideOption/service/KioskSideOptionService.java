...
public interface KioskSideOptionService {
    ...
    List<DefaultMap<String>> getKioskTuClsTypeComboList(KioskSideOptionVO kioskSideOptionVO, SessionInfoVO sessionInfoVO);

    /** 키오스크중분류(카테고리명) 카테고리(대분류) 콤보박스 조회 */
    List<DefaultMap<String>> getKioskCategoryComboList(KioskSideOptionVO kioskSideOptionVO, SessionInfoVO sessionInfoVO);

    /** 키오스크중분류(카테고리명) 탭 리스트 조회 */
    List<DefaultMap<String>> getKioskMClsList(KioskSideOptionVO kioskSideOptionVO, SessionInfoVO sessionInfoVO);

    /** 키오스크중분류(카테고리명) 영문, 중문, 일문 저장 */
    int saveKioskMCls(KioskSideOptionVO[] kioskSideOptionVOs, SessionInfoVO sessionInfoVO);
