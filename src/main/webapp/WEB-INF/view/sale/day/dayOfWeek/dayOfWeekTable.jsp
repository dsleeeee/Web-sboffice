    ...
    <table class="searchTbl">
        ...
        <tbody>
            <tr>
                ...
                <td colspan="3">
                    <div class="sb-select">
                        <span class="txtIn"> <input id="startDateDayOfWeekTable" name="startDate" class="w110px" /></span>
                        <span class="rg">~</span>
                        <span class="txtIn"> <input id="endDateDayOfWeekTable" name="endDate" class="w110px" /></span>
                    </div>
                </td>
            </tr>
            <tr>
        ...
        <div class="wj-gridWrap" style="height:370px; overflow-y: hidden; overflow-x: hidden;">
            <div class="row">
                ...
                <jsp:include page="/WEB-INF/view/layout/columnPicker.jsp" flush="true">
                    <jsp:param name="pickerTarget" value="dayOfWeekTableCtrl"/>
                </jsp:include>
                <%--// ColumnPicker 사용시 include --%>
...
<script type="text/javascript" src="/resource/solbipos/js/sale/day/dayOfWeek/dayOfWeekTable.js?ver=20210322.01" charset="utf-8"></script>