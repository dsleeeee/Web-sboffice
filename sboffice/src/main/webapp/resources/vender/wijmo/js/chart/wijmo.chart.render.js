...
(function (wijmo) {
    ...
    (function (chart) {
        ...
        (function (render) {
            'use strict';
            //Render to canvas.
            var _CanvasRenderEngine = /** @class */ (function () {
                    ...
                    if (wijmo.isString(color) || rect == null) {
                        ...
                        if (color.colors && color.colors.length > 0 && gradient_1 != null) {
                            color.colors.forEach(function (c) {
                                var color = new wijmo.Color('#000000');
                                if (c.color != null) {
                                    color = c.color;
                                }
                                if (c.opacity != null) {
            ...
            render._CanvasRenderEngine = _CanvasRenderEngine;
            ...
            if (wijmo.chart.FlexChartBase && wijmo.chart.FlexChartBase.prototype && wijmo.chart.FlexChartBase.prototype._exportToImage) {
                ...
                wijmo.chart.FlexChartBase.prototype._exportToImage = function (extension, processDataURI) {
                    ...
                    var canvasEngine = new wijmo.chart.render._CanvasRenderEngine(this.hostElement, true), r = this.rendered, dataUrl, canvas;
        ...
        })(render = chart.render || (chart.render = {}));
