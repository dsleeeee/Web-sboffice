package kr.co.solbipos.sale.month.monthPos.web;
...
/**
 * @Class Name : MonthPosController.java
 ...
 */
@Controller
@RequestMapping("/sale/month/monthPos")
public class MonthPosController {

    private final SessionService sessionService;
    private final MonthPosService monthPosService;
     ...
     */
    @Autowired
    public MonthPosController(SessionService sessionService, MonthPosService monthPosService, DayService dayService, StoreChannelService storeChannelService, DayProdService dayProdService, CmmCodeUtil cmmCodeUtil) {
        this.sessionService = sessionService;
        this.monthPosService = monthPosService;
     ...
     * @param model
     */
    @RequestMapping(value = "/monthPos/list.sb", method = RequestMethod.GET)
    public String monthPosView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/month/monthPos/monthPos";
    }
     ...
     * @since   2022.10.11
     */
    @RequestMapping(value = "/monthPos/getMonthPosList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getMonthPosList(HttpServletRequest request, HttpServletResponse response, Model model, MonthPosVO monthPosVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> list = monthPosService.getMonthPosList(monthPosVO, sessionInfoVO);

        return ReturnUtil.returnListJson(Status.OK, list, monthPosVO);
    }
     ...
     * @since   2022.10.11
     */
    @RequestMapping(value = "/monthPos/getMonthPosExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getMonthPosExcelList(HttpServletRequest request, HttpServletResponse response, Model model, MonthPosVO monthPosVO) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> list = monthPosService.getMonthPosExcelList(monthPosVO, sessionInfoVO);
