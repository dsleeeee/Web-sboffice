        ...
        <div class="wj-dialog-body">
            ...
            <table class="tblType01">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <jsp:include page="/WEB-INF/view/sale/com/popup/selectProdSMoms.jsp" flush="true">
                            <jsp:param name="targetId" value="kioskDisplayResveAddProd"/>
                        </jsp:include>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="sb-input w70" id="srchProdClassCd" ng-model="prodClassCdNm" ng-click="popUpProdClass2()" style="float: left;"
                               placeholder="<s:message code="prod.prodClass" /> 선택" readonly/>
                        <input type="hidden" id="_prodClassCd" name="prodClassCd" ng-model="prodClassCd" disabled />
                        <button type="button" class="btn_skyblue fl mr5" id="btnCancelProdClassCd" style="margin-left: 5px;" ng-click="delProdClass2()"><s:message code="cmm.selectCancel"/></button>
                    </td>
                    <%-- 키오스크사용여부 --%>
                ...
                <tr class="brt">
                    ...
                    <th class="oh gr">
                        <div class="sb-select" style="width:120px; float:left;">
                            <wj-combo-box
                                    id="kioskDisplayYnAddCombo2"
                                    ng-model="kioskDisplayYnAddChange"
                                    control="kioskDisplayYnAddCombo2"
                                    items-source="_getComboData('kioskDisplayYnAddCombo2')"
                                    display-member-path="name"
                                    selected-value-path="value"
                                    is-editable="false"
                                    initialized="_initComboBox(s)">
            ...
            <div class="mt10 oh sb-select dkbr">
                <button class="btn_blue fr" id="nxBtnSearch1" ng-click="searchKioskDisplayResveAddList()"><s:message code="cmm.search" /></button>
                ...
                <button class="btn_blue mr5 fr" id="btnShow" ng-click="changeAddShow()">
                    <s:message code="kioskDisplayResve.select.changeAll" />
                </button>
             </div>
            ...
            <div class="w100 mt10">
                ...
                <div class="wj-gridWrap" style="height: 300px; overflow-y: hidden; overflow-x: hidden;">
                    <wj-flex-grid
                        ...
                        <wj-flex-grid-column header="<s:message code="kioskDisplayResve.branchCd"/>" binding="branchCd" is-read-only="true" width="80" is-read-only="true" align="center" visible="false"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="kioskDisplayResve.branchNm"/>" binding="branchNm" is-read-only="true" width="80" is-read-only="true" align="right" visible="false"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="kioskDisplayResve.storeCd"/>" binding="storeCd" width="80" is-read-only="true" align="center"></wj-flex-grid-column>
                        ...
                        <wj-flex-grid-column header="<s:message code="kioskDisplayResve.orgKioskDisplayYn"/>" binding="orgKioskDisplayYn" is-read-only="true" width="100" align="center" data-map="kioskDisplayYnComboDataMap"></wj-flex-grid-column>
                        <wj-flex-grid-column header="<s:message code="kioskDisplayResve.kioskDisplayYn"/>" binding="kioskDisplayYn" width="100" align="center" data-map="kioskDisplayYnComboDataMap"></wj-flex-grid-column>
                    </wj-flex-grid>
                </div>
                <%--//위즈모 테이블--%>
            </div>
            ...
            <div>
                <table class="tblType01">
                    ...
                    <tbody>
                    <tr>
                        <th><s:message code="kioskDisplayResve.startDate"/><s:message code="kioskDisplayResve.startTime"/></th>
                        <td colspan="3">
...
<script type="text/javascript" src="/resource/solbipos/js/base/prod/kioskDisplayResve/kioskDisplayResveAdd.js?ver=20231101.01" charset="utf-8"></script>
