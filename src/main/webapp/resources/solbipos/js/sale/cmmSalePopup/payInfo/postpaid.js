...
app.controller('postpaidCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  ...
  $scope.$on("postpaidCtrl", function (event, data) {
    ...
    $scope.wjPostpaidLayer.show(true);
  ...
  $scope.searchPostpaidList = function () {
    ...
    $scope._inquiryMain("/sale/cmmSalePopup/payInfo/postpaid/postpaid.sb", params);
  };
