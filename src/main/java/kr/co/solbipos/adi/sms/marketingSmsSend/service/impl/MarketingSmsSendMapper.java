...
//    DefaultMap<String> getTelNoNmCodeChk(MarketingSmsSendVO marketingSmsSendVO);
    ...
    List<DefaultMap<Object>> getRegSendUrlList(MarketingSmsSendVO marketingSmsSendVO);

    /** 전송 URL 관리(화이트리스트 등록요청) - 요청 등록 insert */
    int insertRegSendUrl(MarketingSmsSendVO marketingSmsSendVO);

    /** url 중복 요청 확인 */
    int getChkSendUrl(MarketingSmsSendVO marketingSmsSendVO);
}