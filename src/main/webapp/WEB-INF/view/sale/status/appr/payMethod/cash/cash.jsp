...
<div id="apprCashView" class="subCon3"  ng-controller="apprCashCtrl" style="display: none;padding: 10px 20px 40px;">
...
<script type="text/javascript" src="/resource/solbipos/js/sale/status/appr/payMethod/cash/cash.js?ver=20250416.01" charset="utf-8"></script>
