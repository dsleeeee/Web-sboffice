...
app.controller('cornerDayOfWeekCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
	...
	$scope.searchCornerDayOfWeekList = function (isPageChk) {
		...
		var startDt = new Date(wijmo.Globalize.format($scope.srchCornerDayOfWeekStartDate.value, 'yyyy-MM-dd'));
		var endDt = new Date(wijmo.Globalize.format($scope.srchCornerDayOfWeekEndDate.value, 'yyyy-MM-dd'));
