...
public interface StoreProdSaleReportService {
    ...
    int getDayStoreProdSaleReportSaveInsert(StoreProdSaleReportVO storeProdSaleReportVO, SessionInfoVO sessionInfoVO);

    /** 일자별 매장-상품 매출 다운로드 탭 - 삭제 */
    int getDayStoreProdSaleReportDel(StoreProdSaleReportVO[] storeProdSaleReportVOs, SessionInfoVO sessionInfoVO);
    ...
    DefaultMap<String> getDayStoreProdSaleReportChk(StoreProdSaleReportVO storeProdSaleReportVO, SessionInfoVO sessionInfoVO);

    /** 일자별 매장-상품 매출 다운로드 탭 - 조회 */
    List<DefaultMap<Object>> getDayStoreProdSaleReportList(StoreProdSaleReportVO storeProdSaleReportVO, SessionInfoVO sessionInfoVO);
