  ...
  <div class="wj-dialog wj-dialog-columns" ng-controller="prodModifyCtrl">
    ...
    <div class="wj-dialog-body sc2" style="height: 600px;">
            ...
            <td>
              <div class="sb-select">
                <wj-combo-box id="_prodTypeFg" name="prodTypeFg"
                  ...
                  uib-popover="<s:message code="prod.prodTypeFg" />은(는) 필수 값 입니다.">
                </wj-combo-box>
              </div>
            </td>
          </tr>
            ...
            <td>
              <div class="sb-select">
                <wj-combo-box id="_poProdFg" name="poProdFg"
                  ...
                  popover-placement="bottom-left"
                  popover-trigger="'mouseenter'"
                  uib-popover="<s:message code="prod.poProdFg" />은(는) 필수 값 입니다.">
                </wj-combo-box>
              </div>
            </td>
            <%--주문단위--%>
            ...
            <td>
              <div class="sb-select">
                <wj-combo-box id="_poUnitFg" name="poUnitFg"
                  ...
                  popover-placement="bottom-left"
                  popover-trigger="'mouseenter'"
                  uib-popover="<s:message code="prod.poUnitFg" />은(는) 필수 값 입니다.">
                </wj-combo-box>
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <input type="text" id="_poMinQty" name="poMinQty" class="sb-input w100"
                     ...
                     popover-placement="bottom-left"
                     popover-trigger="'mouseenter'"
                     uib-popover="<s:message code="prod.poMinQty" />은(는) 필수 값 입니다."/>
            </td>
            <th></th>
            <td></td>
          </tr>
      ...
      <table class="tblType01">
          ...
          <td>
            <div class="sb-select">
              <wj-combo-box id="_vatFg" name="vatFg"
                ...
                popover-placement="bottom-left"
                popover-trigger="'mouseenter'"
                uib-popover="<s:message code="prod.vatFg" />은(는) 필수 값 입니다.">
              </wj-combo-box>
            </div>
          </td>
          <%--재고관리여부--%>
          ...
          <td>
            <div class="sb-select">
              <wj-combo-box id="_stockProdYn" name="stockProdYn"
                ...
                popover-placement="bottom-left"
                popover-trigger="'mouseenter'"
                uib-popover="<s:message code="prod.stockProdYn" />은(는) 필수 값 입니다.">
              </wj-combo-box>
            </div>
          </td>
        </tr>
          ...
          <td>
            <div class="sb-select">
              <wj-combo-box id="_useYn" name="useYn"
                ...
                popover-placement="bottom-left"
                popover-trigger="'mouseenter'"
                uib-popover="<s:message code="cmm.useYn" />은(는) 필수 값 입니다.">
              </wj-combo-box>
            </div>
          </td>
          <%--안전재고--%>
        ...
        <tr>
          ...
          <td>
            <div class="sb-select">
              <%--<wj-combo-box id="_soldOutYn" name="soldOutYn"
                ...
                popover-placement="bottom-left"
                popover-trigger="'mouseenter'"
                uib-popover="<s:message code="prod.soldOutYn" />은(는) 필수 값 입니다.">
              </wj-combo-box>--%>
            </div>
          </td>
          <%--초기재고 //TODO --%>
          ...
          <td>
            <input type="text" id="_defaultStock" name="defaultStock" class="sb-input w100"
                   ...
                   popover-placement="bottom-left"
                   popover-trigger="'mouseenter'"
                   uib-popover="<s:message code="prod.defaultStock" />은(는) 필수 값 입니다."/>
          </td>
        </tr>
        <tr>
          <%--저장품코드 //TODO --%>
          ...
          <td>
            <div class="sb-select">
              <wj-combo-box id="_setProdFg" name="setProdFg"
                ...
                popover-placement="bottom-left"
                popover-trigger="'mouseenter'"
                uib-popover="<s:message code="prod.setProdFg" />은(는) 필수 값 입니다.">
              </wj-combo-box>
            </div>
          </td>
        </tr>
        <tr>
          <%--환급적용여부--%>
          <th><s:message code="prod.refApplyYn"/></th>
          <td>
            <div class="sb-select">
              <%--<wj-combo-box id="_refApplyYn" name="refApplyYn"
                ...
                initialized="_initComboBox(s)"
                required
                popover-enable="myForm.refApplyYn.$invalid"
                popover-placement="bottom-left"
                popover-trigger="'mouseenter'"
                uib-popover="<s:message code="prod.refApplyYn" />은(는) 필수 값 입니다.">
              </wj-combo-box>--%>
            </div>
          </td>
          <%-- 봉사료 포함 여부 --%>
...
<script type="text/javascript" src="/resource/solbipos/js/base/prod/prod/popUpProdModify.js?ver=20181112.01" charset="utf-8"></script>
