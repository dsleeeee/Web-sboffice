...
app.controller('storeCloseExceptCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  ...
  $scope.$on('storeCloseExceptCtrl', function(event, data) {
    ...
    $scope._inquirySub("/store/manage/storeCloseExcept/storeCloseExcept/getStoreCloseExceptList.sb", params, function() {
  ...
  $scope.delete = function() {
    ...
    $scope._save("/store/manage/storeCloseExcept/storeCloseExcept/deleteStoreCloseExcept.sb", params, function() {
...
app.controller('storeCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
  ...
  $scope.save = function() {
    ...
    // 저장기능 수행 : 저장URL, 파라미터, 콜백함수
    $scope._save("/store/manage/storeCloseExcept/storeCloseExcept/saveStoreCloseExcept.sb", params, function() {
      $scope._broadcast('storeCloseExceptCtrl');
    });
  };
