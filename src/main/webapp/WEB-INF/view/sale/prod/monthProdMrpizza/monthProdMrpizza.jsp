...
<div class="subCon">
    <div ng-controller="monthProdMrpizzaCtrl">
        <div class="searchBar">
            <a href="#" class="open fl"><s:message code="monthProdMrpizza.monthProdMrpizza"/></a>
            <%-- 조회 --%>
            <div class="mr15 fr" style="display:block;position: relative;margin-top: 6px;">
                <button class="btn_blue fr" id="btnSearch" ng-click="_pageView('monthProdMrpizzaCtrl', 1)">
        ...
        <table class="searchTbl">
            ...
            <tr>
                ...
                <td>
                    <jsp:include page="/WEB-INF/view/application/layer/searchProdClassCd3.jsp" flush="true">
                        <jsp:param name="targetId" value="monthProdMrpizzaSelectClass"/>
                    </jsp:include>
                </td>
            </tr>
            <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <jsp:include page="/WEB-INF/view/common/popup/selectStore.jsp" flush="true">
                            ...
                            <jsp:param name="targetId" value="monthProdMrpizzaStore"/>
                        </jsp:include>
                        <%--// 매장선택 모듈 사용시 include --%>
                    </td>
                </tr>
            ...
            <c:if test="${sessionInfo.orgnFg == 'STORE'}">
                <input type="hidden" id="monthProdMrpizzaStoreCd" value="${sessionInfo.storeCd}"/>
            </c:if>
            <tr>
                <c:if test="${sessionInfo.orgnFg == 'HQ'}">
                    <%-- 상품브랜드 --%>
                ...
                <td>
                    ...
                    <jsp:include page="/WEB-INF/view/sale/com/popup/selectProdMMoms.jsp" flush="true">
                        <jsp:param name="targetId" value="monthProdMrpizzaSelect"/>
                    </jsp:include>
    ...
    <div class="pageNum mt20">
        <%-- id --%>
        <ul id="monthProdMrpizzaCtrlPager" data-size="10">
        </ul>
    </div>
    <%-- //페이지 리스트 --%>

    <%--엑셀 리스트--%>
    <div class="w100 mt10" style="display:none;" ng-controller="monthProdMrpizzaExcelCtrl">
        <div class="wj-gridWrap" style="height: 380px; overflow-x: hidden; overflow-y: hidden;">
            <wj-flex-grid
                    id="wjGridExcelList"
                    autoGenerateColumns="false"
...
<script type="text/javascript" src="/resource/solbipos/js/sale/prod/monthProdMrpizza/monthProdMrpizza.js?ver=20250616.01" charset="utf-8"></script>
