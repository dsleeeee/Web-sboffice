package kr.co.solbipos.sale.moms.billSaleMoms.web;
...
/**
 * @Class Name : BillSaleMomsController.java
 ...
 */
@Controller
@RequestMapping("/sale/moms/billSaleMoms")
public class BillSaleMomsController {

    private final SessionService sessionService;
    private final BillSaleMomsService billSaleMomsService;
     ...
     */
    @Autowired
    public BillSaleMomsController(SessionService sessionService, BillSaleMomsService billSaleMomsService, CmmCodeUtil cmmCodeUtil, DayProdService dayProdService, CmmEnvUtil cmmEnvUtil) {
        this.sessionService = sessionService;
        this.billSaleMomsService = billSaleMomsService;
     ...
     * @param model
     */
    @RequestMapping(value = "/billSaleMoms/list.sb", method = RequestMethod.GET)
    public String billSaleMomsView(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "sale/moms/billSaleMoms/billSaleMoms";
    }
     ...
     * @since   2024. 01. 08.
     */
    @RequestMapping(value = "/billSaleMoms/getBillSaleMomsList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getBillSaleMomsList(BillSaleMomsVO billSaleMomsVO, HttpServletRequest request,
                                      HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = billSaleMomsService.getBillSaleMomsList(billSaleMomsVO, sessionInfoVO);
     ...
     * @since   2024. 01. 08.
     */
    @RequestMapping(value = "/billSaleMoms/getBillSaleMomsExcelList.sb", method = RequestMethod.POST)
    @ResponseBody
    public Result getBillSaleMomsExcelList(BillSaleMomsVO billSaleMomsVO, HttpServletRequest request,
                                           HttpServletResponse response, Model model) {

        SessionInfoVO sessionInfoVO = sessionService.getSessionInfo(request);

        List<DefaultMap<Object>> result = billSaleMomsService.getBillSaleMomsExcelList(billSaleMomsVO, sessionInfoVO);
