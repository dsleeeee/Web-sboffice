 ...
 * 설  명 : 매장별출력여부관리 - 사이드메뉴관리 탭 JavaScript
 *
 ...
 *  사이드메뉴관리 조회 그리드 생성
 */
app.controller('storeSideMenuProdPrintYnCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('storeSideMenuProdPrintYnCtrl', $scope, $http, false));
    ...
    // <-- 검색 호출 -->
    $scope.$on("storeSideMenuProdPrintYnCtrl", function(event, data) {
        $scope.searchStoreSideMenuProdPrintYn();
    ...
    $scope.searchStoreSideMenuProdPrintYn = function() {
        ...
        $scope._inquiryMain("/base/prod/storeProdPrintYn/storeSideMenuProdPrintYn/getStoreSideMenuProdPrintYnList.sb", params, function() {}, false);
    };
    // <-- //검색 호출 -->
    ...
    $scope.storeSideMenuProdPrintYnStoreShow = function () {
        $scope._broadcast('storeSideMenuProdPrintYnStoreCtrl');
    };
    ...
    $scope.save2 = function(orgParams) {
        ...
        $http({
            method : 'POST', //방식
            url    : '/base/prod/storeProdPrintYn/storeSideMenuProdPrintYn/getStoreSideMenuProdPrintYnSave.sb', /* 통신할 URL */
    ...
    $scope.excelDownload = function(){
        ...
        $timeout(function () {
            ...
            }, '매장별출력여부관리_사이드메뉴' + getCurDateTime() + '.xlsx', function () {
                $timeout(function () {
