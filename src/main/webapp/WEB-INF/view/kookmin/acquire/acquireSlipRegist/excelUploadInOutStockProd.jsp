...
<div style="display: none;" ng-controller="excelUploadInOutStockProdCtrl">
...
<script type="text/javascript" src="/resource/solbipos/js/kookmin/acquire/acquireSlipRegist/excelUploadInOutStockProd.js?ver=20240904.01" charset="utf-8"></script>
