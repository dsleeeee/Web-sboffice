 ...
 *  매장정보일괄변경 그리드 생성
 */
app.controller('empBatchChangeCtrl', ['$scope', '$http', function ($scope, $http) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('empBatchChangeCtrl', $scope, $http, false));
    ...
    $scope._setComboData("branchCdChgCombo", branchCdComboList3); // 지사
    ...
    // <-- 검색 호출 -->
    $scope.$on("empBatchChangeCtrl", function(event, data) {
        $scope.searchEmpBatchChange();
    ...
    $scope.searchEmpBatchChange = function(){
        ...
        $scope._inquiryMain("/base/store/empBatchChange/empBatchChange/getEmpList.sb", params);
    };
    // <-- //검색 호출 -->
    ...
    $scope.save = function() {
        ...
        $scope._popConfirm(messages["cmm.choo.save"], function() {
            ...
            $scope._save("/base/store/empBatchChange/empBatchChange/getEmpBatchChangeSave.sb", params, function(){
                $scope.searchEmpBatchChange();
            });
        });
    };
