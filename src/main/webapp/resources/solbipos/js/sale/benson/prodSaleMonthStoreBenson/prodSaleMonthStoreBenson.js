/****************************************************************
 *
 * 파일명 : prodSaleMonthStoreBenson.js
 * 설  명 : (벤슨) 간소화화면 > 상품매출월별(매장) JavaScript
 *
 ...
 *  상품매출월별(매장) 그리드 생성
 */
app.controller('prodSaleMonthStoreBensonCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('prodSaleMonthStoreBensonCtrl', $scope, $http, true));
    ...
    // <-- 검색 호출 -->
    $scope.$on("prodSaleMonthStoreBensonCtrl", function (event, data) {
        $scope.searchProdSaleMonthStoreBensonList();
        event.preventDefault();
    });

    $scope.searchProdSaleMonthStoreBensonList = function () {
        ...
        params.storeCds = $("#prodSaleMonthStoreBensonStoreCd").val();
        params.prodCds = $("#prodSaleMonthStoreBensonSelectCd").val();
        ...
        $scope._inquiryMain("/sale/benson/prodSaleMonthStoreBenson/prodSaleMonthStoreBenson/getProdSaleMonthStoreBensonList.sb", params, function (){
            // 상품분류합산조회
    ...
    $scope.prodSaleMonthStoreBensonSelectShow = function () {
        $scope._broadcast('prodSaleMonthStoreBensonSelectCtrl');
    };
    ...
    $scope.excelDownload = function (excelType) {
        ...
        if(params.excelType === '1') {
            ...
            $scope._popConfirm(messages["cmm.excel.totalExceDownload"], function() {
                $scope._broadcast('prodSaleMonthStoreBensonExcelCtrl', params);
            });
        }else{
            // 분할 엑셀다운로드 사용자 제한 체크
            $.postJSON('/sale/benson/prodSaleMonthStoreBenson/prodSaleMonthStoreBenson/getDivisionExcelDownloadUserIdChk.sb', params, function (response) {
                if (response.data.list === 0) {
                    $scope._popMsg(messages["prodSaleMonthStoreBenson.userIdChkAlert"]); // 사용권한이 없습니다.
 ...
 *  엑셀다운로드 그리드 생성
 */
app.controller('prodSaleMonthStoreBensonExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

    // 상위 객체 상속 : T/F 는 picker
    angular.extend(this, new RootController('prodSaleMonthStoreBensonExcelCtrl', $scope, $http, false));
    ...
    // <-- 검색 호출 -->
    $scope.$on("prodSaleMonthStoreBensonExcelCtrl", function (event, data) {
    ...
    $scope.searchExcelList = function (params) {
        // 조회 수행 : 조회URL, 파라미터, 콜백함수
        $scope._inquiryMain("/sale/benson/prodSaleMonthStoreBenson/prodSaleMonthStoreBenson/getProdSaleMonthStoreBensonExcelList.sb", params, function() {
    ...
    $scope.searchExcelDivisionList = function (params) {
        ...
        $.postJSON("/sale/benson/prodSaleMonthStoreBenson/prodSaleMonthStoreBenson/getProdSaleMonthStoreBensonList.sb", params, function(response){
                ...
                function delay(x){
                    return new Promise(function(resolve, reject){
                        ...
                        $.postJSON("/sale/benson/prodSaleMonthStoreBenson/prodSaleMonthStoreBenson/getDivisionExcelDownloadSaveUpdate.sb", params, function(response){
                            ...
                            // ajax 통신 설정
                            $.postJSON("/sale/benson/prodSaleMonthStoreBenson/prodSaleMonthStoreBenson/getProdSaleMonthStoreBensonExcelDivisionList.sb", params, function(response) {
                                // <-- 그리드 visible -->
