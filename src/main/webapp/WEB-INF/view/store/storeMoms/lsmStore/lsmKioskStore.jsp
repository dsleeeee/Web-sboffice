...
<div class="subCon" id ="lsmKioskStoreView" style="display: none;padding: 10px 20px 40px;">
    <div ng-controller="lsmKioskStoreCtrl">
        <div class="searchBar">
        ...
        <div class="w100 mt10">
            ...
            <div class="wj-gridWrap" style="height: 500px; overflow-y: hidden; overflow-x: hidden;">
                <wj-flex-grid
                    ...
                    <wj-flex-grid-column header="<s:message code="lsmStore.kioskClassCd"/>" binding="tuClsCd" width="140" align="center" is-read-only="true"></wj-flex-grid-column>
                    <wj-flex-grid-column header="<s:message code="lsmStore.kioskClassNm"/>" binding="tuClsNm" width="130" align="left" is-read-only="true"></wj-flex-grid-column>
        ...
        <div class="pageNum mt20">
            <%-- id --%>
            <ul id="lsmKioskStoreCtrlPager" data-size="10">
            </ul>
        </div>
        <%--//페이지 리스트--%>
        <%-- 엑셀 리스트 --%>
        <div class="w100 mt10" id="wjWrapType3" style="display:none;" ng-controller="lsmKioskStoreExcelCtrl">
