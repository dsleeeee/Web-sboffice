                ...
                <tr>
                    ...
                    <td>
                        <div class="sb-select mr5" style="width:110px; float:left;">
                            <wj-combo-box
                                    id="storeTuClsType"
                                    ng-model="storeTuClsType"
                                    items-source="_getComboData('storeTuClsType')"
                                    display-member-path="name"
                                    selected-value-path="value"
                                    is-editable="false"
                                    control="storeTuClsTypeCombo">
                            </wj-combo-box>
                        </div>
                    </td>
...
<script type="text/javascript" src="/resource/solbipos/js/base/prod/kioskKeyMap/popUpStoreSalePrice.js?ver=20230830.02" charset="utf-8"></script>
