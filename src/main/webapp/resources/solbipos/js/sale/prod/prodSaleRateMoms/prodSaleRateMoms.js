...
app.controller('prodSaleRateMomsExcelCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.searchExcelDivisionList = function (params) {
        ...
        params.limit = 1;
        params.offset = 1;
        $scope._postJSONQuery.withOutPopUp( "/sale/prod/prodSaleRateMoms/prodSaleRateMoms/getProdSaleRateList.sb", params, function(response){
                    ...
                    return new Promise(function(resolve, reject){
                        //setTimeout(function() {
                            ...
                            $scope._postJSONQuery.withOutPopUp("/sale/moms/prodSaleDayStoreMoms/prodSaleDayStoreMoms/getDivisionExcelDownloadSaveUpdate.sb", params, function(response){
                                ...
                                $http({
                                    method: 'POST', //방식
                                    url: '/sale/prod/prodSaleRateMoms/prodSaleRateMoms/getProdSaleRateList.sb', /* 통신할 URL */
