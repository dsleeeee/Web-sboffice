...
app.controller('posDayCtrl', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
	...
	$scope.srchPosDayStartDate = wcombo.genDateVal("#srchPosDayStartDate", gvStartDate);
	$scope.srchPosDayEndDate   = wcombo.genDateVal("#srchPosDayEndDate", gvEndDate);
	...
	// 포스별매출일자별 리스트 조회
	$scope.searchPosDayList = function () {
		...
		$scope._inquirySub("/sale/status/pos/day/list.sb", params);
	};
